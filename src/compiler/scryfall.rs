...
fn map_single_mana_symbol(s: &str) -> Option<ManaSymbols> {
    ...
    match s_upper.as_str() {
        ...
        // Hybrid / Phyrexian
        "W/P" | "P/W" => Some(ManaSymbols::WP),
        "U/P" | "P/U" => Some(ManaSymbols::UP),
        "B/P" | "P/B" => Some(ManaSymbols::BP),
        "R/P" | "P/R" => Some(ManaSymbols::RP),
        "G/P" | "P/G" => Some(ManaSymbols::GP),
        // Monocolor Hybrid (twobrid)
        "2/W" | "W/2" => Some(ManaSymbols::NW(2)),
        "2/U" | "U/2" => Some(ManaSymbols::NU(2)),
        "2/B" | "B/2" => Some(ManaSymbols::NB(2)),
        "2/R" | "R/2" => Some(ManaSymbols::NR(2)),
        "2/G" | "G/2" => Some(ManaSymbols::NG(2)),
        // Colorless Hybrid
        "C/W" | "W/C" => Some(ManaSymbols::CW),
        "C/U" | "U/C" => Some(ManaSymbols::CU),
        "C/B" | "B/C" => Some(ManaSymbols::CB),
        "C/R" | "R/C" => Some(ManaSymbols::CR),
        "C/G" | "G/C" => Some(ManaSymbols::CG),
        // Tri-Phyrexian / Hybrid Phyrexian
        "W/U/P" | "U/W/P" => Some(ManaSymbols::WUP),
        "W/B/P" | "B/W/P" => Some(ManaSymbols::WBP),
        "U/B/P" | "B/U/P" => Some(ManaSymbols::UBP),
        "U/R/P" | "R/U/P" => Some(ManaSymbols::URP),
        "B/R/P" | "R/B/P" => Some(ManaSymbols::BRP),
        "B/G/P" | "G/B/P" => Some(ManaSymbols::BGP),
        "R/G/P" | "G/R/P" => Some(ManaSymbols::RGP),
        "R/W/P" | "W/R/P" => Some(ManaSymbols::RWP),
        "G/W/P" | "W/G/P" => Some(ManaSymbols::GWP),
        "G/U/P" | "U/G/P" => Some(ManaSymbols::GUP),
        // Standard Hybrids
        "W/U" | "U/W" => Some(ManaSymbols::WU),
        "W/B" | "B/W" => Some(ManaSymbols::WB),
        "U/B" | "B/U" => Some(ManaSymbols::UB),
        "U/R" | "R/U" => Some(ManaSymbols::UR),
        "B/R" | "R/B" => Some(ManaSymbols::BR),
        "B/G" | "G/B" => Some(ManaSymbols::BG),
        "R/G" | "G/R" => Some(ManaSymbols::RG),
        "R/W" | "W/R" => Some(ManaSymbols::RW),
        "G/W" | "W/G" => Some(ManaSymbols::GW),
        "G/U" | "U/G" => Some(ManaSymbols::GU),
        _ => {
...
fn format_mana_symbol(m: &ManaSymbols) -> String {
    match m {
        ...
        ManaSymbols::WU => "W/U".to_string(),
        ManaSymbols::WB => "W/B".to_string(),
        ManaSymbols::UB => "U/B".to_string(),
        ManaSymbols::UR => "U/R".to_string(),
        ManaSymbols::BR => "B/R".to_string(),
        ManaSymbols::BG => "B/G".to_string(),
        ManaSymbols::RG => "R/G".to_string(),
        ManaSymbols::RW => "R/W".to_string(),
        ManaSymbols::GW => "G/W".to_string(),
        ManaSymbols::GU => "G/U".to_string(),
        ManaSymbols::NW(n) => format!("{}/W", n),
        ManaSymbols::NU(n) => format!("{}/U", n),
        ManaSymbols::NB(n) => format!("{}/B", n),
        ManaSymbols::NR(n) => format!("{}/R", n),
        ManaSymbols::NG(n) => format!("{}/G", n),
        ManaSymbols::CW => "C/W".to_string(),
        ManaSymbols::CU => "C/U".to_string(),
        ManaSymbols::CB => "C/B".to_string(),
        ManaSymbols::CR => "C/R".to_string(),
        ManaSymbols::CG => "C/G".to_string(),
        ManaSymbols::WP => "W/P".to_string(),
        ManaSymbols::UP => "U/P".to_string(),
        ManaSymbols::BP => "B/P".to_string(),
        ManaSymbols::RP => "R/P".to_string(),
        ManaSymbols::GP => "G/P".to_string(),
        ManaSymbols::WUP => "W/U/P".to_string(),
        ManaSymbols::WBP => "W/B/P".to_string(),
        ManaSymbols::UBP => "U/B/P".to_string(),
        ManaSymbols::URP => "U/R/P".to_string(),
        ManaSymbols::BRP => "B/R/P".to_string(),
        ManaSymbols::BGP => "B/G/P".to_string(),
        ManaSymbols::RGP => "R/G/P".to_string(),
        ManaSymbols::RWP => "R/W/P".to_string(),
        ManaSymbols::GWP => "G/W/P".to_string(),
        ManaSymbols::GUP => "G/U/P".to_string(),
    }
}
