...
enum Rule {
    ...
    RULE_100_2_PLAY_PLAYER_NEEDS_OWN_CARDS,
    ...
    RULE_100_2a_CONSTRUCTED_PLAY_WAY_PLAYING_CARDS,
    ...
    RULE_100_2b_LIMITED_PLAY_WAY_PLAYING_CARDS,
    ...
    RULE_100_2c_COMMANDER_DECKS_SUBJECT_ADDITIONAL_DECKBUILDING,
    ...
    RULE_100_2d_FORMATS_CARDS_ATTRACTION_PLANECHASE_ARCHENEMY,
    ...
    RULE_100_4_PLAYER_SIDEBOARD_GROUP_ADDITIONAL_CARDS(Condition),
    ...
    RULE_100_4a_CONSTRUCTED_PLAY_SIDEBOARD_CONTAIN_CARDS,
    ...
    RULE_100_4b_LIMITED_PLAY_INVOLVING_CARDS_NOT,
    ...
    RULE_100_4c_LIMITED_PLAY_INVOLVING_CARDS_NOT,
    ...
    RULE_100_4d_LIMITED_PLAY_INVOLVING_CARD_NOT,
    ...
    RULE_100_6_TOURNAMENTS_ORGANIZED_PLAY_ACTIVITIES_CARDS(Condition),
    ...
    RULE_101_3_INSTRUCTION_THATS_IGNORED_CARD_EFFECT(Condition),

    // 101.4. If multiple players would make choices and/or take actions at the same time, the active player (the player whose turn it is) makes any choices required, then the next player in turn order (usually the player seated to the active player’s left) makes any choices required, followed by the remaining nonactive players in turn order. Then the actions happen simultaneously. This rule is often referred to as the “Active Player, Nonactive Player (APNAP) order” rule.
    RULE_101_4_ACTIONS_ACTIVE_TURN_ORDER_NONACTIVE(Condition),
    ...
    RULE_101_4c_PLAYER_THAN_CHOICE_TIME_ORDER(Condition),
    ...
    RULE_101_4d_CHOICE_NONACTIVE_PLAYER_TURN_APNAP(Condition),
    ...
    RULE_102_3_MULTIPLAYER_GAME_TEAMS_PLAYERS_NOT,
    ...
    RULE_103_1a_GAME_SHARED_TEAM_TURNS_OPTION,
    ...
    RULE_103_1b_ARCHENEMY_GAME_METHODS_ARENT_TURN,
    ...
    RULE_103_1c_CARD_POWER_PLAY_CONTROLLER_EFFECT,
    ...
    RULE_103_2_GAMES_REQUIRE_ADDITIONAL_STEPS_ACTIONS,
    ...
    RULE_103_2a_PLAYERS_SIDEBOARDS_CARDS_SUBSTITUTE_SET(Condition),
    ...
    RULE_103_2d_CONSTRUCTED_GAME_PLAYER_PLAYING_STICKER(Condition),
    ...
    RULE_103_2e_CONSPIRACY_DRAFT_GAME_CARDS_ZONE,
    ...
    RULE_103_3_STARTING_PLAYER_ADDITIONAL_STEPS_CARDS,
    ...
    RULE_103_3a_GAME_SUPPLEMENTARY_DECKS_NONTRADITIONAL_CARDS,
    ...
    RULE_103_4d_PLAYER_BRAWL_GAME_STARTING_LIFE,

    // 103.4e. In an Archenemy game, the archenemy’s starting life total is 40.
    RULE_103_4e_ARCHENEMY_GAME_STARTING_LIFE_TOTAL,
    ...
    RULE_103_5_CARDS_HAND_EFFECTS_TURN_LIBRARY(Condition),
    ...
    RULE_103_5a_VANGUARD_GAME_PLAYERS_HAND_CARD,
    ...
    RULE_103_5b_EFFECT_PLAYER_ACTION_TIME_MULLIGAN(Condition),
    ...
    RULE_103_5c_MULTIPLAYER_GAME_BRAWL_CARDS_LIBRARY,
    ...
    RULE_103_5d_MULTIPLAYER_GAME_SHARED_TEAM_HAND(Condition),
    ...
    RULE_103_6_CARDS_ALLOW_ACTIONS_HAND_TURN,
    ...
    RULE_103_6a_CARD_PLAYER_GAME_BATTLEFIELD_ACTION(Condition),
    ...
    RULE_103_6b_CARD_PLAYER_HAND_ACTION_TURN(Condition),
    ...
    RULE_103_6c_MULTIPLAYER_GAME_SHARED_TEAM_ACTIONS,
    ...
    RULE_104_2_SEVERAL_WAYS_WIN_GAME,

    // 104.2a. A player still in the game wins the game if that player’s opponents have all left the game. This happens immediately and overrides all effects that would preclude that player from winning the game.
    RULE_104_2a_PLAYER_GAME_WINS_OPPONENTS_EFFECTS(Condition),

    // 104.2b. An effect may state that a player wins the game.
    RULE_104_2b_EFFECT_STATE_PLAYER_WINS_GAME,
    ...
    RULE_104_2c_MULTIPLAYER_GAME_TEAMS_PLAYER_WINS(Condition),

    // 104.2d. In an Emperor game, a team wins the game if its emperor wins the game. (See rule 809.5.)
    RULE_104_2d_EMPEROR_GAME_TEAM_WINS(Condition),

    // 104.3. There are several ways to lose the game.
    RULE_104_3_SEVERAL_WAYS_LOSE_GAME,

    // 104.3a. A player can concede the game at any time. A player who concedes leaves the game immediately. That player loses the game.
    RULE_104_3a_PLAYER_CONCEDE_GAME_TIME_LEAVES(Condition),
    ...
    RULE_104_3b_PLAYERS_ZERO_STATE_BASED_ACTION(Condition),
    ...
    RULE_104_3c_CARDS_LIBRARY_STATE_BASED_ACTION(Condition),
    ...
    RULE_104_3h_MULTIPLAYER_GAME_LIMITED_EFFECT_NOT(Condition),

    // 104.3i. In an Emperor game, a team loses the game if its emperor loses the game. (See rule 809.5.)
    RULE_104_3i_EMPEROR_GAME_TEAM_LOSES(Condition),
    ...
    RULE_104_4e_MULTIPLAYER_GAME_EFFECT_SPELL_ABILITY,
    ...
    RULE_104_4f_MULTIPLAYER_GAME_LOOP_ACTIONS_OBJECT(Condition),
    ...
    RULE_104_5_PLAYER_LOSES_GAME_LEAVES_DRAW(Condition),
    ...
    RULE_105_3_EFFECTS_CHANGE_OBJECTS_COLORLESS_ADDITION(Condition),
    ...
    RULE_105_4_PLAYER_ASKED_MULTICOLORED_NOT_COLORLESS(Condition),
    ...
    RULE_106_1a_COLORS_MANA_WHITE_BLUE_BLACK,

    // 106.1b. There are six types of mana: white, blue, black, red, green, and colorless.
    RULE_106_1b_TYPES_MANA_WHITE_BLUE_COLORLESS,
    ...
    RULE_106_3_MANA_PRODUCED_EFFECTS_ABILITIES_SPELLS(Condition),
    ...
    RULE_106_4_EFFECT_COSTS_STEP_PHASE_CARDS(Condition),
    ...
    RULE_106_4a_MANA_PLAYERS_POOL_SPENT_COST(Condition),
    ...
    RULE_106_4b_PLAYER_PASSES_PRIORITY_MANA_POOL(Condition),

    // 106.5. If an ability would produce one or more mana of an undefined type, it produces no mana instead.
    RULE_106_5_ABILITY_PRODUCE_MANA_UNDEFINED_TYPE(Condition),
    ...
    RULE_106_6_SPELLS_ABILITIES_PRODUCE_MANA_EFFECT(Condition),
    ...
    RULE_106_6a_REPLACEMENT_EFFECTS_SPELL_ABILITY_CONTINUOUS(Condition),
    ...
    RULE_106_7_ABILITIES_PRODUCE_BASED_PERMANENT_RESOLVE(Condition),
    ...
    RULE_106_8_EFFECT_ADD_MANA_HYBRID_COLORLESS(Condition),
    ...
    RULE_106_9_EFFECT_ADD_MANA_PHYREXIAN_SYMBOL(Condition),
    ...
    RULE_106_10_EFFECT_ADD_MANA_GENERIC_COLORLESS(Condition),
    ...
    RULE_106_11_EFFECT_ADD_MANA_SNOW_COLORLESS(Condition),
    ...
    RULE_106_12_TAP_PERMANENT_MANA_ACTIVATE_ABILITY,
    ...
    RULE_106_12a_ABILITY_PERMANENT_TAPPED_MANA_RESOLVES(Condition),
    ...
    RULE_106_12b_EFFECT_PERMANENT_TAPPED_MANA_ABILITY(Condition),
    ...
    RULE_107_1a_CANT_CHOOSE_DAMAGE_SPELL_ABILITY(Condition),
    ...
    RULE_107_2_ANYTHING_NEEDS_NUMBER_CANT_ZERO(Condition),
    ...
    RULE_107_3_OBJECTS_LETTER_X_PLACEHOLDER_ABILITIES,
    ...
    RULE_107_3a_SPELL_ABILITY_COST_X_STACK(Condition),

    // 107.3b. If a player is casting a spell that has an {X} in its mana cost, the value of X isn’t defined by the text of that spell, and an effect lets that player cast that spell while paying neither its mana cost nor an alternative cost that includes X, then the only legal choice for X is 0. This doesn’t apply to effects that only reduce a cost, even if they reduce it to zero. See rule 601, “Casting Spells.”
    RULE_107_3b_CASTING_SPELL_X_COST_EFFECT(Condition),
    ...
    RULE_107_3c_SPELL_ABILITY_X_COST_STACK(Condition),
    ...
    RULE_107_3d_COST_ASSOCIATED_SPECIAL_ACTION_X(Condition),
    ...
    RULE_107_3e_SPELL_ABILITY_X_COST_OBJECT(Condition),
    ...
    RULE_107_3f_X_SPELL_ABILITY_NOT_COST(Condition),
    ...
    RULE_107_3g_CARD_ZONE_STACK_X_COST(Condition),
    ...
    RULE_107_3h_EFFECT_COST_X_ZERO_SPELL(Condition),

    // 107.3i. Normally, all instances of X on an object have the same value at any given time.
    RULE_107_3i_INSTANCES_X_OBJECT_VALUE_TIME(Condition),
    ...
    RULE_107_3j_OBJECT_ABILITY_X_ZERO_EFFECTS(Condition),
    ...
    RULE_107_3k_OBJECTS_ACTIVATED_ABILITY_X_COST(Condition),
    ...
    RULE_107_3m_BATTLEFIELD_ABILITY_EFFECT_X_SPELL(Condition),
    ...
    RULE_107_4_MANA_SYMBOLS_W_ZERO_X,
    ...
    RULE_107_4a_PRIMARY_COLORED_MANA_COSTS_COLOR,
    ...
    RULE_107_4b_NUMERICAL_SYMBOLS_VARIABLE_X_COSTS,
    ...
    RULE_107_4c_COLORLESS_MANA_SYMBOL_C_COST,
    ...
    RULE_107_4d_SYMBOL_ZERO_MANA_PLACEHOLDER_COST,
    ...
    RULE_107_4e_HYBRID_MANA_SYMBOL_COLORLESS_COST(Condition),
    ...
    RULE_107_4f_PHYREXIAN_MANA_SYMBOLS_COLORED_COST,
    ...
    RULE_107_4h_COST_SNOW_MANA_SYMBOL_EFFECTS(Condition),
    ...
    RULE_107_5_TAP_COST_PERMANENT_CANT_CREATURES(Condition),
    ...
    RULE_107_6_UNTAP_COST_PERMANENT_CANT_CREATURES(Condition),
    ...
    RULE_107_7_ABILITY_LOYALTY_COST_X_ZERO,
    ...
    RULE_107_8_LEVELER_CARD_ABILITY_N1_N2,
    ...
    RULE_107_8a_LEVEL_N1_N2_ABILITIES_P(Condition),
    ...
    RULE_107_8b_LEVEL_N3_ABILITIES_P_LONG,
    ...
    RULE_107_9_BLOCK_CARDS_ABILITIES_GRAVEYARD_EFFECT(Condition),
    ...
    RULE_107_10_TYPE_CARD_TIMESHIFTED_CREATURE_EFFECT(Condition),
    ...
    RULE_107_11_PLANESWALKER_SYMBOL_PW_APPEARS_PLANECHASE(Condition),
    ...
    RULE_107_12_CHAOS_SYMBOL_APPEARS_PLANECHASE_ABILITIES,
    ...
    RULE_107_13_COLOR_INDICATOR_CARDS_MANA_COST,
    ...
    RULE_107_14_ENERGY_SYMBOL_E_COUNTER_PAY,
    ...
    RULE_107_15_SAGA_CARD_ABILITY_RN_EFFECT,
    ...
    RULE_107_15a_RN_EFFECT_LORE_COUNTERS_SAGA(Condition),

    // 107.15b. “{rN1}, {rN2}—[Effect]” is the same as “{rN1}—[Effect]” and “{rN2}—[Effect].”
    RULE_107_15b_RN1_RN2_EFFECT,
    ...
    RULE_107_16_TEXT_CLASS_CARD_ABILITY_COST,
    ...
    RULE_107_16a_COST_LEVEL_N_ABILITIES_ACTIVATE(Condition),

    // 107.17. The ticket symbol is {TK}. It represents one ticket counter.
    RULE_107_17_TICKET_SYMBOL_TK_COUNTER,
    ...
    RULE_107_17a_TICKET_SYMBOL_NUMBER_INSIDE_COST,
    ...
    RULE_108_2_TEXT_CARD_OBJECT(Condition),
    ...
    RULE_108_2a_GAMES_TRADITIONAL_CARDS_MEASURE_NOT,
    ...
    RULE_108_2b_TOKENS_ARENT_CONSIDERED_CARDS_SIZED,
    ...
    RULE_108_3_OWNER_CARD_GAME_PLAYER_ZONE(Condition),
    ...
    RULE_108_3a_PLANECHASE_GAME_SINGLE_PLANAR_CARDS,
    ...
    RULE_108_3b_SPELLS_ABILITIES_ALLOW_PLAYER_CARDS(Condition),
    ...
    RULE_108_4_CARD_DOESNT_CONTROLLER_PERMANENT_SPELL(Condition),

    // 108.4a. If anything asks for the controller of a card that doesn’t have one (because it’s not a permanent or spell), use its owner instead.
    RULE_108_4a_ANYTHING_CARD_NOT_PERMANENT_SPELL(Condition),
    ...
    RULE_108_5_NONTRADITIONAL_CARDS_CANT_ZONE_EFFECT(Condition),
    ...
    RULE_109_2_SPELL_ABILITY_OBJECT_CARD_ZONE(Condition),
    ...
    RULE_109_2a_SPELL_ABILITY_OBJECT_CARD_ZONE(Condition),
    ...
    RULE_109_2b_SPELL_ABILITY_DESCRIPTION_OBJECT_STACK(Condition),
    ...
    RULE_109_2c_SPELL_ABILITY_OBJECT_SOURCE_DAMAGE(Condition),
    ...
    RULE_109_2d_ABILITY_SCHEME_CARD_INCLUDES_ZONE(Condition),
    ...
    RULE_109_3_OBJECTS_COST_CARD_ABILITIES_HAND,
    ...
    RULE_109_4b_TRIGGERED_ABILITY_WAITING_STACK_HANDLING(Condition),

    // 109.4c. An emblem is controlled by the player who puts it into the command zone. See rule 114, “Emblems.”
    RULE_109_4c_EMBLEM_CONTROLLED_PLAYER_COMMAND_ZONE,
    ...
    RULE_110_2_PERMANENTS_OWNER_CARD_TOKEN_BATTLEFIELD(Condition),
    ...
    RULE_110_2a_EFFECT_PLAYER_OBJECT_BATTLEFIELD_ENTERS(Condition),
    ...
    RULE_110_2b_EFFECT_CAUSES_PERMANENT_SPELL_STACK(Condition),
    ...
    RULE_110_3_PERMANENTS_CARD_CONTINUOUS_EFFECTS_INTERACTION,
    ...
    RULE_110_4_PERMANENT_TYPES_CREATURE_CARDS_CANT,
    ...
    RULE_110_4a_TERM_PERMANENT_CARD_BATTLEFIELD_CREATURE,
    ...
    RULE_110_4b_TERM_PERMANENT_SPELL_BATTLEFIELD_CREATURE,

    // 110.4c. If a permanent somehow loses all its permanent types, it remains on the battlefield. It’s still a permanent.
    RULE_110_4c_PERMANENT_SOMEHOW_LOSES_TYPES_BATTLEFIELD(Condition),
    ...
    RULE_110_5_PERMANENTS_STATUS_PHYSICAL_STATE_CATEGORIES,

    // 110.5a. Status is not a characteristic, though it may affect a permanent’s characteristics.
    RULE_110_5a_STATUS_NOT_CHARACTERISTIC_AFFECT_PERMANENTS,
    ...
    RULE_110_5b_PERMANENTS_ENTER_BATTLEFIELD_SPELL_ABILITY(Condition),
    ...
    RULE_110_5c_PERMANENT_SPELL_ABILITY_TURN_BASED(Condition),
    ...
    RULE_111_2_PLAYER_CREATES_TOKEN_OWNER_BATTLEFIELD,
    ...
    RULE_111_3_SPELL_ABILITY_TEXT_CARD_NOT,
    ...
    RULE_111_4_SPELL_ABILITY_CREATES_TOKEN_BATTLEFIELD(Condition),
    ...
    RULE_111_5_SPELL_ABILITY_EFFECT_PERMANENT_CANT(Condition),
    ...
    RULE_111_6_TOKEN_SUBJECT_ANYTHING_PERMANENTS_CARD(Condition),
    ...
    RULE_111_7_ZONE_BATTLEFIELD_STATE_BASED_ACTION(Condition),
    ...
    RULE_111_8_BATTLEFIELD_CANT_ZONE_STATE_BASED(Condition),
    ...
    RULE_111_9_EFFECTS_PLAYER_CREATE_LEGENDARY_NAME,
    ...
    RULE_111_10h_COLORLESS_ADD_C_MANA_CANT,
    ...
    RULE_111_10i_TOKEN_COLORLESS_TRANSFORM_ZERO_CREATURE,
    ...
    RULE_111_10j_COLORLESS_CREATURE_ENCHANTED_BASE_POWER,
    ...
    RULE_111_10k_MONSTER_COLORLESS_CREATURE_ENCHANTED_TRAMPLE,
    ...
    RULE_111_10m_ROYAL_COLORLESS_CREATURE_ENCHANTED_WARD,
    ...
    RULE_111_10n_COLORLESS_CREATURE_ENCHANTED_ATTACKS_SCRY(Condition),
    ...
    RULE_111_10p_COLORLESS_ENCHANTMENT_CREATURE_ENCHANTED_CONTROL,
    ...
    RULE_111_10q_TOKEN_COLORLESS_CREATURE_ENCHANTED_GRAVEYARD(Condition),
    ...
    RULE_111_10r_COLORLESS_CREATURE_ENCHANTED_ATTACKS_TOUGHNESS(Condition),
    ...
    RULE_111_10s_TOKEN_COLORLESS_SACRIFICE_TARGET_CREATURE,
    ...
    RULE_111_10t_TOKEN_COLORLESS_SACRIFICE_EXILE_TOP,
    ...
    RULE_111_10u_TOKEN_COLORLESS_SACRIFICE_SEARCH_LIBRARY,
    ...
    RULE_111_10v_TOKEN_COLORLESS_SACRIFICE_COUNTER_TARGET,
    ...
    RULE_111_11_EFFECT_PLAYER_CREATE_NOT_CARD(Condition),
    ...
    RULE_111_12_EFFECT_PLAYER_CREATE_OBJECT_NOT(Condition),
    ...
    RULE_112_1a_COPY_SPELL_CARD_ASSOCIATED(Condition),
    ...
    RULE_112_1b_EFFECTS_ALLOW_CAST_CARD_SPELL(Condition),
    ...
    RULE_112_2_SPELLS_OWNER_CARD_COPY_STACK(Condition),
    ...
    RULE_112_2a_EFFECTS_PLAYER_CREATE_CARD_CAST,
    ...
    RULE_112_3_SPELLS_CARD_CONTINUOUS_EFFECTS_INTERACTION,
    ...
    RULE_113_1a_ABILITY_CHARACTERISTIC_OBJECT_EFFECT_GAINS,
    ...
    RULE_113_1b_ABILITY_PLAYER_CHANGES_GAME_EFFECTS(Condition),
    ...
    RULE_113_2c_OBJECT_ABILITIES_CARD_NOT_EFFECT(Condition),
    ...
    RULE_113_2d_ABILITIES_GENERATE_SHOT_EFFECTS_CONTINUOUS,

    // 113.3. There are four general categories of abilities:
    RULE_113_3_GENERAL_CATEGORIES_ABILITIES,
    ...
    RULE_113_3a_SPELL_ABILITIES_INSTRUCTIONS_INSTANT_RESOLVING(Condition),
    ...
    RULE_113_3b_ACTIVATED_ABILITIES_COST_EFFECT_ACTIVATION(Condition),

    // 113.3c. Triggered abilities have a trigger condition and an effect. They are written as “[Trigger condition], [effect],” and include (and usually begin with) the word “when,” “whenever,” or “at.” Whenever the trigger event occurs, the ability is put on the stack the next time a player would receive priority and stays there until it’s countered, it resolves, or it otherwise leaves the stack. See rule 603, “Handling Triggered Abilities.”
    RULE_113_3c_TRIGGERED_ABILITIES_TRIGGER_CONDITION_EFFECT(Condition),
    ...
    RULE_113_3d_STATIC_ABILITIES_CONTINUOUS_EFFECTS_PERMANENT,
    ...
    RULE_113_4_ABILITIES_MANA_SPECIAL_STACK_ACTIVATE(Condition),
    ...
    RULE_113_5_ABILITIES_LOYALTY_SPECIAL_ACTIVATE_PERMANENT(Condition),
    ...
    RULE_113_6_ABILITIES_SPELL_OBJECT_STACK_BATTLEFIELD,
    ...
    RULE_113_6a_CHARACTERISTIC_DEFINING_ABILITIES_FUNCTION_EVERYWHERE,

    // 113.6b. An ability that states which zones it functions in functions only from those zones.
    RULE_113_6b_ABILITY_ZONES_FUNCTIONS,
    ...
    RULE_113_6c_ABILITY_ZONES_DOESNT_FUNCTION_EVERYWHERE,
    ...
    RULE_113_6d_OBJECTS_ABILITY_COST_CAST_STACK,
    ...
    RULE_113_6e_OBJECTS_ABILITY_CAST_ZONE_STACK,
    ...
    RULE_113_6h_OBJECTS_ABILITY_MODIFIES_ENTERS_BATTLEFIELD,
    ...
    RULE_113_6i_OBJECTS_ABILITY_COUNTERS_CANT_BATTLEFIELD,
    ...
    RULE_113_6j_ABILITY_COST_CANT_BATTLEFIELD_ZONE,
    ...
    RULE_113_6k_TRIGGER_CANT_BATTLEFIELD_ZONES_ABILITY,
    ...
    RULE_113_6m_ABILITY_COST_EFFECT_OBJECT_ZONE(Condition),
    ...
    RULE_113_6n_ABILITY_MODIFIES_NOT_CANT_CARD(Condition),
    ...
    RULE_113_7a_ABILITY_STACK_CREATURE_DEALS_DAMAGE(Condition),
    ...
    RULE_113_8_CONTROLLER_ACTIVATED_ABILITY_STACK_PLAYER(Condition),
    ...
    RULE_113_9_ABILITIES_STACK_SPELLS_CANT_EFFECTS(Condition),
    ...
    RULE_113_10_EFFECTS_ABILITIES_STATE_GAINS_LOSES,
    ...
    RULE_113_10a_EFFECT_ADDS_ACTIVATED_ABILITY_OBJECT,

    // 113.10b. Effects that remove an ability remove all instances of it.
    RULE_113_10b_EFFECTS_REMOVE_ABILITY_INSTANCES,
    ...
    RULE_113_10c_EFFECTS_ADD_REMOVE_ABILITY_CONTINUOUS(Condition),
    ...
    RULE_113_11_EFFECTS_OBJECT_ABILITY_CANT_RESOLVING(Condition),
    ...
    RULE_114_2_EFFECT_EMBLEM_PLAYER_ABILITY_ZONE,
    ...
    RULE_114_3_EMBLEM_CHARACTERISTICS_ABILITIES_EFFECT_COST,

    // 114.4. Abilities of emblems function in the command zone.
    RULE_114_4_ABILITIES_EMBLEMS_FUNCTION_COMMAND_ZONE,
    ...
    RULE_115_1a_SPELL_ABILITY_TARGET_OBJECT_CAST(Condition),
    ...
    RULE_115_1b_AURA_SPELLS_ABILITY_CAST_PERMANENT,
    ...
    RULE_115_1c_ACTIVATED_ABILITY_TARGETED_TARGET_OBJECT(Condition),
    ...
    RULE_115_1d_TRIGGERED_ABILITY_TARGET_OBJECT_STACK(Condition),
    ...
    RULE_115_1e_KEYWORD_ABILITIES_EQUIP_MODULAR_SPELLS,
    ...
    RULE_115_2_PERMANENTS_SPELLS_ABILITIES_OBJECT_ZONE(Condition),
    ...
    RULE_115_3_TARGET_CANT_SPELL_ABILITY_OBJECT(Condition),
    ...
    RULE_115_4_SPELLS_ABILITIES_DAMAGE_TARGET_CREATURES,

    // 115.5. A spell or ability on the stack is an illegal target for itself.
    RULE_115_5_SPELL_ABILITY_STACK_ILLEGAL_TARGET,
    ...
    RULE_115_6_SPELL_ABILITY_REQUIRES_TARGETS_ZERO(Condition),
    ...
    RULE_115_7_EFFECTS_ALLOW_PLAYER_SPELL_ABILITY,
    ...
    RULE_115_7a_EFFECT_CHANGE_TARGET_SPELL_ABILITY(Condition),
    ...
    RULE_115_7b_EFFECT_CHANGE_TARGET_SPELL_ABILITY(Condition),
    ...
    RULE_115_7c_EFFECT_CHANGE_TARGETS_SPELL_ABILITY(Condition),
    ...
    RULE_115_7d_EFFECT_CHOOSE_NEW_TARGETS_SPELL(Condition),
    ...
    RULE_115_7e_CHANGING_TARGETS_CHOOSING_SPELL_ABILITY(Condition),
    ...
    RULE_115_7f_SPELL_ABILITY_DIVIDE_DISTRIBUTE_EFFECT(Condition),
    ...
    RULE_115_8_MODAL_SPELLS_ABILITIES_TARGETING_EFFECT,
    ...
    RULE_115_9_OBJECTS_CHECK_SPELL_ABILITY_STATE(Condition),
    ...
    RULE_115_9a_OBJECT_SPELL_ABILITY_NUMBER_TARGETS(Condition),
    ...
    RULE_115_9b_OBJECT_SPELL_ABILITY_TARGETS_STATE(Condition),
    ...
    RULE_115_9c_OBJECT_SPELL_ABILITY_TARGETS_STACK(Condition),
    ...
    RULE_115_10_SPELLS_ABILITIES_AFFECT_RESOLVES_RESOLVING,

    // 115.10a. Just because an object or player is being affected by a spell or ability doesn’t make that object or player a target of that spell or ability. Unless that object or player is identified by the word “target” in the text of that spell or ability, or the rule for that keyword ability, it’s not a target.
    RULE_115_10a_OBJECT_SPELL_ABILITY_TARGET_NOT(Condition),
    ...
    RULE_116_2_TWELVE_SPECIAL_ACTIONS,
    ...
    RULE_116_2a_SPECIAL_ACTION_BATTLEFIELD_ZONE_HAND,
    ...
    RULE_116_2b_FACE_CREATURE_SPECIAL_ACTION_SPELLS,
    ...
    RULE_116_2c_EFFECTS_ACTION_CONTINUOUS_ABILITY_SPECIAL(Condition),
    ...
    RULE_116_2d_EFFECTS_STATIC_ABILITIES_ACTION_SPECIAL,
    ...
    RULE_116_2e_CARD_CIRCLING_VULTURES_ABILITY_DISCARD,
    ...
    RULE_116_2f_CARD_SUSPEND_HAND_EXILE_SPECIAL(Condition),
    ...
    RULE_116_2g_CARD_HAND_SPECIAL_ACTION_STACK(Condition),
    ...
    RULE_116_2h_CARD_FORETELL_HAND_EXILE_SPECIAL,
    ...
    RULE_116_2k_CARD_PLOT_HAND_EXILE_SPECIAL,
    ...
    RULE_116_2m_PERMANENT_COST_UNLOCK_ACTION_STACK,
    ...
    RULE_117_1a_PLAYER_CAST_SPELL_PHASE_STACK,

    // 117.1b. A player may activate an activated ability any time they have priority.
    RULE_117_1b_PLAYER_ACTIVATE_ACTIVATED_ABILITY_TIME,
    ...
    RULE_117_1c_PLAYER_SPECIAL_ACTIONS_PHASE_STACK,
    ...
    RULE_117_1d_ACTIVATE_ABILITY_SPELL_EFFECT_RESOLVING(Condition),
    ...
    RULE_117_2_KINDS_ABILITIES_ACTIONS_AUTOMATICALLY_GENERATED,
    ...
    RULE_117_2a_ABILITIES_TRIGGER_SPELL_CAST_RESOLVING(Condition),
    ...
    RULE_117_2b_STATIC_ABILITIES_CONTINUOUSLY_AFFECT_GAME,
    ...
    RULE_117_2c_TURN_BASED_ACTIONS_HAPPEN_PHASE(Condition),
    ...
    RULE_117_2d_STATE_BASED_ACTIONS_HAPPEN_AUTOMATICALLY(Condition),
    ...
    RULE_117_2e_RESOLVING_SPELLS_ABILITIES_ACTIONS_ACTIVATE(Condition),

    // 117.3. Which player has priority is determined by the following rules:
    RULE_117_3_PLAYER_PRIORITY,

    // 117.3a. The active player receives priority at the beginning of most steps and phases, after any turn-based actions (such as drawing a card during the draw step; see rule 703) have been dealt with and abilities that trigger at the beginning of that phase or step have been put on the stack. No player receives priority during the untap step. Players usually don’t get priority during the cleanup step (see rule 514.3).
    RULE_117_3a_TURN_BASED_ACTIONS_CARD_ABILITIES(Condition),

    // 117.3b. The active player receives priority after a spell or ability (other than a mana ability) resolves.
    RULE_117_3b_ACTIVE_PLAYER_SPELL_ABILITY_RESOLVES,

    // 117.3c. If a player has priority when they cast a spell, activate an ability, or take a special action, that player receives priority afterward.
    RULE_117_3c_CAST_SPELL_ACTIVATE_ABILITY_SPECIAL(Condition),

    // 117.3d. If a player has priority and chooses not to take any actions, that player passes. If any mana is in that player’s mana pool, they announce what mana is there. Then the next player in turn order receives priority.
    RULE_117_3d_PLAYER_PRIORITY_NOT_ACTIONS_TURN(Condition),

    // 117.4. If all players pass in succession (that is, if all players pass without taking any actions in between passing), the spell or ability on top of the stack resolves or, if the stack is empty, the phase or step ends.
    RULE_117_4_ACTIONS_SPELL_ABILITY_STACK_RESOLVES(Condition),
    ...
    RULE_117_5_STATE_BASED_ACTIONS_ABILITIES_STACK(Condition),
    ...
    RULE_117_6_MULTIPLAYER_SHARED_TEAM_TURNS_OPTION,
    ...
    RULE_118_2_COST_ACTIVATE_ABILITIES_CAST_SPELL(Condition),
    ...
    RULE_118_3_CANT_COST_MANA_COLOR_ACTIVATING,
    ...
    RULE_118_3a_PAYING_MANA_REMOVING_INDICATED_ZERO(Condition),
    ...
    RULE_118_3b_PAYING_LIFE_SUBTRACTING_INDICATED_ZERO,

    // 118.3c. Activating mana abilities is not mandatory, even if paying a cost is.
    RULE_118_3c_ACTIVATING_MANA_ABILITIES_NOT_COST(Condition),
    ...
    RULE_118_5_COSTS_ZERO_REDUCED_ACTION_NOT,
    ...
    RULE_118_5a_SPELL_COST_ZERO_CAST_ABILITY,
    ...
    RULE_118_6_COST_ABILITY_BASED_CAST_SPELL(Condition),
    ...
    RULE_118_6a_UNPAYABLE_COST_EFFECT_CAST_SPELL(Condition),
    ...
    RULE_118_7_PLAYER_ACTUALLY_COST_EFFECTS_ZERO(Condition),
    ...
    RULE_118_7a_EFFECTS_REDUCE_COST_CANT_COLORLESS,
    ...
    RULE_118_7b_COST_REDUCED_AMOUNT_COLORED_COLORLESS(Condition),
    ...
    RULE_118_7c_COST_REDUCED_AMOUNT_COLORED_MANA(Condition),
    ...
    RULE_118_7d_COST_REDUCED_AMOUNT_COLORLESS_MANA(Condition),
    ...
    RULE_118_7e_COST_REDUCED_AMOUNT_MANA_COLORLESS(Condition),
    ...
    RULE_118_7f_COST_REDUCED_AMOUNT_MANA_PHYREXIAN(Condition),
    ...
    RULE_118_7g_COST_REDUCED_AMOUNT_MANA_SNOW(Condition),
    ...
    RULE_118_8_SPELLS_ABILITIES_ADDITIONAL_COSTS_EFFECT(Condition),
    ...
    RULE_118_8a_NUMBER_COSTS_SPELL_CAST_ABILITY,

    // 118.8b. Some additional costs are optional.
    RULE_118_8b_ADDITIONAL_COSTS_OPTIONAL,
    ...
    RULE_118_8c_EFFECT_CAST_SPELL_ABLE_COST(Condition),
    ...
    RULE_118_8d_ADDITIONAL_COSTS_SPELLS_CAST_ABILITIES,
    ...
    RULE_118_9_SPELLS_COSTS_EFFECT_PAY_RATHER,
    ...
    RULE_118_9a_ALTERNATIVE_COST_APPLIED_SPELL_CAST,
    ...
    RULE_118_9b_ALTERNATIVE_COSTS_EFFECT_CAST_SPELL,
    ...
    RULE_118_9c_ALTERNATIVE_COST_SPELLS_CAST_ABILITIES,
    ...
    RULE_118_9d_ALTERNATIVE_COST_PAID_CAST_SPELL(Condition),
    ...
    RULE_118_10_PAYMENT_COST_SPELL_ABILITY_EFFECT(Condition),
    ...
    RULE_118_11_ACTIONS_PERFORMED_PAYING_COST_EFFECTS(Condition),
    ...
    RULE_118_12_SPELLS_ABILITIES_PLAYER_CANT_EFFECT(Condition),
    ...
    RULE_118_12a_SPELLS_ACTIVATED_ABILITIES_PLAYER_ELSE(Condition),
    ...
    RULE_118_12b_EFFECTS_PLAYER_ZONE_ACTIONS_CARDS(Condition),
    ...
    RULE_118_13_COSTS_CONTAIN_MANA_SYMBOLS_PAID,
    ...
    RULE_118_13a_MANA_COST_SPELL_ACTIVATION_ABILITY(Condition),
    ...
    RULE_118_13b_COST_PAID_RESOLUTION_SPELL_ABILITY(Condition),
    ...
    RULE_118_13c_COST_ASSOCIATED_SPECIAL_ACTION_MANA(Condition),
    ...
    RULE_119_1a_HEADED_GIANT_GAME_TEAMS_VARIANT,
    ...
    RULE_119_1b_VANGUARD_GAME_PLAYERS_STARTING_CARD,

    // 119.1c. In a Commander game, each player’s starting life total is 40. See rule 903, “Commander.”
    RULE_119_1c_COMMANDER_GAME_PLAYERS_STARTING_LIFE,
    ...
    RULE_119_4_COST_EFFECT_PLAYER_PAY_ZERO(Condition),
    ...
    RULE_119_4a_COST_EFFECT_PLAYER_PAY_ZERO(Condition),
    ...
    RULE_119_4b_PLAYERS_PAY_ZERO_EFFECT_CANT(Condition),
    ...
    RULE_119_5_EFFECT_SETS_PLAYERS_LIFE_TOTAL(Condition),

    // 119.6. If a player has 0 or less life, that player loses the game as a state-based action. See rule 704.
    RULE_119_6_PLAYER_ZERO_STATE_BASED_ACTION(Condition),
    ...
    RULE_119_7_EFFECT_SAYS_PLAYER_CANT_COST(Condition),
    ...
    RULE_119_8_EFFECT_SAYS_PLAYER_CANT_COST(Condition),
    ...
    RULE_119_9_ABILITIES_PLAYER_GAINS_LIFE_SOURCE(Condition),
    ...
    RULE_120_1a_DAMAGE_CANT_OBJECT_NOT_CREATURE,
    ...
    RULE_120_2a_DAMAGE_DEALT_COMBAT_CREATURE_STEP,
    ...
    RULE_120_2b_DAMAGE_EFFECT_SPELL_ABILITY_OBJECT,
    ...
    RULE_120_3_DAMAGE_RESULTS_DEPENDING_RECIPIENT_PERMANENT(Condition),

    // 120.3a. Damage dealt to a player by a source without infect causes that player to lose that much life.
    RULE_120_3a_DAMAGE_DEALT_PLAYER_SOURCE_INFECT,
    ...
    RULE_120_3d_DAMAGE_DEALT_CREATURE_SOURCE_WITHER,
    ...
    RULE_120_3e_DAMAGE_DEALT_CREATURE_SOURCE_WITHER,
    ...
    RULE_120_3f_DAMAGE_DEALT_SOURCE_LIFELINK_CAUSES,
    ...
    RULE_120_4a_EFFECT_DAMAGE_PERMANENT_CREATURE_CARD(Condition),
    ...
    RULE_120_4b_DAMAGE_EFFECTS_ABILITIES_TRIGGER_STACK(Condition),
    ...
    RULE_120_4c_DAMAGE_THATS_DEALT_PROCESSED_EFFECTS,

    // 120.4d. Finally, the damage event occurs.
    RULE_120_4d_FINALLY_DAMAGE_EVENT_OCCURS,
    ...
    RULE_120_5_DAMAGE_CREATURE_STATE_BASED_ACTIONS,
    ...
    RULE_120_6_DAMAGE_CREATURE_STEP_PERMANENT_STATE(Condition),
    ...
    RULE_120_7_DAMAGE_OBJECT_EFFECT_PERMANENT_SPELL(Condition),
    ...
    RULE_120_8_ZERO_DAMAGE_NOT_ABILITIES_TRIGGER(Condition),
    ...
    RULE_120_9_ABILITY_DAMAGE_DEALT_EFFECT_NOT(Condition),
    ...
    RULE_121_2_CARDS_DRAWN_TIME_PLAYER_DRAW(Condition),
    ...
    RULE_121_2a_INSTRUCTION_DRAW_MULTIPLE_CARDS_EFFECTS,
    ...
    RULE_121_2b_EFFECTS_CANT_CARD_TURN_COST(Condition),
    ...
    RULE_121_2c_THAN_PLAYER_DRAW_CARDS_TURN(Condition),
    ...
    RULE_121_2d_THAN_PLAYER_DRAW_CARDS_GAME(Condition),
    ...
    RULE_121_3_CARDS_PLAYERS_LIBRARY_EFFECT_CANT(Condition),
    ...
    RULE_121_3a_NOT_CARD_LIBRARY_EFFECT_CANT(Condition),
    ...
    RULE_121_4_CARD_LIBRARY_STATE_BASED_ACTION(Condition),
    ...
    RULE_121_5_EFFECT_CARDS_LIBRARY_HAND_DRAW(Condition),

    // 121.6. Some effects replace card draws.
    RULE_121_6_EFFECTS_REPLACE_CARD_DRAWS,
    ...
    RULE_121_6a_EFFECT_REPLACES_CARD_DRAW_LIBRARY(Condition),
    ...
    RULE_121_6b_EFFECT_REPLACES_DRAW_SEQUENCE_CARD(Condition),
    ...
    RULE_121_6c_EFFECTS_PERFORM_ACTIONS_CARD_NOT(Condition),
    ...
    RULE_121_8_SPELL_ABILITY_CARD_CAST_EFFECT(Condition),
    ...
    RULE_122_1a_X_CREATURE_CARD_ZONE_BATTLEFIELD,
    ...
    RULE_122_1b_PERMANENT_CARD_ZONE_BATTLEFIELD_OBJECT,
    ...
    RULE_122_1c_SHIELD_PERMANENT_REPLACEMENT_EFFECT_PREVENTION(Condition),
    ...
    RULE_122_1d_STUN_PERMANENT_EFFECT_UNTAPPED_REMOVE(Condition),
    ...
    RULE_122_1e_BATTLEFIELD_ZERO_GRAVEYARD_STATE_BASED,
    ...
    RULE_122_1f_PLAYER_STATE_BASED_ACTION_POISONED(Condition),
    ...
    RULE_122_1g_BATTLEFIELD_ZERO_GRAVEYARD_ABILITY_NOT(Condition),
    ...
    RULE_122_1h_PERMANENT_EFFECT_GRAVEYARD_BATTLEFIELD_EXILE(Condition),
    ...
    RULE_122_1i_RAD_COUNTERS_ABILITY_TRIGGER_PHASE(Condition),
    ...
    RULE_122_2_COUNTERS_OBJECT_NOT_ZONE_REMOVED(Condition),
    ...
    RULE_122_3_PERMANENT_N_STATE_BASED_ACTION(Condition),
    ...
    RULE_122_4_PERMANENT_ABILITY_CANT_N_STATE(Condition),
    ...
    RULE_122_5_EFFECT_MOVE_OBJECT_ACTIONS_NOT(Condition),
    ...
    RULE_122_6_SPELLS_ABILITIES_COUNTERS_OBJECT_BATTLEFIELD,
    ...
    RULE_122_6a_OBJECT_ENTERS_BATTLEFIELD_COUNTERS_EFFECT(Condition),
    ...
    RULE_122_7_ABILITY_NTH_KIND_COUNTER_OBJECT(Condition),
    ...
    RULE_122_8_TRIGGERED_ABILITY_TRIGGER_EFFECT_BATTLEFIELD(Condition),
    ...
    RULE_122_9_ACTIVATED_ABILITY_OBJECT_COST_ACTIVATE(Condition),
    ...
    RULE_201_2c_SPELLS_ABILITIES_CHECK_OBJECT_NOT(Condition),
    ...
    RULE_201_3_INTERCHANGEABLE_NAMES_SAME_NAME,
    ...
    RULE_201_3c_CARD_LATER_PRINTINGS_INTERCHANGEABLE_HAND(Condition),
    ...
    RULE_201_4_EFFECT_PLAYER_CHOOSE_CARD_NOT(Condition),
    ...
    RULE_201_4a_PLAYER_CHOOSE_CARD_NAME_CHARACTERISTICS(Condition),
    ...
    RULE_201_4b_PLAYER_WANTS_CHOOSE_CARD_NOT(Condition),
    ...
    RULE_201_4c_PLAYER_WANTS_CHOOSE_FLIP_CARDS(Condition),
    ...
    RULE_201_4d_PLAYER_WANTS_CHOOSE_NAME_CARD(Condition),
    ...
    RULE_201_4e_PLAYER_WANTS_CHOOSE_NAME_CARD(Condition),
    ...
    RULE_201_4f_PLAYER_WANTS_CHOOSE_ADVENTURER_CARDS(Condition),
    ...
    RULE_201_4g_CARDS_INTERCHANGEABLE_NAMES_GAME_PURPOSES(Condition),
    ...
    RULE_201_5_TEXT_OBJECT_NAME_NOT_EFFECTS,
    ...
    RULE_201_5a_ABILITYS_EFFECT_OBJECT_NOT_ZONE(Condition),
    ...
    RULE_201_5b_ABILITY_OBJECT_NAME_GAINS_INSTANCE(Condition),
    ...
    RULE_201_5c_TEXT_PRINTED_CARDS_SHORTENED_VERSION,
    ...
    RULE_202_1a_COST_OBJECT_CAST_CARD_COLORLESS(Condition),
    ...
    RULE_202_1b_OBJECTS_MANA_COST_CARDS_EFFECT(Condition),
    ...
    RULE_202_2b_OBJECTS_COLORED_MANA_COSTS_COLORLESS,
    ...
    RULE_202_2c_OBJECT_COST_MULTICOLORED_CARDS_NOT,
    ...
    RULE_202_2d_OBJECT_HYBRID_MANA_COST_CARDS,
    ...
    RULE_202_3_MANA_VALUE_OBJECT_NUMBER_COST,
    ...
    RULE_202_3a_OBJECT_COST_ZERO_PERMANENT_SPELL(Condition),
    ...
    RULE_202_3b_PERMANENT_SPELLS_COST_OBJECT_CARD(Condition),
    ...
    RULE_202_3c_MANA_PERMANENT_COST_CARD_ZERO(Condition),
    ...
    RULE_202_3d_SPLIT_CARD_NOT_STACK_SPELL,
    ...
    RULE_202_3e_OBJECT_X_COST_ZERO_NOT(Condition),
    ...
    RULE_202_3f_CALCULATING_MANA_VALUE_OBJECT_COST(Condition),

    // 202.3g. Each Phyrexian mana symbol in a card’s mana cost contributes 1 to its mana value.
    RULE_202_3g_PHYREXIAN_MANA_SYMBOL_CARDS_COST,
    ...
    RULE_205_1a_EFFECTS_CARD_DAMAGE_CREATURE_SPELL(Condition),
    ...
    RULE_205_1b_EFFECTS_CARD_TYPE_SUPERTYPE_SUBTYPE,

    // 205.2. Card Types
    RULE_205_2_CARD_TYPES,
    ...
    RULE_205_2a_CARD_TYPES_ARTIFACT_CREATURE_SCHEME,
    ...
    RULE_205_3b_SUBTYPES_CARD_TYPE_EXCEPT_CREATURE,
    ...
    RULE_205_3c_CARD_MULTIPLE_TYPES_SUBTYPES_CORRELATED(Condition),

    // 205.3d. An object can’t gain a subtype that doesn’t correspond to one of that object’s types.
    RULE_205_3d_OBJECT_CANT_GAIN_SUBTYPE_DOESNT,
    ...
    RULE_205_3e_EFFECT_PLAYER_CHOOSE_SUBTYPE_CARD(Condition),
    ...
    RULE_205_3f_CARDS_PRINTED_SUBTYPES_NOW_OBSOLETE,
    ...
    RULE_205_3g_ARTIFACTS_OWN_UNIQUE_SET_SUBTYPES,
    ...
    RULE_205_3h_ENCHANTMENTS_OWN_UNIQUE_SET_SUBTYPES,
    ...
    RULE_205_3i_LANDS_OWN_UNIQUE_SET_SUBTYPES,
    ...
    RULE_205_3j_PLANESWALKERS_OWN_UNIQUE_SET_SUBTYPES,
    ...
    RULE_205_3k_INSTANTS_SORCERIES_SHARE_LISTS_SPELL,
    ...
    RULE_205_3m_CREATURES_KINDREDS_SHARE_LISTS_SUBTYPES,
    ...
    RULE_205_4a_OBJECT_SUPERTYPES_CARDS_PRINTED_TYPES,
    ...
    RULE_205_4b_OBJECTS_SUPERTYPE_INDEPENDENT_CARD_TYPE(Condition),
    ...
    RULE_205_4c_LAND_SUPERTYPE_BASIC_DOESNT_NONBASIC(Condition),
    ...
    RULE_205_4d_PERMANENT_LEGENDARY_STATE_BASED_ACTION,
    ...
    RULE_205_4e_SPELL_LEGENDARY_CANT_CAST_CREATURE(Condition),
    ...
    RULE_205_4f_PERMANENT_WORLD_STATE_BASED_ACTION,
    ...
    RULE_205_4g_PERMANENT_SUPERTYPE_SNOW_DOESNT_NONSNOW,
    ...
    RULE_206_2_COLOR_EXPANSION_CARD_SPECIAL_TIMESHIFTED(Condition),
    ...
    RULE_206_3_SPELL_ABILITY_CARDS_NAME_ORIGINALLY,
    ...
    RULE_206_3a_CARD_PERMANENTS_N_GRAVEYARD_LIBRARY,
    ...
    RULE_206_3b_CARD_GOLGOTHIAN_SYLEX_PERMANENTS_NAME,
    ...
    RULE_206_3c_CARD_APOCALYPSE_CHIME_PERMANENTS_SPELL,
    ...
    RULE_206_4_PLAYERS_INCLUDE_CARDS_PRINTING_CONSTRUCTED(Condition),
    ...
    RULE_207_2_ITALICIZED_TEXT_HAS_NO_GAME_FUNCTION,
    ...
    RULE_207_2a_REMINDER_TEXT_ITALICIZED_CARD_ABILITY(Condition),
    ...
    RULE_207_2b_FLAVOR_TEXT_ITALICIZED_LIKE_ILLUSTRATION,
    ...
    RULE_207_2c_ABILITY_WORD_CARDS_SPECIAL_SPELL(Condition),
    ...
    RULE_207_2d_SIMILAR_ABILITY_WORDS_SPECIAL_NOT(Condition),
    ...
    RULE_207_3_CARDS_DECORATIVE_ICONS_BACKGROUND_EFFECT,
    ...
    RULE_207_4_CHAOS_CARD_ABILITY_SPECIAL_PLANECHASE(Condition),
    ...
    RULE_208_2_RATHER_THAN_FIXED_CREATURE_CARDS,
    ...
    RULE_208_2a_CARD_ABILITY_CREATURES_CANT_ZERO(Condition),
    ...
    RULE_208_2b_CARD_ABILITY_EFFECT_CREATURES_ENTERS,
    ...
    RULE_208_3a_EFFECT_CREATED_SETS_PERMANENT_CREATURE(Condition),
    ...
    RULE_208_4a_EFFECTS_SET_CREATURES_CONTINUOUS_INTERACTION,
    ...
    RULE_208_4b_EFFECTS_CREATURES_ABILITIES_INTERACTION_CONTINUOUS,
    ...
    RULE_213_1d_CARDS_INTERCHANGEABLE_NAMES_INCLUDE_VERSION,
    ...
    RULE_300_2_OBJECTS_CARD_CREATURE_SPELLS_ABILITIES,
    ...
    RULE_300_2a_OBJECT_CARD_CANT_CAST_SPELL,
    ...
    RULE_301_2_ARTIFACT_SPELL_RESOLVES_CONTROLLER_BATTLEFIELD(Condition),
    ...
    RULE_301_3_ARTIFACT_SUBTYPES_SINGLE_WORD_EQUIPMENT,
    ...
    RULE_301_4_ARTIFACTS_CHARACTERISTICS_CARD_COSTS_COLORLESS,
    ...
    RULE_301_5_EQUIPMENT_CONTROL_AND_ATTACHMENT,
    ...
    RULE_301_5a_CREATURE_EQUIPMENT_ATTACHED_EQUIPPED_EQUIPS,
    ...
    RULE_301_5b_SPELLS_CAST_BATTLEFIELD_CREATURE_ABILITY(Condition),
    ...
    RULE_301_5c_EQUIPMENT_CREATURE_CANT_PERMANENT_BATTLEFIELD(Condition),
    ...
    RULE_301_5d_CREATURES_NOT_ACTIVATE_ABILITIES_GAINS(Condition),
    ...
    RULE_301_5e_EFFECT_ATTEMPTS_BATTLEFIELD_OBJECT_CANT(Condition),
    ...
    RULE_301_5f_ABILITY_PERMANENT_EQUIPPED_CREATURE_ATTACHED(Condition),
    ...
    RULE_301_6_FORTIFICATION_CANT_OBJECT_ABILITY_CREATURES,
    ...
    RULE_301_7_ARTIFACTS_VEHICLE_CREW_ABILITY_CREATURES,
    ...
    RULE_301_7a_VEHICLE_PRINTED_POWER_TOUGHNESS_CREATURE(Condition),
    ...
    RULE_302_2_CREATURE_SPELL_RESOLVES_CONTROLLER_BATTLEFIELD(Condition),
    ...
    RULE_302_4c_CREATURES_POWER_TOUGHNESS_CONTINUOUS_EFFECTS,
    ...
    RULE_302_6_CREATURES_ABILITY_COST_CANT_TURN(Condition),
    ...
    RULE_303_2_ENCHANTMENT_SPELL_RESOLVES_CONTROLLER_BATTLEFIELD(Condition),
    ...
    RULE_303_3_ENCHANTMENT_SUBTYPES_SINGLE_WORD_SHRINE,
    ...
    RULE_303_4_AURA_BATTLEFIELD_OBJECT_ABILITY_EFFECTS,

    // 303.4a. An Aura spell requires a target, which is defined by its enchant ability.
    RULE_303_4a_AURA_SPELL_REQUIRES_TARGET_ABILITY,
    ...
    RULE_303_4b_OBJECT_PLAYER_AURA_ATTACHED_ENCHANTS,

    // 303.4c. If an Aura is enchanting an illegal object or player as defined by its enchant ability and other applicable effects, the object it was attached to no longer exists, or the player it was attached to has left the game, the Aura is put into its owner’s graveyard. (This is a state-based action. See rule 704.)
    RULE_303_4c_OBJECT_ABILITY_EFFECTS_GRAVEYARD_STATE(Condition),
    ...
    RULE_303_4d_CANT_GRAVEYARD_CREATURE_STATE_BASED(Condition),
    ...
    RULE_303_4e_AURAS_NOT_ACTIVATE_ABILITIES_GAINS(Condition),

    // 303.4f. If an Aura is entering the battlefield under a player’s control by any means other than by resolving as an Aura spell, and the effect putting it onto the battlefield doesn’t specify the object or player the Aura will enchant, that player chooses what it will enchant as the Aura enters the battlefield. The player must choose a legal object or player according to the Aura’s enchant ability and any other applicable effects.
    RULE_303_4f_BATTLEFIELD_RESOLVING_SPELL_EFFECT_OBJECT(Condition),
    ...
    RULE_303_4g_BATTLEFIELD_OBJECT_ZONE_STACK_GRAVEYARD(Condition),
    ...
    RULE_303_4h_EFFECT_ATTEMPTS_PERMANENT_BATTLEFIELD_OBJECT(Condition),
    ...
    RULE_303_4i_EFFECT_BATTLEFIELD_OBJECT_CANT_ZONE(Condition),
    ...
    RULE_303_4j_EFFECT_ATTEMPTS_BATTLEFIELD_OBJECT_CANT(Condition),
    ...
    RULE_303_4k_EFFECT_AURA_THATS_OBJECT_ABILITY(Condition),
    ...
    RULE_303_4m_ABILITY_PERMANENT_ENCHANTED_OBJECT_PLAYER(Condition),
    ...
    RULE_303_7_AURA_ENCHANTMENTS_SUBTYPE_ROLE,
    ...
    RULE_304_2_INSTANT_SPELL_RESOLVES_ACTIONS_GRAVEYARD(Condition),
    ...
    RULE_304_3_INSTANT_SUBTYPES_SINGLE_ARCANE_SPELL,
    ...
    RULE_304_4_INSTANTS_CANT_ENTER_BATTLEFIELD_ZONE(Condition),
    ...
    RULE_305_2_PLAYER_PLAY_TURN_CONTINUOUS_EFFECTS,
    ...
    RULE_305_2a_TURN_SPECIAL_ACTIONS_SPELLS_ABILITIES(Condition),
    ...
    RULE_305_2b_PLAYER_CANT_PLAY_TURN_EFFECT(Condition),
    ...
    RULE_305_3_PLAYER_CANT_PLAY_TURN_EFFECT(Condition),
    ...
    RULE_305_4_EFFECTS_ALLOW_BATTLEFIELD_PLAYING_TURN,
    ...
    RULE_305_6_BASIC_LAND_OBJECT_CARD_ABILITY(Condition),
    ...
    RULE_305_7_EFFECT_SETS_ABILITIES_CARD_CREATURE(Condition),
    ...
    RULE_306_2_PLANESWALKER_SPELL_RESOLVES_CONTROLLER_BATTLEFIELD(Condition),
    ...
    RULE_306_3_PLANESWALKER_SUBTYPES_SINGLE_WORD_JACE,
    ...
    RULE_306_4_PREVIOUSLY_UNIQUENESS_CARDS_PERMANENTS_LEGEND,

    // 306.5. Loyalty is a characteristic only planeswalkers have.
    RULE_306_5_LOYALTY_CHARACTERISTIC_PLANESWALKERS,
    ...
    RULE_306_5a_LOYALTY_PLANESWALKER_CARD_NOT_BATTLEFIELD,
    ...
    RULE_306_5b_ABILITY_PERMANENT_ENTERS_NUMBER_LOYALTY,

    // 306.5c. The loyalty of a planeswalker on the battlefield is equal to the number of loyalty counters on it.
    RULE_306_5c_LOYALTY_PLANESWALKER_BATTLEFIELD_EQUAL_NUMBER,

    // 306.5d. Each planeswalker has a number of loyalty abilities, which are activated abilities with loyalty symbols in their costs. Loyalty abilities follow special rules: A player may activate a loyalty ability of a permanent they control any time they have priority and the stack is empty during a main phase of their turn, but only if none of that permanent’s loyalty abilities have been activated that turn. See rule 606, “Loyalty Abilities.”
    RULE_306_5d_LOYALTY_ABILITIES_COSTS_SPECIAL_ACTIVATE(Condition),
    ...
    RULE_306_7_PREVIOUSLY_PLANESWALKERS_EFFECT_DAMAGE_CARDS(Condition),

    // 306.8. Damage dealt to a planeswalker results in that many loyalty counters being removed from it.
    RULE_306_8_DAMAGE_DEALT_PLANESWALKER_RESULTS_LOYALTY,
    ...
    RULE_307_2_SORCERY_SPELL_RESOLVES_ACTIONS_GRAVEYARD(Condition),
    ...
    RULE_307_3_SORCERY_SUBTYPES_SINGLE_ARCANE_SPELL,
    ...
    RULE_307_4_SORCERIES_CANT_ENTER_BATTLEFIELD_ZONE(Condition),
    ...
    RULE_307_5_SPELL_ABILITY_EFFECT_TIME_CAST(Condition),
    ...
    RULE_308_2_KINDRED_SUBTYPES_ENCHANTMENT_MERFOLK_CREATURE,
    ...
    RULE_309_2_DUNGEON_CARDS_OUTSIDE_VENTURE_ACTION,
    ...
    RULE_309_2c_CARDS_NOT_PERMANENTS_CANT_CAST,
    ...
    RULE_309_2d_EFFECT_THAN_VENTURE_ACTION_CARD(Condition),
    ...
    RULE_309_3_PLAYER_OWN_CARD_ZONE_CANT(Condition),
    ...
    RULE_309_4c_ROOM_ABILITY_EFFECT_CARD_TRIGGER(Condition),
    ...
    RULE_309_5_VENTURE_DUNGEON_KEYWORD_ACTION_CARD,
    ...
    RULE_309_5a_PLAYER_VENTURES_DUNGEON_CARD_ZONE(Condition),
    ...
    RULE_309_5b_PLAYER_VENTURES_DUNGEON_CARD_ZONE(Condition),
    ...
    RULE_309_6_CARD_ABILITY_NOT_STACK_STATE(Condition),
    ...
    RULE_310_2_BATTLE_SPELL_RESOLVES_CONTROLLER_BATTLEFIELD(Condition),
    ...
    RULE_310_3_BATTLE_SUBTYPES_SINGLE_WORD_SIEGE,
    ...
    RULE_310_4a_DEFENSE_BATTLE_CARD_NOT_BATTLEFIELD,
    ...
    RULE_310_4b_ABILITY_PERMANENT_ENTERS_NUMBER_DEFENSE,

    // 310.4c. The defense of a battle on the battlefield is equal to the number of defense counters on it.
    RULE_310_4c_DEFENSE_BATTLE_BATTLEFIELD_EQUAL_NUMBER,
    ...
    RULE_310_6_DAMAGE_DEALT_BATTLE_RESULTS_DEFENSE,
    ...
    RULE_310_7_ZERO_ABILITY_NOT_STACK_GRAVEYARD(Condition),

    // 310.8. Each battle has a player designated as its protector.
    RULE_310_8_BATTLE_PLAYER_DESIGNATED_PROTECTOR,
    ...
    RULE_310_8a_BATTLE_ENTERS_BATTLEFIELD_CONTROLLER_CHOOSES(Condition),
    ...
    RULE_310_8b_BATTLES_PROTECTOR_ATTACK_ATTACKED_ATTACKING,
    ...
    RULE_310_8c_BATTLES_PROTECTOR_BLOCK_CREATURES_CANT,
    ...
    RULE_310_8d_BATTLES_PROTECTOR_PLAYER_EFFECTS_DEFENDING(Condition),

    // 310.8e. If a rule or effect refers to the player who protects a battle, it means the player who is that battle’s protector.
    RULE_310_8e_EFFECT_PLAYER_PROTECTS_BATTLE_PROTECTOR(Condition),
    ...
    RULE_310_8f_BATTLE_PROTECTOR_TIME_STOPS_PLAYER(Condition),

    // 310.8g. A battle’s protector doesn’t change if it stops being a battle or it becomes a copy of another battle.
    RULE_310_8g_BATTLES_PROTECTOR_DOESNT_CHANGE_STOPS(Condition),
    ...
    RULE_310_9_CANT_PERMANENTS_STATE_BASED_ACTION(Condition),
    ...
    RULE_310_10_CANT_BASED_GRAVEYARD_STATE_ACTION(Condition),

    // 310.11. All currently existing battles have the subtype Siege. Sieges are subject to special rules.
    RULE_310_11_CURRENTLY_EXISTING_BATTLES_SUBTYPE_SPECIAL,
    ...
    RULE_310_11a_SIEGE_ENTERS_BATTLEFIELD_CONTROLLER_CHOOSE,
    ...
    RULE_400_2_ZONES_CARDS_EFFECT_GRAVEYARD_BATTLEFIELD(Condition),

    // 400.3. If an object would go to any library, graveyard, or hand other than its owner’s, it goes to its owner’s corresponding zone.
    RULE_400_3_OBJECT_LIBRARY_GRAVEYARD_HAND_ZONE(Condition),

    // 400.4. Cards with certain card types can’t enter certain zones.
    RULE_400_4_CARDS_TYPES_CANT_ENTER_ZONES,

    // 400.4a. If an instant or sorcery card would enter the battlefield, it remains in its previous zone.
    RULE_400_4a_INSTANT_SORCERY_CARD_BATTLEFIELD_ZONE(Condition),
    ...
    RULE_400_4b_CONSPIRACY_PHENOMENON_SCHEME_CARD_ZONE(Condition),
    ...
    RULE_400_5_LIBRARY_GRAVEYARD_STACK_CANT_EFFECTS(Condition),
    ...
    RULE_400_6_OBJECT_ZONE_ABILITIES_BATTLEFIELD_EFFECTS(Condition),
    ...
    RULE_400_7_OBJECT_MOVES_ZONE_NEW_MEMORY,
    ...
    RULE_400_7a_EFFECTS_SPELLS_ABILITIES_PERMANENT_STACK,
    ...
    RULE_400_7b_EFFECTS_ABILITIES_PERMANENT_SPELL_BATTLEFIELD,
    ...
    RULE_400_7c_EFFECTS_DAMAGE_PERMANENT_SPELL_STACK,
    ...
    RULE_400_7d_ABILITY_PERMANENT_SPELL_COSTS_CAST,
    ...
    RULE_400_7e_ABILITIES_TRIGGER_OBJECT_ZONE_AURA(Condition),
    ...
    RULE_400_7f_ABILITIES_TRIGGER_PERMANENT_BATTLEFIELD_OBJECT(Condition),
    ...
    RULE_400_7g_EFFECT_CARD_ABILITY_CAST_OBJECT(Condition),
    ...
    RULE_400_7h_EFFECT_CARD_CAST_OBJECT_STACK(Condition),
    ...
    RULE_400_7i_EFFECT_LAND_CARD_OBJECT_BATTLEFIELD(Condition),
    ...
    RULE_400_7j_EFFECT_OBJECT_ZONE_COST_SPELL(Condition),
    ...
    RULE_400_7k_RESOLVING_ABILITY_CARD_CAST_ZONE(Condition),
    ...
    RULE_400_7m_STICKERS_OBJECT_PUBLIC_ZONE_EFFECTS,
    ...
    RULE_400_11b_EFFECTS_BRING_CARDS_GAME_OUTSIDE,
    ...
    RULE_400_11c_CARDS_OUTSIDE_CANT_SPELLS_ABILITIES,
    ...
    RULE_401_2_LIBRARY_SINGLE_FACE_CANT_CARDS(Condition),

    // 401.3. Any player may count the number of cards remaining in any player’s library at any time.
    RULE_401_3_PLAYER_COUNT_NUMBER_CARDS_LIBRARY(Condition),
    ...
    RULE_401_4_EFFECT_CARDS_POSITION_LIBRARY_TIME(Condition),
    ...
    RULE_401_5_EFFECTS_CARD_LIBRARY_SPELL_CAST(Condition),
    ...
    RULE_401_6_EFFECT_CAUSES_CARD_LIBRARY_OBJECT(Condition),
    ...
    RULE_402_2_PLAYER_MAXIMUM_HAND_CARDS_STEP,
    ...
    RULE_403_2_SPELL_ABILITY_AFFECTS_BATTLEFIELD_ZONE(Condition),
    ...
    RULE_403_4_PERMANENT_BATTLEFIELD_OBJECT_CARD_ZONE(Condition),
    ...
    RULE_404_2_GRAVEYARD_SINGLE_FACE_CARDS_CANT(Condition),
    ...
    RULE_405_2_STACK_TRACK_SPELLS_ABILITIES_OBJECT,
    ...
    RULE_405_3_EFFECT_OBJECTS_STACK_TIME_APNAP(Condition),
    ...
    RULE_405_4_SPELL_CARD_ABILITY_STACK_CAST(Condition),
    ...
    RULE_405_5_SPELL_ABILITY_STACK_RESOLVES_STEP(Condition),

    // 405.6. Some things that happen during the game don’t use the stack.
    RULE_405_6_THINGS_HAPPEN_GAME_DONT_STACK,
    ...
    RULE_405_6a_EFFECTS_STACK_SPELLS_ABILITIES_RESOLVING(Condition),
    ...
    RULE_405_6b_ABILITIES_EFFECTS_STACK_OBJECT_RED,
    ...
    RULE_405_6c_MANA_ABILITIES_RESOLVE_IMMEDIATELY_EFFECT(Condition),

    // 405.6d. Special actions don’t use the stack; they happen immediately. See rule 116, “Special Actions.”
    RULE_405_6d_SPECIAL_ACTIONS_DONT_STACK_HAPPEN,
    ...
    RULE_405_6e_TURN_BASED_ACTIONS_STACK_PHASE(Condition),
    ...
    RULE_405_6f_STATE_BASED_ACTIONS_DONT_STACK(Condition),

    // 405.6g. A player may concede the game at any time. That player leaves the game immediately. See rule 104.3a.
    RULE_405_6g_PLAYER_CONCEDE_GAME_TIME_LEAVES(Condition),
    ...
    RULE_406_2_EXILE_OBJECT_ZONE_CURRENTLY_CARD,
    ...
    RULE_406_3_EXILED_CARDS_FACE_CANT_EXILE(Condition),
    ...
    RULE_406_3a_CARD_SPELL_ABILITY_EXILE_CAST(Condition),
    ...
    RULE_406_3b_SPELLS_ABILITIES_CAST_CARDS_EXILE(Condition),
    ...
    RULE_406_4_CARDS_EXILE_BASED_SPELL_ABILITY(Condition),
    ...
    RULE_406_5_EXILED_CARDS_BATTLEFIELD_ZONE_ABILITIES,
    ...
    RULE_406_6_OBJECT_ABILITY_CARDS_EXILED_LINKED,
    ...
    RULE_406_7_OBJECT_EXILE_ZONE_EXILED_DOESNT(Condition),
    ...
    RULE_407_2_PLAYING_ANTE_PLAYER_CARD_ZONE(Condition),
    ...
    RULE_407_3_CARDS_REMOVE_DECK_PLAYING_NOT(Condition),
    ...
    RULE_500_2_PHASE_STEP_PLAYERS_RECEIVE_STACK(Condition),
    ...
    RULE_500_3_STEP_PLAYERS_RECEIVE_PRIORITY_ACTIONS(Condition),

    // 500.4. As a step or phase begins, if there are effects that last until that step or phase, those effects expire.
    RULE_500_4_STEP_PHASE_EFFECTS_LAST_EXPIRE(Condition),
    ...
    RULE_500_5_STEP_PHASE_EFFECTS_TURN_BASED(Condition),
    ...
    RULE_500_5a_EFFECTS_END_COMBAT_PHASE_NOT(Condition),

    // 500.5b. Effects that last “until end of turn” are subject to special rules; see rule 514.2.
    RULE_500_5b_EFFECTS_LAST_END_TURN_SPECIAL,
    ...
    RULE_500_6_PHASE_STEP_ABILITIES_TRIGGER_STACK(Condition),
    ...
    RULE_500_7_EFFECTS_PLAYER_EXTRA_TURNS_APNAP(Condition),
    ...
    RULE_500_8_EFFECTS_ADD_PHASES_TURN_PHASE(Condition),
    ...
    RULE_500_10a_EFFECT_SAYS_STEP_PHASE_TURN(Condition),
    ...
    RULE_502_2_DAY_CAST_SPELLS_NIGHT_BASED(Condition),
    ...
    RULE_502_2a_CAST_SPELL_BASED_ACTION_STACK(Condition),
    ...
    RULE_502_3_PERMANENTS_TURN_BASED_ACTION_STACK,
    ...
    RULE_503_1a_ABILITIES_TRIGGERED_UNTAP_STEP_STACK(Condition),
    ...
    RULE_505_1a_MAIN_PHASE_TURN_COMBAT_EFFECT,
    ...
    RULE_505_1b_CARD_TEXT_MAIN_PHASE_TURN(Condition),
    ...
    RULE_505_2_MAIN_PHASE_STEPS_ENDS_STACK(Condition),
    ...
    RULE_505_3_PHASE_CARD_SCHEME_TURN_BASED(Condition),
    ...
    RULE_505_4_PHASE_ABILITIES_TURN_BASED_ACTION(Condition),
    ...
    RULE_505_5_PHASE_TURN_BASED_ACTION_STACK(Condition),

    // 505.6. Fourth, the active player gets priority. (See rule 117, “Timing and Priority.”)
    RULE_505_6_ACTIVE_PLAYER_PRIORITY,
    ...
    RULE_505_6a_MAIN_PHASE_CAST_CREATURE_SPELLS,
    ...
    RULE_506_2_COMBAT_PHASE_ACTIVE_CREATURES_ATTACK,
    ...
    RULE_506_2a_COMBAT_PHASE_PLAYERS_VARIANT_OPTIONS(Condition),
    ...
    RULE_506_2b_MULTIPLAYER_SHARED_TEAM_TURNS_OPTION,

    // 506.3. Only a creature can attack or block. Only a player, a planeswalker, or a battle can be attacked.
    RULE_506_3_CREATURE_ATTACK_BLOCK_PLAYER_PLANESWALKER,
    ...
    RULE_506_3a_EFFECT_NONCREATURE_PERMANENT_BATTLEFIELD_ATTACKING(Condition),
    ...
    RULE_506_3b_EFFECT_CREATURE_BATTLEFIELD_ATTACKING_CONTROL(Condition),
    ...
    RULE_506_3c_EFFECT_CREATURE_BATTLEFIELD_NOT_PERMANENT(Condition),
    ...
    RULE_506_3d_EFFECT_CREATURE_BATTLEFIELD_STEP_COMBAT(Condition),
    ...
    RULE_506_3e_EFFECT_CREATURE_BATTLEFIELD_BLOCKING_BLOCK(Condition),
    ...
    RULE_506_3f_EFFECT_CREATURE_THATS_BATTLEFIELD_PERMANENT(Condition),
    ...
    RULE_506_3g_RESOLVING_SPELL_ABILITY_CREATURE_EFFECT(Condition),
    ...
    RULE_506_4_PERMANENT_COMBAT_BATTLEFIELD_EFFECT_CREATURE(Condition),
    ...
    RULE_506_4a_ONCE_CREATURE_SPELLS_ABILITIES_COMBAT(Condition),
    ...
    RULE_506_4b_TAPPING_UNTAPPING_CREATURE_COMBAT_DAMAGE,
    ...
    RULE_506_4c_CREATURE_ATTACKING_COMBAT_NOT_DAMAGE(Condition),
    ...
    RULE_506_4d_PERMANENT_THATS_CREATURE_COMBAT_CARD(Condition),
    ...
    RULE_506_4e_PERMANENT_THATS_ATTACKED_COMBAT_NOT(Condition),
    ...
    RULE_506_5_CREATURE_ATTACKS_ALONE_DECLARED_STEP(Condition),
    ...
    RULE_506_6_ABILITIES_NOT_CREATURE_ATTACK_COMBAT(Condition),
    ...
    RULE_506_7_SPELLS_STATE_CAST_POINT_COMBAT,
    ...
    RULE_506_7a_SPELL_CAST_ATTACKERS_DECLARED_TURN,
    ...
    RULE_506_7b_SPELL_CAST_BLOCKERS_DECLARED_TURN,
    ...
    RULE_506_7c_SPELLS_STATE_CAST_COMBAT_PHASE(Condition),
    ...
    RULE_506_7d_SPELLS_STATE_CAST_POINT_COMBAT(Condition),
    ...
    RULE_506_7e_SPELL_CAST_POINT_COMBAT_PHASE(Condition),
    ...
    RULE_506_7f_SPELL_CAST_COMBAT_BLOCKERS_DECLARED(Condition),
    ...
    RULE_508_1a_ACTIVE_CREATURES_ATTACK_CANT_TURN(Condition),
    ...
    RULE_508_1b_DEFENDING_PLAYER_CONTROLS_ATTACK_CREATURES(Condition),
    ...
    RULE_508_1c_ACTIVE_CREATURE_EFFECTS_CANT_ATTACK(Condition),
    ...
    RULE_508_1d_CREATURE_EFFECTS_CANT_COST_NOT(Condition),
    ...
    RULE_508_1e_CHOSEN_CREATURES_BANDING_BANDS_ABILITY(Condition),
    ...
    RULE_508_1f_ACTIVE_PLAYER_TAPS_CREATURES_COST(Condition),
    ...
    RULE_508_1g_OPTIONAL_COSTS_ATTACK_CHOSEN_CREATURES(Condition),
    ...
    RULE_508_1h_CREATURES_COSTS_ATTACK_PERMANENTS_CARDS(Condition),
    ...
    RULE_508_1i_COSTS_REQUIRE_MANA_ACTIVATE_ABILITIES(Condition),
    ...
    RULE_508_1j_ONCE_PLAYER_ENOUGH_COSTS_NOT,
    ...
    RULE_508_2a_ABILITIES_TRIGGER_CREATURE_ATTACKING_NOT(Condition),
    ...
    RULE_508_2b_ABILITIES_TRIGGERED_ATTACKERS_DECLARED_STACK,

    // 508.3. Triggered abilities that trigger on attackers being declared may have different trigger conditions.
    RULE_508_3_TRIGGERED_ABILITIES_TRIGGER_ATTACKERS_DECLARED,
    ...
    RULE_508_3a_ABILITY_CREATURE_ATTACKS_PLAYER_PLANESWALKER(Condition),
    ...
    RULE_508_3b_ABILITY_PLAYER_PLANESWALKER_BATTLE_ATTACKED(Condition),
    ...
    RULE_508_3c_ABILITY_READS_PLAYER_ATTACKS_CREATURE(Condition),
    ...
    RULE_508_3d_ABILITY_READS_PLAYER_ATTACKS_CREATURES(Condition),
    ...
    RULE_508_3e_ABILITY_PLAYER_ATTACKS_CREATURES_BATTLEFIELD(Condition),
    ...
    RULE_508_3f_ABILITY_CREATURE_ATTACKS_STEP_NOT(Condition),
    ...
    RULE_508_4_CREATURE_BATTLEFIELD_ATTACKING_EFFECT_TRIGGER(Condition),
    ...
    RULE_508_4a_CREATURE_BATTLEFIELD_ATTACKING_PLAYER_PERMANENT(Condition),
    ...
    RULE_508_4b_EFFECT_CREATURE_RESOLVES_PERMANENT_BATTLEFIELD(Condition),
    ...
    RULE_508_4c_CREATURE_THATS_BATTLEFIELD_ATTACKING_STATED,
    ...
    RULE_508_4d_CREATURE_BATTLEFIELD_STEP_COMBAT_DAMAGE,
    ...
    RULE_508_5_ABILITY_ATTACKING_CREATURE_SPELL_COMBAT(Condition),
    ...
    RULE_508_5a_OBJECT_EFFECT_DEFENDING_PLAYER_NOT(Condition),
    ...
    RULE_508_7_CARDS_ALLOW_PLAYER_RESELECT_CREATURE,
    ...
    RULE_508_7a_ATTACKING_CREATURE_ISNT_COMBAT_PERMANENT,
    ...
    RULE_508_7b_RESELECTING_PLAYER_PLANESWALKER_BATTLE_CREATURE,
    ...
    RULE_508_7c_RESELECTED_PLAYER_PLANESWALKER_BATTLE_CREATURES,
    ...
    RULE_508_7d_MULTIPLAYER_GAME_NOT_ATTACK_MULTIPLE,
    ...
    RULE_508_7e_MULTIPLAYER_GAME_LIMITED_RANGE_CREATURES,
    ...
    RULE_509_1a_DEFENDING_PLAYER_CREATURES_BLOCK_CANT(Condition),
    ...
    RULE_509_1b_DEFENDING_CREATURE_EFFECTS_CANT_BLOCK(Condition),
    ...
    RULE_509_1c_CREATURE_EFFECTS_BLOCK_CANT_COST(Condition),
    ...
    RULE_509_1d_CREATURES_COSTS_BLOCK_PERMANENTS_CARDS(Condition),
    ...
    RULE_509_1e_COSTS_REQUIRE_MANA_ACTIVATE_ABILITIES(Condition),
    ...
    RULE_509_1f_ONCE_PLAYER_ENOUGH_COSTS_NOT,
    ...
    RULE_509_2a_ABILITIES_TRIGGERED_BLOCKERS_DECLARED_STACK,

    // 509.3. Triggered abilities that trigger on blockers being declared may have different trigger conditions.
    RULE_509_3_TRIGGERED_ABILITIES_TRIGGER_BLOCKERS_DECLARED,
    ...
    RULE_509_3a_ABILITY_CREATURE_BLOCKS_COMBAT_EFFECT(Condition),
    ...
    RULE_509_3b_ABILITY_CREATURE_BLOCKS_EFFECT_BATTLEFIELD(Condition),
    ...
    RULE_509_3c_ABILITY_CREATURE_BLOCKED_COMBAT_EFFECT(Condition),
    ...
    RULE_509_3d_ABILITY_CREATURE_BLOCKED_EFFECT_BATTLEFIELD(Condition),
    ...
    RULE_509_3e_ABILITY_TRIGGERS_CREATURE_BLOCKS_EFFECTS(Condition),
    ...
    RULE_509_3f_ABILITY_TRIGGERS_CREATURE_CHARACTERISTICS_EFFECT(Condition),
    ...
    RULE_509_3g_ABILITY_CREATURE_ATTACKS_BATTLEFIELD_COMBAT(Condition),
    ...
    RULE_509_4_CREATURE_BATTLEFIELD_BLOCKING_EFFECT_TRIGGER(Condition),
    ...
    RULE_509_4a_EFFECT_CREATURE_BATTLEFIELD_BLOCKING_SPECIFIES(Condition),
    ...
    RULE_510_1a_ATTACKING_CREATURE_COMBAT_DAMAGE_ZERO(Condition),
    ...
    RULE_510_1b_UNBLOCKED_CREATURE_COMBAT_DAMAGE_BATTLEFIELD(Condition),

    // 510.1c. A blocked creature assigns its combat damage to the creatures blocking it. If no creatures are currently blocking it (if, for example, they were destroyed or removed from combat), it assigns no combat damage. If exactly one creature is blocking it, it assigns all its combat damage to that creature. If two or more creatures are blocking it, it assigns its combat damage to those creatures divided as its controller chooses among them.
    RULE_510_1c_BLOCKED_CREATURE_ASSIGNS_COMBAT_DAMAGE(Condition),
    ...
    RULE_510_1d_BLOCKING_CREATURE_ASSIGNS_COMBAT_DAMAGE(Condition),
    ...
    RULE_510_1e_ONCE_COMBAT_DAMAGE_CREATURE_NOT(Condition),

    // 510.2. Second, all combat damage that’s been assigned is dealt simultaneously. This turn-based action doesn’t use the stack. No player has the chance to cast spells or activate abilities between the time combat damage is assigned and the time it’s dealt.
    RULE_510_2_COMBAT_DAMAGE_TURN_BASED_ACTION,
    ...
    RULE_510_3a_ABILITIES_DAMAGE_STATE_BASED_ACTIONS,
    ...
    RULE_513_1a_ABILITIES_END_STEP_TRIGGER_TURN(Condition),
    ...
    RULE_514_2_ACTIONS_DAMAGE_PERMANENTS_END_TURN,

    // 514.3. Normally, no player receives priority during the cleanup step, so no spells can be cast and no abilities can be activated. However, this rule is subject to the following exception:
    RULE_514_3_PLAYER_STEP_SPELLS_CAST_ABILITIES,
    ...
    RULE_601_1a_EFFECTS_PLAYING_CARD_LAND_SPELL,
    ...
    RULE_601_2_CAST_SPELL_FROM_HAND_ON_STACK(Condition),
    ...
    RULE_601_2a_SPELL_CARD_STACK_OBJECT_CONTINUOUS,
    ...
    RULE_601_2b_SPELL_CARDS_HAND_COSTS_CAST(Condition),
    ...
    RULE_601_2c_OBJECT_TARGET_SPELL_COST_CAST(Condition),

    // 601.2d. If the spell requires the player to divide or distribute an effect (such as damage or counters) among one or more targets, the player announces the division. Each of these targets must receive at least one of whatever is being divided.
    RULE_601_2d_SPELL_REQUIRES_PLAYER_EFFECT_DAMAGE(Condition),
    ...
    RULE_601_2e_GAME_CHECKS_PROPOSED_SPELL_CAST(Condition),
    ...
    RULE_601_2f_COST_SPELL_EFFECTS_PERMANENTS_CARDS(Condition),

    // 601.2g. If the total cost includes a mana payment, the player then has a chance to activate mana abilities (see rule 605, “Mana Abilities”). Mana abilities must be activated before costs are paid.
    RULE_601_2g_TOTAL_COST_INCLUDES_ACTIVATE_ABILITIES(Condition),
    ...
    RULE_601_2h_COST_LIBRARY_ZONE_NOT_CANT,

    // 601.2i. Once the steps described in 601.2a–h are completed, effects that modify the characteristics of the spell as it’s cast are applied, then the spell becomes cast. Any abilities that trigger when a spell is cast or put onto the stack trigger at this time. If the spell’s controller had priority before casting it, they get priority.
    RULE_601_2i_EFFECTS_SPELL_CAST_ABILITIES_TRIGGER(Condition),
    ...
    RULE_601_3_PLAYER_CAST_SPELL_EFFECT_PROHIBITS(Condition),
    ...
    RULE_601_3a_EFFECT_PROHIBITS_PLAYER_SPELL_CAST(Condition),
    ...
    RULE_601_3b_EFFECT_PLAYER_CAST_SPELL_QUALITIES(Condition),
    ...
    RULE_601_3c_EFFECT_PLAYER_CAST_SPELL_COST(Condition),
    ...
    RULE_601_3d_SPELL_FLASH_CONDITIONS_MET_CAST(Condition),
    ...
    RULE_601_3e_EFFECTS_STATE_CARD_CAST_CONTINUOUS(Condition),
    ...
    RULE_601_3f_EFFECTS_CAST_SPELL_CARDS_EXILE(Condition),
    ...
    RULE_601_4_ANNOUNCING_CHOICES_COSTS_SPELLS_STEP(Condition),
    ...
    RULE_601_5_PLAYER_CAST_SPELL_EFFECT_COSTS(Condition),
    ...
    RULE_601_5a_ONCE_PLAYER_CASTING_SPELL_CAST(Condition),
    ...
    RULE_601_6_SPELLS_SPECIFY_CONTROLLERS_OPPONENTS_CAST(Condition),
    ...
    RULE_601_6a_THAN_OPPONENT_CHOICE_SPELLS_CONTROLLER(Condition),
    ...
    RULE_601_6b_SPELL_CONTROLLER_PLAYER_TIME_CAST(Condition),
    ...
    RULE_602_1a_ACTIVATION_COST_EVERYTHING_COLON_ABILITYS,
    ...
    RULE_602_1b_ABILITY_STATE_ACTIVATE_COST_NOT(Condition),
    ...
    RULE_602_1c_ACTIVATED_ABILITY_KIND_OBJECT_ACTIVATING(Condition),
    ...
    RULE_602_1d_ACTION_ABILITY_CARDS_PLAYING_ACTIVATING,
    ...
    RULE_602_1e_SPELL_ABILITY_ACTIVATION_COST_EFFECTS(Condition),
    ...
    RULE_602_2_ACTIVATE_ABILITY_STACK_COSTS_RESOLVE(Condition),
    ...
    RULE_602_2a_ABILITY_HIDDEN_ZONE_CARD_STACK(Condition),
    ...
    RULE_602_2b_REMAINDER_PROCESS_ABILITY_SPELL_COST,
    ...
    RULE_602_3_ABILITIES_SPECIFY_CONTROLLERS_OPPONENTS_ACTIVATED(Condition),
    ...
    RULE_602_3a_THAN_OPPONENT_CHOICE_ABILITYS_CONTROLLER(Condition),
    ...
    RULE_602_5a_CREATURES_ABILITY_COST_CANT_TURN(Condition),
    ...
    RULE_602_5b_ABILITY_ACTIVATE_ONCE_TURN_OBJECT(Condition),
    ...
    RULE_602_5c_OBJECT_ACQUIRES_ACTIVATED_ABILITY_RESTRICTION(Condition),
    ...
    RULE_602_5d_ABILITIES_ACTIVATE_SORCERY_SPELL_CARD,
    ...
    RULE_603_1a_ABILITY_EFFECTS_STATE_CANT_NOT,
    ...
    RULE_603_1b_TRIGGERED_ABILITY_TRIGGER_NOT_BASED,

    // 603.2. Whenever a game event or game state matches a triggered ability’s trigger event, that ability automatically triggers. The ability doesn’t do anything at this point.
    RULE_603_2_GAME_EVENT_STATE_MATCHES_TRIGGER(Condition),
    ...
    RULE_603_2a_CAST_ABILITIES_TRIGGER_SPELLS_ACTIVATE(Condition),

    // 603.2b. When a phase or step begins, all abilities that trigger “at the beginning of” that phase or step trigger.
    RULE_603_2b_PHASE_STEP_ABILITIES_TRIGGER(Condition),
    ...
    RULE_603_2c_ABILITY_TRIGGERS_ONCE_TIME_EVENT(Condition),
    ...
    RULE_603_2d_ABILITY_STATE_EFFECT_OBJECT_NOT,
    ...
    RULE_603_2e_TRIGGER_ATTACHED_BLOCKED_STATE_ABILITY(Condition),
    ...
    RULE_603_2f_TRIGGERED_ABILITYS_TRIGGER_OBJECT_NOT(Condition),
    ...
    RULE_603_2g_ABILITY_TRIGGERS_EVENT_ACTUALLY_OCCURS(Condition),
    ...
    RULE_603_2h_ABILITY_ONCE_TURN_NOT_ACTION(Condition),

    // 603.3. Once an ability has triggered, its controller puts it on the stack as an object that’s not a card the next time a player would receive priority. See rule 117, “Timing and Priority.” The ability becomes the topmost object on the stack. It has the text of the ability that created it, and no other characteristics. It remains on the stack until it’s countered, it resolves, a rule causes it to be removed from the stack, or an effect moves it elsewhere.
    RULE_603_3_ABILITY_STACK_OBJECT_NOT_CARD(Condition),
    ...
    RULE_603_3a_TRIGGERED_ABILITY_CONTROLLED_PLAYER_SOURCE(Condition),
    ...
    RULE_603_3b_ABILITIES_STACK_APNAP_TRIGGER_STATE(Condition),
    ...
    RULE_603_3c_TRIGGERED_ABILITY_MODAL_STACK_CANT(Condition),

    // 603.3d. The remainder of the process for putting a triggered ability on the stack is identical to the process for casting a spell listed in rules 601.2c–d. If a choice is required when the triggered ability goes on the stack but no legal choices can be made for it, or if a rule or a continuous effect otherwise makes the ability illegal, the ability is simply removed from the stack.
    RULE_603_3d_ABILITY_STACK_SPELL_CONTINUOUS_EFFECT(Condition),
    ...
    RULE_603_4_ABILITY_TRIGGER_EVENT_CONDITION_EFFECT(Condition),

    // 603.5. Some triggered abilities’ effects are optional (they contain “may,” as in “At the beginning of your upkeep, you may draw a card”). These abilities go on the stack when they trigger, regardless of whether their controller intends to exercise the ability’s option or not. The choice is made when the ability resolves. Likewise, triggered abilities that have an effect “unless” something is true or a player chooses to do something will go on the stack normally; the “unless” part of the ability is dealt with when the ability resolves.
    RULE_603_5_ABILITIES_EFFECTS_UPKEEP_DRAW_CARD(Condition),
    ...
    RULE_603_6_TRIGGER_ZONES_CHANGE_ABILITIES_HIDDEN(Condition),
    ...
    RULE_603_6a_ENTERS_BATTLEFIELD_ABILITIES_TRIGGER_PERMANENT(Condition),

    // 603.6b. Continuous effects that modify characteristics of a permanent do so the moment the permanent is on the battlefield (and not before then). The permanent is never on the battlefield with its unmodified characteristics. Continuous effects don’t apply before the permanent is on the battlefield, however (see rule 603.6d).
    RULE_603_6b_CONTINUOUS_EFFECTS_PERMANENT_BATTLEFIELD_NOT,
    ...
    RULE_603_6c_LEAVES_BATTLEFIELD_ABILITIES_TRIGGER_PERMANENT(Condition),
    ...
    RULE_603_6d_PERMANENTS_ENTERS_TAPPED_ABILITY_NOT,
    ...
    RULE_603_6e_ABILITIES_TRIGGER_PERMANENT_BATTLEFIELD_OBJECT,
    ...
    RULE_603_7a_ABILITIES_SPELLS_EFFECT_ACTION_TRIGGER(Condition),
    ...
    RULE_603_7b_DELAYED_TRIGGERED_ABILITY_TRIGGER_TURN(Condition),
    ...
    RULE_603_7c_DELAYED_ABILITY_OBJECT_ZONE_RESOLVES(Condition),
    ...
    RULE_603_7d_SPELL_CREATES_DELAYED_TRIGGERED_ABILITY(Condition),
    ...
    RULE_603_7e_ACTIVATED_TRIGGERED_ABILITY_CREATES_DELAYED(Condition),
    ...
    RULE_603_7f_STATIC_ABILITY_GENERATES_EFFECT_OBJECT(Condition),
    ...
    RULE_603_7g_STATIC_ABILITY_PLAYER_ACTION_OBJECT(Condition),
    ...
    RULE_603_7h_ACTIVATED_TRIGGERED_ABILITY_CREATE_TURN(Condition),
    ...
    RULE_603_8_ABILITIES_TRIGGER_STATE_PERMANENTS_CARD(Condition),
    ...
    RULE_603_10_TRIGGER_CONTINUOUS_EFFECTS_TIME_ABILITIES(Condition),
    ...
    RULE_603_10a_ZONE_BATTLEFIELD_ABILITIES_PERMANENT_CARD(Condition),

    // 603.10b. Abilities that trigger when a permanent phases out look back in time.
    RULE_603_10b_ABILITIES_TRIGGER_PERMANENT_PHASES_LOOK(Condition),

    // 603.10c. Abilities that trigger specifically when an object becomes unattached look back in time.
    RULE_603_10c_ABILITIES_TRIGGER_SPECIFICALLY_OBJECT_UNATTACHED(Condition),
    ...
    RULE_603_10d_ABILITIES_TRIGGER_PLAYER_LOSES_OBJECT(Condition),

    // 603.10e. Abilities that trigger when a spell is countered look back in time.
    RULE_603_10e_ABILITIES_TRIGGER_SPELL_COUNTERED_LOOK(Condition),

    // 603.10f. Abilities that trigger when a player loses the game look back in time.
    RULE_603_10f_ABILITIES_TRIGGER_PLAYER_LOSES_GAME(Condition),

    // 603.10g. Abilities that trigger when a player planeswalks away from a plane look back in time.
    RULE_603_10g_ABILITIES_TRIGGER_PLAYER_PLANESWALKS_AWAY(Condition),
    ...
    RULE_603_11_OBJECTS_STATIC_ABILITY_THATS_TRIGGER(Condition),
    ...
    RULE_603_12_RESOLVING_SPELL_ABILITY_PLAYER_ACTION(Condition),
    ...
    RULE_604_2_ABILITIES_CONTINUOUS_EFFECTS_PERMANENT_BATTLEFIELD,
    ...
    RULE_604_3_STATIC_ABILITIES_CHARACTERISTIC_COST_ZONES(Condition),

    // 604.3a. A static ability is a characteristic-defining ability if it meets the following criteria: (1) It defines an object’s colors, subtypes, power, or toughness; (2) it is printed on the card it affects, it was granted to the token it affects by the effect that created the token, or it was acquired by the object it affects as the result of a copy effect or text-changing effect; (3) it does not directly affect the characteristics of any other objects; (4) it is not an ability that an object grants to itself; and (5) it does not set the values of such characteristics only if certain conditions are met.
    RULE_604_3a_STATIC_ABILITY_CARD_EFFECT_NOT(Condition),
    ...
    RULE_604_4_AURAS_EQUIPMENT_FORTIFICATIONS_ABILITIES_OBJECT(Condition),
    ...
    RULE_604_5_ABILITIES_SPELL_STACK_ADDITIONAL_COST,
    ...
    RULE_604_6_ABILITIES_CARD_ZONE_CAST_PLAY,
    ...
    RULE_605_1a_ACTIVATED_ABILITY_MANA_RESOLVES_NOT(Condition),
    ...
    RULE_605_1b_TRIGGERED_ABILITY_MANA_MEETS_RESOLVES(Condition),

    // 605.2. A mana ability remains a mana ability even if the game state doesn’t allow it to produce mana.
    RULE_605_2_MANA_ABILITY_GAME_STATE_DOESNT(Condition),
    ...
    RULE_605_3_ACTIVATING_ACTIVATED_MANA_ABILITY_EXCEPTIONS,

    // 605.3a. A player may activate an activated mana ability whenever they have priority, whenever they are casting a spell or activating an ability that requires a mana payment, or whenever a rule or effect asks for a mana payment, even if it’s in the middle of casting or resolving a spell or activating or resolving an ability.
    RULE_605_3a_ACTIVATE_ABILITY_SPELL_EFFECT_RESOLVING(Condition),

    // 605.3b. An activated mana ability doesn’t go on the stack, so it can’t be targeted, countered, or otherwise responded to. Rather, it resolves immediately after it is activated. (See rule 405.6c.)
    RULE_605_3b_ACTIVATED_ABILITY_STACK_CANT_RESOLVES,

    // 605.3c. Once a player begins to activate a mana ability, that ability can’t be activated again until it has resolved.
    RULE_605_3c_ONCE_PLAYER_ACTIVATE_ABILITY_CANT,
    ...
    RULE_605_5a_ABILITY_TARGET_NOT_MANA_RESOLVES(Condition),
    ...
    RULE_606_3_ACTIVATE_ABILITY_PERMANENT_STACK_PHASE(Condition),
    ...
    RULE_606_4_COST_ACTIVATE_ABILITY_PERMANENT_EFFECTS,
    ...
    RULE_607_1a_ABILITY_PRINTED_OBJECT_GRANTS_CONSIDERED,
    ...
    RULE_607_1d_ABILITIES_PRINTED_OBJECTS_PERMANENT_BATTLEFIELD(Condition),

    // 607.2. There are different kinds of linked abilities.
    RULE_607_2_KINDS_LINKED_ABILITIES,

    // 607.2a. If an object has an activated or triggered ability printed on it that instructs a player to exile one or more cards and an ability printed on it that refers either to “the exiled cards” or to cards “exiled with [this object],” these abilities are linked. The second ability refers only to cards in the exile zone that were put there as a result of an instruction to exile them in the first ability.
    RULE_607_2a_OBJECT_ABILITY_EXILE_CARDS_EXILED(Condition),
    ...
    RULE_607_2b_OBJECT_ABILITY_REPLACEMENT_EFFECT_CARDS(Condition),
    ...
    RULE_607_2c_OBJECT_ACTIVATED_ABILITY_BATTLEFIELD_CREATED(Condition),
    ...
    RULE_607_2d_OBJECT_ABILITY_CHOOSE_VALUE_CHOSEN(Condition),
    ...
    RULE_607_2e_OBJECT_ABILITY_PRINTED_NOTED_LINKED(Condition),
    ...
    RULE_607_2f_OBJECT_ABILITY_PRINTED_CAUSES_PLAYER(Condition),
    ...
    RULE_607_2g_OBJECT_ABILITY_COST_BATTLEFIELD_ENTERED(Condition),
    ...
    RULE_607_2h_OBJECT_STATIC_ABILITY_TRIGGERED_ACTIONS(Condition),
    ...
    RULE_607_2i_OBJECT_ABILITY_COST_CAST_SPELL(Condition),
    ...
    RULE_607_2m_ABILITIES_PRECEDED_ANCHOR_WORD_LINKED,
    ...
    RULE_607_2n_OBJECT_ABILITY_EXILE_CARDS_SHUFFLE(Condition),
    ...
    RULE_607_2p_OBJECT_STATIC_ABILITY_CAUSES_ZONES(Condition),
    ...
    RULE_607_2q_PERMANENT_SPELL_ABILITY_CARDS_EXILED(Condition),
    ...
    RULE_607_3_ABILITIES_OBJECT_EXILED_CARD_ACTIONS(Condition),
    ...
    RULE_607_5_OBJECT_ACQUIRES_ABILITIES_EFFECT_CANT(Condition),
    ...
    RULE_608_2_OBJECT_THATS_RESOLVING_SPELL_ABILITY(Condition),
    ...
    RULE_608_2a_TRIGGERED_ABILITY_INTERVENING_STACK_RESOLVE(Condition),
    ...
    RULE_608_2b_SPELL_ABILITY_ZONE_STATE_EFFECT(Condition),

    // 608.2c. The controller of the spell or ability follows its instructions in the order written. However, replacement effects may modify these actions. In some cases, later text on the card may modify the meaning of earlier text (for example, “Destroy target creature. It can’t be regenerated” or “Counter target spell. If that spell is countered this way, put it on top of its owner’s library instead of into its owner’s graveyard.”) Don’t just apply effects step by step without thinking in these cases—read the whole text and apply the rules of English to the text.
    RULE_608_2c_SPELL_ABILITY_EFFECTS_ACTIONS_CARD(Condition),
    ...
    RULE_608_2d_EFFECT_SPELL_ABILITY_STACK_CANT(Condition),
    ...
    RULE_608_2e_SPELLS_ABILITIES_MULTIPLE_ACTIONS_APNAP,
    ...
    RULE_608_2f_SPELLS_ABILITIES_ACTIONS_CANT_APNAP(Condition),
    ...
    RULE_608_2g_EFFECT_ACTIVATE_ABILITIES_ACTION_CAST(Condition),
    ...
    RULE_608_2h_EFFECT_CREATURES_BATTLEFIELD_OBJECT_ABILITY(Condition),
    ...
    RULE_608_2i_EFFECTS_ACTIONS_STATE_OBJECT_NOT(Condition),
    ...
    RULE_608_2j_EFFECT_CHARACTERISTICS_CHECKS_VALUE_OBJECT(Condition),
    ...
    RULE_608_2k_ABILITYS_EFFECT_OBJECT_COST_TRIGGER(Condition),
    ...
    RULE_608_2m_INSTANT_SPELL_ABILITY_RESOLVE_STACK(Condition),
    ...
    RULE_608_2n_FINAL_INSTANT_SPELLS_GRAVEYARD_STACK,
    ...
    RULE_608_2p_N_ABILITIES_TRIGGER_SPELL_RESOLVES(Condition),
    ...
    RULE_608_3a_OBJECT_RESOLVING_PERMANENT_BATTLEFIELD_SPELLS(Condition),
    ...
    RULE_608_3b_OBJECT_RESOLVING_SPELL_CREATURE_RESOLVE(Condition),
    ...
    RULE_608_3c_OBJECT_RESOLVING_SPELL_PERMANENT_BATTLEFIELD(Condition),
    ...
    RULE_608_3d_OBJECT_RESOLVING_CREATURE_SPELL_PERMANENT(Condition),
    ...
    RULE_608_3e_PERMANENT_SPELL_RESOLVES_CANT_BATTLEFIELD(Condition),
    ...
    RULE_608_3f_OBJECT_RESOLVING_PERMANENT_SPELL_BATTLEFIELD(Condition),
    ...
    RULE_609_2_EFFECTS_APPLY_PERMANENTS_INSTRUCTIONS_ZONES(Condition),

    // 609.3. If an effect attempts to do something impossible, it does only as much as possible.
    RULE_609_3_EFFECT_ATTEMPTS_IMPOSSIBLE_MUCH_POSSIBLE(Condition),
    ...
    RULE_609_4_EFFECTS_STATE_PLAYER_CONDITION_CREATURE(Condition),
    ...
    RULE_609_4a_EFFECTS_STATE_PLAYER_CREATURE_THING(Condition),
    ...
    RULE_609_4b_EFFECT_MANA_TYPE_COLOR_COST(Condition),
    ...
    RULE_609_5_EFFECT_RESULT_TIE_SPELL_ABILITY(Condition),
    ...
    RULE_609_7_EFFECTS_DAMAGE_SOURCE_NEXT_TIME(Condition),
    ...
    RULE_609_7a_EFFECT_DAMAGE_PERMANENT_SPELL_STACK(Condition),
    ...
    RULE_609_7b_EFFECTS_SPELLS_ABILITIES_DAMAGE_CREATURE(Condition),
    ...
    RULE_610_2_SHOT_EFFECTS_ABILITY_SPELL_RESOLVES(Condition),

    // 610.3. Some one-shot effects cause an object to change zones “until” a specified event occurs. A second one-shot effect is created immediately after the specified event. This second one-shot effect returns the object to its previous zone.
    RULE_610_3_SHOT_EFFECTS_CAUSE_OBJECT_ZONES,
    ...
    RULE_610_3a_RESOLVING_SPELL_ABILITY_EFFECT_OBJECT(Condition),
    ...
    RULE_610_3b_RESOLVING_ABILITY_EFFECT_OBJECT_ZONES(Condition),

    // 610.3c. An object returned to the battlefield this way returns under its owner’s control unless otherwise specified.
    RULE_610_3c_OBJECT_RETURNED_BATTLEFIELD_WAY_RETURNS(Condition),
    ...
    RULE_610_3d_MULTIPLE_SHOT_EFFECTS_CREATED_WAY(Condition),
    ...
    RULE_610_4_SHOT_EFFECTS_CAUSE_PERMANENT_PHASE,
    ...
    RULE_610_4a_PERMANENT_PHASE_TURN_BASED_ACTION(Condition),
    ...
    RULE_610_4b_RESOLVING_SPELL_ABILITY_EFFECT_PERMANENT(Condition),
    ...
    RULE_610_4c_RESOLVING_ABILITY_EFFECT_PERMANENT_PHASE(Condition),
    ...
    RULE_610_4d_MULTIPLE_SHOT_EFFECTS_CREATED_WAY(Condition),
    ...
    RULE_611_2_CONTINUOUS_EFFECT_GENERATED_SPELL_ABILITY,

    // 611.2a. A continuous effect generated by the resolution of a spell or ability lasts as long as stated by the spell or ability creating it (such as “until end of turn”). If no duration is stated, it lasts until the end of the game.
    RULE_611_2a_CONTINUOUS_EFFECT_SPELL_ABILITY_END(Condition),
    ...
    RULE_611_2b_CONTINUOUS_EFFECTS_SPELL_ABILITY_LONG(Condition),
    ...
    RULE_611_2c_CONTINUOUS_EFFECT_GENERATED_SPELL_ABILITY(Condition),
    ...
    RULE_611_2d_RESOLVING_SPELL_ABILITY_CONTINUOUS_EFFECT(Condition),
    ...
    RULE_611_2e_RESOLVING_SPELL_ABILITY_PERMANENT_BATTLEFIELD(Condition),
    ...
    RULE_611_2f_SPELLS_ABILITIES_CONTINUOUS_EFFECT_NOT(Condition),

    // 611.3. A continuous effect may be generated by the static ability of an object.
    RULE_611_3_CONTINUOUS_EFFECT_GENERATED_ABILITY_OBJECT,
    ...
    RULE_611_3a_CONTINUOUS_EFFECT_GENERATED_ABILITY_LOCKED(Condition),
    ...
    RULE_611_3b_EFFECT_PERMANENT_BATTLEFIELD_OBJECT_ZONE(Condition),
    ...
    RULE_611_3c_CONTINUOUS_EFFECTS_PERMANENTS_BATTLEFIELD_ABILITY(Condition),
    ...
    RULE_612_2_TEXT_EFFECT_CREATURE_CANT_CARD(Condition),
    ...
    RULE_612_2a_SPELLS_ABILITIES_CREATURE_EFFECT_OBJECT,
    ...
    RULE_612_3_EFFECTS_ADD_REMOVE_ABILITIES_CANT,
    ...
    RULE_612_4_TOKENS_SUBTYPES_SPELL_ABILITY_EFFECT,
    ...
    RULE_612_6_CARD_OBJECT_FULL_TEXT_NOT,
    ...
    RULE_612_7_CARD_OBJECT_NAMES_NONLEGENDARY_CREATURE,
    ...
    RULE_612_8_CARDS_CREATE_CONTINUOUS_EFFECT_OBJECT,
    ...
    RULE_612_9_STICKER_PERMANENT_CARD_NOT_BATTLEFIELD,
    ...
    RULE_613_1a_LAYER_EFFECTS_MODIFY_COPIABLE_VALUES,

    // 613.1b. Layer 2: Control-changing effects are applied.
    RULE_613_1b_LAYER_CONTROL_CHANGING_EFFECTS_APPLIED,

    // 613.1c. Layer 3: Text-changing effects are applied. See rule 612, “Text-Changing Effects.”
    RULE_613_1c_LAYER_TEXT_CHANGING_EFFECTS_APPLIED,

    // 613.1d. Layer 4: Type-changing effects are applied. These include effects that change an object’s card type, subtype, and/or supertype.
    RULE_613_1d_LAYER_TYPE_CHANGING_EFFECTS_CARD,

    // 613.1e. Layer 5: Color-changing effects are applied.
    RULE_613_1e_LAYER_COLOR_CHANGING_EFFECTS_APPLIED,

    // 613.1f. Layer 6: Ability-adding effects, keyword counters, ability-removing effects, and effects that say an object can’t have an ability are applied.
    RULE_613_1f_LAYER_ABILITY_EFFECTS_OBJECT_CANT,

    // 613.1g. Layer 7: Power- and/or toughness-changing effects are applied.
    RULE_613_1g_LAYER_POWER_TOUGHNESS_CHANGING_EFFECTS,
    ...
    RULE_613_2_LAYER_APPLY_EFFECTS_SUBLAYERS_TIMESTAMP,
    ...
    RULE_613_2c_EFFECTS_LAYER_APPLIED_OBJECTS_CHARACTERISTICS,
    ...
    RULE_613_3_LAYERS_APPLY_EFFECTS_ABILITIES_TIMESTAMP,
    ...
    RULE_613_4_LAYER_APPLY_EFFECTS_SUBLAYERS_TIMESTAMP,
    ...
    RULE_613_4a_LAYER_7A_EFFECTS_CHARACTERISTIC_ABILITIES,
    ...
    RULE_613_4b_LAYER_7B_EFFECTS_SET_CREATURE,
    ...
    RULE_613_4c_LAYER_7C_EFFECTS_COUNTERS_MODIFY,
    ...
    RULE_613_4d_LAYER_7D_EFFECTS_SWITCH_CREATURES,
    ...
    RULE_613_6_EFFECT_APPLIED_LAYERS_SUBLAYERS_ABILITY(Condition),
    ...
    RULE_613_7_LAYER_SUBLAYER_ORDER_EFFECTS_TIMESTAMP,
    ...
    RULE_613_7a_CONTINUOUS_EFFECT_ABILITY_TIMESTAMP_OBJECT(Condition),
    ...
    RULE_613_7b_CONTINUOUS_EFFECT_SPELL_ABILITY_TIMESTAMP(Condition),
    ...
    RULE_613_7j_CONSPIRACY_CARD_RECEIVES_TIMESTAMP_GAME(Condition),
    ...
    RULE_613_7k_STICKER_TIMESTAMP_OBJECT_PERMANENT_BATTLEFIELD(Condition),
    ...
    RULE_613_7m_OBJECTS_TIMESTAMP_ZONE_APNAP_TURN(Condition),
    ...
    RULE_613_7n_CONTINUOUS_EFFECT_ABILITY_OBJECT_RESOLVING(Condition),
    ...
    RULE_613_8_LAYER_SUBLAYER_ORDER_EFFECTS_TIMESTAMP(Condition),

    // 613.8a. An effect is said to “depend on” another if (a) it’s applied in the same layer (and, if applicable, sublayer) as the other effect; (b) applying the other would change the text or the existence of the first effect, what it applies to, or what it does to any of the things it applies to; and (c) neither effect is from a characteristic-defining ability or both effects are from characteristic-defining abilities. Otherwise, the effect is considered to be independent of the other effect.
    RULE_613_8a_EFFECT_DEPEND_LAYER_SUBLAYER_ABILITY(Condition),
    ...
    RULE_613_8b_EFFECT_DEPENDENT_WAITS_TIMESTAMP_IGNORED(Condition),
    ...
    RULE_613_8c_EFFECT_APPLIED_ORDER_REEVALUATED_NOT(Condition),
    ...
    RULE_613_10_CONTINUOUS_EFFECTS_AFFECT_PLAYERS_TIMESTAMP,
    ...
    RULE_614_1a_EFFECTS_WORD_REPLACEMENT_INDICATE_EVENTS(Condition),
    ...
    RULE_614_1b_EFFECTS_WORD_SKIP_REPLACEMENT_INDICATE,
    ...
    RULE_614_3_SPECIAL_RESTRICTIONS_SPELL_ABILITY_EFFECT,
    ...
    RULE_614_4_EFFECTS_CANT_TIME_SPELLS_ABILITIES(Condition),
    ...
    RULE_614_6_TURN_TRIGGER_ABILITIES_CANT_IGNORED(Condition),
    ...
    RULE_614_7a_ZERO_DAMAGE_NOT_EFFECTS_OBJECT(Condition),
    ...
    RULE_614_8_EFFECT_CARD_REGENERATE_PERMANENT_NEXT(Condition),
    ...
    RULE_614_9_EFFECTS_DAMAGE_CREATURE_PERMANENTS_BATTLEFIELD(Condition),
    ...
    RULE_614_10_EFFECT_SKIP_STEP_PHASE_TURN(Condition),
    ...
    RULE_614_10a_STEP_PHASE_TURN_NEXT_EFFECTS(Condition),
    ...
    RULE_614_10b_EFFECTS_STEP_PHASE_TURN_ACTION,
    ...
    RULE_614_11_EFFECTS_REPLACE_CARD_DRAWS_LIBRARY(Condition),
    ...
    RULE_614_11a_EFFECT_REPLACES_DRAW_CARD_ACTIONS(Condition),
    ...
    RULE_614_11b_EFFECT_PLAYER_CARD_ACTION_NOT(Condition),
    ...
    RULE_614_12_EFFECTS_PERMANENT_BATTLEFIELD_CONTINUOUS_ABILITIES(Condition),
    ...
    RULE_614_12a_REPLACEMENT_EFFECT_MODIFIES_PERMANENT_BATTLEFIELD(Condition),
    ...
    RULE_614_12b_EFFECTS_PERMANENTS_BATTLEFIELD_NOT_COSTS(Condition),
    ...
    RULE_614_12c_EFFECTS_PERMANENT_BATTLEFIELD_ABILITIES_ANCHOR,

    // 614.13. An effect that modifies how a permanent enters the battlefield may cause other objects to change zones.
    RULE_614_13_EFFECT_MODIFIES_PERMANENT_BATTLEFIELD_ZONES,
    ...
    RULE_614_13a_EFFECT_PERMANENT_BATTLEFIELD_ZONES_CANT(Condition),
    ...
    RULE_614_13b_OBJECT_CANT_ZONES_EFFECTS_PERMANENTS(Condition),
    ...
    RULE_614_13c_EFFECT_PERMANENT_BATTLEFIELD_CARDS_EXILE,
    ...
    RULE_614_14_OBJECT_ABILITY_EFFECT_CARDS_EXILED(Condition),
    ...
    RULE_614_15_EFFECTS_NOT_CONTINUOUS_RESOLVING_SPELL(Condition),
    ...
    RULE_614_17a_CANT_EFFECTS_EXIST_APPROPRIATE_TIME,

    // 614.17b. If an event can’t happen, a player can’t choose to pay a cost that includes that event.
    RULE_614_17b_EVENT_CANT_HAPPEN_PLAYER_COST(Condition),
    ...
    RULE_614_17c_EVENT_CANT_HAPPEN_REPLACED_EFFECT(Condition),
    ...
    RULE_615_1a_EFFECTS_WORD_PREVENT_DAMAGE_NOT,

    // 615.2. Many prevention effects apply to damage from a source. See rule 609.7.
    RULE_615_2_PREVENTION_EFFECTS_APPLY_DAMAGE_SOURCE,
    ...
    RULE_615_3_SPECIAL_RESTRICTIONS_SPELL_ABILITY_EFFECT,
    ...
    RULE_615_4_EFFECTS_DAMAGE_CANT_TIME_SPELLS(Condition),
    ...
    RULE_615_5_PREVENTION_EFFECTS_INCLUDE_ADDITIONAL_DAMAGE(Condition),
    ...
    RULE_615_6_DAMAGE_TURN_TRIGGER_ABILITIES_CANT(Condition),
    ...
    RULE_615_7_EFFECTS_SPELL_ABILITY_DAMAGE_PREVENT(Condition),
    ...
    RULE_615_8_PREVENTION_EFFECTS_SPELL_ABILITY_DAMAGE(Condition),
    ...
    RULE_615_9_EFFECTS_GENERATED_SPELL_ABILITY_DAMAGE(Condition),
    ...
    RULE_615_10_EFFECTS_ABILITIES_DAMAGE_SOURCE_DEAL(Condition),
    ...
    RULE_615_11_EFFECTS_N_DAMAGE_CREATURES_SPELL(Condition),
    ...
    RULE_615_12a_PREVENTION_EFFECT_APPLIED_UNPREVENTABLE_DAMAGE,
    ...
    RULE_616_1a_REPLACEMENT_PREVENTION_EFFECTS_SELF_NOT(Condition),
    ...
    RULE_616_1b_REPLACEMENT_EFFECTS_OBJECT_BATTLEFIELD_NOT(Condition),
    ...
    RULE_616_1c_REPLACEMENT_EFFECTS_OBJECT_BATTLEFIELD_NOT(Condition),
    ...
    RULE_616_1d_REPLACEMENT_EFFECTS_CARD_BATTLEFIELD_NOT(Condition),

    // 616.1e. Any of the applicable replacement and/or prevention effects may be chosen.
    RULE_616_1e_APPLICABLE_REPLACEMENT_PREVENTION_EFFECTS_CHOSEN,
    ...
    RULE_616_1f_ONCE_CHOSEN_EFFECT_APPLIED_PROCESS(Condition),
    ...
    RULE_616_1g_STEPS_1A_F_EFFECT_CANT,
    ...
    RULE_700_2_SPELL_ABILITY_MODAL_CHOOSE_CARDS(Condition),
    ...
    RULE_700_2a_CONTROLLER_MODAL_SPELL_ABILITY_CANT(Condition),
    ...
    RULE_700_2b_CONTROLLER_MODAL_ABILITY_STACK_CANT(Condition),
    ...
    RULE_700_2c_SPELL_ABILITY_TARGETS_MODE_NOT(Condition),
    ...
    RULE_700_2d_CHOOSE_THAN_MODE_SPELL_ABILITY(Condition),
    ...
    RULE_700_2e_SPELLS_ABILITIES_SPECIFY_PLAYER_THAN(Condition),
    ...
    RULE_700_2f_MODAL_SPELLS_ABILITIES_TARGETING_CANT,
    ...
    RULE_700_2g_COPY_MODAL_SPELL_ABILITY_CANT,
    ...
    RULE_700_2h_MODAL_SPELLS_COST_EFFECT_CAST(Condition),
    ...
    RULE_700_3c_OBJECTS_GROUPED_ZONE_CARDS_GRAVEYARD(Condition),

    // 700.3d. A pile can contain zero or more objects.
    RULE_700_3d_PILE_CONTAIN_ZERO_OBJECTS,

    // 700.4. The term dies means “is put into a graveyard from the battlefield.”
    RULE_700_4_TERM_DIES_GRAVEYARD_BATTLEFIELD,
    ...
    RULE_700_5_PLAYERS_DEVOTION_COLOR_COSTS_PERMANENTS,
    ...
    RULE_700_7_ABILITY_PHRASE_IDENTIFY_OBJECT_CHARACTERISTIC(Condition),
    ...
    RULE_700_8_CARDS_PLAYERS_PARTY_CONSISTS_CREATURE,
    ...
    RULE_700_8a_SPELL_ABILITY_EFFECT_CREATURES_ZERO(Condition),
    ...
    RULE_700_8b_CREATURE_MULTIPLE_TYPES_PARTY_MEMBER(Condition),

    // 700.8c. A player has a full party if there are four creatures in that player’s party.
    RULE_700_8c_PLAYER_FULL_PARTY_CREATURES(Condition),
    ...
    RULE_700_8d_CARD_STICK_PLAYERS_CHOOSE_CREATURES,
    ...
    RULE_700_10_CARDS_PERMANENT_ACTIVATED_TURN_ABILITY,
    ...
    RULE_700_12_TERM_OUTLAW_OBJECT_ASSASSIN_CREATURE,
    ...
    RULE_700_12a_CARDS_OUTLAWS_PLAYER_PERMANENTS_EFFECTS(Condition),
    ...
    RULE_700_13_CARDS_SPELL_ABILITY_STACK_PERMANENT(Condition),
    ...
    RULE_700_14_ABILITIES_TRIGGER_EXPEND_N_COST(Condition),
    ...
    RULE_701_2a_ACTIVATE_ACTIVATED_ABILITY_STACK_COSTS(Condition),
    ...
    RULE_701_3a_ATTACH_OBJECT_PERMANENT_BATTLEFIELD_CANT(Condition),
    ...
    RULE_701_3b_EFFECT_TRIES_ATTACH_OBJECT_CANT(Condition),
    ...
    RULE_701_3c_ATTACHING_AURA_BATTLEFIELD_OBJECT_TIMESTAMP,
    ...
    RULE_701_3d_UNATTACH_CREATURE_BATTLEFIELD_NOT_OBJECT(Condition),
    ...
    RULE_701_4a_BEHOLD_QUALITY_REVEAL_CARD_HAND,
    ...
    RULE_701_4b_QUALITY_BEHELD_NOT_OBJECT_ACTION(Condition),
    ...
    RULE_701_5a_CAST_SPELL_ZONE_HAND_STACK(Condition),

    // 701.5b. To cast a card is to cast it as a spell.
    RULE_701_5b_CAST_CARD_SPELL,
    ...
    RULE_701_6a_SPELL_ABILITY_STACK_RESOLVE_EFFECTS,
    ...
    RULE_701_6b_CAST_SPELL_ABILITY_REFUND_COSTS,
    ...
    RULE_701_7a_CREATE_TOKENS_CHARACTERISTICS_SPECIFIED_BATTLEFIELD,
    ...
    RULE_701_7b_REPLACEMENT_EFFECT_APPLIES_CONTINUOUS_BATTLEFIELD(Condition),
    ...
    RULE_701_7c_EFFECT_TOKENS_BATTLEFIELD_CARDS_CREATE,

    // 701.8. Destroy
    RULE_701_8_DESTROY,

    // 701.8a. To destroy a permanent, move it from the battlefield to its owner’s graveyard.
    RULE_701_8a_DESTROY_PERMANENT_MOVE_BATTLEFIELD_GRAVEYARD,
    ...
    RULE_701_8b_PERMANENT_DESTROYED_EFFECT_DESTROY_STATE(Condition),

    // 701.8c. A regeneration effect replaces a destruction event. See rule 701.19, “Regenerate.”
    RULE_701_8c_REGENERATION_EFFECT_REPLACES_DESTRUCTION_REGENERATE,

    // 701.9. Discard
    RULE_701_9_DISCARD,

    // 701.9a. To discard a card, move it from its owner’s hand to that player’s graveyard.
    RULE_701_9a_DISCARD_CARD_MOVE_HAND_GRAVEYARD,
    ...
    RULE_701_9b_DEFAULT_EFFECTS_CAUSE_PLAYER_CARD,
    ...
    RULE_701_9c_CARD_EFFECT_HIDDEN_ZONE_GRAVEYARD(Condition),
    ...
    RULE_701_10a_DOUBLING_CREATURES_POWER_CONTINUOUS_EFFECT,
    ...
    RULE_701_10b_CREATURES_X_ZERO_SPELL_ABILITY,
    ...
    RULE_701_10c_CREATURES_POWER_THAN_ZERO_X(Condition),
    ...
    RULE_701_10d_DOUBLE_PLAYERS_LIFE_TOTAL_GAINS,
    ...
    RULE_701_10e_DOUBLE_NUMBER_KIND_COUNTERS_PERMANENT,
    ...
    RULE_701_10f_DOUBLE_AMOUNT_TYPE_MANA_PLAYERS,
    ...
    RULE_701_10g_DOUBLE_AMOUNT_DAMAGE_SOURCE_EFFECT(Condition),
    ...
    RULE_701_11a_TRIPLING_CREATURES_POWER_CONTINUOUS_EFFECT,
    ...
    RULE_701_11b_CREATURES_X_ZERO_SPELL_ABILITY,
    ...
    RULE_701_11c_CREATURES_POWER_THAN_ZERO_X(Condition),

    // 701.12. Exchange
    RULE_701_12_EXCHANGE,
    ...
    RULE_701_12a_SPELL_ABILITY_PERMANENTS_RESOLVES_CANT(Condition),
    ...
    RULE_701_12b_CONTROL_PERMANENTS_EXCHANGED_HAND_EFFECT(Condition),
    ...
    RULE_701_12c_LIFE_EFFECTS_ABILITIES_TRIGGER_CANT(Condition),
    ...
    RULE_701_12d_SPELLS_ABILITIES_EXCHANGE_CARDS_ZONE(Condition),
    ...
    RULE_701_12e_CARD_ZONE_EXCHANGED_ATTACHED_OBJECT(Condition),
    ...
    RULE_701_12f_SPELL_ABILITY_PLAYER_ZONES_CARDS(Condition),
    ...
    RULE_701_12g_SPELL_ABILITY_EFFECTS_TRIGGER_CANT(Condition),
    ...
    RULE_701_12h_CARD_EXCHANGE_CREATURES_EFFECT_PERMANENT,

    // 701.13. Exile
    RULE_701_13_EXILE,

    // 701.13a. To exile an object, move it to the exile zone from wherever it is. See rule 406, “Exile.”
    RULE_701_13a_EXILE_OBJECT_MOVE_ZONE_WHEREVER,
    ...
    RULE_701_14a_SPELL_ABILITY_CREATURE_FIGHT_DAMAGE,
    ...
    RULE_701_14b_CREATURES_BATTLEFIELD_DAMAGE_RESOLVING_SPELL(Condition),

    // 701.14c. If a creature fights itself, it deals damage to itself equal to twice its power.
    RULE_701_14c_CREATURE_FIGHTS_ITSELF_DEALS_DAMAGE(Condition),

    // 701.14d. The damage dealt when a creature fights isn’t combat damage.
    RULE_701_14d_DAMAGE_DEALT_CREATURE_FIGHTS_COMBAT(Condition),
    ...
    RULE_701_15a_SPELLS_ABILITIES_GOAD_CREATURE_TURN,
    ...
    RULE_701_15b_PERMANENT_CREATURE_COMBAT_SPELL_ABILITY(Condition),

    // 701.15c. A creature can be goaded by multiple players. Doing so creates additional combat requirements.
    RULE_701_15c_CREATURE_GOADED_MULTIPLE_PLAYERS_COMBAT,
    ...
    RULE_701_15d_ONCE_PLAYER_CREATURE_EFFECT_COMBAT,

    // 701.16. Investigate
    RULE_701_16_INVESTIGATE,

    // 701.16a. “Investigate” means “Create a Clue token.” See rule 111.10f.
    RULE_701_16a_INVESTIGATE_CREATE_CLUE_TOKEN_10F,
    ...
    RULE_701_17a_PLAYER_MILL_CARDS_LIBRARY_GRAVEYARD,
    ...
    RULE_701_17b_CANT_CARDS_LIBRARY_ACTION_COST(Condition),
    ...
    RULE_701_17c_EFFECT_MILLED_CARD_ZONE_LIBRARY,
    ...
    RULE_701_17d_SPELLS_ABILITIES_CARD_EFFECTS_CAST(Condition),
    ...
    RULE_701_18c_EFFECTS_PLAY_TOP_CARD_LIBRARY,
    ...
    RULE_701_18d_ACTION_CASTING_SPELL_CARD_PLAYING,
    ...
    RULE_701_18e_ACTION_ABILITY_CARDS_PLAYING_ACTIVATING,

    // 701.19. Regenerate
    RULE_701_19_REGENERATE,
    ...
    RULE_701_19a_EFFECT_RESOLVING_SPELL_ABILITY_PERMANENT(Condition),
    ...
    RULE_701_19b_EFFECT_ABILITY_PERMANENT_REMOVE_DAMAGE(Condition),
    ...
    RULE_701_19c_ABILITY_SPELL_PERMANENT_EFFECTS_CANT,
    ...
    RULE_701_20a_CARD_EFFECT_COST_CAST_SPELL(Condition),

    // 701.20b. Revealing a card doesn’t cause it to leave the zone it’s in.
    RULE_701_20b_REVEALING_CARD_DOESNT_CAUSE_ZONE,

    // 701.20c. A card that is currently revealed may be revealed again.
    RULE_701_20c_CARD_CURRENTLY_REVEALED,
    ...
    RULE_701_20d_CARDS_PLAYERS_LIBRARY_SHUFFLED_OTHERWISE(Condition),
    ...
    RULE_701_20e_EFFECTS_PLAYER_LOOK_CARDS_LOOKING(Condition),
    ...
    RULE_701_21a_PERMANENT_BATTLEFIELD_GRAVEYARD_CANT_EFFECTS,
    ...
    RULE_701_22a_SCRY_N_LOOK_CARDS_LIBRARY(Condition),
    ...
    RULE_701_22b_PLAYER_SCRY_ZERO_ABILITIES_TRIGGER(Condition),
    ...
    RULE_701_22c_MULTIPLE_PLAYERS_CARDS_LIBRARY_APNAP(Condition),
    ...
    RULE_701_22d_ABILITY_TRIGGERS_PLAYER_SCRIES_ACTIONS(Condition),
    ...
    RULE_701_23a_SEARCH_CARD_ZONE_LOOK_HIDDEN(Condition),
    ...
    RULE_701_23b_PLAYER_SEARCHING_HIDDEN_ZONE_CARDS(Condition),
    ...
    RULE_701_23c_PLAYER_HIDDEN_ZONE_CARDS_CANT(Condition),
    ...
    RULE_701_23d_PLAYER_SEARCHING_HIDDEN_ZONE_CARDS(Condition),
    ...
    RULE_701_23e_EFFECT_SEARCH_INSTRUCTION_CARD_NOT(Condition),
    ...
    RULE_701_23f_SEARCHING_ZONE_ABILITIES_TRIGGER_LIBRARY(Condition),
    ...
    RULE_701_23g_EFFECT_OFFERS_ZONE_ACTIONS_CARDS(Condition),
    ...
    RULE_701_23h_EFFECT_PLAYER_SEARCH_LIBRARY_CARDS,
    ...
    RULE_701_23i_MULTIPLE_PLAYERS_SEARCH_CARDS_APNAP(Condition),
    ...
    RULE_701_23j_EFFECT_PLAYER_SEARCH_OUTSIDE_CARD(Condition),
    ...
    RULE_701_24a_SHUFFLE_LIBRARY_FACE_PILE_CARDS,
    ...
    RULE_701_24b_EFFECTS_LIBRARY_CARD_ZONE_ABILITIES(Condition),
    ...
    RULE_701_24c_EFFECT_CAUSE_PLAYER_LIBRARY_ZONE(Condition),
    ...
    RULE_701_24d_EFFECT_CAUSE_PLAYER_SHUFFLE_LIBRARY(Condition),
    ...
    RULE_701_24e_EFFECT_LIBRARY_ZERO_CARDS_ABILITIES(Condition),
    ...
    RULE_701_24f_EFFECTS_CAUSE_LIBRARY_ABILITIES_TRIGGER(Condition),
    ...
    RULE_701_24g_EFFECT_CAUSE_PLAYER_LIBRARY_OBJECT(Condition),
    ...
    RULE_701_25a_SURVEIL_N_CARDS_LIBRARY_GRAVEYARD(Condition),
    ...
    RULE_701_25b_EFFECT_LOOK_CARDS_GRAVEYARD_LIBRARY(Condition),
    ...
    RULE_701_25c_PLAYER_SURVEIL_ZERO_ABILITIES_TRIGGER(Condition),
    ...
    RULE_701_25d_ABILITY_TRIGGERS_PLAYER_SURVEILS_ACTIONS(Condition),
    ...
    RULE_701_26a_TAP_PERMANENT_TURN_SIDEWAYS_UPRIGHT,
    ...
    RULE_701_26b_UNTAP_PERMANENT_ROTATE_UPRIGHT_POSITION,

    // 701.27. Transform
    RULE_701_27_TRANSFORM,
    ...
    RULE_701_27a_TRANSFORM_PERMANENT_TURN_FACE_CARDS,
    ...
    RULE_701_27b_TRANSFORMING_PERMANENT_ACTION_ABILITIES_TRIGGER(Condition),
    ...
    RULE_701_27c_SPELL_ABILITY_PLAYER_PERMANENT_CARD(Condition),
    ...
    RULE_701_27d_SPELL_ABILITY_PLAYER_TRANSFORM_PERMANENT(Condition),
    ...
    RULE_701_27e_TRIGGERED_ABILITIES_TRIGGER_OBJECT_TRANSFORMS(Condition),
    ...
    RULE_701_27f_ACTIVATED_ABILITY_PERMANENT_STACK_IGNORED(Condition),
    ...
    RULE_701_27g_SPELLS_ABILITIES_TRANSFORMED_PERMANENT_BATTLEFIELD(Condition),
    ...
    RULE_701_28a_CONVERT_PERMANENT_TURN_FACE_27A,
    ...
    RULE_701_28b_CONVERTING_PERMANENT_ACTION_ABILITIES_TRIGGER(Condition),
    ...
    RULE_701_28c_SPELL_ABILITY_PLAYER_PERMANENT_CARD(Condition),
    ...
    RULE_701_28d_SPELL_ABILITY_PLAYER_CONVERT_PERMANENT(Condition),
    ...
    RULE_701_28e_ACTIVATED_ABILITY_PERMANENT_STACK_IGNORED(Condition),

    // 701.28f. If a spell or ability states that a permanent can’t transform, that permanent also can’t convert.
    RULE_701_28f_SPELL_ABILITY_PERMANENT_CANT_TRANSFORM(Condition),

    // 701.29. Fateseal
    RULE_701_29_FATESEAL,
    ...
    RULE_701_29a_FATESEAL_N_LOOK_CARDS_LIBRARY(Condition),
    ...
    RULE_701_30c_CLASHING_PLAYER_CARD_LIBRARY_APNAP(Condition),
    ...
    RULE_701_30d_PLAYER_WINS_CLASH_REVEALED_CARD(Condition),
    ...
    RULE_701_31a_PLAYER_PLANESWALK_PLANECHASE_GAME_PLANAR,
    ...
    RULE_701_31b_PLANESWALK_FACE_PLANE_CARD_TURN,

    // 701.31c. A player may planeswalk as the result of the “planeswalking ability” (see rule 901.8), because the owner of a face-up plane card or phenomenon card leaves the game (see rule 901.10), or because a phenomenon’s triggered ability leaves the stack (see rule 704.6f). Abilities may also instruct a player to planeswalk.
    RULE_701_31c_PLAYER_PLANESWALKING_ABILITY_CARD_STACK,
    ...
    RULE_701_31d_PLANE_CARD_THATS_TURNED_FACE,

    // 701.32. Set in Motion
    RULE_701_32_SET_MOTION,
    ...
    RULE_701_32a_SCHEME_CARD_SET_MOTION_ARCHENEMY,
    ...
    RULE_701_32b_SET_SCHEME_MOTION_TURN_ACTIONS(Condition),
    ...
    RULE_701_32c_SCHEMES_SET_MOTION_TIME_PLAYER(Condition),
    ...
    RULE_701_33a_FACE_ONGOING_SCHEME_CARD_ARCHENEMY,

    // 701.33b. To abandon a scheme, turn it face down and put it on the bottom of its owner’s scheme deck.
    RULE_701_33b_ABANDON_SCHEME_TURN_FACE_BOTTOM,

    // 701.34. Proliferate
    RULE_701_34_PROLIFERATE,
    ...
    RULE_701_34a_PROLIFERATE_CHOOSE_NUMBER_PERMANENTS_PLAYERS,
    ...
    RULE_701_34b_HEADED_GIANT_GAME_POISON_VARIANT(Condition),
    ...
    RULE_701_37b_ACTION_SPELLS_ABILITIES_PERMANENTS_BATTLEFIELD,
    ...
    RULE_701_37c_PERMANENTS_ABILITY_PLAYER_MONSTROSITY_X(Condition),
    ...
    RULE_701_38a_SPELLS_ABILITIES_PLAYERS_EFFECT_TURN,
    ...
    RULE_701_38b_LISTED_CHOICES_EFFECT_SPELL_ABILITY,
    ...
    RULE_701_38c_SPELL_ABILITY_VOTING_VOTE_NOT(Condition),
    ...
    RULE_701_38d_EFFECT_PLAYER_MULTIPLE_VOTES_HAPPEN(Condition),
    ...
    RULE_701_39a_BOLSTER_N_CHOOSE_CREATURE_CONTROL,

    // 701.40. Manifest
    RULE_701_40_MANIFEST,
    ...
    RULE_701_40a_CARD_TURN_CREATURE_COST_BATTLEFIELD(Condition),
    ...
    RULE_701_40b_TURN_PERMANENT_SPECIAL_ACTION_STACK(Condition),
    ...
    RULE_701_40c_CARD_MORPH_MANIFESTED_TURN_PERMANENT(Condition),
    ...
    RULE_701_40d_CARD_DISGUISE_MANIFESTED_TURN_PERMANENT(Condition),
    ...
    RULE_701_40e_EFFECT_PLAYER_MANIFEST_CARDS_LIBRARY(Condition),
    ...
    RULE_701_40f_EFFECT_CARD_OBJECT_BATTLEFIELD_ZONE(Condition),
    ...
    RULE_701_40g_PERMANENT_CARD_TURN_ABILITIES_TRIGGER(Condition),

    // 701.40h. See rule 708, “Face-Down Spells and Permanents,” for more information.
    RULE_701_40h_FACE_SPELLS_PERMANENTS,
    ...
    RULE_701_41a_SUPPORT_N_PERMANENT_COUNTER_TARGET,
    ...
    RULE_701_42a_ACTION_ABILITY_CARD_BATTLEFIELD_PERMANENT,
    ...
    RULE_701_43b_PERMANENT_NOT_TURN_STEP_EFFECT(Condition),

    // 701.43c. An object that isn’t on the battlefield can’t be exerted.
    RULE_701_43c_OBJECT_ISNT_BATTLEFIELD_CANT_EXERTED,
    ...
    RULE_701_43d_EXERT_CREATURE_ATTACKS_COST_ABILITY(Condition),
    ...
    RULE_701_44a_SPELLS_ABILITIES_PERMANENT_CARD_LIBRARY(Condition),
    ...
    RULE_701_44b_PERMANENT_EXPLORES_PROCESS_44A_ACTIONS(Condition),
    ...
    RULE_701_44c_PERMANENT_CHANGES_ZONES_EFFECT_OBJECT(Condition),
    ...
    RULE_701_44d_MULTIPLE_PERMANENTS_EXPLORE_APNAP_BATTLEFIELD(Condition),
    ...
    RULE_701_45a_ASSEMBLE_KEYWORD_ACTION_BATTLEFIELD_CARDS,

    // 701.46. Adapt
    RULE_701_46_ADAPT,

    // 701.46a. “Adapt N” means “If this permanent has no +1/+1 counters on it, put N +1/+1 counters on it.”
    RULE_701_46a_ADAPT_N_PERMANENT_COUNTERS(Condition),
    ...
    RULE_701_47a_AMASS_SUBTYPE_N_CREATURE_ZERO(Condition),
    ...
    RULE_701_47b_PLAYER_AMASSED_PROCESS_47A_ACTIONS(Condition),
    ...
    RULE_701_47c_PHRASES_ARMY_AMASSED_CREATURE_NOT,
    ...
    RULE_701_47d_OLDER_CARDS_AMASS_N_ZOMBIES,
    ...
    RULE_701_48a_LEARN_DISCARD_CARD_DRAW_HAND(Condition),

    // 701.49. Venture into the Dungeon
    RULE_701_49_VENTURE_INTO_DUNGEON,
    ...
    RULE_701_49a_PLAYER_VENTURE_DUNGEON_CARD_ZONE(Condition),
    ...
    RULE_701_49b_PLAYER_VENTURE_DUNGEON_MARKER_CARDS(Condition),
    ...
    RULE_701_49c_PLAYER_VENTURE_DUNGEON_CARD_ZONE(Condition),
    ...
    RULE_701_49d_VENTURE_QUALITY_VARIANT_CARD_ZONE(Condition),
    ...
    RULE_701_50a_SPELLS_ABILITIES_PERMANENT_CONNIVE_CARD(Condition),
    ...
    RULE_701_50b_PERMANENT_CONNIVES_PROCESS_50A_ACTIONS(Condition),
    ...
    RULE_701_50c_PERMANENT_CHANGES_ZONES_EFFECT_OBJECT(Condition),
    ...
    RULE_701_50d_MULTIPLE_PERMANENTS_CONNIVE_APNAP_BATTLEFIELD(Condition),
    ...
    RULE_701_50e_CONNIVE_N_VARIANT_PERMANENTS_CARDS,

    // 701.51. Open an Attraction
    RULE_701_51_OPEN_ATTRACTION,
    ...
    RULE_701_51a_PLAYER_OPEN_ATTRACTION_GAME_PLAYING,
    ...
    RULE_701_51b_OPEN_ATTRACTION_CARD_TURN_BATTLEFIELD,
    ...
    RULE_701_51c_ABILITY_TRIGGERS_CARD_BATTLEFIELD_EFFECT(Condition),

    // 701.52. Roll to Visit Your Attractions
    RULE_701_52_ROLL_VISIT_ATTRACTIONS,
    ...
    RULE_701_52a_ROLL_VISIT_VISITED_ABILITY_CARDS(Condition),
    ...
    RULE_701_53a_INCUBATE_N_CREATE_INCUBATOR_BATTLEFIELD,
    ...
    RULE_701_53b_TOKEN_COLORLESS_TRANSFORM_ZERO_PHYREXIAN,

    // 701.54. The Ring Tempts You
    RULE_701_54_RING_TEMPTS,
    ...
    RULE_701_54c_PLAYER_RING_CREATURE_BEARER_LEGENDARY(Condition),
    ...
    RULE_701_54d_ABILITIES_TRIGGER_RING_TEMPTS_ACTIONS(Condition),
    ...
    RULE_701_54e_ABILITIES_CREATURE_RING_BEARER_BATTLEFIELD(Condition),

    // 701.55. Face a Villainous Choice
    RULE_701_55_FACE_VILLAINOUS_CHOICE,
    ...
    RULE_701_55a_PLAYER_FACES_VILLAINOUS_CHOICE_OPTION,
    ...
    RULE_701_55b_FACING_VILLAINOUS_CHOICE_PLAYER_ACTION,
    ...
    RULE_701_55c_REPLACEMENT_EFFECT_REPLACE_INSTRUCTION_FACE(Condition),
    ...
    RULE_701_55d_THAN_PLAYER_FACE_VILLAINOUS_APNAP(Condition),
    ...
    RULE_701_56a_TIME_PERMANENTS_CARDS_EXILE_SUSPEND,

    // 701.57. Discover
    RULE_701_57_DISCOVER,
    ...
    RULE_701_57a_DISCOVER_N_EXILE_CARDS_TOP(Condition),
    ...
    RULE_701_57b_PLAYER_DISCOVERED_PROCESS_57A_ACTIONS(Condition),
    ...
    RULE_701_57c_CARD_N_DISCOVERED_CAST_HAND(Condition),
    ...
    RULE_701_58a_CARD_TURN_CREATURE_COST_BATTLEFIELD(Condition),
    ...
    RULE_701_58b_TURN_PERMANENT_SPECIAL_ACTION_STACK(Condition),
    ...
    RULE_701_58c_CARD_MORPH_CLOAKED_TURN_PERMANENT(Condition),
    ...
    RULE_701_58d_CARD_DISGUISE_CLOAKED_TURN_PERMANENT(Condition),
    ...
    RULE_701_58e_EFFECT_PLAYER_CLOAK_CARDS_LIBRARY(Condition),
    ...
    RULE_701_58f_EFFECT_CARD_OBJECT_BATTLEFIELD_ZONE(Condition),
    ...
    RULE_701_59b_EXILE_CARDS_N_GRAVEYARD_CANT(Condition),
    ...
    RULE_701_59c_SPELL_ABILITY_COST_CAST_LINKED,
    ...
    RULE_701_60a_SPELLS_ABILITIES_PLAYER_CREATURE_BATTLEFIELD,
    ...
    RULE_701_62a_MANIFEST_DREAD_LOOK_TOP_CARDS(Condition),
    ...
    RULE_701_62b_ABILITY_TRIGGERS_PLAYER_MANIFESTS_ACTIONS(Condition),
    ...
    RULE_701_63a_ABILITIES_PERMANENT_ENDURE_N_CREATURE(Condition),
    ...
    RULE_701_63b_PERMANENT_ENDURE_ZERO_NOTHING_HAPPENS(Condition),

    // 701.64. Harness
    RULE_701_64_HARNESS,

    // 701.64a. “Harness [this permanent]” means “If this permanent isn’t harnessed, it becomes harnessed.”
    RULE_701_64a_HARNESS_PERMANENT_ISNT_HARNESSED(Condition),
    ...
    RULE_701_64b_HARNESSED_SPELLS_ABILITIES_PERMANENTS_BATTLEFIELD,
    ...
    RULE_701_65a_SPELLS_ABILITIES_PERMANENTS_CARD_CAST,
    ...
    RULE_701_65b_ABILITY_TRIGGERS_PLAYER_AIRBENDS_EXILES(Condition),

    // 701.66. Earthbend
    RULE_701_66_EARTHBEND,
    ...
    RULE_701_66a_EARTHBEND_N_TARGET_LAND_CONTROL(Condition),
    ...
    RULE_701_66b_ABILITY_TRIGGERS_PLAYER_EARTHBENDS_DELAYED(Condition),

    // 701.67. Waterbend
    RULE_701_67_WATERBEND,
    ...
    RULE_701_67a_WATERBEND_COST_PAY_GENERIC_MANA,
    ...
    RULE_701_67b_COST_CAST_SPELL_ACTIVATE_ABILITY(Condition),
    ...
    RULE_701_67c_ABILITY_TRIGGERS_PLAYER_WATERBENDS_COST(Condition),

    // 701.68. Blight
    RULE_701_68_BLIGHT,

    // 701.68a. To “blight N” means to put N -1/-1 counters on a creature you control.
    RULE_701_68a_BLIGHT_N_COUNTERS_CREATURE_CONTROL,
    ...
    RULE_701_68b_PLAYER_CHOICE_N_CREATURE_CANT(Condition),
    ...
    RULE_701_68c_SPELLS_ABILITIES_BLIGHTED_CREATURE_OBJECT(Condition),
    ...
    RULE_702_1a_EFFECT_KEYWORD_ABILITY_COST_VARIABLE(Condition),
    ...
    RULE_702_1b_EFFECT_OBJECT_ABILITY_BASED_STATE,
    ...
    RULE_702_1c_EFFECT_STATE_TRUE_LIST_ABILITIES(Condition),
    ...
    RULE_702_1d_EFFECT_OBJECT_KEYWORD_ABILITY_THING,

    // 702.2. Deathtouch
    RULE_702_2_DEATHTOUCH,

    // 702.2a. Deathtouch is a static ability.
    RULE_702_2a_DEATHTOUCH_STATIC_ABILITY,
    ...
    RULE_702_2b_CREATURE_ZERO_DAMAGE_STATE_BASED,
    ...
    RULE_702_2c_NONZERO_AMOUNT_COMBAT_DAMAGE_CREATURE(Condition),

    // 702.2d. The deathtouch rules function no matter what zone an object with deathtouch deals damage from.
    RULE_702_2d_DEATHTOUCH_FUNCTION_ZONE_OBJECT_DAMAGE,
    ...
    RULE_702_2e_OBJECT_CHANGES_ZONES_EFFECT_DAMAGE(Condition),

    // 702.2f. Multiple instances of deathtouch on the same object are redundant.
    RULE_702_2f_MULTIPLE_INSTANCES_DEATHTOUCH_OBJECT_REDUNDANT,

    // 702.3. Defender
    RULE_702_3_DEFENDER,

    // 702.3a. Defender is a static ability.
    RULE_702_3a_DEFENDER_STATIC_ABILITY,

    // 702.3b. A creature with defender can’t attack.
    RULE_702_3b_CREATURE_DEFENDER_CANT_ATTACK,

    // 702.3c. Multiple instances of defender on the same creature are redundant.
    RULE_702_3c_MULTIPLE_INSTANCES_DEFENDER_CREATURE_REDUNDANT,

    // 702.4. Double Strike
    RULE_702_4_DOUBLE_STRIKE,
    ...
    RULE_702_4a_DOUBLE_ABILITY_COMBAT_DAMAGE_STEP,
    ...
    RULE_702_4b_CREATURE_COMBAT_DAMAGE_STEP_PHASE(Condition),
    ...
    RULE_702_4c_REMOVING_CREATURE_COMBAT_DAMAGE_STEP,
    ...
    RULE_702_4d_DOUBLE_CREATURE_COMBAT_DAMAGE_STEP,

    // 702.4e. Multiple instances of double strike on the same creature are redundant.
    RULE_702_4e_MULTIPLE_INSTANCES_DOUBLE_STRIKE_CREATURE,
    ...
    RULE_702_5a_ENCHANT_ABILITY_OBJECT_PLAYER_SPELL,

    // 702.5b. For more information about Auras, see rule 303, “Enchantments.”
    RULE_702_5b_AURAS_ENCHANTMENTS,
    ...
    RULE_702_5c_AURA_MULTIPLE_INSTANCES_ENCHANT_ABILITIES(Condition),
    ...
    RULE_702_5d_AURAS_ENCHANT_PLAYER_CANT_PERMANENTS,
    ...
    RULE_702_6a_EQUIP_ABILITY_CARDS_COST_ATTACH,

    // 702.6b. For more information about Equipment, see rule 301, “Artifacts.”
    RULE_702_6b_EQUIPMENT_ARTIFACTS,
    ...
    RULE_702_6c_EQUIP_ABILITIES_FURTHER_CREATURES_QUALITY,

    // 702.6d. If a permanent has multiple equip abilities, any of its equip abilities may be activated.
    RULE_702_6d_PERMANENT_MULTIPLE_EQUIP_ABILITIES_ACTIVATED(Condition),
    ...
    RULE_702_6e_EQUIP_PLANESWALKER_ABILITY_COST_ATTACH,
    ...
    RULE_702_7a_STRIKE_ABILITY_COMBAT_DAMAGE_STEP,
    ...
    RULE_702_7b_CREATURE_COMBAT_DAMAGE_STEP_PHASE(Condition),
    ...
    RULE_702_7c_STRIKE_CREATURE_COMBAT_DAMAGE_STEP(Condition),

    // 702.7d. Multiple instances of first strike on the same creature are redundant.
    RULE_702_7d_MULTIPLE_INSTANCES_STRIKE_CREATURE_REDUNDANT,
    ...
    RULE_702_8a_FLASH_ABILITY_ZONE_PLAY_CARD,

    // 702.8b. Multiple instances of flash on the same object are redundant.
    RULE_702_8b_MULTIPLE_INSTANCES_FLASH_OBJECT_REDUNDANT,

    // 702.9. Flying
    RULE_702_9_FLYING,

    // 702.9a. Flying is an evasion ability.
    RULE_702_9a_FLYING_EVASION_ABILITY,
    ...
    RULE_702_9b_CREATURE_FLYING_CANT_BLOCKED_BLOCK,

    // 702.9c. Multiple instances of flying on the same creature are redundant.
    RULE_702_9c_MULTIPLE_INSTANCES_FLYING_CREATURE_REDUNDANT,

    // 702.10. Haste
    RULE_702_10_HASTE,

    // 702.10a. Haste is a static ability.
    RULE_702_10a_HASTE_STATIC_ABILITY,
    ...
    RULE_702_10b_CREATURE_HASTE_ATTACK_HASNT_TURN(Condition),
    ...
    RULE_702_10c_CREATURE_ACTIVATE_ABILITIES_COST_TURN(Condition),

    // 702.10d. Multiple instances of haste on the same creature are redundant.
    RULE_702_10d_MULTIPLE_INSTANCES_HASTE_CREATURE_REDUNDANT,

    // 702.11. Hexproof
    RULE_702_11_HEXPROOF,

    // 702.11a. Hexproof is a static ability.
    RULE_702_11a_HEXPROOF_STATIC_ABILITY,

    // 702.11b. “Hexproof” on a permanent means “This permanent can’t be the target of spells or abilities your opponents control.”
    RULE_702_11b_HEXPROOF_PERMANENT_CANT_SPELLS_ABILITIES,

    // 702.11c. “Hexproof” on a player means “You can’t be the target of spells or abilities your opponents control.”
    RULE_702_11c_HEXPROOF_PLAYER_CANT_SPELLS_ABILITIES,
    ...
    RULE_702_11d_HEXPROOF_QUALITY_ABILITY_PERMANENT_CANT,
    ...
    RULE_702_11e_EFFECT_OBJECT_HEXPROOF_QUALITY_ABILITIES,
    ...
    RULE_702_11f_HEXPROOF_QUALITY_B_SHORTHAND_ABILITIES,
    ...
    RULE_702_13b_CREATURE_INTIMIDATE_CANT_BLOCKED_EXCEPT,

    // 702.13c. Multiple instances of intimidate on the same creature are redundant.
    RULE_702_13c_MULTIPLE_INSTANCES_INTIMIDATE_CREATURE_REDUNDANT,

    // 702.14. Landwalk
    RULE_702_14_LANDWALK,
    ...
    RULE_702_14a_LANDWALK_GENERIC_TYPE_WALK_CARD,

    // 702.14b. Landwalk is an evasion ability.
    RULE_702_14b_LANDWALK_EVASION_ABILITY,
    ...
    RULE_702_14c_CREATURE_LANDWALK_CANT_ISLANDWALK_ARTIFACT(Condition),

    // 702.14d. Landwalk abilities don’t “cancel” one another.
    RULE_702_14d_LANDWALK_ABILITIES_DONT_CANCEL,

    // 702.14e. Multiple instances of the same kind of landwalk on the same creature are redundant.
    RULE_702_14e_MULTIPLE_INSTANCES_KIND_LANDWALK_CREATURE,

    // 702.15. Lifelink
    RULE_702_15_LIFELINK,

    // 702.15a. Lifelink is a static ability.
    RULE_702_15a_LIFELINK_STATIC_ABILITY,
    ...
    RULE_702_15b_DAMAGE_DEALT_SOURCE_LIFELINK_CAUSES(Condition),
    ...
    RULE_702_15c_OBJECT_CHANGES_ZONES_EFFECT_DAMAGE(Condition),

    // 702.15d. The lifelink rules function no matter what zone an object with lifelink deals damage from.
    RULE_702_15d_LIFELINK_FUNCTION_ZONE_OBJECT_DAMAGE,
    ...
    RULE_702_15e_MULTIPLE_SOURCES_LIFELINK_DEAL_DAMAGE(Condition),

    // 702.15f. Multiple instances of lifelink on the same object are redundant.
    RULE_702_15f_MULTIPLE_INSTANCES_LIFELINK_OBJECT_REDUNDANT,

    // 702.16. Protection
    RULE_702_16_PROTECTION,
    ...
    RULE_702_16a_PROTECTION_ABILITY_QUALITY_BLACK_CARD(Condition),

    // 702.16b. A permanent or player with protection can’t be targeted by spells with the stated quality and can’t be targeted by abilities from a source with the stated quality.
    RULE_702_16b_PERMANENT_PLAYER_CANT_SPELLS_ABILITIES,
    ...
    RULE_702_16c_PERMANENT_CANT_STATE_BASED_ACTION,
    ...
    RULE_702_16d_PERMANENT_CANT_STATE_BASED_ACTION,

    // 702.16e. Any damage that would be dealt by sources that have the stated quality to a permanent or player with protection is prevented.
    RULE_702_16e_DAMAGE_DEALT_SOURCES_STATED_PERMANENT(Condition),

    // 702.16f. Attacking creatures with protection can’t be blocked by creatures that have the stated quality.
    RULE_702_16f_ATTACKING_CREATURES_PROTECTION_CANT_BLOCKED,
    ...
    RULE_702_16g_PROTECTION_QUALITY_B_SHORTHAND_ABILITIES,
    ...
    RULE_702_16h_PROTECTION_CHARACTERISTIC_QUALITY_B_ABILITIES,
    ...
    RULE_702_16i_PROTECTION_SET_CHARACTERISTICS_QUALITIES_PLAYERS,
    ...
    RULE_702_16j_PROTECTION_EVERYTHING_ABILITY_PERMANENT_OBJECT(Condition),
    ...
    RULE_702_16k_PROTECTION_PLAYER_ABILITY_PERMANENT_OBJECT(Condition),

    // 702.16m. Multiple instances of protection from the same quality on the same permanent or player are redundant.
    RULE_702_16m_MULTIPLE_INSTANCES_PROTECTION_QUALITY_PERMANENT,
    ...
    RULE_702_16n_CREATURE_EFFECT_STATE_BASED_ACTION(Condition),
    ...
    RULE_702_16p_CREATURE_EFFECT_PERMANENTS_ATTACHED_NOT(Condition),

    // 702.17. Reach
    RULE_702_17_REACH,

    // 702.17a. Reach is a static ability.
    RULE_702_17a_REACH_STATIC_ABILITY,
    ...
    RULE_702_19a_ABILITY_CREATURES_COMBAT_DAMAGE_EFFECT(Condition),
    ...
    RULE_702_19b_CREATURE_DAMAGE_COMBAT_STEP_NOT(Condition),
    ...
    RULE_702_19c_COMBAT_DAMAGE_CREATURE_STEP_NOT(Condition),
    ...
    RULE_702_19d_ATTACKING_CREATURE_TRAMPLE_PLANESWALKERS_DAMAGE(Condition),
    ...
    RULE_702_19e_CREATURE_TRAMPLE_COMBAT_DAMAGE_NOT(Condition),
    ...
    RULE_702_19f_CREATURE_TRAMPLE_PLANESWALKERS_COMBAT_DAMAGE(Condition),
    ...
    RULE_702_21a_ABILITY_COST_PERMANENT_TARGET_SPELL(Condition),
    ...
    RULE_702_21b_ABILITIES_X_COST_STATE_RESOLVES(Condition),

    // 702.22. Banding
    RULE_702_22_BANDING,

    // 702.22a. Banding is a static ability that modifies the rules for combat.
    RULE_702_22a_BANDING_STATIC_ABILITY_MODIFIES_COMBAT,
    ...
    RULE_702_22b_BANDS_SPECIAL_EFFECT_PERMANENT_ABILITIES(Condition),
    ...
    RULE_702_22c_PLAYER_CREATURES_BANDS_QUALITY_CANT(Condition),

    // 702.22d. All creatures in an attacking band must attack the same player, planeswalker, or battle.
    RULE_702_22d_CREATURES_ATTACKING_BAND_ATTACK_PLAYER,
    ...
    RULE_702_22e_ONCE_ATTACKING_BAND_COMBAT_CREATURES(Condition),

    // 702.22f. An attacking creature that’s removed from combat is also removed from the band it was in.
    RULE_702_22f_ATTACKING_CREATURE_THATS_REMOVED_COMBAT,
    ...
    RULE_702_22g_BANDING_DOESNT_CREATURES_ABILITIES_PERMANENTS,
    ...
    RULE_702_22h_ATTACKING_CREATURE_BLOCKED_BAND_BLOCKING(Condition),

    // 702.22i. If one member of a band would become blocked due to an effect, the entire band becomes blocked.
    RULE_702_22i_MEMBER_BAND_BLOCKED_EFFECT_ENTIRE(Condition),
    ...
    RULE_702_22j_COMBAT_DAMAGE_STEP_CREATURE_QUALITY(Condition),
    ...
    RULE_702_22k_COMBAT_DAMAGE_STEP_CREATURE_QUALITY(Condition),
    ...
    RULE_702_22m_MULTIPLE_INSTANCES_BANDING_CREATURE_BANDS,
    ...
    RULE_702_23a_RAMPAGE_ABILITY_N_CREATURE_BLOCKED(Condition),
    ...
    RULE_702_23b_RAMPAGE_BONUS_COMBAT_ABILITY_RESOLVES(Condition),

    // 702.23c. If a creature has multiple instances of rampage, each triggers separately.
    RULE_702_23c_CREATURE_MULTIPLE_INSTANCES_RAMPAGE_TRIGGERS(Condition),

    // 702.24. Cumulative Upkeep
    RULE_702_24_CUMULATIVE_UPKEEP,
    ...
    RULE_702_24a_CUMULATIVE_UPKEEP_ABILITY_COST_PERMANENT(Condition),
    ...
    RULE_702_24b_PERMANENT_MULTIPLE_NOT_ABILITY_RESOLVES(Condition),

    // 702.25. Flanking
    RULE_702_25_FLANKING,
    ...
    RULE_702_25a_FLANKING_ABILITY_STEP_CREATURE_BLOCKED(Condition),

    // 702.25b. If a creature has multiple instances of flanking, each triggers separately.
    RULE_702_25b_CREATURE_MULTIPLE_INSTANCES_FLANKING_TRIGGERS(Condition),

    // 702.26. Phasing
    RULE_702_26_PHASING_MECHANICS,
    ...
    RULE_702_26a_PHASING_ABILITY_STEP_PERMANENTS_PHASE,
    ...
    RULE_702_26b_PERMANENT_PHASED_EFFECTS_NOT_CANT(Condition),

    // 702.26c. If a permanent phases in, its status changes to “phased in.” The game once again treats it as though it exists.
    RULE_702_26c_PERMANENT_PHASES_STATUS_CHANGES_PHASED(Condition),
    ...
    RULE_702_26d_PERMANENT_ZONES_NOT_BATTLEFIELD_EFFECTS(Condition),
    ...
    RULE_702_26e_CONTINUOUS_EFFECT_SPELL_ABILITY_PERMANENT(Condition),
    ...
    RULE_702_26f_CONTINUOUS_EFFECTS_AFFECT_PERMANENT_LONG(Condition),
    ...
    RULE_702_26g_PERMANENT_PHASES_AURAS_PHASE_INDIRECTLY(Condition),

    // 702.26h. If an object would simultaneously phase out directly and indirectly, it just phases out indirectly.
    RULE_702_26h_OBJECT_SIMULTANEOUSLY_PHASE_INDIRECTLY_PHASES(Condition),
    ...
    RULE_702_26i_PHASE_OBJECT_ZONE_NOT_STATE(Condition),
    ...
    RULE_702_26j_ABILITIES_TRIGGER_PERMANENT_ATTACHED_OBJECT(Condition),
    ...
    RULE_702_26n_MULTIPLAYER_GAME_PERMANENT_STEP_TURN(Condition),

    // 702.26p. Multiple instances of phasing on the same permanent are redundant.
    RULE_702_26p_MULTIPLE_INSTANCES_PHASING_PERMANENT_REDUNDANT,
    ...
    RULE_702_27a_BUYBACK_ABILITIES_SPELL_STACK_COST(Condition),

    // 702.28. Shadow
    RULE_702_28_SHADOW,

    // 702.28a. Shadow is an evasion ability.
    RULE_702_28a_SHADOW_EVASION_ABILITY,
    ...
    RULE_702_28b_CREATURE_SHADOW_CANT_BLOCKED,

    // 702.28c. Multiple instances of shadow on the same creature are redundant.
    RULE_702_28c_MULTIPLE_INSTANCES_SHADOW_CREATURE_REDUNDANT,
    ...
    RULE_702_30a_ECHO_ABILITY_COST_UPKEEP_PERMANENT(Condition),
    ...
    RULE_702_30b_URZA_BLOCK_CARDS_ABILITY_COST,

    // 702.31. Horsemanship
    RULE_702_31_HORSEMANSHIP,

    // 702.31a. Horsemanship is an evasion ability.
    RULE_702_31a_HORSEMANSHIP_EVASION_ABILITY,
    ...
    RULE_702_31b_CREATURE_HORSEMANSHIP_CANT_BLOCKED_BLOCK,

    // 702.31c. Multiple instances of horsemanship on the same creature are redundant.
    RULE_702_31c_MULTIPLE_INSTANCES_HORSEMANSHIP_CREATURE_REDUNDANT,
    ...
    RULE_702_32a_FADING_ABILITIES_N_PERMANENT_ENTERS(Condition),
    ...
    RULE_702_33c_MULTIKICKER_ABILITY_COST_PAY_ADDITIONAL,
    ...
    RULE_702_33d_SPELLS_CONTROLLER_DECLARES_COSTS_KICKED(Condition),
    ...
    RULE_702_33e_OBJECTS_KICKER_MULTIKICKER_ABILITIES_LINKED(Condition),
    ...
    RULE_702_33f_KICKER_COST_ABILITIES_KICKED_B(Condition),
    ...
    RULE_702_33g_SPELLS_ABILITY_EFFECT_CAST_NOT(Condition),
    ...
    RULE_702_33h_STICKER_KICKER_ABILITY_ADDITIONAL_COST(Condition),

    // 702.34. Flashback
    RULE_702_34_FLASHBACK,
    ...
    RULE_702_34a_FLASHBACK_ABILITIES_CARD_GRAVEYARD_STACK(Condition),
    ...
    RULE_702_35a_MADNESS_ABILITIES_CARD_HAND_COST(Condition),
    ...
    RULE_702_35b_CASTING_SPELL_MADNESS_ABILITY_COSTS,
    ...
    RULE_702_35c_RESOLVING_ABILITY_CARD_CAST_ZONE(Condition),

    // 702.36. Fear
    RULE_702_36_FEAR,

    // 702.36a. Fear is an evasion ability.
    RULE_702_36a_FEAR_EVASION_ABILITY,
    ...
    RULE_702_36b_CREATURE_FEAR_CANT_BLOCKED_EXCEPT,

    // 702.36c. Multiple instances of fear on the same creature are redundant.
    RULE_702_36c_MULTIPLE_INSTANCES_FEAR_CREATURE_REDUNDANT,
    ...
    RULE_702_37a_MORPH_ABILITY_ZONE_CARD_EFFECT,
    ...
    RULE_702_37b_MEGAMORPH_ABILITY_COST_CAST_CARD(Condition),
    ...
    RULE_702_37c_CAST_CARD_ABILITY_TURN_CREATURE(Condition),

    // 702.37d. You can’t normally cast a card face down. A morph ability allows you to do so.
    RULE_702_37d_CANT_CAST_CARD_FACE_ABILITY,
    ...
    RULE_702_37e_TURN_PERMANENT_ABILITY_SPECIAL_ACTION(Condition),
    ...
    RULE_702_38a_AMPLIFY_ABILITY_N_OBJECT_ENTERS(Condition),

    // 702.38b. If a creature has multiple instances of amplify, each one works separately.
    RULE_702_38b_CREATURE_MULTIPLE_INSTANCES_AMPLIFY_WORKS(Condition),
    ...
    RULE_702_39a_PROVOKE_ABILITY_CREATURE_ATTACKS_CHOOSE(Condition),

    // 702.39b. If a creature has multiple instances of provoke, each triggers separately.
    RULE_702_39b_CREATURE_MULTIPLE_INSTANCES_PROVOKE_TRIGGERS(Condition),
    ...
    RULE_702_40a_STORM_ABILITY_STACK_CAST_SPELL(Condition),

    // 702.40b. If a spell has multiple instances of storm, each triggers separately.
    RULE_702_40b_SPELL_MULTIPLE_INSTANCES_STORM_TRIGGERS(Condition),

    // 702.41. Affinity
    RULE_702_41_AFFINITY,
    ...
    RULE_702_41a_AFFINITY_ABILITY_SPELL_STACK_TEXT,

    // 702.41b. If a spell has multiple instances of affinity, each of them applies.
    RULE_702_41b_SPELL_MULTIPLE_INSTANCES_AFFINITY_APPLIES(Condition),
    ...
    RULE_702_42a_ENTWINE_ABILITY_SPELLS_STACK_COST(Condition),
    ...
    RULE_702_42b_ENTWINE_COST_CARD_SPELL_RESOLVES(Condition),
    ...
    RULE_702_43a_MODULAR_ABILITY_N_PERMANENT_ENTERS(Condition),

    // 702.43b. If a creature has multiple instances of modular, each one works separately.
    RULE_702_43b_CREATURE_MULTIPLE_INSTANCES_MODULAR_WORKS(Condition),

    // 702.44. Sunburst
    RULE_702_44_SUNBURST,
    ...
    RULE_702_44a_SUNBURST_ABILITY_OBJECT_ENTERING_BATTLEFIELD(Condition),
    ...
    RULE_702_44b_OBJECT_BATTLEFIELD_STACK_RESOLVING_SPELL(Condition),
    ...
    RULE_702_44c_SUNBURST_SET_ABILITY_CREATURE_SPELL(Condition),

    // 702.44d. If an object has multiple instances of sunburst, each one works separately.
    RULE_702_44d_OBJECT_MULTIPLE_INSTANCES_SUNBURST_WORKS(Condition),
    ...
    RULE_702_45a_BUSHIDO_ABILITY_N_CREATURE_BLOCKS(Condition),

    // 702.45b. If a creature has multiple instances of bushido, each triggers separately.
    RULE_702_45b_CREATURE_MULTIPLE_INSTANCES_BUSHIDO_TRIGGERS(Condition),

    // 702.46. Soulshift
    RULE_702_46_SOULSHIFT,
    ...
    RULE_702_46a_SOULSHIFT_ABILITY_N_PERMANENT_GRAVEYARD(Condition),

    // 702.46b. If a permanent has multiple instances of soulshift, each triggers separately.
    RULE_702_46b_PERMANENT_MULTIPLE_INSTANCES_SOULSHIFT_TRIGGERS(Condition),
    ...
    RULE_702_47a_SPLICE_ABILITY_CARD_HAND_QUALITY(Condition),
    ...
    RULE_702_47b_CANT_ABILITY_CARDS_SPELL_EFFECTS(Condition),
    ...
    RULE_702_47c_SPELL_CARDS_EFFECT_COST_STACK,
    ...
    RULE_702_47d_CHOOSE_TARGETS_ADDED_SPELL_RESOLVE(Condition),

    // 702.47e. The spell loses any splice changes once it leaves the stack for any reason.
    RULE_702_47e_SPELL_LOSES_SPLICE_CHANGES_STACK,

    // 702.48. Offering
    RULE_702_48_OFFERING,
    ...
    RULE_702_48a_OFFERING_ABILITY_SPELL_STACK_QUALITY(Condition),
    ...
    RULE_702_48b_CHOOSE_PERMANENT_SACRIFICE_SPELL_COST,
    ...
    RULE_702_48c_GENERIC_PERMANENTS_COST_SPELLS_COLORLESS,
    ...
    RULE_702_49a_NINJUTSU_ABILITY_CARD_HAND_COST,
    ...
    RULE_702_49b_CARD_NINJUTSU_REVEALED_ABILITY_STACK,
    ...
    RULE_702_49c_CREATURE_BATTLEFIELD_NINJUTSU_ABILITY_HAND,
    ...
    RULE_702_49d_COMMANDER_NINJUTSU_ABILITY_CARD_COMMAND,
    ...
    RULE_702_50a_EPIC_SPELL_ABILITIES_REST_GAME(Condition),
    ...
    RULE_702_50b_CANT_CAST_SPELLS_RESOLVES_EFFECTS,
    ...
    RULE_702_51a_CONVOKE_ABILITY_SPELL_STACK_COLORED,
    ...
    RULE_702_52a_DREDGE_ABILITY_CARD_GRAVEYARD_N(Condition),
    ...
    RULE_702_52b_PLAYER_CARDS_LIBRARY_ABILITY_CANT,

    // 702.53. Transmute
    RULE_702_53_TRANSMUTE,
    ...
    RULE_702_53a_TRANSMUTE_ABILITY_CARD_HAND_COST,
    ...
    RULE_702_53b_ABILITY_CARD_HAND_OBJECT_BATTLEFIELD(Condition),

    // 702.54. Bloodthirst
    RULE_702_54_BLOODTHIRST,
    ...
    RULE_702_54a_BLOODTHIRST_ABILITY_N_OPPONENT_DEALT(Condition),
    ...
    RULE_702_54b_BLOODTHIRST_X_SPECIAL_PERMANENT_ENTERS,

    // 702.54c. If an object has multiple instances of bloodthirst, each applies separately.
    RULE_702_54c_OBJECT_MULTIPLE_INSTANCES_BLOODTHIRST_APPLIES(Condition),
    ...
    RULE_702_55a_HAUNT_ABILITY_PERMANENT_GRAVEYARD_BATTLEFIELD(Condition),
    ...
    RULE_702_55b_CARDS_EXILE_ZONE_HAUNT_ABILITY,

    // 702.55c. Triggered abilities of cards with haunt that refer to the haunted creature can trigger in the exile zone.
    RULE_702_55c_ABILITIES_CARDS_CREATURE_TRIGGER_EXILE,

    // 702.56. Replicate
    RULE_702_56_REPLICATE,
    ...
    RULE_702_56a_REPLICATE_ABILITIES_SPELL_STACK_COST(Condition),
    ...
    RULE_702_56b_SPELL_MULTIPLE_INSTANCES_BASED_NOT(Condition),
    ...
    RULE_702_57a_FORECAST_ABILITY_SPECIAL_ACTIVATED_HAND,
    ...
    RULE_702_57b_ABILITY_STEP_CARDS_TURN_HAND,
    ...
    RULE_702_58a_GRAFT_ABILITY_N_PERMANENT_ENTERS(Condition),

    // 702.58b. If a permanent has multiple instances of graft, each one works separately.
    RULE_702_58b_PERMANENT_MULTIPLE_INSTANCES_GRAFT_WORKS(Condition),
    ...
    RULE_702_59a_RECOVER_ABILITY_CARD_GRAVEYARD_COST(Condition),
    ...
    RULE_702_60a_RIPPLE_ABILITY_CARD_STACK_N(Condition),

    // 702.60b. If a spell has multiple instances of ripple, each triggers separately.
    RULE_702_60b_SPELL_MULTIPLE_INSTANCES_RIPPLE_TRIGGERS(Condition),
    ...
    RULE_702_61a_SPLIT_ABILITY_SPELL_STACK_LONG,
    ...
    RULE_702_61b_ACTIVATE_ABILITIES_SPECIAL_ACTIONS_SPELL,

    // 702.61c. Multiple instances of split second on the same spell are redundant.
    RULE_702_61c_MULTIPLE_INSTANCES_SPLIT_SPELL_REDUNDANT,
    ...
    RULE_702_62a_SUSPEND_ABILITIES_CARD_HAND_EXILE(Condition),

    // 702.62b. A card is “suspended” if it’s in the exile zone, has suspend, and has a time counter on it.
    RULE_702_62b_CARD_SUSPENDED_EXILE_ZONE_SUSPEND(Condition),
    ...
    RULE_702_62c_CAST_CARD_SUSPEND_CONSIDERATION_EFFECTS(Condition),
    ...
    RULE_702_62d_CASTING_SPELL_EFFECT_ABILITY_COSTS,

    // 702.63. Vanishing
    RULE_702_63_VANISHING,
    ...
    RULE_702_63a_VANISHING_ABILITIES_N_PERMANENT_ENTERS(Condition),
    ...
    RULE_702_63b_UPKEEP_PERMANENT_TIME_COUNTER_REMOVE(Condition),

    // 702.63c. If a permanent has multiple instances of vanishing, each works separately.
    RULE_702_63c_PERMANENT_MULTIPLE_INSTANCES_VANISHING_WORKS(Condition),
    ...
    RULE_702_64a_ABSORB_ABILITY_N_SOURCE_DEAL(Condition),
    ...
    RULE_702_64b_ABSORB_ABILITY_PREVENT_N_DAMAGE(Condition),

    // 702.64c. If an object has multiple instances of absorb, each applies separately.
    RULE_702_64c_OBJECT_MULTIPLE_INSTANCES_ABSORB_APPLIES(Condition),

    // 702.65. Aura Swap
    RULE_702_65_AURA_SWAP,
    ...
    RULE_702_65a_AURA_SWAP_ABILITY_CARDS_COST,

    // 702.65b. If either half of the exchange can’t be completed, the ability has no effect.
    RULE_702_65b_HALF_EXCHANGE_CANT_ABILITY_EFFECT(Condition),
    ...
    RULE_702_66a_DELVE_ABILITY_SPELL_STACK_GENERIC,
    ...
    RULE_702_66b_DELVE_ABILITY_ISNT_COST_SPELL,

    // 702.66c. Multiple instances of delve on the same spell are redundant.
    RULE_702_66c_MULTIPLE_INSTANCES_DELVE_SPELL_REDUNDANT,
    ...
    RULE_702_68a_FRENZY_ABILITY_N_CREATURE_ATTACKS(Condition),

    // 702.68b. If a creature has multiple instances of frenzy, each triggers separately.
    RULE_702_68b_CREATURE_MULTIPLE_INSTANCES_FRENZY_TRIGGERS(Condition),

    // 702.69. Gravestorm
    RULE_702_69_GRAVESTORM,
    ...
    RULE_702_69a_GRAVESTORM_ABILITY_STACK_CAST_SPELL(Condition),

    // 702.69b. If a spell has multiple instances of gravestorm, each triggers separately.
    RULE_702_69b_SPELL_MULTIPLE_INSTANCES_GRAVESTORM_TRIGGERS(Condition),

    // 702.70. Poisonous
    RULE_702_70_POISONOUS,
    ...
    RULE_702_70a_POISONOUS_ABILITY_N_CREATURE_DEALS(Condition),

    // 702.70b. If a creature has multiple instances of poisonous, each triggers separately.
    RULE_702_70b_CREATURE_MULTIPLE_INSTANCES_POISONOUS_TRIGGERS(Condition),
    ...
    RULE_702_71a_TRANSFIGURE_ABILITY_COST_SACRIFICE_PERMANENT,

    // 702.72. Champion
    RULE_702_72_CHAMPION,
    ...
    RULE_702_72a_CHAMPION_ABILITIES_OBJECT_PERMANENT_ENTERS(Condition),

    // 702.72b. The two abilities represented by champion are linked. See rule 607, “Linked Abilities.”
    RULE_702_72b_ABILITIES_CHAMPION_LINKED,
    ...
    RULE_702_72c_PERMANENT_CHAMPIONED_LATTER_EXILES_ABILITY(Condition),
    ...
    RULE_702_73a_CHANGELING_ABILITY_OBJECT_CREATURE_TYPE,
    ...
    RULE_702_74a_EVOKE_ABILITIES_ZONE_CARD_CAST(Condition),

    // 702.75. Hideaway
    RULE_702_75_HIDEAWAY,
    ...
    RULE_702_75a_HIDEAWAY_ABILITY_N_PERMANENT_ENTERS(Condition),
    ...
    RULE_702_75b_HIDEAWAY_ABILITY_PERMANENT_BATTLEFIELD_TAPPED(Condition),
    ...
    RULE_702_76a_PROWL_ABILITY_STACK_COST_PAY(Condition),

    // 702.77. Reinforce
    RULE_702_77_REINFORCE,
    ...
    RULE_702_77a_REINFORCE_ABILITY_CARD_HAND_N,
    ...
    RULE_702_77b_ABILITY_CARD_HAND_OBJECT_BATTLEFIELD(Condition),

    // 702.78. Conspire
    RULE_702_78_CONSPIRE,
    ...
    RULE_702_78a_CONSPIRE_ABILITIES_SPELL_STACK_ADDITIONAL(Condition),
    ...
    RULE_702_78b_SPELL_MULTIPLE_INSTANCES_BASED_NOT(Condition),
    ...
    RULE_702_79a_PERSIST_ABILITY_PERMANENT_GRAVEYARD_BATTLEFIELD(Condition),
    ...
    RULE_702_80a_WITHER_STATIC_ABILITY_DAMAGE_CREATURE,
    ...
    RULE_702_81a_RETRACE_ABILITY_CARD_GRAVEYARD_CAST,
    ...
    RULE_702_82a_DEVOUR_ABILITY_N_OBJECT_ENTERS,
    ...
    RULE_702_82b_ABILITIES_CREATURES_PERMANENT_DEVOURED_SACRIFICED,
    ...
    RULE_702_82c_DEVOUR_QUALITY_N_OBJECT_ENTERS,
    ...
    RULE_702_83a_EXALTED_ABILITY_CREATURE_CONTROL_ATTACKS(Condition),
    ...
    RULE_702_83b_CREATURE_ATTACKS_ALONE_COMBAT_PHASE(Condition),
    ...
    RULE_702_84a_UNEARTH_ABILITY_CARD_GRAVEYARD_COST(Condition),
    ...
    RULE_702_85a_CASCADE_ABILITY_SPELL_STACK_CAST(Condition),
    ...
    RULE_702_85b_EFFECT_ACTION_CARDS_CASCADE_ABILITY(Condition),

    // 702.85c. If a spell has multiple instances of cascade, each triggers separately.
    RULE_702_85c_SPELL_MULTIPLE_INSTANCES_CASCADE_TRIGGERS(Condition),

    // 702.86. Annihilator
    RULE_702_86_ANNIHILATOR,
    ...
    RULE_702_86a_ANNIHILATOR_ABILITY_N_CREATURE_ATTACKS(Condition),

    // 702.86b. If a creature has multiple instances of annihilator, each triggers separately.
    RULE_702_86b_CREATURE_MULTIPLE_INSTANCES_ANNIHILATOR_TRIGGERS(Condition),
    ...
    RULE_702_87a_LEVEL_ABILITY_COST_COUNTER_PERMANENT,
    ...
    RULE_702_87b_CARD_PRINTED_LEVEL_ABILITY_LEVELER,
    ...
    RULE_702_87c_ENCHANTMENTS_CLASS_ABILITIES_NOT_CARDS,
    ...
    RULE_702_88a_REBOUND_ABILITY_SPELL_STACK_CAST(Condition),
    ...
    RULE_702_88b_CASTING_SPELL_EFFECT_ABILITY_COSTS,

    // 702.88c. Multiple instances of rebound on the same spell are redundant.
    RULE_702_88c_MULTIPLE_INSTANCES_REBOUND_SPELL_REDUNDANT,

    // 702.89. Umbra Armor
    RULE_702_89_UMBRA_ARMOR,
    ...
    RULE_702_89a_UMBRA_ARMOR_ABILITY_ENCHANTED_PERMANENT(Condition),
    ...
    RULE_702_89b_OLDER_CARDS_ABILITY_TOTEM_ARMOR(Condition),

    // 702.90. Infect
    RULE_702_90_INFECT,

    // 702.90a. Infect is a static ability.
    RULE_702_90a_INFECT_STATIC_ABILITY,
    ...
    RULE_702_90b_DAMAGE_DEALT_PLAYER_SOURCE_INFECT,
    ...
    RULE_702_90c_DAMAGE_DEALT_CREATURE_SOURCE_INFECT,
    ...
    RULE_702_90d_OBJECT_CHANGES_ZONES_EFFECT_DAMAGE(Condition),

    // 702.90e. The infect rules function no matter what zone an object with infect deals damage from.
    RULE_702_90e_INFECT_FUNCTION_ZONE_OBJECT_DAMAGE,

    // 702.90f. Multiple instances of infect on the same object are redundant.
    RULE_702_90f_MULTIPLE_INSTANCES_INFECT_OBJECT_REDUNDANT,

    // 702.91. Battle Cry
    RULE_702_91_BATTLE_CRY,
    ...
    RULE_702_91a_BATTLE_CRY_ABILITY_CREATURE_ATTACKS(Condition),

    // 702.91b. If a creature has multiple instances of battle cry, each triggers separately.
    RULE_702_91b_CREATURE_MULTIPLE_INSTANCES_BATTLE_CRY(Condition),

    // 702.92. Living Weapon
    RULE_702_92_LIVING_WEAPON,
    ...
    RULE_702_92a_LIVING_WEAPON_ABILITY_EQUIPMENT_ENTERS(Condition),
    ...
    RULE_702_93a_UNDYING_ABILITY_PERMANENT_GRAVEYARD_BATTLEFIELD(Condition),
    ...
    RULE_702_94a_MIRACLE_ABILITY_COST_REVEAL_CARD(Condition),
    ...
    RULE_702_94b_CARD_ABILITY_HAND_RESOLVES_STACK(Condition),

    // 702.95. Soulbond
    RULE_702_95_SOULBOND,
    ...
    RULE_702_95a_SOULBOND_ABILITIES_CREATURE_ENTERS_CONTROL(Condition),
    ...
    RULE_702_95b_CREATURE_PAIRED_ABILITY_UNPAIRED_NOT,
    ...
    RULE_702_95c_ABILITY_RESOLVES_OBJECT_CREATURE_BATTLEFIELD(Condition),

    // 702.95d. A creature can be paired with only one other creature.
    RULE_702_95d_CREATURE_PAIRED,
    ...
    RULE_702_95e_PAIRED_CREATURE_UNPAIRED_OCCUR_BATTLEFIELD(Condition),

    // 702.96. Overload
    RULE_702_96_OVERLOAD,
    ...
    RULE_702_96a_ABILITIES_SPELL_STACK_COST_CHOOSE(Condition),
    ...
    RULE_702_96b_PLAYER_CHOOSES_COST_SPELL_CAST(Condition),

    // 702.96c. Overload’s second ability creates a text-changing effect. See rule 612, “Text-Changing Effects.”
    RULE_702_96c_OVERLOADS_ABILITY_TEXT_CHANGING_EFFECT,
    ...
    RULE_702_97a_SCAVENGE_ABILITY_CARD_GRAVEYARD_COST,
    ...
    RULE_702_98a_UNLEASH_ABILITIES_PERMANENT_ENTER_ADDITIONAL,
    ...
    RULE_702_99a_CIPHER_ABILITIES_SPELL_STACK_CARD(Condition),
    ...
    RULE_702_99b_ENCODED_CARD_EXILE_ZONE_CREATURE(Condition),
    ...
    RULE_702_99c_CARD_CIPHER_CREATURE_BATTLEFIELD_OBJECT(Condition),
    ...
    RULE_702_101a_EXTORT_ABILITY_CAST_SPELL_PAY(Condition),

    // 702.101b. If a permanent has multiple instances of extort, each triggers separately.
    RULE_702_101b_PERMANENT_MULTIPLE_INSTANCES_EXTORT_TRIGGERS(Condition),
    ...
    RULE_702_102d_FUSED_SPLIT_SPELL_RESOLVES_CONTROLLER,
    ...
    RULE_702_103a_BESTOW_ABILITY_ZONE_CARD_COST(Condition),
    ...
    RULE_702_103b_SPELL_CAST_STACK_CREATURE_PERMANENT,
    ...
    RULE_702_103c_BESTOWED_AURA_SPELL_COPIED_CAST(Condition),
    ...
    RULE_702_103d_CASTING_SPELL_BESTOWED_ABILITY_CAST(Condition),
    ...
    RULE_702_103e_BESTOWED_SPELL_RESOLVING_EFFECT_CREATURE(Condition),
    ...
    RULE_702_103f_BESTOWED_AURA_UNATTACHED_CEASES_OBJECT(Condition),

    // 702.103g. If a bestowed Aura phases in unattached, it ceases to be bestowed. See rule 702.26, “Phasing.”
    RULE_702_103g_BESTOWED_AURA_PHASES_UNATTACHED_PHASING(Condition),

    // 702.104. Tribute
    RULE_702_104_TRIBUTE,
    ...
    RULE_702_104a_TRIBUTE_ABILITY_CREATURE_BATTLEFIELD_N,
    ...
    RULE_702_104b_OBJECTS_TRIBUTE_ABILITIES_CREATURE_BATTLEFIELD(Condition),

    // 702.105. Dethrone
    RULE_702_105_DETHRONE,
    ...
    RULE_702_105a_DETHRONE_ABILITY_CREATURE_ATTACKS_PLAYER(Condition),

    // 702.105b. If a creature has multiple instances of dethrone, each triggers separately.
    RULE_702_105b_CREATURE_MULTIPLE_INSTANCES_DETHRONE_TRIGGERS(Condition),

    // 702.106. Hidden Agenda
    RULE_702_106_HIDDEN_AGENDA,
    ...
    RULE_702_106c_TURN_CARD_ZONE_SPECIAL_ACTION,
    ...
    RULE_702_106d_HIDDEN_ABILITY_OBJECT_CHOSEN_NAME,
    ...
    RULE_702_106e_PLAYER_LEAVES_GAME_FACE_CARDS(Condition),
    ...
    RULE_702_106f_DOUBLE_HIDDEN_ABILITY_CARD_ZONE,
    ...
    RULE_702_107a_OUTLAST_ABILITY_COST_COUNTER_CREATURE,

    // 702.108. Prowess
    RULE_702_108_PROWESS,
    ...
    RULE_702_108a_PROWESS_ABILITY_CAST_NONCREATURE_SPELL(Condition),

    // 702.108b. If a creature has multiple instances of prowess, each triggers separately.
    RULE_702_108b_CREATURE_MULTIPLE_INSTANCES_PROWESS_TRIGGERS(Condition),
    ...
    RULE_702_109a_DASH_ABILITIES_CARD_STACK_OBJECT(Condition),

    // 702.110. Exploit
    RULE_702_110_EXPLOIT,

    // 702.110a. Exploit is a triggered ability. “Exploit” means “When this creature enters, you may sacrifice a creature.”
    RULE_702_110a_EXPLOIT_ABILITY_CREATURE_ENTERS_SACRIFICE(Condition),
    ...
    RULE_702_112a_RENOWN_ABILITY_N_CREATURE_DEALS(Condition),
    ...
    RULE_702_112b_RENOWNED_ABILITY_SPELLS_PERMANENTS_BATTLEFIELD,
    ...
    RULE_702_112c_CREATURE_MULTIPLE_ABILITY_RESOLVE_EFFECT(Condition),
    ...
    RULE_702_113a_AWAKEN_ABILITIES_SPELL_STACK_N(Condition),
    ...
    RULE_702_113b_CONTROLLER_SPELL_ABILITY_COST_CAST(Condition),
    ...
    RULE_702_114a_DEVOID_CHARACTERISTIC_ABILITY_OBJECT_COLORLESS,
    ...
    RULE_702_115a_INGEST_ABILITY_CREATURE_DEALS_COMBAT(Condition),

    // 702.115b. If a creature has multiple instances of ingest, each triggers separately.
    RULE_702_115b_CREATURE_MULTIPLE_INSTANCES_INGEST_TRIGGERS(Condition),
    ...
    RULE_702_116a_MYRIAD_ABILITY_CREATE_CREATURE_ATTACKS(Condition),

    // 702.116b. If a creature has multiple instances of myriad, each triggers separately.
    RULE_702_116b_CREATURE_MULTIPLE_INSTANCES_MYRIAD_TRIGGERS(Condition),
    ...
    RULE_702_119a_EMERGE_ABILITIES_SPELL_STACK_COST(Condition),
    ...
    RULE_702_119b_EMERGE_QUALITY_COST_CAST_SPELL(Condition),
    ...
    RULE_702_119c_CHOOSE_PERMANENT_SACRIFICE_SPELLS_COST,
    ...
    RULE_702_120a_ESCALATE_ABILITY_SPELLS_STACK_COST,
    ...
    RULE_702_121a_MELEE_ABILITY_CREATURE_ATTACKS_END(Condition),

    // 702.121b. If a creature has multiple instances of melee, each triggers separately.
    RULE_702_121b_CREATURE_MULTIPLE_INSTANCES_MELEE_TRIGGERS(Condition),
    ...
    RULE_702_122c_EFFECT_CREATURE_CANT_CREW_COST(Condition),
    ...
    RULE_702_122d_ABILITIES_TRIGGER_CREWED_CREW_RESOLVES(Condition),

    // 702.123. Fabricate
    RULE_702_123_FABRICATE,
    ...
    RULE_702_123a_FABRICATE_ABILITY_N_PERMANENT_ENTERS(Condition),

    // 702.123b. If a permanent has multiple instances of fabricate, each triggers separately.
    RULE_702_123b_PERMANENT_MULTIPLE_INSTANCES_FABRICATE_TRIGGERS(Condition),

    // 702.124. Partner
    RULE_702_124_PARTNER,
    ...
    RULE_702_124a_PARTNER_ABILITIES_KEYWORD_MODIFY_CARDS,
    ...
    RULE_702_124b_DECK_CONTAIN_EXACTLY_CARDS_ZONE,
    ...
    RULE_702_124c_EFFECT_COMMANDERS_COLOR_IDENTITY_COMBINED,
    ...
    RULE_702_124d_EXCEPT_IDENTITY_CAST_COMBAT_DAMAGE(Condition),
    ...
    RULE_702_124e_EFFECT_COMMANDER_CAUSES_PERFORM_ACTION(Condition),

    // 702.124f. Different partner abilities are distinct from one another and cannot be combined.
    RULE_702_124f_PARTNER_ABILITIES_DISTINCT_CANNOT_COMBINED,
    ...
    RULE_702_124g_LEGENDARY_CARD_THAN_ABILITY_CANT(Condition),
    ...
    RULE_702_124h_PARTNER_DESIGNATE_LEGENDARY_CARDS_COMMANDER(Condition),
    ...
    RULE_702_124i_PARTNER_TEXT_DESIGNATE_LEGENDARY_CARDS(Condition),
    ...
    RULE_702_124j_PARTNER_NAME_ABILITIES_DESIGNATE_LEGENDARY(Condition),
    ...
    RULE_702_124k_CHOOSE_BACKGROUND_DESIGNATE_CARDS_COMMANDER(Condition),
    ...
    RULE_702_124m_DESIGNATE_LEGENDARY_CREATURE_CARDS_COMMANDER(Condition),
    ...
    RULE_702_124n_EFFECT_PARTNER_ABILITY_NOT_CARDS(Condition),

    // 702.125. Undaunted
    RULE_702_125_UNDAUNTED,
    ...
    RULE_702_126a_IMPROVISE_ABILITY_SPELL_STACK_GENERIC,
    ...
    RULE_702_126b_IMPROVISE_ABILITY_ISNT_COST_SPELL,

    // 702.126c. Multiple instances of improvise on the same spell are redundant.
    RULE_702_126c_MULTIPLE_INSTANCES_IMPROVISE_SPELL_REDUNDANT,

    // 702.127. Aftermath
    RULE_702_127_AFTERMATH,
    ...
    RULE_702_127a_AFTERMATH_ABILITY_SPLIT_CARDS_CAST(Condition),
    ...
    RULE_702_128a_EMBALM_ABILITY_CARD_GRAVEYARD_COST,

    // 702.128b. A token is “embalmed” if it’s created by a resolving embalm ability.
    RULE_702_128b_TOKEN_EMBALMED_CREATED_RESOLVING_ABILITY(Condition),
    ...
    RULE_702_129a_ETERNALIZE_ABILITY_CARD_GRAVEYARD_COST,

    // 702.130. Afflict
    RULE_702_130_AFFLICT,
    ...
    RULE_702_130a_AFFLICT_ABILITY_N_CREATURE_BLOCKED(Condition),

    // 702.130b. If a creature has multiple instances of afflict, each triggers separately.
    RULE_702_130b_CREATURE_MULTIPLE_INSTANCES_AFFLICT_TRIGGERS(Condition),
    ...
    RULE_702_131a_ASCEND_SPELL_ABILITY_CONTROL_PERMANENTS(Condition),
    ...
    RULE_702_131b_ASCEND_PERMANENT_ABILITY_TIME_CONTROL,
    ...
    RULE_702_131c_CITYS_BLESSING_DESIGNATION_THAN_EFFECTS(Condition),
    ...
    RULE_702_131d_PLAYER_CONTINUOUS_EFFECTS_STATE_TRIGGER(Condition),
    ...
    RULE_702_132a_ABILITY_SPELL_COST_CAST_ACTIVATE(Condition),

    // 702.133. Jump-Start
    RULE_702_133_JUMP_START,
    ...
    RULE_702_133a_JUMP_START_ABILITIES_CARD_GRAVEYARD(Condition),
    ...
    RULE_702_134a_MENTOR_ABILITY_CREATURE_ATTACKS_COUNTER(Condition),

    // 702.134b. If a creature has multiple instances of mentor, each triggers separately.
    RULE_702_134b_CREATURE_MULTIPLE_INSTANCES_MENTOR_TRIGGERS(Condition),
    ...
    RULE_702_134c_ABILITY_TRIGGERS_CREATURE_MENTORS_RESOLVES(Condition),

    // 702.135. Afterlife
    RULE_702_135_AFTERLIFE,
    ...
    RULE_702_135a_AFTERLIFE_ABILITY_N_PERMANENT_GRAVEYARD(Condition),

    // 702.135b. If a permanent has multiple instances of afterlife, each triggers separately.
    RULE_702_135b_PERMANENT_MULTIPLE_INSTANCES_AFTERLIFE_TRIGGERS(Condition),
    ...
    RULE_702_136a_RIOT_ABILITY_PERMANENT_ENTER_ADDITIONAL(Condition),

    // 702.136b. If a permanent has multiple instances of riot, each works separately.
    RULE_702_136b_PERMANENT_MULTIPLE_INSTANCES_RIOT_WORKS(Condition),

    // 702.137. Spectacle
    RULE_702_137_SPECTACLE,
    ...
    RULE_702_137a_SPECTACLE_ABILITY_STACK_COST_PAY(Condition),
    ...
    RULE_702_138a_ESCAPE_ABILITY_CARD_GRAVEYARD_COST,
    ...
    RULE_702_138b_SPELL_PERMANENT_ESCAPED_CAST_GRAVEYARD(Condition),
    ...
    RULE_702_138c_ABILITY_PERMANENT_ESCAPES_KIND_COUNTER(Condition),

    // 702.138d. An ability that reads “[This permanent] escapes with [ability]” means “If this permanent escaped, it has [ability].”
    RULE_702_138d_ABILITY_READS_PERMANENT_ESCAPES_ESCAPED(Condition),

    // 702.139. Companion
    RULE_702_139_COMPANION,
    ...
    RULE_702_139a_COMPANION_ABILITY_CONDITION_CARD_STACK,
    ...
    RULE_702_139b_COMPANION_ABILITY_STARTING_DECK_CARDS(Condition),
    ...
    RULE_702_140a_MUTATE_CREATURE_CARDS_ABILITY_SPELL(Condition),
    ...
    RULE_702_140b_MUTATING_CREATURE_SPELL_RESOLVING_BATTLEFIELD(Condition),
    ...
    RULE_702_140c_CREATURE_SPELL_RESOLVES_BATTLEFIELD_OBJECT(Condition),
    ...
    RULE_702_140d_ABILITY_TRIGGERS_CREATURE_SPELL_RESOLVING(Condition),
    ...
    RULE_702_140e_MUTATED_PERMANENT_ABILITIES_CARD_TOKEN,
    ...
    RULE_702_140f_EFFECT_CREATURE_SPELL_PERMANENT_RESOLVES,
    ...
    RULE_702_141a_ENCORE_ABILITY_CARD_GRAVEYARD_COST(Condition),
    ...
    RULE_702_142a_BOAST_ABILITY_SPECIAL_COST_EFFECT(Condition),
    ...
    RULE_702_142b_EFFECTS_BOAST_ABILITIES_CREATURE_BOASTING(Condition),

    // 702.143. Foretell
    RULE_702_143_FORETELL,
    ...
    RULE_702_143a_CARD_HAND_TURN_EXILE_CAST(Condition),
    ...
    RULE_702_143b_CARD_ABILITY_SPECIAL_ACTION_STACK,
    ...
    RULE_702_143c_EFFECT_CARD_SPECIAL_ACTION_ABILITY(Condition),
    ...
    RULE_702_143d_EFFECT_CARD_EXILE_COST_CAST(Condition),
    ...
    RULE_702_143e_PLAYER_OWNS_CARDS_EXILE_COSTS(Condition),
    ...
    RULE_702_143f_PLAYER_LEAVES_GAME_FACE_CARDS(Condition),

    // 702.144. Demonstrate
    RULE_702_144_DEMONSTRATE,
    ...
    RULE_702_145b_DAYBOUND_FRONT_DOUBLE_FACED_CARDS(Condition),
    ...
    RULE_702_145c_TIME_PERMANENT_STATE_BASED_ACTION,

    // 702.145d. Any time a player controls a permanent with daybound, if it’s neither day nor night, it becomes day.
    RULE_702_145d_TIME_PLAYER_CONTROLS_PERMANENT_DAYBOUND(Condition),
    ...
    RULE_702_145e_NIGHTBOUND_CARDS_ABILITIES_DAY_PERMANENT(Condition),
    ...
    RULE_702_145f_TIME_PERMANENT_STATE_BASED_ACTION,
    ...
    RULE_702_145g_TIME_PLAYER_CONTROLS_PERMANENT_BATTLEFIELD(Condition),
    ...
    RULE_702_146a_DISTURB_ABILITY_CARDS_COST_CAST,
    ...
    RULE_702_146b_RESOLVING_SPELL_CAST_ABILITY_BATTLEFIELD,

    // 702.147. Decayed
    RULE_702_147_DECAYED,
    ...
    RULE_702_147a_DECAYED_ABILITY_CREATURE_CANT_BLOCK(Condition),
    ...
    RULE_702_148a_CLEAVE_ABILITIES_SPELL_STACK_COST(Condition),

    // 702.148b. Cleave’s second ability is a text-changing effect. See rule 612, “Text-Changing Effects.”
    RULE_702_148b_CLEAVES_ABILITY_TEXT_CHANGING_EFFECT,

    // 702.149. Training
    RULE_702_149_TRAINING,
    ...
    RULE_702_149a_TRAINING_ABILITY_CREATURE_POWER_GREATER(Condition),

    // 702.149b. If a creature has multiple instances of training, each triggers separately.
    RULE_702_149b_CREATURE_MULTIPLE_INSTANCES_TRAINING_TRIGGERS(Condition),
    ...
    RULE_702_149c_CREATURES_TRAINING_ABILITIES_TRIGGER_RESOLVING(Condition),

    // 702.150. Compleated
    RULE_702_150_COMPLEATED,
    ...
    RULE_702_150a_ABILITY_CARDS_PERMANENT_ENTER_LOYALTY(Condition),

    // 702.151. Reconfigure
    RULE_702_151_RECONFIGURE,
    ...
    RULE_702_151a_ABILITIES_COST_ATTACH_PERMANENT_TARGET(Condition),
    ...
    RULE_702_151b_ATTACHING_EQUIPMENT_RECONFIGURE_CREATURE_CAUSES,
    ...
    RULE_702_152a_BLITZ_ABILITIES_CARD_STACK_OBJECT(Condition),
    ...
    RULE_702_152b_SPELL_CAST_PERMANENT_ABILITY_NOT(Condition),

    // 702.153. Casualty
    RULE_702_153_CASUALTY,
    ...
    RULE_702_153a_CASUALTY_ABILITIES_SPELL_STACK_N(Condition),
    ...
    RULE_702_153b_SPELL_MULTIPLE_INSTANCES_BASED_NOT(Condition),
    ...
    RULE_702_154a_ABILITY_CREATURE_ATTACKS_TAP_UNTAPPED(Condition),
    ...
    RULE_702_154b_ENLISTS_STATIC_ABILITY_COST_ATTACK,
    ...
    RULE_702_154c_CREATURE_ENLISTS_PAY_COST_ABILITY(Condition),
    ...
    RULE_702_154d_MULTIPLE_INSTANCES_CREATURE_ABILITY_COST,

    // 702.155. Read Ahead
    RULE_702_155_READ_AHEAD,
    ...
    RULE_702_155a_READ_AHEAD_SAGA_CARDS_ABILITIES(Condition),
    ...
    RULE_702_155b_SAGA_ABILITIES_ENTERS_CHOOSE_NUMBER,

    // 702.155c. Multiple instances of read ahead on the same object are redundant.
    RULE_702_155c_MULTIPLE_INSTANCES_READ_AHEAD_OBJECT,

    // 702.156. Ravenous
    RULE_702_156_RAVENOUS,
    ...
    RULE_702_156a_RAVENOUS_CREATURE_CARDS_X_COST(Condition),
    ...
    RULE_702_157a_SQUAD_ABILITIES_CREATURE_SPELL_STACK(Condition),
    ...
    RULE_702_157b_SPELL_PERMANENT_BASED_ABILITY_CAST(Condition),

    // 702.158. Space Sculptor
    RULE_702_158_SPACE_SCULPTOR,
    ...
    RULE_702_158a_CARD_SPACE_BELEREN_ABILITY_CREATURES,
    ...
    RULE_702_158b_SECTOR_DESIGNATION_PERMANENT_ABILITY_NOT,
    ...
    RULE_702_158c_PERMANENT_CREATURES_BATTLEFIELD_STATE_BASED(Condition),
    ...
    RULE_702_158d_ABILITIES_INCLUDE_INSTRUCTION_ACTION_CREATURE,

    // 702.158e. Two permanents are in the same sector if each has the same sector designation.
    RULE_702_158e_PERMANENTS_SECTOR_DESIGNATION(Condition),
    ...
    RULE_702_159a_VISIT_ABILITY_ATTRACTION_CARDS_EFFECT(Condition),
    ...
    RULE_702_159b_ATTRACTIONS_CLAIM_PRIZE_ABILITY_ACTIONS,

    // 702.160. Prototype
    RULE_702_160_PROTOTYPE,
    ...
    RULE_702_160a_PROTOTYPE_ABILITY_CARDS_COST_SPELL(Condition),
    ...
    RULE_702_161a_LIVING_METAL_ABILITY_TURN_PERMANENT,
    ...
    RULE_702_162a_THAN_MEETS_EYE_ABILITY_ZONE,

    // 702.163. For Mirrodin!
    RULE_702_163_MIRRODIN,
    ...
    RULE_702_163a_MIRRODIN_ABILITY_EQUIPMENT_ENTERS_CREATE(Condition),

    // 702.164. Toxic
    RULE_702_164_TOXIC,

    // 702.164a. Toxic is a static ability. It is written “toxic N,” where N is a number.
    RULE_702_164a_TOXIC_STATIC_ABILITY_WRITTEN_N,
    ...
    RULE_702_164b_EFFECTS_CREATURES_TOTAL_TOXIC_VALUE,
    ...
    RULE_702_164c_COMBAT_DAMAGE_DEALT_PLAYER_CREATURE,
    ...
    RULE_702_165a_BACKUP_ABILITY_N_CREATURE_ENTERS(Condition),
    ...
    RULE_702_165b_PERMANENT_ENTERS_BATTLEFIELD_COPY_ABILITY(Condition),
    ...
    RULE_702_165c_ABILITIES_OBJECT_PERMANENT_EFFECT_NOT,
    ...
    RULE_702_165d_ABILITIES_BACKUP_STACK_PERMANENT_RESOLVES(Condition),

    // 702.166. Bargain
    RULE_702_166_BARGAIN,
    ...
    RULE_702_166a_BARGAIN_ABILITY_SPELL_STACK_ADDITIONAL,
    ...
    RULE_702_166b_SPELLS_CONTROLLER_DECLARES_COST_BARGAINED(Condition),
    ...
    RULE_702_166c_OBJECTS_BARGAIN_ADDITIONAL_ABILITIES_LINKED(Condition),
    ...
    RULE_702_166d_SPELLS_ABILITY_EFFECT_CAST_NOT(Condition),
    ...
    RULE_702_167a_CRAFT_ABILITY_MATERIALS_COST_EXILE,
    ...
    RULE_702_167b_OBJECT_ABILITY_CARD_PERMANENT_BATTLEFIELD(Condition),
    ...
    RULE_702_167c_ABILITY_PERMANENT_CARDS_EXILE_COST,

    // 702.168. Disguise
    RULE_702_168_DISGUISE,
    ...
    RULE_702_168a_DISGUISE_ABILITY_ZONE_CARD_EFFECT,
    ...
    RULE_702_168b_CAST_CARD_ABILITY_TURN_CREATURE(Condition),

    // 702.168c. You can’t normally cast a card face down. A disguise ability allows you to do so.
    RULE_702_168c_CANT_CAST_CARD_FACE_ABILITY,
    ...
    RULE_702_168d_TURN_PERMANENT_ABILITY_SPECIAL_ACTION(Condition),
    ...
    RULE_702_168e_PERMANENTS_COST_X_ABILITIES_SPECIAL(Condition),
    ...
    RULE_702_168f_FACE_SPELLS_PERMANENTS_CAST_CARDS,
    ...
    RULE_702_169c_ABILITY_SOLVED_TEXT_TRIGGERS_CASE(Condition),

    // 702.169d. For an activated ability, “Solved — [Ability text]” means “[Ability text]. Activate only if this Case is solved.”
    RULE_702_169d_ABILITY_SOLVED_TEXT_ACTIVATE_CASE(Condition),
    ...
    RULE_702_170a_PLOT_ABILITY_CARD_HAND_COST,
    ...
    RULE_702_170f_EFFECT_ABILITY_CARD_ZONE_HAND,
    ...
    RULE_702_171a_SADDLE_ABILITY_N_TAP_NUMBER,
    ...
    RULE_702_171b_SPELLS_ABILITIES_PERMANENTS_TURN_BATTLEFIELD,

    // 702.171c. A creature “saddles” a permanent as it’s tapped to pay the cost to activate a permanent’s saddle ability.
    RULE_702_171c_CREATURE_SADDLES_PERMANENT_COST_ACTIVATE,
    ...
    RULE_702_172a_ABILITY_SPELLS_STACK_CHOOSE_MODES,
    ...
    RULE_702_172b_CARDS_ABILITY_COST_CAST_NOT,

    // 702.173. Freerunning
    RULE_702_173_FREERUNNING,
    ...
    RULE_702_173a_FREERUNNING_ABILITY_STACK_COST_PAY(Condition),
    ...
    RULE_702_174a_GIFT_ABILITIES_CARD_STACK_BATTLEFIELD,
    ...
    RULE_702_174b_PERMANENT_ABILITY_GIFT_ENTERS_COST(Condition),
    ...
    RULE_702_174j_SPELLS_EFFECT_ABILITY_CARD_STACK(Condition),

    // 702.174k. If a spell’s controller declares the intention to pay a spell’s gift cost, that spell’s gift was promised.
    RULE_702_174k_SPELLS_CONTROLLER_DECLARES_INTENTION_COST(Condition),
    ...
    RULE_702_174m_SPELLS_ABILITY_EFFECT_GIFT_PROMISED(Condition),

    // 702.175. Offspring
    RULE_702_175_OFFSPRING,
    ...
    RULE_702_175a_OFFSPRING_ABILITIES_COST_PAY_ADDITIONAL(Condition),
    ...
    RULE_702_175b_SPELL_MULTIPLE_INSTANCES_BASED_NOT(Condition),

    // 702.176. Impending
    RULE_702_176_IMPENDING,
    ...
    RULE_702_176a_IMPENDING_ABILITIES_SPELL_STACK_EFFECT(Condition),

    // 702.177. Exhaust
    RULE_702_177_EXHAUST,
    ...
    RULE_702_177a_EXHAUST_ABILITY_SPECIAL_COST_EFFECT,
    ...
    RULE_702_177b_EFFECT_ACTION_ABILITY_TURN_ACTIVATE(Condition),

    // 702.178. Max Speed
    RULE_702_178_MAX_SPEED,
    ...
    RULE_702_178a_MAX_SPEED_ABILITY_SPECIAL_LONG,
    ...
    RULE_702_178b_ABILITY_GRANTED_MAX_SPEED_ZONES(Condition),

    // 702.179. Start Your Engines!
    RULE_702_179_START_ENGINES,
    ...
    RULE_702_179a_ABILITY_PERMANENT_STATE_BASED_ACTION(Condition),

    // 702.179b. Players do not have speed until a rule or effect sets their speed to a specific value.
    RULE_702_179b_PLAYERS_NOT_SPEED_EFFECT_SETS,
    ...
    RULE_702_179c_PLAYER_SPEED_INCREASE_VALUE(Condition),
    ...
    RULE_702_179f_EFFECTS_PLAYERS_SPEED_ZERO_PURPOSE(Condition),

    // 702.180. Harmonize
    RULE_702_180_HARMONIZE,
    ...
    RULE_702_180a_HARMONIZE_ABILITIES_CARD_GRAVEYARD_SPELL(Condition),
    ...
    RULE_702_180b_CHOOSE_CREATURE_TAP_SPELLS_COST,

    // 702.181. Mobilize
    RULE_702_181_MOBILIZE,
    ...
    RULE_702_181a_MOBILIZE_ABILITY_N_CREATURE_ATTACKS(Condition),

    // 702.182. Job Select
    RULE_702_182_JOB_SELECT,
    ...
    RULE_702_182a_JOB_SELECT_ABILITY_EQUIPMENT_ENTERS(Condition),
    ...
    RULE_702_183a_ABILITY_SPELLS_STACK_CHOOSE_ADDITIONAL,
    ...
    RULE_702_184a_STATION_ABILITY_TAP_UNTAPPED_CREATURE,
    ...
    RULE_702_184b_CARD_PRINTED_STATION_ABILITY_NONSTANDARD,
    ...
    RULE_702_184c_STATIC_ABILITIES_MODIFY_CREATURES_PERMANENT,
    ...
    RULE_702_185a_WARP_ABILITIES_CARD_STACK_COST(Condition),
    ...
    RULE_702_185b_EFFECTS_WARPED_CARDS_EXILE_ABILITY,
    ...
    RULE_702_185c_EFFECTS_SPELL_WARPED_TURN_CAST,
    ...
    RULE_702_188a_WEB_SLINGING_ABILITY_SPELL_STACK,

    // 702.189. Firebending
    RULE_702_189_FIREBENDING,
    ...
    RULE_702_189a_FIREBENDING_ABILITY_N_CREATURE_ATTACKS(Condition),
    ...
    RULE_702_189b_ABILITY_TRIGGERS_PLAYER_FIREBENDS_RESOLVES(Condition),
    ...
    RULE_702_190a_SNEAK_ABILITY_SPELL_STACK_COST,
    ...
    RULE_702_190b_PERMANENT_SPELL_COST_BATTLEFIELD_CREATURE,

    // 702.191. Increment
    RULE_702_191_INCREMENT,
    ...
    RULE_702_191a_INCREMENT_ABILITY_CAST_SPELL_PERMANENT(Condition),

    // 702.191b. If a creature has multiple instances of increment, each one triggers separately.
    RULE_702_191b_CREATURE_MULTIPLE_INSTANCES_INCREMENT_TRIGGERS(Condition),

    // 702.192. Paradigm
    RULE_702_192_PARADIGM,
    ...
    RULE_703_1a_ABILITIES_STEP_PHASE_NOT_TURN,

    // 703.2. Turn-based actions are not controlled by any player.
    RULE_703_2_TURN_BASED_ACTIONS_NOT_CONTROLLED,
    ...
    RULE_703_3_STEP_PHASE_TURN_BASED_ACTION(Condition),

    // 703.4. The turn-based actions are as follows:
    RULE_703_4_TURN_BASED_ACTIONS,
    ...
    RULE_703_4a_IMMEDIATELY_UNTAP_STEP_PERMANENTS_PHASE(Condition),
    ...
    RULE_703_4b_IMMEDIATELY_PHASING_ACTION_COMPLETED_STEP(Condition),
    ...
    RULE_703_4c_IMMEDIATELY_GAME_STEP_ACTION_PERMANENTS(Condition),

    // 703.4d. Immediately after the draw step begins, the active player draws a card. See rule 504.1.
    RULE_703_4d_IMMEDIATELY_DRAW_STEP_ACTIVE_CARD,
    ...
    RULE_703_4e_ARCHENEMY_GAME_PHASE_CARD_SCHEME,
    ...
    RULE_703_4f_PHASE_SAGA_ABILITIES_SCHEME_ACTION,
    ...
    RULE_703_4g_IMMEDIATELY_ACTION_PLACING_ATTRACTIONS_VISIT(Condition),
    ...
    RULE_703_4k_COMBAT_DAMAGE_STEP_APNAP_CREATURE,
    ...
    RULE_703_4m_IMMEDIATELY_COMBAT_DAMAGE_ASSIGNED_STEP,
    ...
    RULE_703_4n_IMMEDIATELY_CLEANUP_STEP_HAND_CARDS(Condition),
    ...
    RULE_703_4p_CARDS_STEP_DAMAGE_PERMANENTS_END(Condition),
    ...
    RULE_704_3_STATE_BASED_ACTIONS_ABILITIES_STACK(Condition),

    // 704.4. Unlike triggered abilities, state-based actions pay no attention to what happens during the resolution of a spell or ability.
    RULE_704_4_ABILITIES_STATE_BASED_ACTIONS_SPELL,

    // 704.5. The state-based actions are as follows:
    RULE_704_5_STATE_BASED_ACTIONS,

    // 704.5a. If a player has 0 or less life, that player loses the game.
    RULE_704_5a_PLAYER_ZERO_LIFE_LOSES_GAME(Condition),
    ...
    RULE_704_5b_CARD_LIBRARY_STATE_BASED_ACTIONS(Condition),
    ...
    RULE_704_5c_PLAYER_POISON_COUNTERS_LOSES_GAME(Condition),

    // 704.5d. If a token is in a zone other than the battlefield, it ceases to exist.
    RULE_704_5d_TOKEN_ZONE_THAN_BATTLEFIELD_CEASES(Condition),

    // 704.5e. If a copy of a spell is in a zone other than the stack, it ceases to exist. If a copy of a card is in any zone other than the stack or the battlefield, it ceases to exist.
    RULE_704_5e_SPELL_ZONE_STACK_CARD_BATTLEFIELD(Condition),

    // 704.5f. If a creature has toughness 0 or less, it’s put into its owner’s graveyard. Regeneration can’t replace this event.
    RULE_704_5f_CREATURE_TOUGHNESS_ZERO_GRAVEYARD_CANT(Condition),

    // 704.5g. If a creature has toughness greater than 0, it has damage marked on it, and the total damage marked on it is greater than or equal to its toughness, that creature has been dealt lethal damage and is destroyed. Regeneration can replace this event.
    RULE_704_5g_CREATURE_TOUGHNESS_GREATER_ZERO_DAMAGE(Condition),

    // 704.5h. If a creature has toughness greater than 0, and it’s been dealt damage by a source with deathtouch since the last time state-based actions were checked, that creature is destroyed. Regeneration can replace this event.
    RULE_704_5h_CREATURE_ZERO_DAMAGE_STATE_BASED(Condition),

    // 704.5i. If a planeswalker has loyalty 0, it’s put into its owner’s graveyard.
    RULE_704_5i_PLANESWALKER_LOYALTY_ZERO_OWNERS_GRAVEYARD(Condition),

    // 704.5j. If two or more legendary permanents with the same name are controlled by the same player, that player chooses one of them, and the rest are put into their owners’ graveyards. This is called the “legend rule.”
    RULE_704_5j_LEGENDARY_PERMANENTS_NAME_CONTROLLED_LEGEND(Condition),

    // 704.5k. If two or more permanents have the supertype world, all except the one that has had the world supertype for the shortest amount of time are put into their owners’ graveyards. In the event of a tie for the shortest amount of time, all are put into their owners’ graveyards. This is called the “world rule.”
    RULE_704_5k_PERMANENTS_SUPERTYPE_WORLD_EXCEPT_SHORTEST(Condition),

    // 704.5m. If an Aura is attached to an illegal object or player, or is not attached to an object or player, that Aura is put into its owner’s graveyard.
    RULE_704_5m_AURA_ATTACHED_OBJECT_NOT_GRAVEYARD(Condition),
    ...
    RULE_704_5n_EQUIPMENT_FORTIFICATION_ATTACHED_PERMANENT_BATTLEFIELD(Condition),
    ...
    RULE_704_5p_BATTLE_CREATURE_OBJECT_BATTLEFIELD_PERMANENT(Condition),

    // 704.5q. If a permanent has both a +1/+1 counter and a -1/-1 counter on it, N +1/+1 and N -1/-1 counters are removed from it, where N is the smaller of the number of +1/+1 and -1/-1 counters on it.
    RULE_704_5q_PERMANENT_COUNTER_N_REMOVED_SMALLER(Condition),
    ...
    RULE_704_5r_PERMANENT_ABILITY_SAYS_CANT_N(Condition),
    ...
    RULE_704_5s_SAGA_PERMANENT_ABILITIES_NOT_STACK(Condition),
    ...
    RULE_704_5t_PLAYERS_CARD_ABILITY_NOT_STACK(Condition),
    ...
    RULE_704_5u_PERMANENT_SPACE_SCULPTOR_CREATURES_BATTLEFIELD(Condition),
    ...
    RULE_704_5v_ZERO_ABILITY_NOT_STACK_GRAVEYARD(Condition),
    ...
    RULE_704_5w_BATTLE_PLAYER_CREATURES_BASED_GRAVEYARD(Condition),
    ...
    RULE_704_5x_SIEGES_CONTROLLER_DESIGNATED_PROTECTOR_GRAVEYARD(Condition),
    ...
    RULE_704_5y_PERMANENT_THAN_ROLE_TIMESTAMP_GRAVEYARD(Condition),
    ...
    RULE_704_5z_PLAYER_CONTROLS_PERMANENT_START_ENGINES(Condition),

    // 704.6. Some variant games include additional state-based actions that aren’t normally applicable:
    RULE_704_6_VARIANT_GAMES_STATE_BASED_ACTIONS,
    ...
    RULE_704_6a_HEADED_GIANT_GAME_ZERO_VARIANT(Condition),
    ...
    RULE_704_6b_HEADED_GIANT_GAME_TEAM_VARIANT(Condition),
    ...
    RULE_704_6c_COMMANDER_GAME_PLAYER_COMBAT_DAMAGE,
    ...
    RULE_704_6d_COMMANDER_GRAVEYARD_EXILE_OBJECT_ZONE(Condition),
    ...
    RULE_704_6e_ARCHENEMY_SCHEME_CARD_ZONE_ABILITIES(Condition),
    ...
    RULE_704_6f_PLANECHASE_CARD_ZONE_ABILITY_NOT(Condition),
    ...
    RULE_704_7_MULTIPLE_STATE_BASED_ACTIONS_EFFECT(Condition),
    ...
    RULE_705_2_EFFECTS_PLAYER_FLIP_HEADS_TAILS(Condition),
    ...
    RULE_706_1a_EFFECT_N_SIDED_DIE_DICE,
    ...
    RULE_706_1b_PLAYERS_AGREE_ALTERNATE_METHOD_ROLLING,
    ...
    RULE_706_2_ROLL_NUMBER_INDICATED_TOP_FACE,
    ...
    RULE_706_2a_MODIFIERS_OPTIONAL_COSTS_ACTIVATE_ABILITIES(Condition),
    ...
    RULE_706_2b_EFFECTS_ATTEMPTING_MODIFY_NATURAL_RESULT(Condition),

    // 706.3. Some abilities that instruct a player to roll one or more dice include a results table.
    RULE_706_3_ABILITIES_PLAYER_ROLL_DICE_INCLUDE,
    ...
    RULE_706_3a_EFFECT_RANGE_N1_N2_N(Condition),
    ...
    RULE_706_3b_INSTRUCTION_ROLL_DICE_BASED_ABILITY,
    ...
    RULE_706_3c_EFFECTS_RESULTS_CHARTS_INCLUDE_ROLL,
    ...
    RULE_706_4_ABILITIES_PLAYER_ROLL_DICE_NOT(Condition),
    ...
    RULE_706_5_CARD_ABILITY_EFFECT_ROLLED_DOUBLES(Condition),
    ...
    RULE_706_6_PLAYER_ABILITIES_TRIGGER_IGNORED_EFFECTS(Condition),
    ...
    RULE_706_7_PLANECHASE_GAME_ROLLING_ABILITY_EFFECT(Condition),
    ...
    RULE_706_8_CARD_CENTAUR_ATTENTION_ABILITY_STORE,
    ...
    RULE_706_8a_STORE_RESULT_PERMANENT_STORED_VALUE,
    ...
    RULE_706_8b_REROLL_STORED_RESULTS_PERMANENT_ROLL(Condition),
    ...
    RULE_707_2_OBJECT_STACK_X_COST_CARD(Condition),
    ...
    RULE_707_2c_STATIC_ABILITY_GENERATES_CONTINUOUS_EFFECT(Condition),
    ...
    RULE_707_3_COPYS_COPIABLE_VALUES_COPIED_MODIFIED,
    ...
    RULE_707_4_EFFECTS_PERMANENT_OBJECT_BATTLEFIELD_ABILITIES,
    ...
    RULE_707_5_OBJECT_ENTERS_BATTLEFIELD_COPY_PERMANENT(Condition),
    ...
    RULE_707_6_COPYING_PERMANENT_OBJECT_ENTERS_BATTLEFIELD(Condition),
    ...
    RULE_707_7_LINKED_ABILITIES_OBJECT_ACTIONS_CANT(Condition),
    ...
    RULE_707_8_COPYING_PERMANENT_DOUBLE_FACED_CARDS(Condition),
    ...
    RULE_707_8a_EFFECT_PERMANENT_CARD_NOT_BATTLEFIELD(Condition),

    // 707.9. Copy effects may include modifications or exceptions to the copying process.
    RULE_707_9_COPY_EFFECTS_INCLUDE_MODIFICATIONS_EXCEPTIONS,
    ...
    RULE_707_9a_COPY_EFFECTS_CAUSE_GAIN_ABILITY,
    ...
    RULE_707_9b_COPY_EFFECTS_MODIFY_CHARACTERISTIC_COPYING,
    ...
    RULE_707_9c_COPY_EFFECTS_SPECIFICALLY_STATE_NOT(Condition),
    ...
    RULE_707_9d_EFFECT_ABILITY_OBJECT_NOT_STATE(Condition),
    ...
    RULE_707_9e_REPLACEMENT_EFFECTS_GENERATE_COPY_INCLUDE(Condition),
    ...
    RULE_707_9f_EXCEPTIONS_COPYING_PROCESS_PERMANENTS_EFFECT(Condition),
    ...
    RULE_707_9g_REPLACEMENT_EFFECTS_ABILITIES_OBJECT_TRIGGER(Condition),
    ...
    RULE_707_10_SPELL_ABILITY_STACK_CAST_X(Condition),
    ...
    RULE_707_10a_SPELL_ZONE_STACK_CARD_BATTLEFIELD(Condition),
    ...
    RULE_707_10b_ABILITY_OBJECT_NOT_EFFECTS_TURN(Condition),
    ...
    RULE_707_10c_EFFECTS_SPELL_ABILITY_STATE_STACK(Condition),
    ...
    RULE_707_10d_EFFECTS_SPELL_ABILITY_OBJECT_TARGET(Condition),
    ...
    RULE_707_10e_EFFECTS_SPELL_ABILITY_TARGET_OBJECT(Condition),
    ...
    RULE_707_10f_EFFECTS_COPY_PERMANENT_SPELL_RESOLVES,
    ...
    RULE_707_10g_EFFECT_PERMANENT_SPELL_BATTLEFIELD_RESOLVES(Condition),
    ...
    RULE_707_12_EFFECT_CAST_OBJECT_NOT_SPELL,
    ...
    RULE_707_13_CARD_GARTH_EYE_PLAYER_OBJECT,
    ...
    RULE_708_2_FACE_SPELLS_PERMANENTS_CHARACTERISTICS_ABILITY,
    ...
    RULE_708_2a_PERMANENT_SPELL_ABILITY_OBJECT_CREATURE(Condition),
    ...
    RULE_708_2b_PERMANENT_CANT_SPELL_ABILITY_TURN(Condition),
    ...
    RULE_708_3_BATTLEFIELD_PERMANENTS_ABILITIES_TRIGGER_EFFECT(Condition),
    ...
    RULE_708_4_CAST_STACK_EFFECTS_SPELL_NOT(Condition),
    ...
    RULE_708_5_SPELL_STACK_PERMANENT_CANT_CARDS(Condition),
    ...
    RULE_708_6_SPELLS_PERMANENTS_NOT_ABILITY_CAST(Condition),
    ...
    RULE_708_7_ABILITY_PERMANENT_TURN_SPELLS_CANT,
    ...
    RULE_708_8_PERMANENT_EFFECTS_ABILITIES_BATTLEFIELD_TRIGGER,
    ...
    RULE_708_9_PERMANENT_BATTLEFIELD_ZONE_SPELL_STACK(Condition),
    ...
    RULE_708_10_FACE_PERMANENT_COPY_COPIABLE_ABILITY(Condition),
    ...
    RULE_708_11_FACE_PERMANENT_TURNED_ABILITY_NOT(Condition),
    ...
    RULE_709_3b_STACK_CHARACTERISTICS_HALF_CAST_EXIST,
    ...
    RULE_709_4a_SPLIT_CARD_EFFECT_NOT_OBJECT(Condition),
    ...
    RULE_709_4d_CHARACTERISTICS_FUSED_SPLIT_SPELL_STACK,
    ...
    RULE_709_5_CARDS_PERMANENT_OBJECT_ABILITIES_BATTLEFIELD,
    ...
    RULE_709_5a_HALF_SPLIT_CARD_SHARED_TYPE,
    ...
    RULE_709_5b_EXISTENCE_HALF_OBJECT_SPELL_STACK(Condition),
    ...
    RULE_709_5c_LEFT_HALF_UNLOCKED_RIGHT_PERMANENT(Condition),
    ...
    RULE_709_5d_PERMANENT_LEFT_HALF_UNLOCKED_BATTLEFIELD(Condition),
    ...
    RULE_709_5e_PERMANENT_COST_UNLOCK_SPECIAL_ACTION,
    ...
    RULE_709_5f_SPELLS_ABILITIES_PLAYER_UNLOCK_PERMANENT,
    ...
    RULE_709_5g_SPELLS_ABILITIES_PLAYER_LOCK_PERMANENT,
    ...
    RULE_709_5h_ABILITIES_TRIGGER_PLAYER_PERMANENT_BATTLEFIELD(Condition),
    ...
    RULE_709_5i_ABILITIES_TRIGGER_FULLY_UNLOCKS_PERMANENT(Condition),
    ...
    RULE_710_1a_TOP_FLIP_CARD_ABILITY_PERMANENT(Condition),
    ...
    RULE_710_1b_BOTTOM_HALF_CARD_PERMANENT_BATTLEFIELD(Condition),
    ...
    RULE_710_1c_FLIP_CARDS_COST_PERMANENT_EFFECTS(Condition),
    ...
    RULE_710_2_ZONE_THAN_BATTLEFIELD_PERMANENT_CARD(Condition),
    ...
    RULE_710_3_ENSURE_CLEAR_TIMES_PERMANENT_NOT(Condition),
    ...
    RULE_710_4_FLIPPING_PERMANENT_WAY_PROCESS_BATTLEFIELD(Condition),
    ...
    RULE_711_2a_LEVEL_N1_N2_ABILITIES_P(Condition),
    ...
    RULE_711_2b_LEVEL_N3_ABILITIES_P_LONG,
    ...
    RULE_711_3_TEXT_BOX_STRIATIONS_ABILITIES_CARDS,
    ...
    RULE_711_4_ABILITY_LEVELER_CARD_ISNT_PERMANENT(Condition),
    ...
    RULE_712_2_CARDS_ABILITIES_TRANSFORM_CONVERT_TURN,
    ...
    RULE_712_2a_NONMODAL_DOUBLE_FACED_CARDS_BLOCK,
    ...
    RULE_712_2b_NONMODAL_DOUBLE_FACED_CARDS_BLOCK,
    ...
    RULE_712_2c_FRONT_FACE_CARD_CREATURE_EFFECT,
    ...
    RULE_712_3_MODAL_CARDS_ABILITY_TRANSFORM_CONVERT,
    ...
    RULE_712_3a_MODAL_DOUBLE_FACED_CARDS_FRONT,
    ...
    RULE_712_3b_MODAL_DOUBLE_FACED_CARDS_FACE,
    ...
    RULE_712_4a_CARD_ABILITY_OBJECT_BATTLEFIELD_PERMANENT,
    ...
    RULE_712_4b_PERMANENT_BATTLEFIELD_EFFECT_CARD_NOT(Condition),
    ...
    RULE_712_4c_UNLIKE_DOUBLE_FACED_CARDS_IGNORED,
    ...
    RULE_712_7_PLAYERS_ENSURE_CARDS_HIDDEN_ZONES,
    ...
    RULE_712_8_FACE_DOUBLE_FACED_CARD_ISNT,
    ...
    RULE_712_8a_DOUBLE_CARD_ZONE_BATTLEFIELD_STACK,

    // 712.8b. A meld card on the stack has only the characteristics of its front face.
    RULE_712_8b_MELD_CARD_STACK_CHARACTERISTICS_FRONT,
    ...
    RULE_712_8e_NONMODAL_PERMANENT_COST_OBJECT_ZERO(Condition),
    ...
    RULE_712_8f_MODAL_SPELL_STACK_PERMANENT_BATTLEFIELD,
    ...
    RULE_712_8g_CARDS_BATTLEFIELD_PERMANENT_OBJECT_ZERO(Condition),
    ...
    RULE_712_9_PERMANENTS_CARDS_NOT_SPELL_ABILITY(Condition),
    ...
    RULE_712_10_SPELL_ABILITY_PLAYER_PERMANENT_CARD(Condition),

    // 712.11. A double-faced spell is cast with its front face up by default. See rule 601, “Casting Spells.”
    RULE_712_11_DOUBLE_FACED_SPELL_CAST_CASTING,
    ...
    RULE_712_11a_CARD_CAST_SPELL_TRANSFORMED_CONVERTED(Condition),
    ...
    RULE_712_11b_PLAYER_CASTING_CARD_SPELL_STACK,
    ...
    RULE_712_11c_FACE_STACK_EVALUATED_CAST_CONSIDERED(Condition),
    ...
    RULE_712_11d_ABILITY_CARDS_CAST_TRANSFORMED_CONVERTED(Condition),
    ...
    RULE_712_12_PLAYER_PLAYING_MODAL_CARD_BATTLEFIELD,
    ...
    RULE_712_13_RESOLVING_SPELL_PERMANENT_BATTLEFIELD_STACK,
    ...
    RULE_712_13a_ABILITIES_SPELL_STACK_BATTLEFIELD_CARD(Condition),
    ...
    RULE_712_14_DOUBLE_CARD_BATTLEFIELD_ZONE_STACK,
    ...
    RULE_712_14a_SPELL_ABILITY_CARD_BATTLEFIELD_TRANSFORMED(Condition),
    ...
    RULE_712_14b_PLAYER_CARD_BATTLEFIELD_PERMANENT_ZONE(Condition),
    ...
    RULE_712_14c_MELD_CARD_MELDED_BATTLEFIELD_PERMANENT(Condition),
    ...
    RULE_712_15_EFFECT_CAST_CARD_FACE_CREATURE(Condition),
    ...
    RULE_712_15a_FACE_DOUBLE_FACED_PERMANENT_CANT(Condition),
    ...
    RULE_712_16_PERMANENTS_CANT_SPELL_ABILITY_TURN(Condition),
    ...
    RULE_712_17_DOUBLE_FACED_CARD_HIDDEN_SUBSTITUTE,
    ...
    RULE_712_18_DOUBLE_FACED_PERMANENT_OBJECT_EFFECTS(Condition),
    ...
    RULE_712_19_EFFECT_PLAYER_CHOOSE_CARD_NOT(Condition),
    ...
    RULE_712_20_CARD_PERMANENT_TRANSFORMS_ABILITY_NOT(Condition),
    ...
    RULE_712_21_MELDED_PERMANENT_BATTLEFIELD_CARDS_ZONE(Condition),
    ...
    RULE_712_21a_MELDED_PERMANENT_GRAVEYARD_LIBRARY_CARDS(Condition),
    ...
    RULE_712_21b_PLAYER_EXILES_PERMANENT_TIMESTAMP_CARDS(Condition),
    ...
    RULE_712_21c_EFFECT_OBJECT_PERMANENT_BATTLEFIELD_CARDS(Condition),
    ...
    RULE_712_21d_EFFECTS_PERMANENT_BATTLEFIELD_ZONE_CARDS(Condition),
    ...
    RULE_713_2_SUBSTITUTE_CARD_CLEARLY_INDICATE_COST(Condition),
    ...
    RULE_713_2a_SUBSTITUTE_CARDS_LIST_NAMES_COSTS,
    ...
    RULE_713_2b_SUBSTITUTE_CARDS_LISTED_STYLE_CORE,
    ...
    RULE_713_2c_SUBSTITUTE_CARDS_MODAL_DOUBLE_FACED,
    ...
    RULE_713_3_SUBSTITUTE_CARD_DECK_SET_CANT(Condition),
    ...
    RULE_714_2a_SYMBOL_INCLUDES_ROMAN_NUMERAL_RN,
    ...
    RULE_714_2b_RN_EFFECT_LORE_COUNTERS_SAGA(Condition),

    // 714.2c. “{rN1}, {rN2}—[Effect]” means the same as “{rN1}—[Effect]” and “{rN2}—[Effect].”
    RULE_714_2c_RN1_RN2_EFFECT,
    ...
    RULE_714_3a_SAGA_ABILITY_ENTERS_LORE_COUNTER,
    ...
    RULE_714_3b_SAGA_ABILITIES_ENTERS_CHOOSE_NUMBER,
    ...
    RULE_714_3c_PHASE_ABILITIES_TURN_BASED_ACTION,
    ...
    RULE_715_2_TEXT_APPEARS_OBJECT_SPELL_CARDS,
    ...
    RULE_715_3a_CASTING_ADVENTURER_CARD_ADVENTURE_CAST(Condition),

    // 715.3b. While on the stack as an Adventure, the spell has only its alternative characteristics.
    RULE_715_3b_STACK_ADVENTURE_SPELL_ALTERNATIVE_CHARACTERISTICS,
    ...
    RULE_715_3c_SPELL_NOT_CARD_EFFECT_CAST(Condition),
    ...
    RULE_715_3d_SPELL_CAST_GRAVEYARD_RESOLVES_CARD(Condition),
    ...
    RULE_715_4_ZONE_EXCEPT_STACK_NOT_CARD,
    ...
    RULE_716_2_CLASS_LEVEL_BAR_ABILITY_COST,
    ...
    RULE_716_2a_COST_LEVEL_N_ABILITIES_ACTIVATE(Condition),
    ...
    RULE_716_2b_LEVEL_DESIGNATION_PERMANENT_CLASS_NOT(Condition),

    // 716.2c. The phrase “to gain a Class level” means “to activate an ability indicated by a class level bar”
    RULE_716_2c_GAIN_CLASS_LEVEL_ACTIVATE_ABILITY,
    ...
    RULE_716_2d_EFFECT_PERMANENTS_LEVEL_DOESNT_TREATED(Condition),
    ...
    RULE_716_3_ABILITY_PRINTED_CLASS_CARD_TRIGGER(Condition),
    ...
    RULE_718_2_COST_OBJECT_SPELL_PERMANENT_BATTLEFIELD,

    // 718.2a. The existence and values of these alternative characteristics are part of the object’s copiable values.
    RULE_718_2a_EXISTENCE_VALUES_ALTERNATIVE_CHARACTERISTICS_OBJECTS,
    ...
    RULE_718_3_PLAYER_CASTS_CARD_SPELL_ABILITY,
    ...
    RULE_718_3a_CASTING_PROTOTYPED_SPELL_COST_CAST(Condition),
    ...
    RULE_718_3b_PROTOTYPED_SPELL_PERMANENT_ALTERNATIVE_COST(Condition),
    ...
    RULE_718_3c_SPELL_COST_NOT_CARD_EFFECT(Condition),
    ...
    RULE_718_3d_PERMANENT_SPELL_COST_NOT_CARD(Condition),
    ...
    RULE_718_4_ZONE_STACK_BATTLEFIELD_NOT_CAST(Condition),
    ...
    RULE_723_1a_MULTIPLE_PLAYER_CONTROLLING_EFFECTS_AFFECT,
    ...
    RULE_723_1b_TURN_SKIPPED_PENDING_PLAYER_EFFECTS(Condition),
    ...
    RULE_723_3_CONTROL_PLAYER_CHANGES_OBJECTS_TURN,
    ...
    RULE_723_4_OBJECT_GAME_VISIBLE_CARDS_NOT(Condition),
    ...
    RULE_723_5_CONTROLLING_PLAYER_CHOICES_SPELLS_ABILITIES,
    ...
    RULE_723_5a_CONTROLLER_PLAYER_RESOURCES_CARDS_COSTS,
    ...
    RULE_723_5b_CONTROLLER_PLAYER_CANT_CHOICES_DECISIONS(Condition),
    ...
    RULE_724_1a_TRIGGERED_ABILITIES_STACK_NOT_TRIGGER(Condition),
    ...
    RULE_724_1d_PHASE_STEP_COMBAT_CREATURES_EFFECT(Condition),
    ...
    RULE_724_1e_TURN_ENDS_STEP_ABILITIES_TRIGGER(Condition),
    ...
    RULE_724_1f_ABILITIES_NOT_STACK_CLEANUP_STEP(Condition),
    ...
    RULE_724_2_CARD_COMBAT_PHASE_EFFECT_RESOLVING(Condition),
    ...
    RULE_724_2a_TRIGGERED_ABILITIES_STACK_NOT_TRIGGER(Condition),
    ...
    RULE_724_2d_CURRENT_COMBAT_PHASE_CREATURES_EFFECTS,
    ...
    RULE_724_2e_COMBAT_PHASE_ABILITIES_TRIGGER_STEP(Condition),
    ...
    RULE_724_2f_ABILITIES_NOT_STACK_PHASE_CAST(Condition),
    ...
    RULE_725_2_ABILITIES_MONARCH_STEP_CARD_CREATURE(Condition),
    ...
    RULE_725_3_PLAYER_MONARCH_TIME_CURRENT_CEASES(Condition),
    ...
    RULE_725_4_MONARCH_LEAVES_GAME_ACTIVE_TURN(Condition),
    ...
    RULE_726_4_PLAYER_INITIATIVE_LEAVES_GAME_TURN(Condition),
    ...
    RULE_727_1a_STARTING_PLAYER_NEW_SPELL_ABILITY,
    ...
    RULE_727_2_CARDS_INVOLVED_GAME_PERMANENTS_NOT(Condition),
    ...
    RULE_727_3_CARDS_LIBRARY_STATE_BASED_ACTIONS(Condition),
    ...
    RULE_727_4_EFFECT_RESOLVING_STEP_SPELL_ABILITY(Condition),
    ...
    RULE_727_5_EFFECTS_EXEMPT_CARDS_PROCEDURE_NOT,
    ...
    RULE_727_5a_COMMANDER_GAME_EXEMPTED_PROCEDURE_ZONE,
    ...
    RULE_727_6_SUBGAME_RESTARTED_MAIN_GAME_EFFECTS(Condition),
    ...
    RULE_729_1a_SUBGAME_GAME_EFFECT_MAIN_SPELL(Condition),
    ...
    RULE_729_1b_EFFECTS_DEFINITIONS_CREATED_MAIN_GAME,
    ...
    RULE_729_2_GAME_ZONES_CARDS_LIBRARY_STARTING,
    ...
    RULE_729_2a_SUBGAME_SUPPLEMENTARY_DECKS_CARDS_ZONE(Condition),
    ...
    RULE_729_2b_SUBGAME_VANGUARD_GAME_CARD_ZONE,
    ...
    RULE_729_2c_SUBGAME_COMMANDER_GAME_STARTS_ZONE(Condition),
    ...
    RULE_729_3_CARDS_STATE_BASED_ACTIONS_STEP(Condition),
    ...
    RULE_729_4_OBJECTS_MAIN_GAME_CARDS_NOT,
    ...
    RULE_729_4a_EFFECTS_CARDS_ABILITIES_TRIGGER_ZONE(Condition),
    ...
    RULE_729_4b_PLAYERS_MAIN_GAME_COUNTERS_ARENT(Condition),
    ...
    RULE_729_5_CARDS_ZONE_LIBRARY_EXILE_PERMANENTS(Condition),
    ...
    RULE_729_5a_END_SUBGAME_CARD_NOT_ZONE(Condition),
    ...
    RULE_729_5b_END_SUBGAME_VANGUARD_CARD_ZONE(Condition),
    ...
    RULE_729_5c_END_SUBGAME_COMMANDER_GAME_ZONE(Condition),
    ...
    RULE_730_2_MERGE_OBJECT_PERMANENT_PLACE_CARD,
    ...
    RULE_730_2a_MERGED_PERMANENT_CHARACTERISTICS_EFFECT_TIMESTAMP(Condition),
    ...
    RULE_730_2b_OBJECT_MERGES_PERMANENT_ZONE_BATTLEFIELD,
    ...
    RULE_730_2c_MERGED_PERMANENT_OBJECT_CONTINUOUS_EFFECTS,
    ...
    RULE_730_2d_MERGED_PERMANENT_TOKEN_RESULTING_TOPMOST(Condition),
    ...
    RULE_730_2e_MERGED_PERMANENT_FACE_OBJECT_EFFECTS(Condition),
    ...
    RULE_730_2f_MERGED_PERMANENT_TURNED_FACE_COMPONENT(Condition),
    ...
    RULE_730_2g_PERMANENT_CARD_CANT_TURN_ABILITIES(Condition),
    ...
    RULE_730_2h_MERGED_PERMANENT_FLIP_CARD_COMPONENTS(Condition),
    ...
    RULE_730_2i_MERGED_PERMANENT_NOT_DOUBLE_TURN(Condition),

    // 730.2j. A face-up merged permanent that contains a double-faced component can’t be turned face down.
    RULE_730_2j_FACE_MERGED_PERMANENT_DOUBLE_CANT,
    ...
    RULE_730_3_MERGED_PERMANENT_LEAVES_BATTLEFIELD_ZONE(Condition),
    ...
    RULE_730_3a_MERGED_PERMANENT_OWNERS_GRAVEYARD_LIBRARY(Condition),
    ...
    RULE_730_3b_PLAYER_EXILES_PERMANENT_TIMESTAMP_CARDS(Condition),
    ...
    RULE_730_3c_EFFECT_OBJECT_PERMANENT_BATTLEFIELD_ACTIONS(Condition),
    ...
    RULE_730_3d_EFFECTS_PERMANENT_BATTLEFIELD_ZONE_OBJECT(Condition),
    ...
    RULE_731_1a_PHRASES_DAY_NIGHT_GAME_LOSING,
    ...
    RULE_731_2_UNTAP_STEP_GAME_CHECKS_TURN(Condition),
    ...
    RULE_731_2a_DAY_PREVIOUS_TURNS_CAST_SPELLS(Condition),
    ...
    RULE_731_2b_NIGHT_PREVIOUS_TURNS_CAST_SPELLS(Condition),
    ...
    RULE_732_1a_SHORTCUTS_LARGELY_INFORMAL_LONG_PLAYER,
    ...
    RULE_732_1b_OCCASIONALLY_GAME_STATE_ACTIONS_LOOP,
    ...
    RULE_732_1c_TOURNAMENTS_MODIFIED_VERSION_GOVERNING_PRECEDENCE(Condition),

    // 732.2. Taking a shortcut follows the following procedure.
    RULE_732_2_SHORTCUT_PROCEDURE,
    ...
    RULE_732_2a_BASED_STATE_CANT_ACTIONS_NOT(Condition),
    ...
    RULE_732_2b_PLAYER_TURN_ORDER_STARTING_SUGGESTED(Condition),
    ...
    RULE_800_4b_OBJECT_CHANGE_BATTLEFIELD_STACK_ZONE(Condition),
    ...
    RULE_800_4c_EFFECT_OBJECT_NOT_STATE_BASED(Condition),
    ...
    RULE_800_4d_OBJECT_OWNED_ZONE_ABILITY_STACK(Condition),

    // 800.4e. If combat damage would be assigned to a player who has left the game, that damage isn’t assigned.
    RULE_800_4e_COMBAT_DAMAGE_ASSIGNED_PLAYER_LEFT(Condition),
    ...
    RULE_800_4f_OBJECT_REQUIRES_PLAYER_COST_NOT(Condition),
    ...
    RULE_800_4g_OBJECT_REQUIRES_PLAYER_LEFT_COST(Condition),
    ...
    RULE_800_4h_REQUIRES_PLAYER_LEFT_GAME_TURN(Condition),
    ...
    RULE_800_4i_EFFECT_REQUIRES_PLAYER_CURRENT_ACTIONS(Condition),
    ...
    RULE_800_4j_TURN_OBJECT_STACK_RESOLVES_PHASE(Condition),

    // 800.4k. If a player who has left the game would begin a turn, that turn doesn’t begin.
    RULE_800_4k_PLAYER_LEFT_GAME_TURN_DOESNT(Condition),
    ...
    RULE_800_4m_PLAYER_LEAVES_CONTINUOUS_EFFECTS_TURN(Condition),
    ...
    RULE_800_4n_PLAYER_LEAVES_ANTE_ZONE_NOT(Condition),
    ...
    RULE_800_4p_PLANECHASE_GAME_PLAYER_DESIGNATED_TURN(Condition),
    ...
    RULE_800_6_MULTIPLAYER_GAME_MULLIGAN_CARDS_LIBRARY,
    ...
    RULE_801_2_PLAYERS_SPELLS_ABILITIES_EFFECTS_DAMAGE,
    ...
    RULE_801_2d_OBJECT_PLAYERS_RANGE_INFLUENCE_CONTROLLED(Condition),
    ...
    RULE_801_3_CREATURES_ATTACK_OPPONENTS_CONTROLLERS_CANT(Condition),
    ...
    RULE_801_4_OBJECTS_PLAYERS_CANT_SPELLS_ABILITIES,
    ...
    RULE_801_5a_PLAYER_ASKED_CHOOSE_OBJECT_RANGE(Condition),
    ...
    RULE_801_5b_PLAYER_ASKED_CHOOSE_OPTIONS_NOT(Condition),
    ...
    RULE_801_5c_EFFECT_REQUIRES_CHOICE_THERES_PLAYER(Condition),

    // 801.6. A player can’t activate the activated abilities of an object outside of their range of influence.
    RULE_801_6_PLAYER_CANT_ACTIVATE_ABILITIES_OBJECT,
    ...
    RULE_801_7a_TRIGGER_EVENT_OBJECT_STATE_ABILITY(Condition),
    ...
    RULE_801_8_CANT_OBJECT_GRAVEYARD_STATE_BASED(Condition),
    ...
    RULE_801_9_CANT_OBJECT_PERMANENT_BATTLEFIELD_STATE(Condition),
    ...
    RULE_801_10_SPELLS_ABILITIES_CANT_AFFECT_EFFECT,
    ...
    RULE_801_13_REPLACEMENT_PREVENTION_EFFECTS_WATCH_CANT,
    ...
    RULE_801_13a_REPLACEMENT_EFFECT_SPELL_ABILITY_OBJECT(Condition),
    ...
    RULE_801_13b_SPELL_ABILITY_EFFECT_DAMAGE_PERMANENT(Condition),
    ...
    RULE_801_14_EFFECT_PLAYER_WINS_GAME_OPPONENTS(Condition),
    ...
    RULE_801_15_EFFECT_SPELL_ABILITY_GAME_DRAW(Condition),
    ...
    RULE_801_16_GAME_SOMEHOW_LOOP_ACTIONS_OBJECT(Condition),
    ...
    RULE_802_2a_OBJECT_EFFECT_DEFENDING_PLAYER_NOT(Condition),
    ...
    RULE_802_3_ATTACKING_CREATURE_ATTACK_ATTACKERS_STEP,
    ...
    RULE_802_3a_RESTRICTIONS_REQUIREMENTS_DONT_BASED_CREATURES,

    // 802.3b. Creatures in a band can’t attack different players. See rule 702.22, “Banding.”
    RULE_802_3b_CREATURES_BAND_CANT_ATTACK_BANDING,
    ...
    RULE_802_4_THAN_PLAYER_ATTACKED_APNAP_STEP(Condition),
    ...
    RULE_802_4a_DEFENDING_PLAYER_BLOCK_CREATURES_CONTROL,
    ...
    RULE_802_4b_DEFENDING_PLAYERS_BLOCKS_LEGAL_CREATURES(Condition),
    ...
    RULE_803_1a_ATTACK_LEFT_OPTION_PLAYER_CANT(Condition),
    ...
    RULE_805_2_CANT_CREATURES_ATTACK_ABILITIES_STACK(Condition),
    ...
    RULE_805_3_METHODS_TEAM_TURN_WAY_STARTING,
    ...
    RULE_805_3a_PROCESS_TURN_CARDS_LIBRARY_HAND(Condition),
    ...
    RULE_805_4d_ABILITY_TRIGGERS_STEP_PHASE_EFFECT(Condition),

    // 805.5. Teams have priority, not individual players.
    RULE_805_5_TEAMS_PRIORITY_NOT_INDIVIDUAL_PLAYERS,

    // 805.5a. A player may cast a spell, activate an ability, or take a special action when their team has priority.
    RULE_805_5a_CAST_SPELL_ACTIVATE_ABILITY_SPECIAL(Condition),
    ...
    RULE_805_5b_ACTIONS_OBJECT_STACK_RESOLVES_PHASE(Condition),
    ...
    RULE_805_6_ACTIVE_PLAYER_NONACTIVE_ORDER_ACTIONS(Condition),
    ...
    RULE_805_6a_THAN_PLAYER_DRAW_CARDS_GAME(Condition),
    ...
    RULE_805_7_MULTIPLE_TRIGGERED_ABILITIES_STACK_TURN(Condition),
    ...
    RULE_805_8_EFFECT_PLAYER_TURN_PHASE_STEP(Condition),
    ...
    RULE_805_9_ABILITY_ACTIVE_PLAYER_NOT_EFFECT(Condition),

    // 805.10. The shared team turns option uses different combat rules than other multiplayer options.
    RULE_805_10_SHARED_TEAM_COMBAT_BLOCK_DAMAGE,
    ...
    RULE_805_10a_TEAMS_CREATURES_ATTACK_COMBAT_PHASE,
    ...
    RULE_805_10b_DECLARE_ATTACKERS_STEP_CREATURE_ATTACK,
    ...
    RULE_805_10c_OBJECT_EFFECT_ATTACKING_PLAYER_NOT(Condition),
    ...
    RULE_805_10d_DECLARE_BLOCKERS_STEP_CREATURES_BLOCK,
    ...
    RULE_805_10e_OBJECT_EFFECT_DEFENDING_PLAYER_NOT(Condition),
    ...
    RULE_806_2_MULTIPLAYER_OPTIONS_PLAY_FREE_VARIANT,
    ...
    RULE_806_2a_LIMITED_RANGE_INFLUENCE_OPTION_ISNT(Condition),
    ...
    RULE_806_2b_ATTACK_LEFT_RIGHT_MULTIPLE_PLAYERS,

    // 806.2c. The deploy creatures option isn’t used in the Free-for-All variant.
    RULE_806_2c_DEPLOY_CREATURES_OPTION_ISNT_FREE,
    ...
    RULE_808_3_MULTIPLAYER_OPTIONS_PLAY_TEAM_VS,

    // 808.3a. The attack multiple players option is used (see rule 802).
    RULE_808_3a_ATTACK_MULTIPLE_PLAYERS_OPTION,
    ...
    RULE_808_3b_DEPLOY_CREATURES_OPTIONS_LIMITED_RANGE,
    ...
    RULE_808_4_PLAYER_RANDOMLY_CHOOSE_TEAM_TURN(Condition),
    ...
    RULE_810_5_CARDS_HAND_NOT_CANT_PERMANENTS(Condition),

    // 810.6. The team who plays first skips the draw step of its first turn.
    RULE_810_6_TEAM_PLAYS_SKIPS_STEP_TURN,
    ...
    RULE_810_8_HEADED_GIANT_VARIANT_NORMAL_WINNING,
    ...
    RULE_810_9_DAMAGE_LOSS_LIFE_GAINING_HAPPEN,
    ...
    RULE_810_9a_COST_EFFECT_NEEDS_VALUE_INDIVIDUAL(Condition),
    ...
    RULE_810_9b_COST_EFFECT_MEMBERS_NOT_ZERO(Condition),
    ...
    RULE_810_9c_EFFECT_SETS_SINGLE_PLAYERS_LIFE(Condition),
    ...
    RULE_810_9d_EFFECT_SET_LIFE_TOTAL_PLAYER(Condition),
    ...
    RULE_810_9e_PLAYER_CANT_EXCHANGE_LIFE_EFFECT(Condition),
    ...
    RULE_810_9f_EFFECT_PLAYER_REDISTRIBUTE_NUMBER_NOT(Condition),

    // 810.9g. If an effect says that a player can’t gain life, no player on that player’s team can gain life.
    RULE_810_9g_EFFECT_SAYS_PLAYER_CANT_GAIN(Condition),
    ...
    RULE_810_9h_EFFECT_SAYS_PLAYER_CANT_ZERO(Condition),
    ...
    RULE_810_10_EFFECTS_CAUSE_PLAYERS_POISON_COUNTERS,
    ...
    RULE_810_10a_EFFECT_NEEDS_POISON_COUNTERS_INDIVIDUAL(Condition),

    // 810.10b. If an effect says that a player loses poison counters, that player’s team loses that many poison counters.
    RULE_810_10b_EFFECT_SAYS_PLAYER_LOSES_POISON(Condition),
    ...
    RULE_810_10c_EFFECT_SAYS_PLAYER_CANT_POISON(Condition),
    ...
    RULE_810_10d_EFFECT_NEEDS_KINDS_COUNTERS_POISONED(Condition),
    ...
    RULE_903_2_COMMANDER_GAME_FREE_VARIANT_ATTACK,
    ...
    RULE_903_3_CARD_CREATURE_NOT_OBJECT_ZONES(Condition),
    ...
    RULE_903_3a_CARDS_ABILITY_COMMANDER_MODIFIES_DECK,
    ...
    RULE_903_3b_PLAYERS_COMMANDER_MELD_CARD_PERMANENT(Condition),
    ...
    RULE_903_3c_PLAYERS_COMMANDER_COMPONENT_MERGED_PERMANENT(Condition),
    ...
    RULE_903_3d_EFFECT_PERMANENT_BATTLEFIELD_SPELL_ZONE(Condition),
    ...
    RULE_903_3e_EFFECT_COMMANDER_CONTINUOUS_ZONES_LIBRARY(Condition),

    // 903.4. The Commander variant uses color identity to determine what cards can be in a deck with a certain commander. The color identity of a card is the color or colors of any mana symbols in that card’s mana cost or rules text, plus any colors defined by its characteristic-defining abilities (see rule 604.3) or color indicator (see rule 204).
    RULE_903_4_COMMANDER_IDENTITY_CARDS_COST_ABILITIES,
    ...
    RULE_903_4a_COLOR_IDENTITY_EFFECT_OBJECT_CARD(Condition),
    ...
    RULE_903_4b_COMMANDER_STATIC_ABILITY_ZONES_IDENTITY(Condition),

    // 903.4c. Reminder text is ignored when determining a card’s color identity. See rule 207.2.
    RULE_903_4c_REMINDER_TEXT_IGNORED_CARDS_IDENTITY(Condition),
    ...
    RULE_903_4d_FACE_DOUBLE_FACED_CARD_IDENTITY(Condition),
    ...
    RULE_903_4e_CARD_ALTERNATIVE_CHARACTERISTICS_ADVENTURER_IDENTITY(Condition),
    ...
    RULE_903_4f_ABILITY_COLORS_NUMBER_IDENTITY_COSTS(Condition),

    // 903.5. Each Commander deck is subject to the following deck construction rules.
    RULE_903_5_COMMANDER_DECK_CONSTRUCTION_RESTRICTIONS,
    ...
    RULE_903_5a_DECK_CONTAIN_EXACTLY_CARDS_INCLUDING,
    ...
    RULE_903_5b_THAN_BASIC_LANDS_CARD_COMMANDER,
    ...
    RULE_903_5c_CARD_INCLUDED_COMMANDER_DECK_IDENTITY(Condition),

    // 903.5d. A card with a basic land type may be included in a Commander deck only if each color of mana it could produce is included in the commander’s color identity.
    RULE_903_5d_CARD_BASIC_LAND_TYPE_IDENTITY(Condition),

    // 903.5e. Commander games do not use sideboards.
    RULE_903_5e_COMMANDER_GAMES_NOT_SIDEBOARDS,
    ...
    RULE_903_6_START_GAME_ZONE_CARDS_LIBRARY(Condition),
    ...
    RULE_903_7_ONCE_STARTING_PLAYER_HAND_CARDS,
    ...
    RULE_903_8_CAST_COMMANDER_ZONE_COSTS_TAX,

    // 903.9. A commander may return to the command zone during a Commander game.
    RULE_903_9_COMMANDER_RETURN_COMMAND_ZONE_GAME,

    // 903.9a. If a commander is in a graveyard or in exile and that object was put into that zone since the last time state-based actions were checked, its owner may put it into the command zone. This is a state-based action. See rule 704.
    RULE_903_9a_GRAVEYARD_EXILE_OBJECT_ZONE_STATE(Condition),

    // 903.9b. If a commander would be put into its owner’s hand or library from anywhere, its owner may put it into the command zone instead. This replacement effect may apply more than once to the same event. This is an exception to rule 614.5.
    RULE_903_9b_COMMANDER_HAND_LIBRARY_ZONE_EFFECT(Condition),
    ...
    RULE_903_9c_COMMANDER_PERMANENT_ZONE_EFFECT_CARD(Condition),
    ...
    RULE_903_10_COMMANDER_VARIANT_INCLUDES_SPECIFICATION_WINNING,
    ...
    RULE_903_10a_COMBAT_DAMAGE_STATE_BASED_ACTION,
    ...
    RULE_903_11_EXCEPT_SPECIAL_ACTIONS_EFFECTS_CARDS,
    ...
    RULE_903_11a_PLAYER_ALLOWED_CARD_CANT_IDENTITY(Condition),

    // 903.12. Brawl Option
    RULE_903_12_BRAWL_OPTION,
    ...
    RULE_903_12a_BRAWL_OPTION_STYLE_COMMANDER_GAME,

    // 903.12b. Brawl decks are usually constructed using cards from the Standard format.
    RULE_903_12b_BRAWL_DECKS_CONSTRUCTED_CARDS_STANDARD,
    ...
    RULE_903_12c_DECK_LEGENDARY_CARD_DESIGNATED_CREATURE,
    ...
    RULE_903_12d_PLAYERS_DECK_CONTAIN_EXACTLY_CARDS,
    ...
    RULE_903_12e_PLAYERS_COMMANDER_COLORS_IDENTITY_DECK(Condition),
    ...
    RULE_903_12f_PLAYER_BRAWL_GAME_STARTING_LIFE,
    ...
    RULE_903_12g_BRAWL_GAME_MULLIGAN_CARDS_LIBRARY,
    ...
    RULE_903_12h_NOT_STATE_BASED_ACTION_COMBAT(Condition),

    // 903.13. Commander Draft
    RULE_903_13_COMMANDER_DRAFT,
    ...
    RULE_903_13a_COMMANDER_DRAFT_OPTION_STYLE_CARDS,
    ...
    RULE_903_13b_DRAFT_TYPICALLY_CONSISTS_ROUNDS_CARDS,
    ...
    RULE_903_13c_DRAFT_ROUNDS_BOOSTER_PACKS_PASSED,
    ...
    RULE_903_13d_DRAFT_PLAYER_CARDS_NOT_ABILITY(Condition),
    ...
    RULE_903_13e_DRAFT_COMPLETE_CARDS_PLAYER_DRAFTED(Condition),
    ...
    RULE_903_13f_COMMANDER_DRAFT_CARDS_IDENTITY_ABILITY(Condition),

    // 903.13g. Commander Draft games follow the same rules as Commander games. See rules 903.6–903.11.
    RULE_903_13g_COMMANDER_DRAFT_GAMES,
