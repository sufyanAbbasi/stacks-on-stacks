...
enum Rule {
    ...
    // 720.2c. Although omen cards are printed with multiple sets of characteristics, each omen card is only one card.
    ...
    // 722.2c. Although preparation cards are printed with multiple sets of characteristics, each preparation card is only one card.
    ...
    Rule100_2PlayPlayerNeedsOwnCards,
    ...
    Rule100_2aConstructedPlayWayPlayingCards,
    ...
    Rule100_2bLimitedPlayWayPlayingCards,
    ...
    Rule100_2cCommanderDecksSubjectAdditionalDeckbuilding,
    ...
    Rule100_2dFormatsCardsAttractionPlanechaseArchenemy,
    ...
    Rule100_3CardsRequireCoinsTraditionalDice,
    ...
    Rule100_4PlayerSideboardGroupAdditionalCards(Condition),
    ...
    Rule100_4aConstructedPlaySideboardContainCards,
    ...
    Rule100_4bLimitedPlayInvolvingCardsNot,
    ...
    Rule100_4cLimitedPlayInvolvingCardsNot,
    ...
    Rule100_4dLimitedPlayInvolvingCardNot,
    ...
    Rule100_5DeckContainNumberCardsMinimum(Condition),
    ...
    Rule100_6TournamentsOrganizedPlayActivitiesCards(Condition),
    ...
    Rule100_7CardsIntendedCasualUnSets(Condition),

    // 101. The Magic Golden Rules

    // 101.1. Whenever a card’s text directly contradicts these rules, the card takes precedence. The card overrides only the rule that applies to that specific situation. The only exception is that a player can concede the game at any time (see rule 104.3a).
    Rule101_1CardsTextContradictsPrecedenceOverrides(Condition),

    // 101.2. When a rule or effect allows or directs something to happen, and another effect states that it can’t happen, the “can’t” effect takes precedence.
    Rule101_2EffectDirectsHappenCantPrecedence(Condition),

    // 101.2a. Adding abilities to objects and removing abilities from objects don’t fall under this rule. (See rule 113.10.)
    Rule101_2aAddingAbilitiesObjectsRemovingDont,
    ...
    Rule101_3InstructionThatsIgnoredCardEffect(Condition),

    // 101.4. If multiple players would make choices and/or take actions at the same time, the active player (the player whose turn it is) makes any choices required, then the next player in turn order (usually the player seated to the active player’s left) makes any choices required, followed by the remaining nonactive players in turn order. Then the actions happen simultaneously. This rule is often referred to as the “Active Player, Nonactive Player (APNAP) order” rule.
    Rule101_4ActionsActiveTurnOrderNonactive(Condition),
    ...
    Rule101_4cPlayerThanChoiceTimeOrder(Condition),
    ...
    Rule101_4dChoiceNonactivePlayerTurnApnap(Condition),
    ...
    Rule101_4eMultiplePlayersChoicesActionsStarting(Condition),
    ...
    Rule102_3MultiplayerGameTeamsPlayersNot,
    ...
    Rule102_4SpellAbilityTermTeamTeammates,
    ...
    Rule103_1bArchenemyGameMethodsArentTurn,
    ...
    Rule103_1cCardPowerPlayControllerEffect,
    ...
    Rule103_2GamesRequireAdditionalStepsActions,
    ...
    Rule103_2aPlayersSideboardsCardsSubstituteSet(Condition),
    ...
    Rule103_2dConstructedGamePlayerPlayingSticker(Condition),
    ...
    Rule103_2eConspiracyDraftGameCardsZone,
    ...
    Rule103_3StartingPlayerAdditionalStepsCards,
    ...
    Rule103_3aGameSupplementaryDecksNontraditionalCards,
    ...
    Rule103_4dPlayerBrawlGameStartingLife,

    // 103.4e. In an Archenemy game, the archenemy’s starting life total is 40.
    Rule103_4eArchenemyGameStartingLifeTotal,
    ...
    Rule103_5CardsHandEffectsTurnLibrary(Condition),
    ...
    Rule103_5aVanguardGamePlayersHandCard,
    ...
    Rule103_5bEffectPlayerActionTimeMulligan(Condition),
    ...
    Rule103_5cMultiplayerGameBrawlCardsLibrary,
    ...
    Rule103_5dMultiplayerGameSharedTeamHand(Condition),
    ...
    Rule103_6CardsAllowActionsHandTurn,
    ...
    Rule103_6aCardPlayerGameBattlefieldAction(Condition),
    ...
    Rule103_6bCardPlayerHandActionTurn(Condition),
    ...
    Rule103_6cMultiplayerGameSharedTeamActions,
    ...
    Rule104_2cMultiplayerGameTeamsPlayerWins(Condition),

    // 104.2d. In an Emperor game, a team wins the game if its emperor wins the game. (See rule 809.5.)
    Rule104_2dEmperorGameTeamWins(Condition),

    // 104.3. There are several ways to lose the game.
    Rule104_3SeveralWaysLoseGame,

    // 104.3a. A player can concede the game at any time. A player who concedes leaves the game immediately. That player loses the game.
    Rule104_3aPlayerConcedeGameTimeLeaves(Condition),
    ...
    Rule104_3bPlayersZeroStateBasedAction(Condition),
    ...
    Rule104_3cCardsLibraryStateBasedAction(Condition),
    ...
    Rule104_4eMultiplayerGameEffectSpellAbility,
    ...
    Rule104_4fMultiplayerGameLoopActionsObject(Condition),
    ...
    Rule104_5PlayerLosesGameLeavesDraw(Condition),
    ...
    Rule105_3EffectsChangeObjectsColorlessAddition(Condition),
    ...
    Rule105_4PlayerAskedMulticoloredNotColorless(Condition),
    ...
    Rule105_5EffectColorPairExactlyWhite(Condition),
    ...
    Rule106_3ManaProducedEffectsAbilitiesSpells(Condition),
    ...
    Rule106_4EffectCostsStepPhaseCards(Condition),
    ...
    Rule106_4aManaPlayersPoolSpentCost(Condition),
    ...
    Rule106_6SpellsAbilitiesProduceManaEffect(Condition),
    ...
    Rule106_6aReplacementEffectsSpellAbilityContinuous(Condition),
    ...
    Rule106_7AbilitiesProduceBasedPermanentResolve(Condition),
    ...
    Rule106_8EffectAddManaHybridColorless(Condition),
    ...
    Rule106_9EffectAddManaPhyrexianSymbol(Condition),
    ...
    Rule106_10EffectAddManaGenericColorless(Condition),
    ...
    Rule106_11EffectAddManaSnowColorless(Condition),
    ...
    Rule106_12TapPermanentManaActivateAbility,
    ...
    Rule106_12aAbilityPermanentTappedManaResolves(Condition),
    ...
    Rule106_12bEffectPermanentTappedManaAbility(Condition),
    ...
    Rule106_13CardManaLostWayPermanents,

    // 107. Numbers and Symbols

    // 107.1. The only numbers the Magic game uses are integers.
    Rule107_1NumbersGameIntegers,
    ...
    Rule107_1aCantChooseDamageSpellAbility(Condition),
    ...
    Rule107_2AnythingNeedsNumberCantZero(Condition),
    ...
    Rule107_3ObjectsLetterXPlaceholderAbilities,
    ...
    Rule107_3aSpellAbilityCostXStack(Condition),

    // 107.3b. If a player is casting a spell that has an {X} in its mana cost, the value of X isn’t defined by the text of that spell, and an effect lets that player cast that spell while paying neither its mana cost nor an alternative cost that includes X, then the only legal choice for X is 0. This doesn’t apply to effects that only reduce a cost, even if they reduce it to zero. See rule 601, “Casting Spells.”
    Rule107_3bCastingSpellXCostEffect(Condition),
    ...
    Rule107_3cSpellAbilityXCostStack(Condition),
    ...
    Rule107_3dCostAssociatedSpecialActionX(Condition),
    ...
    Rule107_3eSpellAbilityXCostObject(Condition),
    ...
    Rule107_3fXSpellAbilityNotCost(Condition),
    ...
    Rule107_3gCardZoneStackXCost(Condition),
    ...
    Rule107_3hEffectCostXZeroSpell(Condition),

    // 107.3i. Normally, all instances of X on an object have the same value at any given time.
    Rule107_3iInstancesXObjectValueTime(Condition),
    ...
    Rule107_3jObjectAbilityXZeroEffects(Condition),
    ...
    Rule107_3kObjectsActivatedAbilityXCost(Condition),
    ...
    Rule107_3mBattlefieldAbilityEffectXSpell(Condition),
    ...
    Rule107_4aPrimaryColoredManaCostsColor,
    ...
    Rule107_4bNumericalSymbolsVariableXCosts,
    ...
    Rule107_4cColorlessManaSymbolCCost,
    ...
    Rule107_4dSymbolZeroManaPlaceholderCost,
    ...
    Rule107_4eHybridManaSymbolColorlessCost(Condition),
    ...
    Rule107_4hCostSnowManaSymbolEffects(Condition),
    ...
    Rule107_5TapCostPermanentCantCreatures(Condition),
    ...
    Rule107_6UntapCostPermanentCantCreatures(Condition),
    ...
    Rule107_7AbilityLoyaltyCostXZero,
    ...
    Rule107_8LevelerCardAbilityN1N2,
    ...
    Rule107_8aLevelN1N2AbilitiesP(Condition),
    ...
    Rule107_8bLevelN3AbilitiesPLong,
    ...
    Rule107_9BlockCardsAbilitiesGraveyardEffect(Condition),
    ...
    Rule107_10TypeCardTimeshiftedCreatureEffect(Condition),
    ...
    Rule107_11PlaneswalkerSymbolPwAppearsPlanechase(Condition),
    ...
    Rule107_12ChaosSymbolAppearsPlanechaseAbilities,
    ...
    Rule107_13ColorIndicatorCardsManaCost,
    ...
    Rule107_14EnergySymbolECounterPay,
    ...
    Rule107_15SagaCardAbilityRnEffect,
    ...
    Rule107_15aRnEffectLoreCountersSaga(Condition),

    // 107.15b. “{rN1}, {rN2}—[Effect]” is the same as “{rN1}—[Effect]” and “{rN2}—[Effect].”
    Rule107_15bRn1Rn2Effect,
    ...
    Rule107_16TextClassCardAbilityCost,
    ...
    Rule107_16aCostLevelNAbilitiesActivate(Condition),

    // 107.17. The ticket symbol is {TK}. It represents one ticket counter.
    Rule107_17TicketSymbolTkCounter,
    ...
    Rule107_17aTicketSymbolNumberInsideCost,
    ...
    Rule107_18PawprintSymbolSpellsNotCost,
    ...
    Rule108_2aGamesTraditionalCardsMeasureNot,
    ...
    Rule108_2bTokensArentConsideredCardsSized,
    ...
    Rule108_3OwnerCardGamePlayerZone(Condition),
    ...
    Rule108_3aPlanechaseGameSinglePlanarCards,
    ...
    Rule108_3bSpellsAbilitiesAllowPlayerCards(Condition),
    ...
    Rule108_4CardDoesntControllerPermanentSpell(Condition),

    // 108.4a. If anything asks for the controller of a card that doesn’t have one (because it’s not a permanent or spell), use its owner instead.
    Rule108_4aAnythingCardNotPermanentSpell(Condition),
    ...
    Rule108_5NontraditionalCardsCantZoneEffect(Condition),
    ...
    Rule109_1ObjectAbilityStackCardSpell,
    ...
    Rule109_2SpellAbilityObjectCardZone(Condition),
    ...
    Rule109_2aSpellAbilityObjectCardZone(Condition),
    ...
    Rule109_2bSpellAbilityDescriptionObjectStack(Condition),
    ...
    Rule109_2cSpellAbilityObjectSourceDamage(Condition),
    ...
    Rule109_2dAbilitySchemeCardIncludesZone(Condition),
    ...
    Rule109_3ObjectsCostCardAbilitiesHand,
    ...
    Rule109_4bTriggeredAbilityWaitingStackHandling(Condition),

    // 109.4c. An emblem is controlled by the player who puts it into the command zone. See rule 114, “Emblems.”
    Rule109_4cEmblemControlledPlayerCommandZone,
    ...
    Rule110_2PermanentsOwnerCardTokenBattlefield(Condition),
    ...
    Rule110_2aEffectPlayerObjectBattlefieldEnters(Condition),
    ...
    Rule110_2bEffectCausesPermanentSpellStack(Condition),
    ...
    Rule110_3PermanentsCardContinuousEffectsInteraction,
    ...
    Rule110_4PermanentTypesCreatureCardsCant,
    ...
    Rule110_4aTermPermanentCardBattlefieldCreature,
    ...
    Rule110_5PermanentsStatusPhysicalStateCategories,

    // 110.5a. Status is not a characteristic, though it may affect a permanent’s characteristics.
    Rule110_5aStatusNotCharacteristicAffectPermanents,
    ...
    Rule110_5bPermanentsEnterBattlefieldSpellAbility(Condition),
    ...
    Rule110_5cPermanentSpellAbilityTurnBased(Condition),
    ...
    Rule110_5dPermanentsCardsNotBattlefieldState,
    ...
    Rule111_3SpellAbilityTextCardNot,
    ...
    Rule111_4SpellAbilityCreatesTokenBattlefield(Condition),
    ...
    Rule111_5SpellAbilityEffectPermanentCant(Condition),
    ...
    Rule111_6TokenSubjectAnythingPermanentsCard(Condition),
    ...
    Rule111_7ZoneBattlefieldStateBasedAction(Condition),
    ...
    Rule111_8BattlefieldCantZoneStateBased(Condition),
    ...
    Rule111_9EffectsPlayerCreateLegendaryName,
    ...
    Rule111_10hColorlessAddCManaCant,
    ...
    Rule111_10iTokenColorlessTransformZeroCreature,
    ...
    Rule111_10jColorlessCreatureEnchantedBasePower,
    ...
    Rule111_10kMonsterColorlessCreatureEnchantedTrample,
    ...
    Rule111_10mRoyalColorlessCreatureEnchantedWard,
    ...
    Rule111_10nColorlessCreatureEnchantedAttacksScry(Condition),
    ...
    Rule111_10pColorlessEnchantmentCreatureEnchantedControl,
    ...
    Rule111_10qTokenColorlessCreatureEnchantedGraveyard(Condition),
    ...
    Rule111_10rColorlessCreatureEnchantedAttacksToughness(Condition),
    ...
    Rule111_10sTokenColorlessSacrificeTargetCreature,
    ...
    Rule111_10tTokenColorlessSacrificeExileTop,
    ...
    Rule111_10uTokenColorlessSacrificeSearchLibrary,
    ...
    Rule111_10vTokenColorlessSacrificeCounterTarget,
    ...
    Rule111_11EffectPlayerCreateNotCard(Condition),
    ...
    Rule111_12EffectPlayerCreateObjectNot(Condition),
    ...
    Rule111_13PermanentSpellResolvesNotCreated,
    ...
    Rule112_1bEffectsAllowCastCardSpell(Condition),
    ...
    Rule112_2SpellsOwnerCardCopyStack(Condition),
    ...
    Rule112_2aEffectsPlayerCreateCardCast,
    ...
    Rule112_3SpellsCardContinuousEffectsInteraction,
    ...
    Rule112_4EffectResolvingSpellAbilityPermanent(Condition),

    // 113. Abilities

    // 113.1. An ability can be one of three things:
    Rule113_1AbilityThings,
    ...
    Rule113_1aAbilityCharacteristicObjectEffectGains,
    ...
    Rule113_1bAbilityPlayerChangesGameEffects(Condition),
    ...
    Rule113_2cObjectAbilitiesCardNotEffect(Condition),
    ...
    Rule113_2dAbilitiesGenerateShotEffectsContinuous,

    // 113.3. There are four general categories of abilities:
    Rule113_3GeneralCategoriesAbilities,
    ...
    Rule113_3aSpellAbilitiesInstructionsInstantResolving(Condition),
    ...
    Rule113_3dStaticAbilitiesContinuousEffectsPermanent,
    ...
    Rule113_4AbilitiesManaSpecialStackActivate(Condition),
    ...
    Rule113_5AbilitiesLoyaltySpecialActivatePermanent(Condition),
    ...
    Rule113_6AbilitiesSpellObjectStackBattlefield,
    ...
    Rule113_6aCharacteristicDefiningAbilitiesFunctionEverywhere,

    // 113.6b. An ability that states which zones it functions in functions only from those zones.
    Rule113_6bAbilityZonesFunctions,
    ...
    Rule113_6cAbilityZonesDoesntFunctionEverywhere,
    ...
    Rule113_6dObjectsAbilityCostCastStack,
    ...
    Rule113_6eObjectsAbilityCastZoneStack,
    ...
    Rule113_6hObjectsAbilityModifiesEntersBattlefield,
    ...
    Rule113_6iObjectsAbilityCountersCantBattlefield,
    ...
    Rule113_6jAbilityCostCantBattlefieldZone,
    ...
    Rule113_6kTriggerCantBattlefieldZonesAbility,
    ...
    Rule113_6mAbilityCostEffectObjectZone(Condition),
    ...
    Rule113_6nAbilityModifiesNotCantCard(Condition),
    ...
    Rule113_7aAbilityStackCreatureDealsDamage(Condition),
    ...
    Rule113_8ControllerActivatedAbilityStackPlayer(Condition),
    ...
    Rule113_9AbilitiesStackSpellsCantEffects(Condition),
    ...
    Rule113_10EffectsAbilitiesStateGainsLoses,
    ...
    Rule113_10aEffectAddsActivatedAbilityObject,

    // 113.10b. Effects that remove an ability remove all instances of it.
    Rule113_10bEffectsRemoveAbilityInstances,
    ...
    Rule113_10cEffectsAddRemoveAbilityContinuous(Condition),
    ...
    Rule113_11EffectsObjectAbilityCantResolving(Condition),
    ...
    Rule113_12EffectCharacteristicAbilityGainsPermanent(Condition),
    ...
    Rule114_1EffectsEmblemsZoneObjectAbilities,
    ...
    Rule114_2EffectEmblemPlayerAbilityZone,
    ...
    Rule114_3EmblemCharacteristicsAbilitiesEffectCost,

    // 114.4. Abilities of emblems function in the command zone.
    Rule114_4AbilitiesEmblemsFunctionCommandZone,

    // 114.5. An emblem is neither a card nor a permanent. Emblem isn’t a card type.
    Rule114_5EmblemCardPermanentIsntType,
    ...
    Rule115_1SpellsAbilitiesObjectStackCant,
    ...
    Rule115_1aSpellAbilityTargetObjectCast(Condition),
    ...
    Rule115_1bAuraSpellsAbilityCastPermanent,
    ...
    Rule115_1cActivatedAbilityTargetedTargetObject(Condition),
    ...
    Rule115_1dTriggeredAbilityTargetObjectStack(Condition),
    ...
    Rule115_1eKeywordAbilitiesEquipModularSpells,
    ...
    Rule115_2PermanentsSpellsAbilitiesObjectZone(Condition),
    ...
    Rule115_3TargetCantSpellAbilityObject(Condition),
    ...
    Rule115_4SpellsAbilitiesDamageTargetCreatures,

    // 115.5. A spell or ability on the stack is an illegal target for itself.
    Rule115_5SpellAbilityStackIllegalTarget,
    ...
    Rule115_6SpellAbilityRequiresTargetsZero(Condition),
    ...
    Rule115_7EffectsAllowPlayerSpellAbility,
    ...
    Rule115_7aEffectChangeTargetSpellAbility(Condition),
    ...
    Rule115_7bEffectChangeTargetSpellAbility(Condition),
    ...
    Rule115_7cEffectChangeTargetsSpellAbility(Condition),
    ...
    Rule115_7dEffectChooseNewTargetsSpell(Condition),
    ...
    Rule115_7eChangingTargetsChoosingSpellAbility(Condition),
    ...
    Rule115_7fSpellAbilityDivideDistributeEffect(Condition),
    ...
    Rule115_8ModalSpellsAbilitiesTargetingEffect,
    ...
    Rule115_9ObjectsCheckSpellAbilityState(Condition),
    ...
    Rule115_9aObjectSpellAbilityNumberTargets(Condition),
    ...
    Rule115_9bObjectSpellAbilityTargetsState(Condition),
    ...
    Rule115_9cObjectSpellAbilityTargetsStack(Condition),
    ...
    Rule116_1SpecialActionsStackNotTurn(Condition),

    // 116.2. There are twelve special actions:
    Rule116_2TwelveSpecialActions,
    ...
    Rule116_2aSpecialActionBattlefieldZoneHand,
    ...
    Rule116_2bFaceCreatureSpecialActionSpells,
    ...
    Rule116_2cEffectsActionContinuousAbilitySpecial(Condition),
    ...
    Rule116_2dEffectsStaticAbilitiesActionSpecial,
    ...
    Rule116_2eCardCirclingVulturesAbilityDiscard,
    ...
    Rule116_2fCardSuspendHandExileSpecial(Condition),
    ...
    Rule116_2gCardHandSpecialActionStack(Condition),
    ...
    Rule116_2hCardForetellHandExileSpecial,
    ...
    Rule116_2kCardPlotHandExileSpecial,
    ...
    Rule116_2mPermanentCostUnlockActionStack,

    // 116.3. If a player takes a special action, that player receives priority afterward.
    Rule116_3PlayerSpecialActionReceivesPriority(Condition),
    ...
    Rule117_1SpellAbilityActionCastActivate(Condition),
    ...
    Rule117_1aPlayerCastSpellPhaseStack,

    // 117.1b. A player may activate an activated ability any time they have priority.
    Rule117_1bPlayerActivateActivatedAbilityTime,
    ...
    Rule117_1cPlayerSpecialActionsPhaseStack,
    ...
    Rule117_1dActivateAbilitySpellEffectResolving(Condition),
    ...
    Rule117_2KindsAbilitiesActionsAutomaticallyGenerated,
    ...
    Rule117_2aAbilitiesTriggerSpellCastResolving(Condition),
    ...
    Rule117_2bStaticAbilitiesContinuouslyAffectGame,
    ...
    Rule117_2cTurnBasedActionsHappenPhase(Condition),
    ...
    Rule117_2dStateBasedActionsHappenAutomatically(Condition),
    ...
    Rule117_2eResolvingSpellsAbilitiesActionsActivate(Condition),

    // 117.3. Which player has priority is determined by the following rules:
    Rule117_3PlayerPriority,

    // 117.3a. The active player receives priority at the beginning of most steps and phases, after any turn-based actions (such as drawing a card during the draw step; see rule 703) have been dealt with and abilities that trigger at the beginning of that phase or step have been put on the stack. No player receives priority during the untap step. Players usually don’t get priority during the cleanup step (see rule 514.3).
    Rule117_3aTurnBasedActionsCardAbilities(Condition),

    // 117.3b. The active player receives priority after a spell or ability (other than a mana ability) resolves.
    Rule117_3bActivePlayerSpellAbilityResolves,

    // 117.3c. If a player has priority when they cast a spell, activate an ability, or take a special action, that player receives priority afterward.
    Rule117_3cCastSpellActivateAbilitySpecial(Condition),

    // 117.3d. If a player has priority and chooses not to take any actions, that player passes. If any mana is in that player’s mana pool, they announce what mana is there. Then the next player in turn order receives priority.
    Rule117_3dPlayerPriorityNotActionsTurn(Condition),

    // 117.4. If all players pass in succession (that is, if all players pass without taking any actions in between passing), the spell or ability on top of the stack resolves or, if the stack is empty, the phase or step ends.
    Rule117_4ActionsSpellAbilityStackResolves(Condition),
    ...
    Rule117_5StateBasedActionsAbilitiesStack(Condition),
    ...
    Rule117_6MultiplayerSharedTeamTurnsOption,
    ...
    Rule117_7SpellAbilityStackResponseResolve(Condition),
    ...
    Rule118_1CostActionSpellAbilityEffect,
    ...
    Rule118_2CostActivateAbilitiesCastSpell(Condition),

    // 118.3. A player can’t pay a cost without having the necessary resources to pay it fully. See rule 202, “Mana Cost and Color,” and rule 602, “Activating Activated Abilities.”
    Rule118_3CantCostManaColorActivating,
    ...
    Rule118_3aPayingManaRemovingIndicatedZero(Condition),
    ...
    Rule118_5CostsZeroReducedActionNot,
    ...
    Rule118_5aSpellCostZeroCastAbility,
    ...
    Rule118_6CostAbilityBasedCastSpell(Condition),
    ...
    Rule118_6aUnpayableCostEffectCastSpell(Condition),
    ...
    Rule118_7PlayerActuallyCostEffectsZero(Condition),
    ...
    Rule118_7aEffectsReduceCostCantColorless,
    ...
    Rule118_7bCostReducedAmountColoredColorless(Condition),
    ...
    Rule118_7cCostReducedAmountColoredMana(Condition),
    ...
    Rule118_7dCostReducedAmountColorlessMana(Condition),
    ...
    Rule118_7eCostReducedAmountManaColorless(Condition),
    ...
    Rule118_7fCostReducedAmountManaPhyrexian(Condition),
    ...
    Rule118_7gCostReducedAmountManaSnow(Condition),
    ...
    Rule118_8SpellsAbilitiesAdditionalCostsEffect(Condition),
    ...
    Rule118_8aNumberCostsSpellCastAbility,

    // 118.8b. Some additional costs are optional.
    Rule118_8bAdditionalCostsOptional,
    ...
    Rule118_8cEffectCastSpellAbleCost(Condition),
    ...
    Rule118_8dAdditionalCostsSpellsCastAbilities,
    ...
    Rule118_9SpellsCostsEffectPayRather,
    ...
    Rule118_9aAlternativeCostAppliedSpellCast,
    ...
    Rule118_9bAlternativeCostsEffectCastSpell,
    ...
    Rule118_9cAlternativeCostSpellsCastAbilities,
    ...
    Rule118_9dAlternativeCostPaidCastSpell(Condition),

    // 118.10. Each payment of a cost applies to only one spell, ability, or effect. Also, the resolution of a spell or ability doesn’t pay another spell or ability’s cost, even if part of its effect is doing the same thing the other cost asks for.
    Rule118_10PaymentCostSpellAbilityEffect(Condition),
    ...
    Rule118_11ActionsPerformedPayingCostEffects(Condition),
    ...
    Rule118_12SpellsAbilitiesPlayerCantEffect(Condition),
    ...
    Rule118_12aSpellsActivatedAbilitiesPlayerElse(Condition),
    ...
    Rule118_12bEffectsPlayerZoneActionsCards(Condition),
    ...
    Rule118_13CostsContainManaSymbolsPaid,
    ...
    Rule118_13aManaCostSpellActivationAbility(Condition),
    ...
    Rule118_13bCostPaidResolutionSpellAbility(Condition),
    ...
    Rule118_13cCostAssociatedSpecialActionMana(Condition),
    ...
    Rule118_14EffectsManaTypeSpentCost(Condition),
    ...
    Rule119_4CostEffectPlayerPayZero(Condition),
    ...
    Rule119_4aCostEffectPlayerPayZero(Condition),
    ...
    Rule119_4bPlayersPayZeroEffectCant(Condition),
    ...
    Rule119_7EffectSaysPlayerCantCost(Condition),
    ...
    Rule119_8EffectSaysPlayerCantCost(Condition),
    ...
    Rule119_9AbilitiesPlayerGainsLifeSource(Condition),
    ...
    Rule119_10EffectsPlayerGainLifeAbilities(Condition),
    ...
    Rule120_2aDamageDealtCombatCreatureStep,
    ...
    Rule120_2bDamageEffectSpellAbilityObject,
    ...
    Rule120_3dDamageDealtCreatureSourceWither,
    ...
    Rule120_3eDamageDealtCreatureSourceWither,
    ...
    Rule120_3fDamageDealtSourceLifelinkCauses,
    ...
    Rule120_4aEffectDamagePermanentCreatureCard(Condition),
    ...
    Rule120_4bDamageEffectsAbilitiesTriggerStack(Condition),
    ...
    Rule120_4cDamageThatsDealtProcessedEffects,

    // 120.4d. Finally, the damage event occurs.
    Rule120_4dFinallyDamageEventOccurs,
    ...
    Rule120_5DamageCreatureStateBasedActions,
    ...
    Rule120_6DamageCreatureStepPermanentState(Condition),
    ...
    Rule120_7DamageObjectEffectPermanentSpell(Condition),
    ...
    Rule120_8ZeroDamageNotAbilitiesTrigger(Condition),
    ...
    Rule120_9AbilityDamageDealtEffectNot(Condition),
    ...
    Rule120_10AbilitiesPermanentDamageCreatureCard(Condition),
    ...
    Rule121_1CardLibraryHandTurnBased,
    ...
    Rule121_2CardsDrawnTimePlayerDraw(Condition),
    ...
    Rule121_2aInstructionDrawMultipleCardsEffects,
    ...
    Rule121_2bEffectsCantCardTurnCost(Condition),
    ...
    Rule121_2cThanPlayerDrawCardsTurn(Condition),
    ...
    Rule121_2dThanPlayerDrawCardsGame(Condition),
    ...
    Rule121_3CardsPlayersLibraryEffectCant(Condition),
    ...
    Rule121_3aNotCardLibraryEffectCant(Condition),
    ...
    Rule121_4CardLibraryStateBasedAction(Condition),
    ...
    Rule121_5EffectCardsLibraryHandDraw(Condition),

    // 121.6. Some effects replace card draws.
    Rule121_6EffectsReplaceCardDraws,
    ...
    Rule121_6aEffectReplacesCardDrawLibrary(Condition),
    ...
    Rule121_6bEffectReplacesDrawSequenceCard(Condition),
    ...
    Rule121_6cEffectsPerformActionsCardNot(Condition),
    ...
    Rule121_7ReplacementEffectsPreventionResultCard(Condition),
    ...
    Rule121_8SpellAbilityCardCastEffect(Condition),
    ...
    Rule122_1aXCreatureCardZoneBattlefield,
    ...
    Rule122_1bPermanentCardZoneBattlefieldObject,
    ...
    Rule122_1cShieldPermanentReplacementEffectPrevention(Condition),
    ...
    Rule122_1dStunPermanentEffectUntappedRemove(Condition),
    ...
    Rule122_1eBattlefieldZeroGraveyardStateBased,
    ...
    Rule122_1fPlayerStateBasedActionPoisoned(Condition),
    ...
    Rule122_1gBattlefieldZeroGraveyardAbilityNot(Condition),
    ...
    Rule122_1hPermanentEffectGraveyardBattlefieldExile(Condition),
    ...
    Rule122_1iRadCountersAbilityTriggerPhase(Condition),
    ...
    Rule122_2CountersObjectNotZoneRemoved(Condition),
    ...
    Rule122_3PermanentNStateBasedAction(Condition),
    ...
    Rule122_4PermanentAbilityCantNState(Condition),
    ...
    Rule122_5EffectMoveObjectActionsNot(Condition),
    ...
    Rule122_6SpellsAbilitiesCountersObjectBattlefield,
    ...
    Rule122_6aObjectEntersBattlefieldCountersEffect(Condition),
    ...
    Rule122_7AbilityNthKindCounterObject(Condition),
    ...
    Rule122_8TriggeredAbilityTriggerEffectBattlefield(Condition),
    ...
    Rule122_9ActivatedAbilityObjectCostActivate(Condition),
    ...
    Rule201_2aObjectsNameCommonAdditionalDoesnt(Condition),
    ...
    Rule201_2bSpellsAbilitiesObjectsNamesGroup(Condition),
    ...
    Rule201_2cSpellsAbilitiesCheckObjectNot(Condition),
    ...
    Rule201_3InterchangeableNamesSameName,
    ...
    Rule201_3cCardLaterPrintingsInterchangeableHand(Condition),
    ...
    Rule201_4EffectPlayerChooseCardNot(Condition),
    ...
    Rule201_4aPlayerChooseCardNameCharacteristics(Condition),
    ...
    Rule201_4bPlayerWantsChooseCardNot(Condition),
    ...
    Rule201_4cPlayerWantsChooseFlipCards(Condition),
    ...
    Rule201_4dPlayerWantsChooseNameCard(Condition),
    ...
    Rule201_4ePlayerWantsChooseNameCard(Condition),
    ...
    Rule201_4fPlayerWantsChooseAdventurerCards(Condition),
    ...
    Rule201_4gCardsInterchangeableNamesGamePurposes(Condition),
    ...
    Rule201_5TextObjectNameNotEffects,
    ...
    Rule201_5aAbilitysEffectObjectNotZone(Condition),
    ...
    Rule201_5bAbilityObjectNameGainsInstance(Condition),
    ...
    Rule201_5cTextPrintedCardsShortenedVersion,
    ...
    Rule201_6PromotionalAlternateArtCardsEffects,
    ...
    Rule202_1CardsManaCostIndicatedSymbols,
    ...
    Rule202_1aCostObjectCastCardColorless(Condition),
    ...
    Rule202_2cObjectCostMulticoloredCardsNot,
    ...
    Rule202_2dObjectHybridManaCostCards,
    ...
    Rule202_2eObjectColorIndicatorPrintedLeft,
    ...
    Rule202_3aObjectCostZeroPermanentSpell(Condition),
    ...
    Rule202_3bPermanentSpellsCostObjectCard(Condition),
    ...
    Rule202_3cManaPermanentCostCardZero(Condition),
    ...
    Rule202_3dSplitCardNotStackSpell,
    ...
    Rule202_3eObjectXCostZeroNot(Condition),
    ...
    Rule202_3fCalculatingManaValueObjectCost(Condition),

    // 202.3g. Each Phyrexian mana symbol in a card’s mana cost contributes 1 to its mana value.
    Rule202_3gPhyrexianManaSymbolCardsCost,
    ...
    Rule202_4AdditionalCostListedEffectSpells(Condition),

    // 203. Illustration

    // 203.1. The illustration is printed on the upper half of a card and has no effect on game play.
    Rule203_1IllustrationPrintedUpperCardEffect,
    ...
    Rule205_1TypeLinePrintedIllustrationCards(Condition),
    ...
    Rule205_1aEffectsCardDamageCreatureSpell(Condition),
    ...
    Rule205_1bEffectsCardTypeSupertypeSubtype,
    ...
    Rule205_2aCardTypesArtifactCreatureScheme,
    ...
    Rule205_3bSubtypesCardTypeExceptCreature,
    ...
    Rule205_3cCardMultipleTypesSubtypesCorrelated(Condition),

    // 205.3d. An object can’t gain a subtype that doesn’t correspond to one of that object’s types.
    Rule205_3dObjectCantGainSubtypeDoesnt,

    // 205.3e. If an effect instructs a player to choose a subtype, that player must choose one, and only one, existing subtype, and the subtype must be for the appropriate card type.
    Rule205_3eEffectPlayerChooseSubtypeCard(Condition),
    ...
    Rule205_3fCardsPrintedSubtypesNowObsolete,
    ...
    Rule205_3gArtifactsOwnUniqueSetSubtypes,
    ...
    Rule205_3hEnchantmentsOwnUniqueSetSubtypes,
    ...
    Rule205_3iLandsOwnUniqueSetSubtypes,
    ...
    Rule205_3jPlaneswalkersOwnUniqueSetSubtypes,
    ...
    Rule205_3kInstantsSorceriesShareListsSpell,
    ...
    Rule205_3mCreaturesKindredsShareListsSubtypes,
    ...
    Rule205_4aObjectSupertypesCardsPrintedTypes,
    ...
    Rule205_4bObjectsSupertypeIndependentCardType(Condition),
    ...
    Rule205_4cLandSupertypeBasicDoesntNonbasic(Condition),
    ...
    Rule205_4dPermanentLegendaryStateBasedAction,
    ...
    Rule205_4eSpellLegendaryCantCastCreature(Condition),
    ...
    Rule205_4fPermanentWorldStateBasedAction,
    ...
    Rule206_1ExpansionSymbolIndicatesCardEffect,
    ...
    Rule206_2ColorExpansionCardSpecialTimeshifted(Condition),
    ...
    Rule206_3SpellAbilityCardsNameOriginally,
    ...
    Rule206_3aCardPermanentsNGraveyardLibrary,
    ...
    Rule206_3bCardGolgothianSylexPermanentsName,
    ...
    Rule206_3cCardApocalypseChimePermanentsSpell,
    ...
    Rule206_4PlayersIncludeCardsPrintingConstructed(Condition),
    ...
    Rule207_2aReminderTextItalicizedCardAbility(Condition),
    ...
    Rule207_2bFlavorTextItalicizedLikeIllustration,
    ...
    Rule207_2cAbilityWordCardsSpecialSpell(Condition),
    ...
    Rule207_2dSimilarAbilityWordsSpecialNot(Condition),

    // 207.3. Some cards have decorative icons in the background of their text boxes. Similarly, many promotional cards include decorative icons. These icons have no effect on game play.
    Rule207_3CardsDecorativeIconsBackgroundEffect,
    ...
    Rule207_4ChaosCardAbilitySpecialPlanechase(Condition),
    ...
    Rule207_5CardCrypticSpiresAbilityIdentity,
    ...
    Rule208_2aCardAbilityCreaturesCantZero(Condition),
    ...
    Rule208_2bCardAbilityEffectCreaturesEnters,
    ...
    Rule208_3NoncreaturePermanentHasNoPowerToughness(Condition),
    ...
    Rule208_3aEffectCreatedSetsPermanentCreature(Condition),

    // 208.4. Some effects refer to a creature’s “base power,” “base toughness,” or “base power and toughness.”
    Rule208_4EffectsCreaturesBasePowerToughness,
    ...
    Rule208_4aEffectsSetCreaturesContinuousInteraction,
    ...
    Rule208_4bEffectsCreaturesAbilitiesInteractionContinuous,

    // 208.5. If a creature somehow has no value for its power, its power is 0. The same is true for toughness.
    Rule208_5CreatureSomehowValuePowerZero(Condition),
    ...
    Rule209_1PlaneswalkerCardLoyaltyNotBattlefield,
    ...
    Rule209_2AbilityLoyaltyCostSpecialActivate(Condition),
    ...
    Rule210_1BattleCardDefenseNotBattlefield,
    ...
    Rule211_1VanguardCardHandModifierZero,
    ...
    Rule212_1VanguardCardLifeModifierZero,
    ...
    Rule213_1CardFeaturesTextEffectNot,
    ...
    Rule213_1dCardsInterchangeableNamesIncludeVersion,
    ...
    Rule300_1CardTypesArtifactCreatureScheme,
    ...
    Rule300_2ObjectsCardCreatureSpellsAbilities,
    ...
    Rule300_2aObjectCardCantCastSpell,
    ...
    Rule300_2bKindredCardTypeCastingResolving,
    ...
    Rule301_1CastCardHandPhaseTurn(Condition),

    // 301.2. When an artifact spell resolves, its controller puts it onto the battlefield under their control.
    Rule301_2ArtifactSpellResolvesControllerBattlefield(Condition),
    ...
    Rule301_3ArtifactSubtypesSingleWordEquipment,
    ...
    Rule301_4ArtifactsCharacteristicsCardCostsColorless,
    ...
    Rule301_5EquipmentControlAndAttachment,
    ...
    Rule301_5aCreatureEquipmentAttachedEquippedEquips,
    ...
    Rule301_5bSpellsCastBattlefieldCreatureAbility(Condition),
    ...
    Rule301_5cEquipmentCreatureCantPermanentBattlefield(Condition),
    ...
    Rule301_5dCreaturesNotActivateAbilitiesGains(Condition),
    ...
    Rule301_5eEffectAttemptsBattlefieldObjectCant(Condition),
    ...
    Rule301_5fAbilityPermanentEquippedCreatureAttached(Condition),
    ...
    Rule301_6FortificationCantObjectAbilityCreatures,
    ...
    Rule301_7ArtifactsVehicleCrewAbilityCreatures,
    ...
    Rule301_7aVehiclePrintedPowerToughnessCreature(Condition),
    ...
    Rule301_7bVehicleCreatureImmediatelyPrintedEffects(Condition),
    ...
    Rule302_1CastCreatureCardHandPhase(Condition),

    // 302.2. When a creature spell resolves, its controller puts it onto the battlefield under their control.
    Rule302_2CreatureSpellResolvesControllerBattlefield(Condition),
    ...
    Rule302_7DamageCreatureStateBasedAction(Condition),
    ...
    Rule303_1CastCardHandPhaseTurn(Condition),

    // 303.2. When an enchantment spell resolves, its controller puts it onto the battlefield under their control.
    Rule303_2EnchantmentSpellResolvesControllerBattlefield(Condition),
    ...
    Rule303_3EnchantmentSubtypesSingleWordShrine,
    ...
    Rule303_4AuraBattlefieldObjectAbilityEffects,

    // 303.4a. An Aura spell requires a target, which is defined by its enchant ability.
    Rule303_4aAuraSpellRequiresTargetAbility,
    ...
    Rule303_4bObjectPlayerAuraAttachedEnchants,

    // 303.4c. If an Aura is enchanting an illegal object or player as defined by its enchant ability and other applicable effects, the object it was attached to no longer exists, or the player it was attached to has left the game, the Aura is put into its owner’s graveyard. (This is a state-based action. See rule 704.)
    Rule303_4cObjectAbilityEffectsGraveyardState(Condition),
    ...
    Rule303_4dCantGraveyardCreatureStateBased(Condition),
    ...
    Rule303_4eAurasNotActivateAbilitiesGains(Condition),

    // 303.4f. If an Aura is entering the battlefield under a player’s control by any means other than by resolving as an Aura spell, and the effect putting it onto the battlefield doesn’t specify the object or player the Aura will enchant, that player chooses what it will enchant as the Aura enters the battlefield. The player must choose a legal object or player according to the Aura’s enchant ability and any other applicable effects.
    Rule303_4fBattlefieldResolvingSpellEffectObject(Condition),
    ...
    Rule303_4gBattlefieldObjectZoneStackGraveyard(Condition),
    ...
    Rule303_4hEffectAttemptsPermanentBattlefieldObject(Condition),
    ...
    Rule303_4iEffectBattlefieldObjectCantZone(Condition),
    ...
    Rule303_4jEffectAttemptsBattlefieldObjectCant(Condition),
    ...
    Rule303_4kEffectAuraThatsObjectAbility(Condition),
    ...
    Rule303_7aPermanentTimestampGraveyardStateBased(Condition),
    ...
    Rule304_1CastCardHandSpellStack,
    ...
    Rule304_2InstantSpellResolvesActionsGraveyard(Condition),
    ...
    Rule304_3InstantSubtypesSingleArcaneSpell,
    ...
    Rule304_4InstantsCantEnterBattlefieldZone(Condition),
    ...
    Rule304_5TimeCastInstantCardEffects(Condition),
    ...
    Rule305_2aTurnSpecialActionsSpellsAbilities(Condition),
    ...
    Rule305_2bPlayerCantPlayTurnEffect(Condition),
    ...
    Rule305_3PlayerCantPlayTurnEffect(Condition),
    ...
    Rule305_4EffectsAllowBattlefieldPlayingTurn,
    ...
    Rule305_7EffectSetsAbilitiesCardCreature(Condition),
    ...
    Rule306_1CastCardHandPhaseTurn(Condition),

    // 306.2. When a planeswalker spell resolves, its controller puts it onto the battlefield under their control.
    Rule306_2PlaneswalkerSpellResolvesControllerBattlefield(Condition),
    ...
    Rule306_3PlaneswalkerSubtypesSingleWordJace,
    ...
    Rule306_4PreviouslyUniquenessCardsPermanentsLegend,

    // 306.5. Loyalty is a characteristic only planeswalkers have.
    Rule306_5LoyaltyCharacteristicPlaneswalkers,
    ...
    Rule306_5aLoyaltyPlaneswalkerCardNotBattlefield,
    ...
    Rule307_1CastCardHandPhaseTurn(Condition),
    ...
    Rule307_2SorcerySpellResolvesActionsGraveyard(Condition),
    ...
    Rule307_3SorcerySubtypesSingleArcaneSpell,
    ...
    Rule307_4SorceriesCantEnterBattlefieldZone(Condition),
    ...
    Rule307_5SpellAbilityEffectTimeCast(Condition),
    ...
    Rule307_5aEffectSpellCastTimeSorcery(Condition),
    ...
    Rule308_1KindredCardTypeCastingResolving,
    ...
    Rule308_2KindredSubtypesEnchantmentMerfolkCreature,
    ...
    Rule308_3OlderKindredCardsPrintedTribal,

    // 309. Dungeons

    // 309.1. Dungeon is a card type seen only on nontraditional Magic cards.
    Rule309_1DungeonCardTypeNontraditional,
    ...
    Rule309_2DungeonCardsOutsideVentureAction,
    ...
    Rule309_2cCardsNotPermanentsCantCast,
    ...
    Rule309_2dEffectThanVentureActionCard(Condition),
    ...
    Rule309_3PlayerOwnCardZoneCant(Condition),
    ...
    Rule309_4cRoomAbilityEffectCardTrigger(Condition),
    ...
    Rule309_5VentureDungeonKeywordActionCard,
    ...
    Rule309_5aPlayerVenturesDungeonCardZone(Condition),
    ...
    Rule309_5bPlayerVenturesDungeonCardZone(Condition),
    ...
    Rule309_6CardAbilityNotStackState(Condition),

    // 309.7. A player completes a dungeon as that dungeon card is removed from the game.
    Rule309_7PlayerCompletesDungeonCardRemoved,
    ...
    Rule310_1CastCardHandPhaseTurn(Condition),

    // 310.2. When a battle spell resolves, its controller puts it onto the battlefield under their control.
    Rule310_2BattleSpellResolvesControllerBattlefield(Condition),
    ...
    Rule310_7ZeroAbilityNotStackGraveyard(Condition),

    // 310.8. Each battle has a player designated as its protector.
    Rule310_8BattlePlayerDesignatedProtector,
    ...
    Rule310_8aBattleEntersBattlefieldControllerChooses(Condition),
    ...
    Rule310_8bBattlesProtectorAttackAttackedAttacking,
    ...
    Rule310_8cBattlesProtectorBlockCreaturesCant,
    ...
    Rule310_9CantPermanentsStateBasedAction(Condition),
    ...
    Rule310_10CantBasedGraveyardStateAction(Condition),

    // 310.11. All currently existing battles have the subtype Siege. Sieges are subject to special rules.
    Rule310_11CurrentlyExistingBattlesSubtypeSpecial,
    ...
    Rule310_11aSiegeEntersBattlefieldControllerChoose,
    ...
    Rule310_11bAbilityLastDefenseCounterRemoved(Condition),
    ...
    Rule400_1ZoneLibraryHandBattlefieldGraveyard,
    ...
    Rule400_2ZonesCardsEffectGraveyardBattlefield(Condition),

    // 400.3. If an object would go to any library, graveyard, or hand other than its owner’s, it goes to its owner’s corresponding zone.
    Rule400_3ObjectLibraryGraveyardHandZone(Condition),

    // 400.4. Cards with certain card types can’t enter certain zones.
    Rule400_4CardsTypesCantEnterZones,

    // 400.4a. If an instant or sorcery card would enter the battlefield, it remains in its previous zone.
    Rule400_4aInstantSorceryCardBattlefieldZone(Condition),
    ...
    Rule400_4bConspiracyPhenomenonSchemeCardZone(Condition),
    ...
    Rule400_5LibraryGraveyardStackCantEffects(Condition),
    ...
    Rule400_6ObjectZoneAbilitiesBattlefieldEffects(Condition),
    ...
    Rule400_7ObjectMovesZoneNewMemory,
    ...
    Rule400_7aEffectsSpellsAbilitiesPermanentStack,
    ...
    Rule400_7bEffectsAbilitiesPermanentSpellBattlefield,
    ...
    Rule400_7cEffectsDamagePermanentSpellStack,
    ...
    Rule400_7dAbilityPermanentSpellCostsCast,
    ...
    Rule400_7eAbilitiesTriggerObjectZoneAura(Condition),
    ...
    Rule400_7fAbilitiesTriggerPermanentBattlefieldObject(Condition),
    ...
    Rule400_7gEffectCardAbilityCastObject(Condition),
    ...
    Rule400_7hEffectCardCastObjectStack(Condition),
    ...
    Rule400_7iEffectLandCardObjectBattlefield(Condition),
    ...
    Rule400_7jEffectObjectZoneCostSpell(Condition),
    ...
    Rule400_7kResolvingAbilityCardCastZone(Condition),
    ...
    Rule400_7mStickersObjectPublicZoneEffects,
    ...
    Rule400_8ObjectExileZoneExiledDoesnt(Condition),

    // 400.9. If a face-up object in the command zone is turned face down, it becomes a new object.
    Rule400_9FaceObjectCommandZoneTurned(Condition),
    ...
    Rule400_11bEffectsBringCardsGameOutside,
    ...
    Rule400_11cCardsOutsideCantSpellsAbilities,
    ...
    Rule400_12EffectsZoneShuffleHandLibrary,

    // 401. Library

    // 401.1. When a game begins, each player’s deck becomes their library.
    Rule401_1GamePlayersDeckLibrary(Condition),
    ...
    Rule401_2LibrarySingleFaceCantCards(Condition),

    // 401.3. Any player may count the number of cards remaining in any player’s library at any time.
    Rule401_3PlayerCountNumberCardsLibrary(Condition),
    ...
    Rule401_4EffectCardsPositionLibraryTime(Condition),
    ...
    Rule401_5EffectsCardLibrarySpellCast(Condition),
    ...
    Rule401_6EffectCausesCardLibraryObject(Condition),
    ...
    Rule401_7EffectCardLibraryNthTop(Condition),
    ...
    Rule402_1HandPlayerHoldsCardsEffects(Condition),
    ...
    Rule402_2PlayerMaximumHandCardsStep,
    ...
    Rule402_3PlayerArrangeHandCantCards(Condition),
    ...
    Rule403_1AreaPlayersBattlefieldStartsPermanents(Condition),
    ...
    Rule403_4PermanentBattlefieldObjectCardZone(Condition),
    ...
    Rule403_5PreviouslyBattlefieldPlayZoneCards,
    ...
    Rule404_1PlayersGraveyardObjectSpellResolving,
    ...
    Rule404_2GraveyardSingleFaceCardsCant(Condition),
    ...
    Rule404_3EffectCardsGraveyardTimeOwner(Condition),
    ...
    Rule405_1SpellCastCardStackAbility(Condition),
    ...
    Rule405_2StackTrackSpellsAbilitiesObject,
    ...
    Rule405_3EffectObjectsStackTimeApnap(Condition),
    ...
    Rule405_4SpellCardAbilityStackCast(Condition),
    ...
    Rule405_5SpellAbilityStackResolvesStep(Condition),

    // 405.6. Some things that happen during the game don’t use the stack.
    Rule405_6ThingsHappenGameDontStack,
    ...
    Rule405_6aEffectsStackSpellsAbilitiesResolving(Condition),
    ...
    Rule405_6bAbilitiesEffectsStackObjectRed,
    ...
    Rule405_6cManaAbilitiesResolveImmediatelyEffect(Condition),

    // 405.6d. Special actions don’t use the stack; they happen immediately. See rule 116, “Special Actions.”
    Rule405_6dSpecialActionsDontStackHappen,
    ...
    Rule405_6eTurnBasedActionsStackPhase(Condition),
    ...
    Rule405_6hPlayerLeavesMultiplayerGameActions(Condition),
    ...
    Rule406_1ExileZoneEssentiallySpellsAbilities,
    ...
    Rule406_2ExileObjectZoneCurrentlyCard,
    ...
    Rule406_3ExiledCardsFaceCantExile(Condition),
    ...
    Rule406_3aCardSpellAbilityExileCast(Condition),
    ...
    Rule406_3bSpellsAbilitiesCastCardsExile(Condition),
    ...
    Rule406_4CardsExileBasedSpellAbility(Condition),
    ...
    Rule406_5ExiledCardsBattlefieldZoneAbilities,
    ...
    Rule406_6ObjectAbilityCardsExiledLinked,
    ...
    Rule406_7ObjectExileZoneExiledDoesnt(Condition),
    ...
    Rule406_8ExileZoneRemovedGameCards,
    ...
    Rule407_1EarlierVersionsIncludedAnteNot,
    ...
    Rule407_2PlayingAntePlayerCardZone(Condition),
    ...
    Rule407_3CardsRemoveDeckPlayingNot(Condition),
    ...
    Rule407_4AnteObjectZoneWhicheverCurrently,
    ...
    Rule408_1CommandZoneEffectNotPermanents,

    // 408.2. Emblems may be created in the command zone. See rule 114, “Emblems.”
    Rule408_2EmblemsCreatedCommandZone,
    ...
    Rule408_3PlanechaseCasualVariantsCardsZone,
    ...
    Rule500_1TurnConsistsPhasesCombatPhase(Condition),

    // 500.2. A phase or step in which players receive priority ends when the stack is empty and all players pass in succession. Simply having the stack become empty doesn’t cause such a phase or step to end; all players have to pass in succession with the stack empty. Because of this, each player gets a chance to add new things to the stack before that phase or step ends.
    Rule500_2PhaseStepPlayersReceiveStack(Condition),
    ...
    Rule500_5StepPhaseEffectsTurnBased(Condition),
    ...
    Rule500_6PhaseStepAbilitiesTriggerStack(Condition),
    ...
    Rule500_7EffectsPlayerExtraTurnsApnap(Condition),
    ...
    Rule500_8EffectsAddPhasesTurnPhase(Condition),
    ...
    Rule500_9EffectsAddStepsPhaseAdding(Condition),
    ...
    Rule500_10EffectsAddStepPhaseCase(Condition),
    ...
    Rule500_10aEffectSaysStepPhaseTurn(Condition),
    ...
    Rule502_1PermanentsPhasingPhaseTurnBased(Condition),
    ...
    Rule502_2DayCastSpellsNightBased(Condition),
    ...
    Rule502_2aCastSpellBasedActionStack(Condition),
    ...
    Rule502_3PermanentsTurnBasedActionStack,
    ...
    Rule502_4StepSpellsCastResolveAbilities(Condition),
    ...
    Rule503_1UpkeepStepTurnBasedActions,
    ...
    Rule503_1aAbilitiesTriggeredUntapStepStack(Condition),
    ...
    Rule503_2SpellCastPlayersStepTurn(Condition),

    // 504. Draw Step

    // 504.1. First, the active player draws a card. This turn-based action doesn’t use the stack.
    Rule504_1CardTurnBasedActionStack,

    // 504.2. Second, the active player gets priority. (See rule 117, “Timing and Priority.”)
    Rule504_2ActivePlayerPriority,
    ...
    Rule505_1MainPhasesTurnPhaseCombat,
    ...
    Rule505_1aMainPhaseTurnCombatEffect,
    ...
    Rule505_1bCardTextMainPhaseTurn(Condition),
    ...
    Rule505_2MainPhaseStepsEndsStack(Condition),
    ...
    Rule505_3PhaseCardSchemeTurnBased(Condition),
    ...
    Rule505_4PhaseAbilitiesTurnBasedAction(Condition),
    ...
    Rule505_6aMainPhaseCastCreatureSpells,
    ...
    Rule505_6bPhaseCardHandStackTurn(Condition),
    ...
    Rule506_1CombatPhaseDamageCreaturesBattlefield(Condition),
    ...
    Rule506_2CombatPhaseActiveCreaturesAttack,
    ...
    Rule506_2aCombatPhasePlayersVariantOptions(Condition),
    ...
    Rule506_3aEffectNoncreaturePermanentBattlefieldAttacking(Condition),
    ...
    Rule506_3bEffectCreatureBattlefieldAttackingControl(Condition),
    ...
    Rule506_3cEffectCreatureBattlefieldNotPermanent(Condition),
    ...
    Rule506_3dEffectCreatureBattlefieldStepCombat(Condition),
    ...
    Rule506_3eEffectCreatureBattlefieldBlockingBlock(Condition),
    ...
    Rule506_3fEffectCreatureThatsBattlefieldPermanent(Condition),
    ...
    Rule506_3gResolvingSpellAbilityCreatureEffect(Condition),
    ...
    Rule506_4PermanentCombatBattlefieldEffectCreature(Condition),
    ...
    Rule506_4aOnceCreatureSpellsAbilitiesCombat(Condition),
    ...
    Rule506_4bTappingUntappingCreatureCombatDamage,
    ...
    Rule506_4cCreatureAttackingCombatNotDamage(Condition),
    ...
    Rule506_4dPermanentThatsCreatureCombatCard(Condition),
    ...
    Rule506_4ePermanentThatsAttackedCombatNot(Condition),
    ...
    Rule506_5CreatureAttacksAloneDeclaredStep(Condition),
    ...
    Rule506_6AbilitiesNotCreatureAttackCombat(Condition),
    ...
    Rule506_7SpellsStateCastPointCombat,
    ...
    Rule506_7aSpellCastAttackersDeclaredTurn,
    ...
    Rule506_7bSpellCastBlockersDeclaredTurn,
    ...
    Rule506_7cSpellsStateCastCombatPhase(Condition),
    ...
    Rule506_7dSpellsStateCastPointCombat(Condition),
    ...
    Rule506_7eSpellCastPointCombatPhase(Condition),
    ...
    Rule506_7fSpellCastCombatBlockersDeclared(Condition),
    ...
    Rule506_7gAbilitiesStateCombatSpellsCast(Condition),
    ...
    Rule507_1MultiplayerChooseDefendingPlayer(Condition),

    // 507.2. Second, the active player gets priority. (See rule 117, “Timing and Priority.”)
    Rule507_2ActivePlayerPriority,
    ...
    Rule508_1ActiveTurnBasedActionStack(Condition),
    ...
    Rule508_1aActiveCreaturesAttackCantTurn(Condition),
    ...
    Rule508_1bDefendingPlayerControlsAttackCreatures(Condition),
    ...
    Rule508_1cActiveCreatureEffectsCantAttack(Condition),
    ...
    Rule508_1dCreatureEffectsCantCostNot(Condition),
    ...
    Rule508_1eChosenCreaturesBandingBandsAbility(Condition),
    ...
    Rule508_1fActivePlayerTapsCreaturesCost(Condition),
    ...
    Rule508_1gOptionalCostsAttackChosenCreatures(Condition),
    ...
    Rule508_1hCreaturesCostsAttackPermanentsCards(Condition),
    ...
    Rule508_1iCostsRequireManaActivateAbilities(Condition),
    ...
    Rule508_1jOncePlayerEnoughCostsNot,
    ...
    Rule508_2aAbilitiesTriggerCreatureAttackingNot(Condition),
    ...
    Rule508_3aAbilityCreatureAttacksPlayerPlaneswalker(Condition),
    ...
    Rule508_3bAbilityPlayerPlaneswalkerBattleAttacked(Condition),
    ...
    Rule508_3cAbilityReadsPlayerAttacksCreature(Condition),
    ...
    Rule508_3dAbilityReadsPlayerAttacksCreatures(Condition),
    ...
    Rule508_3eAbilityPlayerAttacksCreaturesBattlefield(Condition),
    ...
    Rule508_3fAbilityCreatureAttacksStepNot(Condition),
    ...
    Rule508_4CreatureBattlefieldAttackingEffectTrigger(Condition),
    ...
    Rule508_4aCreatureBattlefieldAttackingPlayerPermanent(Condition),
    ...
    Rule508_4bEffectCreatureResolvesPermanentBattlefield(Condition),
    ...
    Rule508_4cCreatureThatsBattlefieldAttackingStated,
    ...
    Rule508_4dCreatureBattlefieldStepCombatDamage,
    ...
    Rule508_5AbilityAttackingCreatureSpellCombat(Condition),
    ...
    Rule508_5aObjectEffectDefendingPlayerNot(Condition),
    ...
    Rule508_7aAttackingCreatureIsntCombatPermanent,
    ...
    Rule508_7bReselectingPlayerPlaneswalkerBattleCreature,
    ...
    Rule508_7cReselectedPlayerPlaneswalkerBattleCreatures,
    ...
    Rule508_7dMultiplayerGameNotAttackMultiple,
    ...
    Rule508_7eMultiplayerGameLimitedRangeCreatures,
    ...
    Rule508_8CreaturesDeclaredBattlefieldCombatDamage(Condition),
    ...
    Rule509_1DefendingTurnBasedActionStack(Condition),
    ...
    Rule509_1aDefendingPlayerCreaturesBlockCant(Condition),
    ...
    Rule509_1bDefendingCreatureEffectsCantBlock(Condition),
    ...
    Rule509_1cCreatureEffectsBlockCantCost(Condition),
    ...
    Rule509_1dCreaturesCostsBlockPermanentsCards(Condition),
    ...
    Rule509_1eCostsRequireManaActivateAbilities(Condition),
    ...
    Rule509_1fOncePlayerEnoughCostsNot,
    ...
    Rule509_3aAbilityCreatureBlocksCombatEffect(Condition),
    ...
    Rule509_3bAbilityCreatureBlocksEffectBattlefield(Condition),
    ...
    Rule509_3cAbilityCreatureBlockedCombatEffect(Condition),
    ...
    Rule509_3dAbilityCreatureBlockedEffectBattlefield(Condition),
    ...
    Rule509_3eAbilityTriggersCreatureBlocksEffects(Condition),
    ...
    Rule509_3fAbilityTriggersCreatureCharacteristicsEffect(Condition),
    ...
    Rule509_3gAbilityCreatureAttacksBattlefieldCombat(Condition),
    ...
    Rule509_4CreatureBattlefieldBlockingEffectTrigger(Condition),
    ...
    Rule509_4aEffectCreatureBattlefieldBlockingSpecifies(Condition),
    ...
    Rule509_4bCreatureThatsBattlefieldBlockingIsnt,

    // 510. Combat Damage Step

    // 510.1. First, the active player announces how each attacking creature assigns its combat damage, then the defending player announces how each blocking creature assigns its combat damage. This turn-based action doesn’t use the stack. A player assigns a creature’s combat damage according to the following rules:
    Rule510_1CreatureCombatDamageTurnBased,
    ...
    Rule510_1aAttackingCreatureCombatDamageZero(Condition),
    ...
    Rule510_1dBlockingCreatureAssignsCombatDamage(Condition),
    ...
    Rule510_3aAbilitiesDamageStateBasedActions,
    ...
    Rule510_4CreatureCombatDamageStepPhase(Condition),
    ...
    Rule511_1CombatStepTurnBasedActions,
    ...
    Rule511_2AbilitiesTriggerEndCombatStep(Condition),
    ...
    Rule511_3SoonCombatStepCreaturesPhase,

    // 512. Ending Phase

    // 512.1. The ending phase consists of two steps: end and cleanup.
    Rule512_1EndingPhaseConsistsStepsEnd,
    ...
    Rule513_1EndStepTurnBasedActions,
    ...
    Rule513_1aAbilitiesEndStepTriggerTurn(Condition),
    ...
    Rule513_2PermanentAbilityEndStepBattlefield(Condition),
    ...
    Rule601_1ActionCastingSpellCardPlaying,
    ...
    Rule601_1aEffectsPlayingCardLandSpell,
    ...
    Rule601_2CastSpellFromHandOnStack(Condition),
    ...
    Rule601_2aSpellCardStackObjectContinuous,
    ...
    Rule601_2bSpellCardsHandCostsCast(Condition),
    ...
    Rule601_2cObjectTargetSpellCostCast(Condition),

    // 601.2d. If the spell requires the player to divide or distribute an effect (such as damage or counters) among one or more targets, the player announces the division. Each of these targets must receive at least one of whatever is being divided.
    Rule601_2dSpellRequiresPlayerEffectDamage(Condition),
    ...
    Rule601_2eGameChecksProposedSpellCast(Condition),
    ...
    Rule601_2fCostSpellEffectsPermanentsCards(Condition),

    // 601.2g. If the total cost includes a mana payment, the player then has a chance to activate mana abilities (see rule 605, “Mana Abilities”). Mana abilities must be activated before costs are paid.
    Rule601_2gTotalCostIncludesActivateAbilities(Condition),
    ...
    Rule601_2hCostLibraryZoneNotCant,

    // 601.2i. Once the steps described in 601.2a–h are completed, effects that modify the characteristics of the spell as it’s cast are applied, then the spell becomes cast. Any abilities that trigger when a spell is cast or put onto the stack trigger at this time. If the spell’s controller had priority before casting it, they get priority.
    Rule601_2iEffectsSpellCastAbilitiesTrigger(Condition),
    ...
    Rule601_3PlayerCastSpellEffectProhibits(Condition),
    ...
    Rule601_3aEffectProhibitsPlayerSpellCast(Condition),
    ...
    Rule601_3bEffectPlayerCastSpellQualities(Condition),
    ...
    Rule601_3cEffectPlayerCastSpellCost(Condition),
    ...
    Rule601_3dSpellFlashConditionsMetCast(Condition),
    ...
    Rule601_3eEffectsStateCardCastContinuous(Condition),
    ...
    Rule601_3fEffectsCastSpellCardsExile(Condition),
    ...
    Rule601_4AnnouncingChoicesCostsSpellsStep(Condition),
    ...
    Rule601_5PlayerCastSpellEffectCosts(Condition),
    ...
    Rule601_5aOncePlayerCastingSpellCast(Condition),
    ...
    Rule601_6SpellsSpecifyControllersOpponentsCast(Condition),
    ...
    Rule601_6aThanOpponentChoiceSpellsController(Condition),
    ...
    Rule601_6bSpellControllerPlayerTimeCast(Condition),

    // 601.7. Casting a spell that alters costs won’t affect spells and abilities that are already on the stack.
    Rule601_7CastingSpellCostsAbilitiesStack,

    // 602. Activating Activated Abilities

    // 602.1. Activated abilities have a cost and an effect. They are written as “[Cost]: [Effect.] [Activation instructions (if any).]”
    Rule602_1AbilitiesCostEffectActivationInstructions(Condition),
    ...
    Rule602_1aActivationCostEverythingColonAbilitys,
    ...
    Rule602_1bAbilityStateActivateCostNot(Condition),
    ...
    Rule602_1cActivatedAbilityKindObjectActivating(Condition),
    ...
    Rule602_1dActionAbilityCardsPlayingActivating,
    ...
    Rule602_1eSpellAbilityActivationCostEffects(Condition),
    ...
    Rule602_2ActivateAbilityStackCostsResolve(Condition),
    ...
    Rule602_2aAbilityHiddenZoneCardStack(Condition),
    ...
    Rule602_2bRemainderProcessAbilitySpellCost,
    ...
    Rule602_3AbilitiesSpecifyControllersOpponentsActivated(Condition),
    ...
    Rule602_3aThanOpponentChoiceAbilitysController(Condition),
    ...
    Rule602_5aCreaturesAbilityCostCantTurn(Condition),
    ...
    Rule602_5bAbilityActivateOnceTurnObject(Condition),
    ...
    Rule602_5cObjectAcquiresActivatedAbilityRestriction(Condition),
    ...
    Rule602_5dAbilitiesActivateSorcerySpellCard,
    ...
    Rule602_5eAbilitiesActivateInstantSpellCard,

    // 603. Handling Triggered Abilities

    // 603.1. Triggered abilities have a trigger condition and an effect. They are written as “[When/Whenever/At] [trigger condition or event], [effect]. [Instructions (if any).]”
    Rule603_1AbilitiesTriggerConditionEffectEvent(Condition),
    ...
    Rule603_1aAbilityEffectsStateCantNot,
    ...
    Rule603_1bTriggeredAbilityTriggerNotBased,

    // 603.2. Whenever a game event or game state matches a triggered ability’s trigger event, that ability automatically triggers. The ability doesn’t do anything at this point.
    Rule603_2GameEventStateMatchesTrigger(Condition),
    ...
    Rule603_2cAbilityTriggersOnceTimeEvent(Condition),
    ...
    Rule603_2dAbilityStateEffectObjectNot,
    ...
    Rule603_2eTriggerAttachedBlockedStateAbility(Condition),
    ...
    Rule603_2fTriggeredAbilitysTriggerObjectNot(Condition),
    ...
    Rule603_2gAbilityTriggersEventActuallyOccurs(Condition),
    ...
    Rule603_2hAbilityOnceTurnNotAction(Condition),

    // 603.3. Once an ability has triggered, its controller puts it on the stack as an object that’s not a card the next time a player would receive priority. See rule 117, “Timing and Priority.” The ability becomes the topmost object on the stack. It has the text of the ability that created it, and no other characteristics. It remains on the stack until it’s countered, it resolves, a rule causes it to be removed from the stack, or an effect moves it elsewhere.
    Rule603_3AbilityStackObjectNotCard(Condition),
    ...
    Rule603_3aTriggeredAbilityControlledPlayerSource(Condition),
    ...
    Rule603_3bAbilitiesStackApnapTriggerState(Condition),
    ...
    Rule603_3cTriggeredAbilityModalStackCant(Condition),

    // 603.3d. The remainder of the process for putting a triggered ability on the stack is identical to the process for casting a spell listed in rules 601.2c–d. If a choice is required when the triggered ability goes on the stack but no legal choices can be made for it, or if a rule or a continuous effect otherwise makes the ability illegal, the ability is simply removed from the stack.
    Rule603_3dAbilityStackSpellContinuousEffect(Condition),
    ...
    Rule603_6TriggerZonesChangeAbilitiesHidden(Condition),
    ...
    Rule603_6cLeavesBattlefieldAbilitiesTriggerPermanent(Condition),
    ...
    Rule603_6dPermanentsEntersTappedAbilityNot,
    ...
    Rule603_6eAbilitiesTriggerPermanentBattlefieldObject,

    // 603.7. An effect may create a delayed triggered ability that can do something at a later time. A delayed triggered ability will contain “when,” “whenever,” or “at,” although that word won’t usually begin the ability.
    Rule603_7EffectCreateDelayedTriggeredAbility(Condition),
    ...
    Rule603_7aAbilitiesSpellsEffectActionTrigger(Condition),
    ...
    Rule603_7bDelayedTriggeredAbilityTriggerTurn(Condition),
    ...
    Rule603_7cDelayedAbilityObjectZoneResolves(Condition),
    ...
    Rule603_7dSpellCreatesDelayedTriggeredAbility(Condition),
    ...
    Rule603_7eActivatedTriggeredAbilityCreatesDelayed(Condition),
    ...
    Rule603_7fStaticAbilityGeneratesEffectObject(Condition),
    ...
    Rule603_7gStaticAbilityPlayerActionObject(Condition),
    ...
    Rule603_7hActivatedTriggeredAbilityCreateTurn(Condition),
    ...
    Rule603_8AbilitiesTriggerStatePermanentsCard(Condition),
    ...
    Rule603_9TriggeredAbilitiesTriggerSpecificallyPlayer(Condition),

    // 603.10. Normally, objects that exist immediately after an event are checked to see if the event matched any trigger conditions, and continuous effects that exist at that time are used to determine what the trigger conditions are and what the objects involved in the event look like. However, some triggered abilities are exceptions to this rule; the game “looks back in time” to determine if those abilities trigger, using the existence of those abilities and the appearance of objects immediately prior to the event. The list of exceptions is as follows:
    Rule603_10TriggerContinuousEffectsTimeAbilities(Condition),
    ...
    Rule603_10aZoneBattlefieldAbilitiesPermanentCard(Condition),

    // 603.10b. Abilities that trigger when a permanent phases out look back in time.
    Rule603_10bAbilitiesTriggerPermanentPhasesLook(Condition),

    // 603.10c. Abilities that trigger specifically when an object becomes unattached look back in time.
    Rule603_10cAbilitiesTriggerSpecificallyObjectUnattached(Condition),
    ...
    Rule603_11ObjectsStaticAbilityThatsTrigger(Condition),
    ...
    Rule603_12ResolvingSpellAbilityPlayerAction(Condition),
    ...
    Rule603_12aTriggerTimesSpellAbilityResolving(Condition),

    // 604. Handling Static Abilities

    // 604.1. Static abilities do something all the time rather than being activated or triggered. They are written as statements, and they’re simply true.
    Rule604_1StaticAbilitiesTimeRatherThan,
    ...
    Rule604_2AbilitiesContinuousEffectsPermanentBattlefield,
    ...
    Rule604_4AurasEquipmentFortificationsAbilitiesObject(Condition),
    ...
    Rule604_5AbilitiesSpellStackAdditionalCost,
    ...
    Rule604_6AbilitiesCardZoneCastPlay,
    ...
    Rule604_7UnlikeSpellsAbilitiesCantEffects,
    ...
    Rule605_1AbilitiesSpecialEffectsActivateInstant,

    // 605.1a. An activated ability is a mana ability if it meets all of the following criteria: it doesn’t require a target (see rule 115.6), it could add mana to a player’s mana pool when it resolves, and it’s not a loyalty ability. (See rule 606, “Loyalty Abilities.”)
    Rule605_1aActivatedAbilityManaResolvesNot(Condition),
    ...
    Rule605_3ActivatingActivatedManaAbilityExceptions,

    // 605.3a. A player may activate an activated mana ability whenever they have priority, whenever they are casting a spell or activating an ability that requires a mana payment, or whenever a rule or effect asks for a mana payment, even if it’s in the middle of casting or resolving a spell or activating or resolving an ability.
    Rule605_3aActivateAbilitySpellEffectResolving(Condition),

    // 605.3b. An activated mana ability doesn’t go on the stack, so it can’t be targeted, countered, or otherwise responded to. Rather, it resolves immediately after it is activated. (See rule 405.6c.)
    Rule605_3bActivatedAbilityStackCantResolves,

    // 605.3c. Once a player begins to activate a mana ability, that ability can’t be activated again until it has resolved.
    Rule605_3cOncePlayerActivateAbilityCant,
    ...
    Rule605_4TriggeredManaAbilitiesException,
    ...
    Rule605_5aAbilityTargetNotManaResolves(Condition),
    ...
    Rule605_5bSpellManaAbilityResolvesCast(Condition),

    // 606. Loyalty Abilities

    // 606.1. Some activated abilities are loyalty abilities, which are subject to special rules.
    Rule606_1ActivatedAbilitiesLoyaltySubjectSpecial,
    ...
    Rule606_2ActivatedAbilityLoyaltySymbolCost,
    ...
    Rule606_3ActivateAbilityPermanentStackPhase(Condition),
    ...
    Rule606_4CostActivateAbilityPermanentEffects,
    ...
    Rule606_5TotalCostActivateLoyaltyAbility(Condition),
    ...
    Rule606_6LoyaltyAbilityCostCantPermanent(Condition),

    // 607. Linked Abilities

    // 607.1. An object may have two abilities printed on it such that one of them causes actions to be taken or objects or players to be affected and the other one directly refers to those actions, objects, or players. If so, these two abilities are linked: the second refers only to actions that were taken or objects or players that were affected by the first, and not by any other ability.
    Rule607_1ObjectAbilitiesPrintedActionsNot(Condition),
    ...
    Rule607_1aAbilityPrintedObjectGrantsConsidered,
    ...
    Rule607_1dAbilitiesPrintedObjectsPermanentBattlefield(Condition),

    // 607.2. There are different kinds of linked abilities.
    Rule607_2KindsLinkedAbilities,

    // 607.2a. If an object has an activated or triggered ability printed on it that instructs a player to exile one or more cards and an ability printed on it that refers either to “the exiled cards” or to cards “exiled with [this object],” these abilities are linked. The second ability refers only to cards in the exile zone that were put there as a result of an instruction to exile them in the first ability.
    Rule607_2aObjectAbilityExileCardsExiled(Condition),
    ...
    Rule607_2bObjectAbilityReplacementEffectCards(Condition),
    ...
    Rule607_2cObjectActivatedAbilityBattlefieldCreated(Condition),
    ...
    Rule607_2dObjectAbilityChooseValueChosen(Condition),
    ...
    Rule607_2eObjectAbilityPrintedNotedLinked(Condition),
    ...
    Rule607_2fObjectAbilityPrintedCausesPlayer(Condition),
    ...
    Rule607_2gObjectAbilityCostBattlefieldEntered(Condition),
    ...
    Rule607_2hObjectStaticAbilityTriggeredActions(Condition),
    ...
    Rule607_2iObjectAbilityCostCastSpell(Condition),
    ...
    Rule607_2mAbilitiesPrecededAnchorWordLinked,
    ...
    Rule607_2nObjectAbilityExileCardsShuffle(Condition),
    ...
    Rule607_2pObjectStaticAbilityCausesZones(Condition),
    ...
    Rule607_2qPermanentSpellAbilityCardsExiled(Condition),
    ...
    Rule607_3AbilitiesObjectExiledCardActions(Condition),

    // 607.4. An ability may be part of more than one pair of linked abilities.
    Rule607_4AbilityThanPairLinked,
    ...
    Rule607_5ObjectAcquiresAbilitiesEffectCant(Condition),
    ...
    Rule608_2ObjectThatsResolvingSpellAbility(Condition),
    ...
    Rule608_2aTriggeredAbilityInterveningStackResolve(Condition),
    ...
    Rule608_2dEffectSpellAbilityStackCant(Condition),
    ...
    Rule608_2eSpellsAbilitiesMultipleActionsApnap,
    ...
    Rule608_2fSpellsAbilitiesActionsCantApnap(Condition),
    ...
    Rule608_2gEffectActivateAbilitiesActionCast(Condition),
    ...
    Rule608_2hEffectCreaturesBattlefieldObjectAbility(Condition),
    ...
    Rule608_2iEffectsActionsStateObjectNot(Condition),
    ...
    Rule608_2jEffectCharacteristicsChecksValueObject(Condition),
    ...
    Rule608_2kAbilitysEffectObjectCostTrigger(Condition),
    ...
    Rule608_2mInstantSpellAbilityResolveStack(Condition),
    ...
    Rule608_2nFinalInstantSpellsGraveyardStack,
    ...
    Rule608_2pNAbilitiesTriggerSpellResolves(Condition),
    ...
    Rule608_3ObjectThatsResolvingPermanentSpell(Condition),
    ...
    Rule608_3aObjectResolvingPermanentBattlefieldSpells(Condition),
    ...
    Rule608_3bObjectResolvingSpellCreatureResolve(Condition),
    ...
    Rule608_3cObjectResolvingSpellPermanentBattlefield(Condition),
    ...
    Rule608_3dObjectResolvingCreatureSpellPermanent(Condition),
    ...
    Rule608_3ePermanentSpellResolvesCantBattlefield(Condition),
    ...
    Rule608_3fObjectResolvingPermanentSpellBattlefield(Condition),
    ...
    Rule608_3gObjectResolvingAbilityStackPermanent(Condition),
    ...
    Rule609_1EffectSpellAbilityResolvesContinuous(Condition),
    ...
    Rule609_2EffectsApplyPermanentsInstructionsZones(Condition),

    // 609.3. If an effect attempts to do something impossible, it does only as much as possible.
    Rule609_3EffectAttemptsImpossibleMuchPossible(Condition),
    ...
    Rule609_4EffectsStatePlayerConditionCreature(Condition),
    ...
    Rule609_4aEffectsStatePlayerCreatureThing(Condition),
    ...
    Rule609_4bEffectManaTypeColorCost(Condition),
    ...
    Rule609_7EffectsDamageSourceNextTime(Condition),
    ...
    Rule609_7aEffectDamagePermanentSpellStack(Condition),
    ...
    Rule609_7bEffectsSpellsAbilitiesDamageCreature(Condition),
    ...
    Rule609_7cEffectsAbilitiesDamagePermanentsBattlefield,
    ...
    Rule610_1EffectDamagePermanentObjectZone,
    ...
    Rule610_2ShotEffectsAbilitySpellResolves(Condition),

    // 610.3. Some one-shot effects cause an object to change zones “until” a specified event occurs. A second one-shot effect is created immediately after the specified event. This second one-shot effect returns the object to its previous zone.
    Rule610_3ShotEffectsCauseObjectZones,
    ...
    Rule610_3aResolvingSpellAbilityEffectObject(Condition),
    ...
    Rule610_3dMultipleShotEffectsCreatedWay(Condition),
    ...
    Rule610_4ShotEffectsCausePermanentPhase,
    ...
    Rule610_4aPermanentPhaseTurnBasedAction(Condition),
    ...
    Rule610_4bResolvingSpellAbilityEffectPermanent(Condition),
    ...
    Rule610_4cResolvingAbilityEffectPermanentPhase(Condition),
    ...
    Rule610_4dMultipleShotEffectsCreatedWay(Condition),
    ...
    Rule610_5StaticAbilitiesEffectsSpellsStack(Condition),

    // 611. Continuous Effects

    // 611.1. A continuous effect modifies characteristics of objects, modifies control of objects, or affects players or the rules of the game, for a fixed or indefinite period.
    Rule611_1ContinuousEffectModifiesCharacteristicsObjects,

    // 611.2. A continuous effect may be generated by the resolution of a spell or ability.
    Rule611_2ContinuousEffectGeneratedSpellAbility,

    // 611.2a. A continuous effect generated by the resolution of a spell or ability lasts as long as stated by the spell or ability creating it (such as “until end of turn”). If no duration is stated, it lasts until the end of the game.
    Rule611_2aContinuousEffectSpellAbilityEnd(Condition),
    ...
    Rule611_2bContinuousEffectsSpellAbilityLong(Condition),
    ...
    Rule611_2cContinuousEffectGeneratedSpellAbility(Condition),
    ...
    Rule611_2dResolvingSpellAbilityContinuousEffect(Condition),
    ...
    Rule611_2eResolvingSpellAbilityPermanentBattlefield(Condition),
    ...
    Rule611_2fSpellsAbilitiesContinuousEffectNot(Condition),

    // 611.3. A continuous effect may be generated by the static ability of an object.
    Rule611_3ContinuousEffectGeneratedAbilityObject,
    ...
    Rule611_3aContinuousEffectGeneratedAbilityLocked(Condition),
    ...
    Rule611_3bEffectPermanentBattlefieldObjectZone(Condition),
    ...
    Rule611_3cContinuousEffectsPermanentsBattlefieldAbility(Condition),
    ...
    Rule611_3dContinuousEffectsAbilitiesCastPermanent(Condition),
    ...
    Rule612_1ContinuousEffectsChangeObjectsText,
    ...
    Rule612_2TextEffectCreatureCantCard(Condition),
    ...
    Rule612_2aSpellsAbilitiesCreatureEffectObject,
    ...
    Rule612_3EffectsAddRemoveAbilitiesCant,
    ...
    Rule612_4TokensSubtypesSpellAbilityEffect,
    ...
    Rule612_5CardExchangeWordsPlayerText,
    ...
    Rule612_6CardObjectFullTextNot,
    ...
    Rule612_7CardObjectNamesNonlegendaryCreature,
    ...
    Rule612_8CardsCreateContinuousEffectObject,
    ...
    Rule612_9StickerPermanentCardNotBattlefield,
    ...
    Rule612_10SpliceAbilityChangesSpellsCard,

    // 613. Interaction of Continuous Effects

    // 613.1. The values of an object’s characteristics are determined by starting with the actual object. For a card, that means the values of the characteristics printed on that card. For a token or a copy of a spell or card, that means the values of the characteristics defined by the effect that created it. Then all applicable continuous effects are applied in a series of layers in the following order:
    Rule613_1CardSpellEffectContinuousLayers,

    // 613.1a. Layer 1: Rules and effects that modify copiable values are applied.
    Rule613_1aLayerEffectsModifyCopiableValues,

    // 613.1b. Layer 2: Control-changing effects are applied.
    Rule613_1bLayerControlChangingEffectsApplied,

    // 613.1c. Layer 3: Text-changing effects are applied. See rule 612, “Text-Changing Effects.”
    Rule613_1cLayerTextChangingEffectsApplied,

    // 613.1d. Layer 4: Type-changing effects are applied. These include effects that change an object’s card type, subtype, and/or supertype.
    Rule613_1dLayerTypeChangingEffectsCard,

    // 613.1e. Layer 5: Color-changing effects are applied.
    Rule613_1eLayerColorChangingEffectsApplied,

    // 613.1f. Layer 6: Ability-adding effects, keyword counters, ability-removing effects, and effects that say an object can’t have an ability are applied.
    Rule613_1fLayerAbilityEffectsObjectCant,

    // 613.1g. Layer 7: Power- and/or toughness-changing effects are applied.
    Rule613_1gLayerPowerToughnessChangingEffects,
    ...
    Rule613_2LayerApplyEffectsSublayersTimestamp,
    ...
    Rule613_2cEffectsLayerAppliedObjectsCharacteristics,
    ...
    Rule613_3LayersApplyEffectsAbilitiesTimestamp,
    ...
    Rule613_4LayerApplyEffectsSublayersTimestamp,
    ...
    Rule613_4aLayer7aEffectsCharacteristicAbilities,
    ...
    Rule613_4bLayer7bEffectsSetCreature,
    ...
    Rule613_4cLayer7cEffectsCountersModify,
    ...
    Rule613_4dLayer7dEffectsSwitchCreatures,
    ...
    Rule613_5ApplicationContinuousEffectsLayerSystem,
    ...
    Rule613_6EffectAppliedLayersSublayersAbility(Condition),
    ...
    Rule613_7LayerSublayerOrderEffectsTimestamp,
    ...
    Rule613_7aContinuousEffectAbilityTimestampObject(Condition),
    ...
    Rule613_7bContinuousEffectSpellAbilityTimestamp(Condition),
    ...
    Rule613_7jConspiracyCardReceivesTimestampGame(Condition),
    ...
    Rule613_7kStickerTimestampObjectPermanentBattlefield(Condition),
    ...
    Rule613_7mObjectsTimestampZoneApnapTurn(Condition),
    ...
    Rule613_7nContinuousEffectAbilityObjectResolving(Condition),
    ...
    Rule613_8LayerSublayerOrderEffectsTimestamp(Condition),

    // 613.8a. An effect is said to “depend on” another if (a) it’s applied in the same layer (and, if applicable, sublayer) as the other effect; (b) applying the other would change the text or the existence of the first effect, what it applies to, or what it does to any of the things it applies to; and (c) neither effect is from a characteristic-defining ability or both effects are from characteristic-defining abilities. Otherwise, the effect is considered to be independent of the other effect.
    Rule613_8aEffectDependLayerSublayerAbility(Condition),
    ...
    Rule613_8bEffectDependentWaitsTimestampIgnored(Condition),
    ...
    Rule613_8cEffectAppliedOrderReevaluatedNot(Condition),
    ...
    Rule613_9ContinuousEffectOverrideSometimesResults,

    // 613.10. Some continuous effects affect players rather than objects. All such effects are applied in timestamp order after the determination of objects’ characteristics. See also the rules for timestamp order and dependency (rules 613.7 and 613.8).
    Rule613_10ContinuousEffectsAffectPlayersTimestamp,
    ...
    Rule613_11ContinuousEffectsCostsSpellsAbilities,

    // 614. Replacement Effects

    // 614.1. Some continuous effects are replacement effects. Like prevention effects (see rule 615), replacement effects apply continuously as events happen—they aren’t locked in ahead of time. Such effects watch for a particular event that would happen and completely or partially replace that event with a different event. They act like “shields” around whatever they’re affecting.
    Rule614_1ContinuousEffectsReplacementLikeShields(Condition),

    // 614.1a. Effects that use the word “instead” are replacement effects. Most replacement effects use the word “instead” to indicate what events will be replaced with other events.
    Rule614_1aEffectsWordReplacementIndicateEvents(Condition),
    ...
    Rule614_1bEffectsWordSkipReplacementIndicate,
    ...
    Rule614_3SpecialRestrictionsSpellAbilityEffect,
    ...
    Rule614_4EffectsCantTimeSpellsAbilities(Condition),
    ...
    Rule614_5ReplacementEffectDoesntInvokeItself,

    // 614.6. If an event is replaced, it never happens. A modified event occurs instead, which may in turn trigger abilities. Note that the modified event may contain instructions that can’t be carried out, in which case the impossible instruction is simply ignored.
    Rule614_6TurnTriggerAbilitiesCantIgnored(Condition),
    ...
    Rule614_7ReplacementEffectReplaceEventHappens(Condition),
    ...
    Rule614_7aZeroDamageNotEffectsObject(Condition),
    ...
    Rule614_8EffectCardRegeneratePermanentNext(Condition),
    ...
    Rule614_9EffectsDamageCreaturePermanentsBattlefield(Condition),
    ...
    Rule614_10EffectSkipStepPhaseTurn(Condition),
    ...
    Rule614_10aStepPhaseTurnNextEffects(Condition),
    ...
    Rule614_10bEffectsStepPhaseTurnAction,
    ...
    Rule614_11EffectsReplaceCardDrawsLibrary(Condition),
    ...
    Rule614_11aEffectReplacesDrawCardActions(Condition),
    ...
    Rule614_11bEffectPlayerCardActionNot(Condition),
    ...
    Rule614_12EffectsPermanentBattlefieldContinuousAbilities(Condition),
    ...
    Rule614_12aReplacementEffectModifiesPermanentBattlefield(Condition),
    ...
    Rule614_12bEffectsPermanentsBattlefieldNotCosts(Condition),
    ...
    Rule614_13aEffectPermanentBattlefieldZonesCant(Condition),
    ...
    Rule614_13bObjectCantZonesEffectsPermanents(Condition),
    ...
    Rule614_13cEffectPermanentBattlefieldCardsExile,
    ...
    Rule614_14ObjectAbilityEffectCardsExiled(Condition),
    ...
    Rule614_15EffectsNotContinuousResolvingSpell(Condition),
    ...
    Rule614_17cEventCantHappenReplacedEffect(Condition),
    ...
    Rule614_17dCantEffectsPermanentBattlefieldContinuous(Condition),
    ...
    Rule615_1ContinuousEffectsPreventionDamageShields(Condition),
    ...
    Rule615_1aEffectsWordPreventDamageNot,

    // 615.2. Many prevention effects apply to damage from a source. See rule 609.7.
    Rule615_2PreventionEffectsApplyDamageSource,
    ...
    Rule615_3SpecialRestrictionsSpellAbilityEffect,
    ...
    Rule615_4EffectsDamageCantTimeSpells(Condition),
    ...
    Rule615_5PreventionEffectsIncludeAdditionalDamage(Condition),
    ...
    Rule615_6DamageTurnTriggerAbilitiesCant(Condition),
    ...
    Rule615_7EffectsSpellAbilityDamagePrevent(Condition),
    ...
    Rule615_8PreventionEffectsSpellAbilityDamage(Condition),
    ...
    Rule615_9EffectsGeneratedSpellAbilityDamage(Condition),
    ...
    Rule615_10EffectsAbilitiesDamageSourceDeal(Condition),
    ...
    Rule615_11EffectsNDamageCreaturesSpell(Condition),
    ...
    Rule615_12EffectsStateDamageCantPrevented(Condition),
    ...
    Rule615_12aPreventionEffectAppliedUnpreventableDamage,
    ...
    Rule615_13TriggeredAbilitiesTriggerDamageEffect(Condition),

    // 616. Interaction of Replacement and/or Prevention Effects

    // 616.1. If two or more replacement and/or prevention effects are attempting to modify the way an event affects an object or player, the affected object’s controller (or its owner if it has no controller) or the affected player chooses one to apply, following the steps listed below. If two or more players have to make these choices at the same time, choices are made in APNAP order (see rule 101.4).
    Rule616_1ReplacementPreventionEffectsObjectApnap(Condition),
    ...
    Rule616_1aReplacementPreventionEffectsSelfNot(Condition),
    ...
    Rule616_1bReplacementEffectsObjectBattlefieldNot(Condition),
    ...
    Rule616_1cReplacementEffectsObjectBattlefieldNot(Condition),
    ...
    Rule616_1dReplacementEffectsCardBattlefieldNot(Condition),

    // 616.1e. Any of the applicable replacement and/or prevention effects may be chosen.
    Rule616_1eApplicableReplacementPreventionEffectsChosen,
    ...
    Rule616_1fOnceChosenEffectAppliedProcess(Condition),
    ...
    Rule616_2ReplacementPreventionEffectApplicableEvent,
    ...
    Rule700_1AnythingSpellAbilityEffectsHappening,
    ...
    Rule700_2SpellAbilityModalChooseCards(Condition),
    ...
    Rule700_2aControllerModalSpellAbilityCant(Condition),
    ...
    Rule700_2bControllerModalAbilityStackCant(Condition),
    ...
    Rule700_2cSpellAbilityTargetsModeNot(Condition),
    ...
    Rule700_2dChooseThanModeSpellAbility(Condition),
    ...
    Rule700_2eSpellsAbilitiesSpecifyPlayerThan(Condition),
    ...
    Rule700_2fModalSpellsAbilitiesTargetingCant,
    ...
    Rule700_2gCopyModalSpellAbilityCant,
    ...
    Rule700_2hModalSpellsCostEffectCast(Condition),
    ...
    Rule700_3cObjectsGroupedZoneCardsGraveyard(Condition),

    // 700.3d. A pile can contain zero or more objects.
    Rule700_3dPileContainZeroObjects,

    // 700.4. The term dies means “is put into a graveyard from the battlefield.”
    Rule700_4TermDiesGraveyardBattlefield,
    ...
    Rule700_5PlayersDevotionColorCostsPermanents,
    ...
    Rule700_7AbilityPhraseIdentifyObjectCharacteristic(Condition),
    ...
    Rule700_8CardsPlayersPartyConsistsCreature,
    ...
    Rule700_8aSpellAbilityEffectCreaturesZero(Condition),
    ...
    Rule700_8bCreatureMultipleTypesPartyMember(Condition),

    // 700.8c. A player has a full party if there are four creatures in that player’s party.
    Rule700_8cPlayerFullPartyCreatures(Condition),
    ...
    Rule700_8dCardStickPlayersChooseCreatures,
    ...
    Rule700_9CardsModifiedPermanentsCountersEquipped(Condition),
    ...
    Rule700_10CardsPermanentActivatedTurnAbility,
    ...
    Rule700_12aCardsOutlawsPlayerPermanentsEffects(Condition),
    ...
    Rule700_13CardsSpellAbilityStackPermanent(Condition),
    ...
    Rule700_14AbilitiesTriggerExpendNCost(Condition),

    // 700.15. The term enter[s] is short for “enter[s] the battlefield.”
    Rule700_15TermEnterShortBattlefield,
    ...
    Rule701_1ActionsCardsTextNotKeywords,
    ...
    Rule701_2aActivateActivatedAbilityStackCosts(Condition),
    ...
    Rule701_3aAttachObjectPermanentBattlefieldCant(Condition),
    ...
    Rule701_3bEffectTriesAttachObjectCant(Condition),
    ...
    Rule701_3cAttachingAuraBattlefieldObjectTimestamp,
    ...
    Rule701_3dUnattachCreatureBattlefieldNotObject(Condition),
    ...
    Rule701_4aBeholdQualityRevealCardHand,
    ...
    Rule701_4bQualityBeheldNotObjectAction(Condition),
    ...
    Rule701_5aCastSpellZoneHandStack(Condition),

    // 701.5b. To cast a card is to cast it as a spell.
    Rule701_5bCastCardSpell,
    ...
    Rule701_6aSpellAbilityStackResolveEffects,
    ...
    Rule701_6bCastSpellAbilityRefundCosts,
    ...
    Rule701_7aCreateTokensCharacteristicsSpecifiedBattlefield,
    ...
    Rule701_7bReplacementEffectAppliesContinuousBattlefield(Condition),
    ...
    Rule701_7cEffectTokensBattlefieldCardsCreate,

    // 701.8. Destroy
    Rule701_8Destroy,

    // 701.8a. To destroy a permanent, move it from the battlefield to its owner’s graveyard.
    Rule701_8aDestroyPermanentMoveBattlefieldGraveyard,
    ...
    Rule701_9bDefaultEffectsCausePlayerCard,
    ...
    Rule701_9cCardEffectHiddenZoneGraveyard(Condition),
    ...
    Rule701_10aDoublingCreaturesPowerContinuousEffect,
    ...
    Rule701_10bCreaturesXZeroSpellAbility,
    ...
    Rule701_10cCreaturesPowerThanZeroX(Condition),
    ...
    Rule701_10dDoublePlayersLifeTotalGains,
    ...
    Rule701_10eDoubleNumberKindCountersPermanent,
    ...
    Rule701_10fDoubleAmountTypeManaPlayers,
    ...
    Rule701_10gDoubleAmountDamageSourceEffect(Condition),
    ...
    Rule701_11aTriplingCreaturesPowerContinuousEffect,
    ...
    Rule701_11bCreaturesXZeroSpellAbility,
    ...
    Rule701_11cCreaturesPowerThanZeroX(Condition),
    ...
    Rule701_12aSpellAbilityPermanentsResolvesCant(Condition),
    ...
    Rule701_12bControlPermanentsExchangedHandEffect(Condition),
    ...
    Rule701_12cLifeEffectsAbilitiesTriggerCant(Condition),
    ...
    Rule701_12dSpellsAbilitiesExchangeCardsZone(Condition),
    ...
    Rule701_12eCardZoneExchangedAttachedObject(Condition),
    ...
    Rule701_12fSpellAbilityPlayerZonesCards(Condition),
    ...
    Rule701_12gSpellAbilityEffectsTriggerCant(Condition),
    ...
    Rule701_14aSpellAbilityCreatureFightDamage,
    ...
    Rule701_14bCreaturesBattlefieldDamageResolvingSpell(Condition),

    // 701.14c. If a creature fights itself, it deals damage to itself equal to twice its power.
    Rule701_14cCreatureFightsItselfDealsDamage(Condition),

    // 701.14d. The damage dealt when a creature fights isn’t combat damage.
    Rule701_14dDamageDealtCreatureFightsCombat(Condition),
    ...
    Rule701_15aSpellsAbilitiesGoadCreatureTurn,
    ...
    Rule701_15bPermanentCreatureCombatSpellAbility(Condition),

    // 701.15c. A creature can be goaded by multiple players. Doing so creates additional combat requirements.
    Rule701_15cCreatureGoadedMultiplePlayersCombat,
    ...
    Rule701_15dOncePlayerCreatureEffectCombat,

    // 701.16. Investigate
    Rule701_16Investigate,

    // 701.16a. “Investigate” means “Create a Clue token.” See rule 111.10f.
    Rule701_16aInvestigateCreateClueToken10f,
    ...
    Rule701_17aPlayerMillCardsLibraryGraveyard,
    ...
    Rule701_17bCantCardsLibraryActionCost(Condition),
    ...
    Rule701_17cEffectMilledCardZoneLibrary,
    ...
    Rule701_17dSpellsAbilitiesCardEffectsCast(Condition),
    ...
    Rule701_18cEffectsPlayTopCardLibrary,
    ...
    Rule701_18dActionCastingSpellCardPlaying,
    ...
    Rule701_18eActionAbilityCardsPlayingActivating,

    // 701.19. Regenerate
    Rule701_19Regenerate,
    ...
    Rule701_19aEffectResolvingSpellAbilityPermanent(Condition),
    ...
    Rule701_19bEffectAbilityPermanentRemoveDamage(Condition),
    ...
    Rule701_19cAbilitySpellPermanentEffectsCant,
    ...
    Rule701_20dCardsPlayersLibraryShuffledOtherwise(Condition),
    ...
    Rule701_20eEffectsPlayerLookCardsLooking(Condition),
    ...
    Rule701_21aPermanentBattlefieldGraveyardCantEffects,
    ...
    Rule701_22aScryNLookCardsLibrary(Condition),
    ...
    Rule701_22bPlayerScryZeroAbilitiesTrigger(Condition),
    ...
    Rule701_22cMultiplePlayersCardsLibraryApnap(Condition),
    ...
    Rule701_22dAbilityTriggersPlayerScriesActions(Condition),
    ...
    Rule701_23aSearchCardZoneLookHidden(Condition),
    ...
    Rule701_23bPlayerSearchingHiddenZoneCards(Condition),
    ...
    Rule701_23cPlayerHiddenZoneCardsCant(Condition),
    ...
    Rule701_23dPlayerSearchingHiddenZoneCards(Condition),
    ...
    Rule701_23eEffectSearchInstructionCardNot(Condition),
    ...
    Rule701_23fSearchingZoneAbilitiesTriggerLibrary(Condition),
    ...
    Rule701_23gEffectOffersZoneActionsCards(Condition),
    ...
    Rule701_23hEffectPlayerSearchLibraryCards,
    ...
    Rule701_23iMultiplePlayersSearchCardsApnap(Condition),
    ...
    Rule701_23jEffectPlayerSearchOutsideCard(Condition),
    ...
    Rule701_24aShuffleLibraryFacePileCards,
    ...
    Rule701_24bEffectsLibraryCardZoneAbilities(Condition),
    ...
    Rule701_24cEffectCausePlayerLibraryZone(Condition),
    ...
    Rule701_24dEffectCausePlayerShuffleLibrary(Condition),
    ...
    Rule701_24eEffectLibraryZeroCardsAbilities(Condition),
    ...
    Rule701_24fEffectsCauseLibraryAbilitiesTrigger(Condition),
    ...
    Rule701_24gEffectCausePlayerLibraryObject(Condition),
    ...
    Rule701_25aSurveilNCardsLibraryGraveyard(Condition),
    ...
    Rule701_25bEffectLookCardsGraveyardLibrary(Condition),
    ...
    Rule701_25cPlayerSurveilZeroAbilitiesTrigger(Condition),
    ...
    Rule701_25dAbilityTriggersPlayerSurveilsActions(Condition),
    ...
    Rule701_26aTapPermanentTurnSidewaysUpright,
    ...
    Rule701_26bUntapPermanentRotateUprightPosition,
    ...
    Rule701_27aTransformPermanentTurnFaceCards,
    ...
    Rule701_27bTransformingPermanentActionAbilitiesTrigger(Condition),
    ...
    Rule701_27cSpellAbilityPlayerPermanentCard(Condition),
    ...
    Rule701_27dSpellAbilityPlayerTransformPermanent(Condition),
    ...
    Rule701_27eTriggeredAbilitiesTriggerObjectTransforms(Condition),
    ...
    Rule701_27fActivatedAbilityPermanentStackIgnored(Condition),
    ...
    Rule701_27gSpellsAbilitiesTransformedPermanentBattlefield(Condition),
    ...
    Rule701_28aConvertPermanentTurnFace27a,
    ...
    Rule701_28bConvertingPermanentActionAbilitiesTrigger(Condition),
    ...
    Rule701_28cSpellAbilityPlayerPermanentCard(Condition),
    ...
    Rule701_28dSpellAbilityPlayerConvertPermanent(Condition),
    ...
    Rule701_28eActivatedAbilityPermanentStackIgnored(Condition),

    // 701.28f. If a spell or ability states that a permanent can’t transform, that permanent also can’t convert.
    Rule701_28fSpellAbilityPermanentCantTransform(Condition),
    ...
    Rule701_29aFatesealNLookCardsLibrary(Condition),
    ...
    Rule701_30cClashingPlayerCardLibraryApnap(Condition),
    ...
    Rule701_30dPlayerWinsClashRevealedCard(Condition),

    // 701.31. Planeswalk
    Rule701_31Planeswalk,
    ...
    Rule701_31aPlayerPlaneswalkPlanechaseGamePlanar,
    ...
    Rule701_31bPlaneswalkFacePlaneCardTurn,

    // 701.31c. A player may planeswalk as the result of the “planeswalking ability” (see rule 901.8), because the owner of a face-up plane card or phenomenon card leaves the game (see rule 901.10), or because a phenomenon’s triggered ability leaves the stack (see rule 704.6f). Abilities may also instruct a player to planeswalk.
    Rule701_31cPlayerPlaneswalkingAbilityCardStack,
    ...
    Rule701_31dPlaneCardThatsTurnedFace,
    ...
    Rule701_32aSchemeCardSetMotionArchenemy,
    ...
    Rule701_32bSetSchemeMotionTurnActions(Condition),
    ...
    Rule701_32cSchemesSetMotionTimePlayer(Condition),
    ...
    Rule701_33aFaceOngoingSchemeCardArchenemy,

    // 701.33b. To abandon a scheme, turn it face down and put it on the bottom of its owner’s scheme deck.
    Rule701_33bAbandonSchemeTurnFaceBottom,

    // 701.34. Proliferate
    Rule701_34Proliferate,
    ...
    Rule701_34aProliferateChooseNumberPermanentsPlayers,
    ...
    Rule701_34bHeadedGiantGamePoisonVariant(Condition),
    ...
    Rule701_37bActionSpellsAbilitiesPermanentsBattlefield,
    ...
    Rule701_37cPermanentsAbilityPlayerMonstrosityX(Condition),
    ...
    Rule701_38aSpellsAbilitiesPlayersEffectTurn,
    ...
    Rule701_38bListedChoicesEffectSpellAbility,
    ...
    Rule701_38cSpellAbilityVotingVoteNot(Condition),
    ...
    Rule701_38dEffectPlayerMultipleVotesHappen(Condition),
    ...
    Rule701_39aBolsterNChooseCreatureControl,
    ...
    Rule701_40aCardTurnCreatureCostBattlefield(Condition),
    ...
    Rule701_40bTurnPermanentSpecialActionStack(Condition),
    ...
    Rule701_40cCardMorphManifestedTurnPermanent(Condition),
    ...
    Rule701_40dCardDisguiseManifestedTurnPermanent(Condition),
    ...
    Rule701_40eEffectPlayerManifestCardsLibrary(Condition),
    ...
    Rule701_40fEffectCardObjectBattlefieldZone(Condition),
    ...
    Rule701_40gPermanentCardTurnAbilitiesTrigger(Condition),

    // 701.40h. See rule 708, “Face-Down Spells and Permanents,” for more information.
    Rule701_40hFaceSpellsPermanents,
    ...
    Rule701_41aSupportNPermanentCounterTarget,
    ...
    Rule701_42aActionAbilityCardBattlefieldPermanent,
    ...
    Rule701_43bPermanentNotTurnStepEffect(Condition),

    // 701.43c. An object that isn’t on the battlefield can’t be exerted.
    Rule701_43cObjectIsntBattlefieldCantExerted,
    ...
    Rule701_43dExertCreatureAttacksCostAbility(Condition),
    ...
    Rule701_44aSpellsAbilitiesPermanentCardLibrary(Condition),
    ...
    Rule701_44bPermanentExploresProcess44aActions(Condition),
    ...
    Rule701_44cPermanentChangesZonesEffectObject(Condition),
    ...
    Rule701_44dMultiplePermanentsExploreApnapBattlefield(Condition),
    ...
    Rule701_45aAssembleKeywordActionBattlefieldCards,

    // 701.46. Adapt
    Rule701_46Adapt,

    // 701.46a. “Adapt N” means “If this permanent has no +1/+1 counters on it, put N +1/+1 counters on it.”
    Rule701_46aAdaptNPermanentCounters(Condition),
    ...
    Rule701_47aAmassSubtypeNCreatureZero(Condition),
    ...
    Rule701_47bPlayerAmassedProcess47aActions(Condition),
    ...
    Rule701_47cPhrasesArmyAmassedCreatureNot,
    ...
    Rule701_47dOlderCardsAmassNZombies,
    ...
    Rule701_48aLearnDiscardCardDrawHand(Condition),

    // 701.49. Venture into the Dungeon
    Rule701_49VentureIntoDungeon,
    ...
    Rule701_49aPlayerVentureDungeonCardZone(Condition),
    ...
    Rule701_49bPlayerVentureDungeonMarkerCards(Condition),
    ...
    Rule701_49cPlayerVentureDungeonCardZone(Condition),
    ...
    Rule701_49dVentureQualityVariantCardZone(Condition),
    ...
    Rule701_50aSpellsAbilitiesPermanentConniveCard(Condition),
    ...
    Rule701_50bPermanentConnivesProcess50aActions(Condition),
    ...
    Rule701_50cPermanentChangesZonesEffectObject(Condition),
    ...
    Rule701_50dMultiplePermanentsConniveApnapBattlefield(Condition),
    ...
    Rule701_50eConniveNVariantPermanentsCards,

    // 701.51. Open an Attraction
    Rule701_51OpenAttraction,
    ...
    Rule701_51aPlayerOpenAttractionGamePlaying,
    ...
    Rule701_51bOpenAttractionCardTurnBattlefield,
    ...
    Rule701_51cAbilityTriggersCardBattlefieldEffect(Condition),

    // 701.52. Roll to Visit Your Attractions
    Rule701_52RollVisitAttractions,
    ...
    Rule701_53bTokenColorlessTransformZeroPhyrexian,

    // 701.54. The Ring Tempts You
    Rule701_54RingTempts,
    ...
    Rule701_54cPlayerRingCreatureBearerLegendary(Condition),
    ...
    Rule701_54dAbilitiesTriggerRingTemptsActions(Condition),
    ...
    Rule701_54eAbilitiesCreatureRingBearerBattlefield(Condition),

    // 701.55. Face a Villainous Choice
    Rule701_55FaceVillainousChoice,
    ...
    Rule701_55aPlayerFacesVillainousChoiceOption,
    ...
    Rule701_55bFacingVillainousChoicePlayerAction,
    ...
    Rule701_55cReplacementEffectReplaceInstructionFace(Condition),
    ...
    Rule701_55dThanPlayerFaceVillainousApnap(Condition),

    // 701.56. Time Travel
    Rule701_56TimeTravel,
    ...
    Rule701_56aTimePermanentsCardsExileSuspend,
    ...
    Rule701_57aDiscoverNExileCardsTop(Condition),
    ...
    Rule701_57bPlayerDiscoveredProcess57aActions(Condition),
    ...
    Rule701_57cCardNDiscoveredCastHand(Condition),
    ...
    Rule701_58aCardTurnCreatureCostBattlefield(Condition),
    ...
    Rule701_58bTurnPermanentSpecialActionStack(Condition),
    ...
    Rule701_58cCardMorphCloakedTurnPermanent(Condition),
    ...
    Rule701_58dCardDisguiseCloakedTurnPermanent(Condition),
    ...
    Rule701_58eEffectPlayerCloakCardsLibrary(Condition),
    ...
    Rule701_58fEffectCardObjectBattlefieldZone(Condition),
    ...
    Rule701_59bExileCardsNGraveyardCant(Condition),
    ...
    Rule701_59cSpellAbilityCostCastLinked,
    ...
    Rule701_60aSpellsAbilitiesPlayerCreatureBattlefield,
    ...
    Rule701_62aManifestDreadLookTopCards(Condition),
    ...
    Rule701_62bAbilityTriggersPlayerManifestsActions(Condition),
    ...
    Rule701_63aAbilitiesPermanentEndureNCreature(Condition),
    ...
    Rule701_63bPermanentEndureZeroNothingHappens(Condition),

    // 701.64. Harness
    Rule701_64Harness,

    // 701.64a. “Harness [this permanent]” means “If this permanent isn’t harnessed, it becomes harnessed.”
    Rule701_64aHarnessPermanentIsntHarnessed(Condition),
    ...
    Rule701_64bHarnessedSpellsAbilitiesPermanentsBattlefield,
    ...
    Rule701_65aSpellsAbilitiesPermanentsCardCast,
    ...
    Rule701_65bAbilityTriggersPlayerAirbendsExiles(Condition),
    ...
    Rule701_66aEarthbendNTargetLandControl(Condition),
    ...
    Rule701_66bAbilityTriggersPlayerEarthbendsDelayed(Condition),
    ...
    Rule701_67aWaterbendCostPayGenericMana,
    ...
    Rule701_67bCostCastSpellActivateAbility(Condition),
    ...
    Rule701_67cAbilityTriggersPlayerWaterbendsCost(Condition),

    // 701.68. Blight
    Rule701_68Blight,

    // 701.68a. To “blight N” means to put N -1/-1 counters on a creature you control.
    Rule701_68aBlightNCountersCreatureControl,
    ...
    Rule701_68bPlayerChoiceNCreatureCant(Condition),
    ...
    Rule701_68cSpellsAbilitiesBlightedCreatureObject(Condition),
    ...
    Rule701_68dAbilityTriggersPlayerBlightsProcess(Condition),
    ...
    Rule702_1bEffectObjectAbilityBasedState,
    ...
    Rule702_1cEffectStateTrueListAbilities(Condition),
    ...
    Rule702_1dEffectObjectKeywordAbilityThing,

    // 702.2. Deathtouch
    Rule702_2Deathtouch,

    // 702.2a. Deathtouch is a static ability.
    Rule702_2aDeathtouchStaticAbility,
    ...
    Rule702_2bCreatureZeroDamageStateBased,
    ...
    Rule702_2eObjectChangesZonesEffectDamage(Condition),

    // 702.2f. Multiple instances of deathtouch on the same object are redundant.
    Rule702_2fMultipleInstancesDeathtouchObjectRedundant,

    // 702.3. Defender
    Rule702_3Defender,

    // 702.3a. Defender is a static ability.
    Rule702_3aDefenderStaticAbility,

    // 702.3b. A creature with defender can’t attack.
    Rule702_3bCreatureDefenderCantAttack,

    // 702.3c. Multiple instances of defender on the same creature are redundant.
    Rule702_3cMultipleInstancesDefenderCreatureRedundant,

    // 702.4. Double Strike
    Rule702_4DoubleStrike,
    ...
    Rule702_4aDoubleAbilityCombatDamageStep,
    ...
    Rule702_4bCreatureCombatDamageStepPhase(Condition),
    ...
    Rule702_4cRemovingCreatureCombatDamageStep,
    ...
    Rule702_4dDoubleCreatureCombatDamageStep,

    // 702.4e. Multiple instances of double strike on the same creature are redundant.
    Rule702_4eMultipleInstancesDoubleStrikeCreature,
    ...
    Rule702_5aEnchantAbilityObjectPlayerSpell,

    // 702.5b. For more information about Auras, see rule 303, “Enchantments.”
    Rule702_5bAurasEnchantments,
    ...
    Rule702_5cAuraMultipleInstancesEnchantAbilities(Condition),
    ...
    Rule702_5dAurasEnchantPlayerCantPermanents,
    ...
    Rule702_6cEquipAbilitiesFurtherCreaturesQuality,

    // 702.6d. If a permanent has multiple equip abilities, any of its equip abilities may be activated.
    Rule702_6dPermanentMultipleEquipAbilitiesActivated(Condition),
    ...
    Rule702_6eEquipPlaneswalkerAbilityCostAttach,
    ...
    Rule702_7aStrikeAbilityCombatDamageStep,
    ...
    Rule702_7bCreatureCombatDamageStepPhase(Condition),
    ...
    Rule702_7cStrikeCreatureCombatDamageStep(Condition),

    // 702.7d. Multiple instances of first strike on the same creature are redundant.
    Rule702_7dMultipleInstancesStrikeCreatureRedundant,
    ...
    Rule702_8aFlashAbilityZonePlayCard,

    // 702.8b. Multiple instances of flash on the same object are redundant.
    Rule702_8bMultipleInstancesFlashObjectRedundant,

    // 702.9. Flying
    Rule702_9Flying,

    // 702.9a. Flying is an evasion ability.
    Rule702_9aFlyingEvasionAbility,
    ...
    Rule702_9bCreatureFlyingCantBlockedBlock,

    // 702.9c. Multiple instances of flying on the same creature are redundant.
    Rule702_9cMultipleInstancesFlyingCreatureRedundant,

    // 702.10. Haste
    Rule702_10Haste,

    // 702.10a. Haste is a static ability.
    Rule702_10aHasteStaticAbility,
    ...
    Rule702_10bCreatureHasteAttackHasntTurn(Condition),
    ...
    Rule702_11dHexproofQualityAbilityPermanentCant,
    ...
    Rule702_11eEffectObjectHexproofQualityAbilities,
    ...
    Rule702_11fHexproofQualityBShorthandAbilities,
    ...
    Rule702_11gHexproofCharacteristicQualityBAbilities,

    // 702.11h. Multiple instances of the same hexproof ability on the same permanent or player are redundant.
    Rule702_11hMultipleInstancesHexproofAbilityPermanent,

    // 702.12. Indestructible
    Rule702_12Indestructible,

    // 702.12a. Indestructible is a static ability.
    Rule702_12aIndestructibleStaticAbility,

    // 702.12b. A permanent with indestructible can’t be destroyed. Such permanents aren’t destroyed by lethal damage, and they ignore the state-based action that checks for lethal damage (see rule 704.5g).
    Rule702_12bPermanentCantDamageStateBased,

    // 702.12c. Multiple instances of indestructible on the same permanent are redundant.
    Rule702_12cMultipleInstancesIndestructiblePermanentRedundant,

    // 702.13. Intimidate
    Rule702_13Intimidate,

    // 702.13a. Intimidate is an evasion ability.
    Rule702_13aIntimidateEvasionAbility,
    ...
    Rule702_13bCreatureIntimidateCantBlockedExcept,

    // 702.13c. Multiple instances of intimidate on the same creature are redundant.
    Rule702_13cMultipleInstancesIntimidateCreatureRedundant,
    ...
    Rule702_14aLandwalkGenericTypeWalkCard,

    // 702.14b. Landwalk is an evasion ability.
    Rule702_14bLandwalkEvasionAbility,
    ...
    Rule702_14cCreatureLandwalkCantIslandwalkArtifact(Condition),

    // 702.14d. Landwalk abilities don’t “cancel” one another.
    Rule702_14dLandwalkAbilitiesDontCancel,

    // 702.14e. Multiple instances of the same kind of landwalk on the same creature are redundant.
    Rule702_14eMultipleInstancesKindLandwalkCreature,

    // 702.15. Lifelink
    Rule702_15Lifelink,

    // 702.15a. Lifelink is a static ability.
    Rule702_15aLifelinkStaticAbility,
    ...
    Rule702_15bDamageDealtSourceLifelinkCauses(Condition),
    ...
    Rule702_15eMultipleSourcesLifelinkDealDamage(Condition),

    // 702.15f. Multiple instances of lifelink on the same object are redundant.
    Rule702_15fMultipleInstancesLifelinkObjectRedundant,

    // 702.16. Protection
    Rule702_16Protection,
    ...
    Rule702_16aProtectionAbilityQualityBlackCard(Condition),

    // 702.16b. A permanent or player with protection can’t be targeted by spells with the stated quality and can’t be targeted by abilities from a source with the stated quality.
    Rule702_16bPermanentPlayerCantSpellsAbilities,
    ...
    Rule702_16cPermanentCantStateBasedAction,
    ...
    Rule702_16dPermanentCantStateBasedAction,

    // 702.16e. Any damage that would be dealt by sources that have the stated quality to a permanent or player with protection is prevented.
    Rule702_16eDamageDealtSourcesStatedPermanent(Condition),

    // 702.16f. Attacking creatures with protection can’t be blocked by creatures that have the stated quality.
    Rule702_16fAttackingCreaturesProtectionCantBlocked,
    ...
    Rule702_16gProtectionQualityBShorthandAbilities,
    ...
    Rule702_16hProtectionCharacteristicQualityBAbilities,
    ...
    Rule702_16iProtectionSetCharacteristicsQualitiesPlayers,
    ...
    Rule702_16jProtectionEverythingAbilityPermanentObject(Condition),
    ...
    Rule702_16kProtectionPlayerAbilityPermanentObject(Condition),

    // 702.16m. Multiple instances of protection from the same quality on the same permanent or player are redundant.
    Rule702_16mMultipleInstancesProtectionQualityPermanent,
    ...
    Rule702_16nCreatureEffectStateBasedAction(Condition),
    ...
    Rule702_16pCreatureEffectPermanentsAttachedNot(Condition),

    // 702.17. Reach
    Rule702_17Reach,

    // 702.17a. Reach is a static ability.
    Rule702_17aReachStaticAbility,
    ...
    Rule702_19aAbilityCreaturesCombatDamageEffect(Condition),
    ...
    Rule702_19bCreatureDamageCombatStepNot(Condition),
    ...
    Rule702_19cCombatDamageCreatureStepNot(Condition),
    ...
    Rule702_19dAttackingCreatureTramplePlaneswalkersDamage(Condition),
    ...
    Rule702_19eCreatureTrampleCombatDamageNot(Condition),
    ...
    Rule702_19fCreatureTramplePlaneswalkersCombatDamage(Condition),
    ...
    Rule702_21aAbilityCostPermanentTargetSpell(Condition),
    ...
    Rule702_21bAbilitiesXCostStateResolves(Condition),

    // 702.22. Banding
    Rule702_22Banding,

    // 702.22a. Banding is a static ability that modifies the rules for combat.
    Rule702_22aBandingStaticAbilityModifiesCombat,
    ...
    Rule702_22bBandsSpecialEffectPermanentAbilities(Condition),
    ...
    Rule702_22cPlayerCreaturesBandsQualityCant(Condition),

    // 702.22d. All creatures in an attacking band must attack the same player, planeswalker, or battle.
    Rule702_22dCreaturesAttackingBandAttackPlayer,
    ...
    Rule702_22eOnceAttackingBandCombatCreatures(Condition),

    // 702.22f. An attacking creature that’s removed from combat is also removed from the band it was in.
    Rule702_22fAttackingCreatureThatsRemovedCombat,
    ...
    Rule702_22gBandingDoesntCreaturesAbilitiesPermanents,
    ...
    Rule702_22hAttackingCreatureBlockedBandBlocking(Condition),

    // 702.22i. If one member of a band would become blocked due to an effect, the entire band becomes blocked.
    Rule702_22iMemberBandBlockedEffectEntire(Condition),
    ...
    Rule702_22jCombatDamageStepCreatureQuality(Condition),
    ...
    Rule702_22kCombatDamageStepCreatureQuality(Condition),
    ...
    Rule702_22mMultipleInstancesBandingCreatureBands,
    ...
    Rule702_23aRampageAbilityNCreatureBlocked(Condition),
    ...
    Rule702_23bRampageBonusCombatAbilityResolves(Condition),

    // 702.23c. If a creature has multiple instances of rampage, each triggers separately.
    Rule702_23cCreatureMultipleInstancesRampageTriggers(Condition),

    // 702.24. Cumulative Upkeep
    Rule702_24CumulativeUpkeep,
    ...
    Rule702_24aCumulativeUpkeepAbilityCostPermanent(Condition),
    ...
    Rule702_24bPermanentMultipleNotAbilityResolves(Condition),
    ...
    Rule702_25aFlankingAbilityStepCreatureBlocked(Condition),

    // 702.25b. If a creature has multiple instances of flanking, each triggers separately.
    Rule702_25bCreatureMultipleInstancesFlankingTriggers(Condition),

    // 702.26. Phasing
    Rule702_26PhasingMechanics,
    ...
    Rule702_26aPhasingAbilityStepPermanentsPhase,
    ...
    Rule702_26dPermanentZonesNotBattlefieldEffects(Condition),
    ...
    Rule702_26eContinuousEffectSpellAbilityPermanent(Condition),
    ...
    Rule702_26fContinuousEffectsAffectPermanentLong(Condition),
    ...
    Rule702_26gPermanentPhasesAurasPhaseIndirectly(Condition),

    // 702.26h. If an object would simultaneously phase out directly and indirectly, it just phases out indirectly.
    Rule702_26hObjectSimultaneouslyPhaseIndirectlyPhases(Condition),
    ...
    Rule702_26iPhaseObjectZoneNotState(Condition),
    ...
    Rule702_26jAbilitiesTriggerPermanentAttachedObject(Condition),
    ...
    Rule702_26nMultiplayerGamePermanentStepTurn(Condition),

    // 702.26p. Multiple instances of phasing on the same permanent are redundant.
    Rule702_26pMultipleInstancesPhasingPermanentRedundant,
    ...
    Rule702_27aBuybackAbilitiesSpellStackCost(Condition),

    // 702.28. Shadow
    Rule702_28Shadow,

    // 702.28a. Shadow is an evasion ability.
    Rule702_28aShadowEvasionAbility,
    ...
    Rule702_28bCreatureShadowCantBlocked,

    // 702.28c. Multiple instances of shadow on the same creature are redundant.
    Rule702_28cMultipleInstancesShadowCreatureRedundant,
    ...
    Rule702_29aCyclingAbilityCardHandCost,
    ...
    Rule702_29bCyclingAbilityCardHandObject(Condition),
    ...
    Rule702_29cCardsCyclingAbilitiesTriggerCycle(Condition),
    ...
    Rule702_29dCardsAbilitiesTriggerCyclesDiscards(Condition),
    ...
    Rule702_29eTypecyclingCyclingAbilityTypeCost,
    ...
    Rule702_29fTypecyclingAbilitiesCyclingCostsCards(Condition),
    ...
    Rule702_30aEchoAbilityCostUpkeepPermanent(Condition),
    ...
    Rule702_30bUrzaBlockCardsAbilityCost,

    // 702.31. Horsemanship
    Rule702_31Horsemanship,

    // 702.31a. Horsemanship is an evasion ability.
    Rule702_31aHorsemanshipEvasionAbility,
    ...
    Rule702_31bCreatureHorsemanshipCantBlockedBlock,

    // 702.31c. Multiple instances of horsemanship on the same creature are redundant.
    Rule702_31cMultipleInstancesHorsemanshipCreatureRedundant,
    ...
    Rule702_32aFadingAbilitiesNPermanentEnters(Condition),
    ...
    Rule702_33cMultikickerAbilityCostPayAdditional,
    ...
    Rule702_33dSpellsControllerDeclaresCostsKicked(Condition),
    ...
    Rule702_33eObjectsKickerMultikickerAbilitiesLinked(Condition),
    ...
    Rule702_33fKickerCostAbilitiesKickedB(Condition),
    ...
    Rule702_33gSpellsAbilityEffectCastNot(Condition),
    ...
    Rule702_33hStickerKickerAbilityAdditionalCost(Condition),
    ...
    Rule702_34aFlashbackAbilitiesCardGraveyardStack(Condition),
    ...
    Rule702_35aMadnessAbilitiesCardHandCost(Condition),
    ...
    Rule702_35bCastingSpellMadnessAbilityCosts,
    ...
    Rule702_35cResolvingAbilityCardCastZone(Condition),

    // 702.36. Fear
    Rule702_36Fear,

    // 702.36a. Fear is an evasion ability.
    Rule702_36aFearEvasionAbility,
    ...
    Rule702_36bCreatureFearCantBlockedExcept,

    // 702.36c. Multiple instances of fear on the same creature are redundant.
    Rule702_36cMultipleInstancesFearCreatureRedundant,
    ...
    Rule702_37aMorphAbilityZoneCardEffect,
    ...
    Rule702_37bMegamorphAbilityCostCastCard(Condition),
    ...
    Rule702_37eTurnPermanentAbilitySpecialAction(Condition),
    ...
    Rule702_38aAmplifyAbilityNObjectEnters(Condition),

    // 702.38b. If a creature has multiple instances of amplify, each one works separately.
    Rule702_38bCreatureMultipleInstancesAmplifyWorks(Condition),
    ...
    Rule702_39aProvokeAbilityCreatureAttacksChoose(Condition),

    // 702.39b. If a creature has multiple instances of provoke, each triggers separately.
    Rule702_39bCreatureMultipleInstancesProvokeTriggers(Condition),
    ...
    Rule702_40aStormAbilityStackCastSpell(Condition),

    // 702.40b. If a spell has multiple instances of storm, each triggers separately.
    Rule702_40bSpellMultipleInstancesStormTriggers(Condition),
    ...
    Rule702_41aAffinityAbilitySpellStackText,

    // 702.41b. If a spell has multiple instances of affinity, each of them applies.
    Rule702_41bSpellMultipleInstancesAffinityApplies(Condition),
    ...
    Rule702_42aEntwineAbilitySpellsStackCost(Condition),
    ...
    Rule702_42bEntwineCostCardSpellResolves(Condition),
    ...
    Rule702_43aModularAbilityNPermanentEnters(Condition),

    // 702.43b. If a creature has multiple instances of modular, each one works separately.
    Rule702_43bCreatureMultipleInstancesModularWorks(Condition),
    ...
    Rule702_44aSunburstAbilityObjectEnteringBattlefield(Condition),
    ...
    Rule702_44bObjectBattlefieldStackResolvingSpell(Condition),
    ...
    Rule702_44cSunburstSetAbilityCreatureSpell(Condition),

    // 702.44d. If an object has multiple instances of sunburst, each one works separately.
    Rule702_44dObjectMultipleInstancesSunburstWorks(Condition),
    ...
    Rule702_45aBushidoAbilityNCreatureBlocks(Condition),

    // 702.45b. If a creature has multiple instances of bushido, each triggers separately.
    Rule702_45bCreatureMultipleInstancesBushidoTriggers(Condition),
    ...
    Rule702_46aSoulshiftAbilityNPermanentGraveyard(Condition),

    // 702.46b. If a permanent has multiple instances of soulshift, each triggers separately.
    Rule702_46bPermanentMultipleInstancesSoulshiftTriggers(Condition),
    ...
    Rule702_47aSpliceAbilityCardHandQuality(Condition),
    ...
    Rule702_47bCantAbilityCardsSpellEffects(Condition),
    ...
    Rule702_47cSpellCardsEffectCostStack,
    ...
    Rule702_47dChooseTargetsAddedSpellResolve(Condition),

    // 702.47e. The spell loses any splice changes once it leaves the stack for any reason.
    Rule702_47eSpellLosesSpliceChangesStack,
    ...
    Rule702_48aOfferingAbilitySpellStackQuality(Condition),
    ...
    Rule702_48bChoosePermanentSacrificeSpellCost,
    ...
    Rule702_48cGenericPermanentsCostSpellsColorless,
    ...
    Rule702_49aNinjutsuAbilityCardHandCost,
    ...
    Rule702_49bCardNinjutsuRevealedAbilityStack,
    ...
    Rule702_49cCreatureBattlefieldNinjutsuAbilityHand,
    ...
    Rule702_49dCommanderNinjutsuAbilityCardCommand,
    ...
    Rule702_50aEpicSpellAbilitiesRestGame(Condition),
    ...
    Rule702_50bCantCastSpellsResolvesEffects,
    ...
    Rule702_51aConvokeAbilitySpellStackColored,
    ...
    Rule702_52aDredgeAbilityCardGraveyardN(Condition),
    ...
    Rule702_52bPlayerCardsLibraryAbilityCant,
    ...
    Rule702_53aTransmuteAbilityCardHandCost,
    ...
    Rule702_53bAbilityCardHandObjectBattlefield(Condition),

    // 702.54. Bloodthirst
    Rule702_54Bloodthirst,
    ...
    Rule702_54aBloodthirstAbilityNOpponentDealt(Condition),
    ...
    Rule702_54bBloodthirstXSpecialPermanentEnters,

    // 702.54c. If an object has multiple instances of bloodthirst, each applies separately.
    Rule702_54cObjectMultipleInstancesBloodthirstApplies(Condition),
    ...
    Rule702_55aHauntAbilityPermanentGraveyardBattlefield(Condition),
    ...
    Rule702_56aReplicateAbilitiesSpellStackCost(Condition),
    ...
    Rule702_56bSpellMultipleInstancesBasedNot(Condition),
    ...
    Rule702_57aForecastAbilitySpecialActivatedHand,
    ...
    Rule702_57bAbilityStepCardsTurnHand,
    ...
    Rule702_58aGraftAbilityNPermanentEnters(Condition),

    // 702.58b. If a permanent has multiple instances of graft, each one works separately.
    Rule702_58bPermanentMultipleInstancesGraftWorks(Condition),
    ...
    Rule702_59aRecoverAbilityCardGraveyardCost(Condition),
    ...
    Rule702_60aRippleAbilityCardStackN(Condition),

    // 702.60b. If a spell has multiple instances of ripple, each triggers separately.
    Rule702_60bSpellMultipleInstancesRippleTriggers(Condition),
    ...
    Rule702_61aSplitAbilitySpellStackLong,
    ...
    Rule702_61bActivateAbilitiesSpecialActionsSpell,

    // 702.61c. Multiple instances of split second on the same spell are redundant.
    Rule702_61cMultipleInstancesSplitSpellRedundant,
    ...
    Rule702_62aSuspendAbilitiesCardHandExile(Condition),

    // 702.62b. A card is “suspended” if it’s in the exile zone, has suspend, and has a time counter on it.
    Rule702_62bCardSuspendedExileZoneSuspend(Condition),
    ...
    Rule702_62cCastCardSuspendConsiderationEffects(Condition),
    ...
    Rule702_62dCastingSpellEffectAbilityCosts,
    ...
    Rule702_63aVanishingAbilitiesNPermanentEnters(Condition),
    ...
    Rule702_63bUpkeepPermanentTimeCounterRemove(Condition),

    // 702.63c. If a permanent has multiple instances of vanishing, each works separately.
    Rule702_63cPermanentMultipleInstancesVanishingWorks(Condition),
    ...
    Rule702_64aAbsorbAbilityNSourceDeal(Condition),
    ...
    Rule702_64bAbsorbAbilityPreventNDamage(Condition),

    // 702.64c. If an object has multiple instances of absorb, each applies separately.
    Rule702_64cObjectMultipleInstancesAbsorbApplies(Condition),
    ...
    Rule702_65aAuraSwapAbilityCardsCost,

    // 702.65b. If either half of the exchange can’t be completed, the ability has no effect.
    Rule702_65bHalfExchangeCantAbilityEffect(Condition),
    ...
    Rule702_66aDelveAbilitySpellStackGeneric,
    ...
    Rule702_66bDelveAbilityIsntCostSpell,

    // 702.66c. Multiple instances of delve on the same spell are redundant.
    Rule702_66cMultipleInstancesDelveSpellRedundant,
    ...
    Rule702_68aFrenzyAbilityNCreatureAttacks(Condition),

    // 702.68b. If a creature has multiple instances of frenzy, each triggers separately.
    Rule702_68bCreatureMultipleInstancesFrenzyTriggers(Condition),

    // 702.69. Gravestorm
    Rule702_69Gravestorm,
    ...
    Rule702_69aGravestormAbilityStackCastSpell(Condition),

    // 702.69b. If a spell has multiple instances of gravestorm, each triggers separately.
    Rule702_69bSpellMultipleInstancesGravestormTriggers(Condition),
    ...
    Rule702_70aPoisonousAbilityNCreatureDeals(Condition),

    // 702.70b. If a creature has multiple instances of poisonous, each triggers separately.
    Rule702_70bCreatureMultipleInstancesPoisonousTriggers(Condition),

    // 702.71. Transfigure
    Rule702_71Transfigure,
    ...
    Rule702_71aTransfigureAbilityCostSacrificePermanent,
    ...
    Rule702_72aChampionAbilitiesObjectPermanentEnters(Condition),

    // 702.72b. The two abilities represented by champion are linked. See rule 607, “Linked Abilities.”
    Rule702_72bAbilitiesChampionLinked,
    ...
    Rule702_72cPermanentChampionedLatterExilesAbility(Condition),

    // 702.73. Changeling
    Rule702_73Changeling,
    ...
    Rule702_73aChangelingAbilityObjectCreatureType,
    ...
    Rule702_74aEvokeAbilitiesZoneCardCast(Condition),
    ...
    Rule702_75aHideawayAbilityNPermanentEnters(Condition),
    ...
    Rule702_75bHideawayAbilityPermanentBattlefieldTapped(Condition),
    ...
    Rule702_76aProwlAbilityStackCostPay(Condition),
    ...
    Rule702_77aReinforceAbilityCardHandN,
    ...
    Rule702_77bAbilityCardHandObjectBattlefield(Condition),
    ...
    Rule702_78aConspireAbilitiesSpellStackAdditional(Condition),
    ...
    Rule702_78bSpellMultipleInstancesBasedNot(Condition),
    ...
    Rule702_79aPersistAbilityPermanentGraveyardBattlefield(Condition),
    ...
    Rule702_80aWitherStaticAbilityDamageCreature,
    ...
    Rule702_81aRetraceAbilityCardGraveyardCast,
    ...
    Rule702_82aDevourAbilityNObjectEnters,
    ...
    Rule702_82bAbilitiesCreaturesPermanentDevouredSacrificed,
    ...
    Rule702_82cDevourQualityNObjectEnters,
    ...
    Rule702_83aExaltedAbilityCreatureControlAttacks(Condition),
    ...
    Rule702_83bCreatureAttacksAloneCombatPhase(Condition),
    ...
    Rule702_84aUnearthAbilityCardGraveyardCost(Condition),
    ...
    Rule702_85aCascadeAbilitySpellStackCast(Condition),
    ...
    Rule702_85bEffectActionCardsCascadeAbility(Condition),

    // 702.85c. If a spell has multiple instances of cascade, each triggers separately.
    Rule702_85cSpellMultipleInstancesCascadeTriggers(Condition),

    // 702.86. Annihilator
    Rule702_86Annihilator,
    ...
    Rule702_86aAnnihilatorAbilityNCreatureAttacks(Condition),

    // 702.86b. If a creature has multiple instances of annihilator, each triggers separately.
    Rule702_86bCreatureMultipleInstancesAnnihilatorTriggers(Condition),
    ...
    Rule702_87aLevelAbilityCostCounterPermanent,
    ...
    Rule702_87bCardPrintedLevelAbilityLeveler,
    ...
    Rule702_87cEnchantmentsClassAbilitiesNotCards,
    ...
    Rule702_88aReboundAbilitySpellStackCast(Condition),
    ...
    Rule702_88bCastingSpellEffectAbilityCosts,

    // 702.88c. Multiple instances of rebound on the same spell are redundant.
    Rule702_88cMultipleInstancesReboundSpellRedundant,

    // 702.89. Umbra Armor
    Rule702_89UmbraArmor,
    ...
    Rule702_89aUmbraArmorAbilityEnchantedPermanent(Condition),
    ...
    Rule702_89bOlderCardsAbilityTotemArmor(Condition),

    // 702.90. Infect
    Rule702_90Infect,

    // 702.90a. Infect is a static ability.
    Rule702_90aInfectStaticAbility,
    ...
    Rule702_90bDamageDealtPlayerSourceInfect,
    ...
    Rule702_90cDamageDealtCreatureSourceInfect,
    ...
    Rule702_91aBattleCryAbilityCreatureAttacks(Condition),

    // 702.91b. If a creature has multiple instances of battle cry, each triggers separately.
    Rule702_91bCreatureMultipleInstancesBattleCry(Condition),

    // 702.92. Living Weapon
    Rule702_92LivingWeapon,
    ...
    Rule702_92aLivingWeaponAbilityEquipmentEnters(Condition),
    ...
    Rule702_93aUndyingAbilityPermanentGraveyardBattlefield(Condition),
    ...
    Rule702_94aMiracleAbilityCostRevealCard(Condition),
    ...
    Rule702_94bCardAbilityHandResolvesStack(Condition),
    ...
    Rule702_95aSoulbondAbilitiesCreatureEntersControl(Condition),
    ...
    Rule702_95bCreaturePairedAbilityUnpairedNot,
    ...
    Rule702_95cAbilityResolvesObjectCreatureBattlefield(Condition),

    // 702.95d. A creature can be paired with only one other creature.
    Rule702_95dCreaturePaired,
    ...
    Rule702_95ePairedCreatureUnpairedOccurBattlefield(Condition),
    ...
    Rule702_96aAbilitiesSpellStackCostChoose(Condition),
    ...
    Rule702_97aScavengeAbilityCardGraveyardCost,
    ...
    Rule702_98aUnleashAbilitiesPermanentEnterAdditional,
    ...
    Rule702_99aCipherAbilitiesSpellStackCard(Condition),
    ...
    Rule702_99bEncodedCardExileZoneCreature(Condition),
    ...
    Rule702_99cCardCipherCreatureBattlefieldObject(Condition),
    ...
    Rule702_101aExtortAbilityCastSpellPay(Condition),

    // 702.101b. If a permanent has multiple instances of extort, each triggers separately.
    Rule702_101bPermanentMultipleInstancesExtortTriggers(Condition),
    ...
    Rule702_102dFusedSplitSpellResolvesController,
    ...
    Rule702_103aBestowAbilityZoneCardCost(Condition),
    ...
    Rule702_103bSpellCastStackCreaturePermanent,
    ...
    Rule702_103cBestowedAuraSpellCopiedCast(Condition),
    ...
    Rule702_103dCastingSpellBestowedAbilityCast(Condition),
    ...
    Rule702_103eBestowedSpellResolvingEffectCreature(Condition),
    ...
    Rule702_103fBestowedAuraUnattachedCeasesObject(Condition),

    // 702.103g. If a bestowed Aura phases in unattached, it ceases to be bestowed. See rule 702.26, “Phasing.”
    Rule702_103gBestowedAuraPhasesUnattachedPhasing(Condition),
    ...
    Rule702_104aTributeAbilityCreatureBattlefieldN,
    ...
    Rule702_104bObjectsTributeAbilitiesCreatureBattlefield(Condition),
    ...
    Rule702_105aDethroneAbilityCreatureAttacksPlayer(Condition),

    // 702.105b. If a creature has multiple instances of dethrone, each triggers separately.
    Rule702_105bCreatureMultipleInstancesDethroneTriggers(Condition),

    // 702.106. Hidden Agenda
    Rule702_106HiddenAgenda,
    ...
    Rule702_106cTurnCardZoneSpecialAction,
    ...
    Rule702_106dHiddenAbilityObjectChosenName,
    ...
    Rule702_106ePlayerLeavesGameFaceCards(Condition),
    ...
    Rule702_106fDoubleHiddenAbilityCardZone,
    ...
    Rule702_107aOutlastAbilityCostCounterCreature,
    ...
    Rule702_108aProwessAbilityCastNoncreatureSpell(Condition),

    // 702.108b. If a creature has multiple instances of prowess, each triggers separately.
    Rule702_108bCreatureMultipleInstancesProwessTriggers(Condition),
    ...
    Rule702_109aDashAbilitiesCardStackObject(Condition),

    // 702.110. Exploit
    Rule702_110Exploit,

    // 702.110a. Exploit is a triggered ability. “Exploit” means “When this creature enters, you may sacrifice a creature.”
    Rule702_110aExploitAbilityCreatureEntersSacrifice(Condition),
    ...
    Rule702_112aRenownAbilityNCreatureDeals(Condition),
    ...
    Rule702_112bRenownedAbilitySpellsPermanentsBattlefield,
    ...
    Rule702_112cCreatureMultipleAbilityResolveEffect(Condition),
    ...
    Rule702_113aAwakenAbilitiesSpellStackN(Condition),
    ...
    Rule702_113bControllerSpellAbilityCostCast(Condition),
    ...
    Rule702_114aDevoidCharacteristicAbilityObjectColorless,
    ...
    Rule702_115aIngestAbilityCreatureDealsCombat(Condition),

    // 702.115b. If a creature has multiple instances of ingest, each triggers separately.
    Rule702_115bCreatureMultipleInstancesIngestTriggers(Condition),
    ...
    Rule702_116aMyriadAbilityCreateCreatureAttacks(Condition),

    // 702.116b. If a creature has multiple instances of myriad, each triggers separately.
    Rule702_116bCreatureMultipleInstancesMyriadTriggers(Condition),
    ...
    Rule702_119aEmergeAbilitiesSpellStackCost(Condition),
    ...
    Rule702_119bEmergeQualityCostCastSpell(Condition),
    ...
    Rule702_119cChoosePermanentSacrificeSpellsCost,
    ...
    Rule702_120aEscalateAbilitySpellsStackCost,
    ...
    Rule702_121aMeleeAbilityCreatureAttacksEnd(Condition),

    // 702.121b. If a creature has multiple instances of melee, each triggers separately.
    Rule702_121bCreatureMultipleInstancesMeleeTriggers(Condition),
    ...
    Rule702_122cEffectCreatureCantCrewCost(Condition),
    ...
    Rule702_122dAbilitiesTriggerCrewedCrewResolves(Condition),

    // 702.123. Fabricate
    Rule702_123Fabricate,
    ...
    Rule702_123aFabricateAbilityNPermanentEnters(Condition),

    // 702.123b. If a permanent has multiple instances of fabricate, each triggers separately.
    Rule702_123bPermanentMultipleInstancesFabricateTriggers(Condition),
    ...
    Rule702_124aPartnerAbilitiesKeywordModifyCards,
    ...
    Rule702_124bDeckContainExactlyCardsZone,
    ...
    Rule702_124cEffectCommandersColorIdentityCombined,
    ...
    Rule702_124dExceptIdentityCastCombatDamage(Condition),
    ...
    Rule702_124eEffectCommanderCausesPerformAction(Condition),

    // 702.124f. Different partner abilities are distinct from one another and cannot be combined.
    Rule702_124fPartnerAbilitiesDistinctCannotCombined,
    ...
    Rule702_124gLegendaryCardThanAbilityCant(Condition),
    ...
    Rule702_124hPartnerDesignateLegendaryCardsCommander(Condition),
    ...
    Rule702_124iPartnerTextDesignateLegendaryCards(Condition),
    ...
    Rule702_124jPartnerNameAbilitiesDesignateLegendary(Condition),
    ...
    Rule702_124kChooseBackgroundDesignateCardsCommander(Condition),
    ...
    Rule702_124mDesignateLegendaryCreatureCardsCommander(Condition),
    ...
    Rule702_124nEffectPartnerAbilityNotCards(Condition),

    // 702.125. Undaunted
    Rule702_125Undaunted,
    ...
    Rule702_126aImproviseAbilitySpellStackGeneric,
    ...
    Rule702_126bImproviseAbilityIsntCostSpell,

    // 702.126c. Multiple instances of improvise on the same spell are redundant.
    Rule702_126cMultipleInstancesImproviseSpellRedundant,

    // 702.127. Aftermath
    Rule702_127Aftermath,
    ...
    Rule702_127aAftermathAbilitySplitCardsCast(Condition),
    ...
    Rule702_128aEmbalmAbilityCardGraveyardCost,

    // 702.128b. A token is “embalmed” if it’s created by a resolving embalm ability.
    Rule702_128bTokenEmbalmedCreatedResolvingAbility(Condition),

    // 702.129. Eternalize
    Rule702_129Eternalize,
    ...
    Rule702_129aEternalizeAbilityCardGraveyardCost,
    ...
    Rule702_130aAfflictAbilityNCreatureBlocked(Condition),

    // 702.130b. If a creature has multiple instances of afflict, each triggers separately.
    Rule702_130bCreatureMultipleInstancesAfflictTriggers(Condition),
    ...
    Rule702_131aAscendSpellAbilityControlPermanents(Condition),
    ...
    Rule702_131bAscendPermanentAbilityTimeControl,
    ...
    Rule702_131cCitysBlessingDesignationThanEffects(Condition),
    ...
    Rule702_131dPlayerContinuousEffectsStateTrigger(Condition),
    ...
    Rule702_132aAbilitySpellCostCastActivate(Condition),

    // 702.133. Jump-Start
    Rule702_133JumpStart,
    ...
    Rule702_133aJumpStartAbilitiesCardGraveyard(Condition),
    ...
    Rule702_134aMentorAbilityCreatureAttacksCounter(Condition),

    // 702.134b. If a creature has multiple instances of mentor, each triggers separately.
    Rule702_134bCreatureMultipleInstancesMentorTriggers(Condition),
    ...
    Rule702_134cAbilityTriggersCreatureMentorsResolves(Condition),

    // 702.135. Afterlife
    Rule702_135Afterlife,
    ...
    Rule702_135aAfterlifeAbilityNPermanentGraveyard(Condition),

    // 702.135b. If a permanent has multiple instances of afterlife, each triggers separately.
    Rule702_135bPermanentMultipleInstancesAfterlifeTriggers(Condition),
    ...
    Rule702_136aRiotAbilityPermanentEnterAdditional(Condition),

    // 702.136b. If a permanent has multiple instances of riot, each works separately.
    Rule702_136bPermanentMultipleInstancesRiotWorks(Condition),

    // 702.137. Spectacle
    Rule702_137Spectacle,
    ...
    Rule702_137aSpectacleAbilityStackCostPay(Condition),
    ...
    Rule702_138aEscapeAbilityCardGraveyardCost,
    ...
    Rule702_138bSpellPermanentEscapedCastGraveyard(Condition),
    ...
    Rule702_138cAbilityPermanentEscapesKindCounter(Condition),

    // 702.138d. An ability that reads “[This permanent] escapes with [ability]” means “If this permanent escaped, it has [ability].”
    Rule702_138dAbilityReadsPermanentEscapesEscaped(Condition),

    // 702.139. Companion
    Rule702_139Companion,
    ...
    Rule702_139aCompanionAbilityConditionCardStack,
    ...
    Rule702_139bCompanionAbilityStartingDeckCards(Condition),
    ...
    Rule702_140aMutateCreatureCardsAbilitySpell(Condition),
    ...
    Rule702_140bMutatingCreatureSpellResolvingBattlefield(Condition),
    ...
    Rule702_140cCreatureSpellResolvesBattlefieldObject(Condition),
    ...
    Rule702_140dAbilityTriggersCreatureSpellResolving(Condition),
    ...
    Rule702_140eMutatedPermanentAbilitiesCardToken,
    ...
    Rule702_140fEffectCreatureSpellPermanentResolves,
    ...
    Rule702_141aEncoreAbilityCardGraveyardCost(Condition),
    ...
    Rule702_142aBoastAbilitySpecialCostEffect(Condition),
    ...
    Rule702_142bEffectsBoastAbilitiesCreatureBoasting(Condition),
    ...
    Rule702_143aCardHandTurnExileCast(Condition),
    ...
    Rule702_143bCardAbilitySpecialActionStack,
    ...
    Rule702_143cEffectCardSpecialActionAbility(Condition),
    ...
    Rule702_143dEffectCardExileCostCast(Condition),
    ...
    Rule702_143ePlayerOwnsCardsExileCosts(Condition),
    ...
    Rule702_143fPlayerLeavesGameFaceCards(Condition),

    // 702.144. Demonstrate
    Rule702_144Demonstrate,
    ...
    Rule702_145bDayboundFrontDoubleFacedCards(Condition),
    ...
    Rule702_145eNightboundCardsAbilitiesDayPermanent(Condition),
    ...
    Rule702_145fTimePermanentStateBasedAction,
    ...
    Rule702_145gTimePlayerControlsPermanentBattlefield(Condition),
    ...
    Rule702_146aDisturbAbilityCardsCostCast,
    ...
    Rule702_146bResolvingSpellCastAbilityBattlefield,
    ...
    Rule702_147aDecayedAbilityCreatureCantBlock(Condition),
    ...
    Rule702_148aCleaveAbilitiesSpellStackCost(Condition),

    // 702.148b. Cleave’s second ability is a text-changing effect. See rule 612, “Text-Changing Effects.”
    Rule702_148bCleavesAbilityTextChangingEffect,
    ...
    Rule702_149aTrainingAbilityCreaturePowerGreater(Condition),

    // 702.149b. If a creature has multiple instances of training, each triggers separately.
    Rule702_149bCreatureMultipleInstancesTrainingTriggers(Condition),
    ...
    Rule702_149cCreaturesTrainingAbilitiesTriggerResolving(Condition),

    // 702.150. Compleated
    Rule702_150Compleated,
    ...
    Rule702_150aAbilityCardsPermanentEnterLoyalty(Condition),

    // 702.151. Reconfigure
    Rule702_151Reconfigure,
    ...
    Rule702_151aAbilitiesCostAttachPermanentTarget(Condition),
    ...
    Rule702_151bAttachingEquipmentReconfigureCreatureCauses,
    ...
    Rule702_152aBlitzAbilitiesCardStackObject(Condition),
    ...
    Rule702_152bSpellCastPermanentAbilityNot(Condition),
    ...
    Rule702_153aCasualtyAbilitiesSpellStackN(Condition),
    ...
    Rule702_153bSpellMultipleInstancesBasedNot(Condition),
    ...
    Rule702_154aAbilityCreatureAttacksTapUntapped(Condition),
    ...
    Rule702_154bEnlistsStaticAbilityCostAttack,
    ...
    Rule702_154cCreatureEnlistsPayCostAbility(Condition),
    ...
    Rule702_154dMultipleInstancesCreatureAbilityCost,

    // 702.155. Read Ahead
    Rule702_155ReadAhead,
    ...
    Rule702_155aReadAheadSagaCardsAbilities(Condition),
    ...
    Rule702_155bSagaAbilitiesEntersChooseNumber,

    // 702.155c. Multiple instances of read ahead on the same object are redundant.
    Rule702_155cMultipleInstancesReadAheadObject,
    ...
    Rule702_156aRavenousCreatureCardsXCost(Condition),
    ...
    Rule702_157aSquadAbilitiesCreatureSpellStack(Condition),
    ...
    Rule702_157bSpellPermanentBasedAbilityCast(Condition),

    // 702.158. Space Sculptor
    Rule702_158SpaceSculptor,
    ...
    Rule702_158aCardSpaceBelerenAbilityCreatures,
    ...
    Rule702_158bSectorDesignationPermanentAbilityNot,
    ...
    Rule702_158cPermanentCreaturesBattlefieldStateBased(Condition),
    ...
    Rule702_158dAbilitiesIncludeInstructionActionCreature,

    // 702.158e. Two permanents are in the same sector if each has the same sector designation.
    Rule702_158ePermanentsSectorDesignation(Condition),
    ...
    Rule702_159aVisitAbilityAttractionCardsEffect(Condition),
    ...
    Rule702_159bAttractionsClaimPrizeAbilityActions,

    // 702.160. Prototype
    Rule702_160Prototype,
    ...
    Rule702_160aPrototypeAbilityCardsCostSpell(Condition),

    // 702.161. Living Metal
    Rule702_161LivingMetal,
    ...
    Rule702_161aLivingMetalAbilityTurnPermanent,

    // 702.162. More Than Meets the Eye
    Rule702_162ThanMeetsEye,
    ...
    Rule702_162aThanMeetsEyeAbilityZone,
    ...
    Rule702_163aMirrodinAbilityEquipmentEntersCreate(Condition),

    // 702.164. Toxic
    Rule702_164Toxic,

    // 702.164a. Toxic is a static ability. It is written “toxic N,” where N is a number.
    Rule702_164aToxicStaticAbilityWrittenN,
    ...
    Rule702_164bEffectsCreaturesTotalToxicValue,
    ...
    Rule702_164cCombatDamageDealtPlayerCreature,
    ...
    Rule702_165aBackupAbilityNCreatureEnters(Condition),
    ...
    Rule702_165bPermanentEntersBattlefieldCopyAbility(Condition),
    ...
    Rule702_165cAbilitiesObjectPermanentEffectNot,
    ...
    Rule702_165dAbilitiesBackupStackPermanentResolves(Condition),
    ...
    Rule702_166aBargainAbilitySpellStackAdditional,
    ...
    Rule702_166bSpellsControllerDeclaresCostBargained(Condition),
    ...
    Rule702_166cObjectsBargainAdditionalAbilitiesLinked(Condition),
    ...
    Rule702_166dSpellsAbilityEffectCastNot(Condition),
    ...
    Rule702_167aCraftAbilityMaterialsCostExile,
    ...
    Rule702_167bObjectAbilityCardPermanentBattlefield(Condition),
    ...
    Rule702_167cAbilityPermanentCardsExileCost,
    ...
    Rule702_168aDisguiseAbilityZoneCardEffect,
    ...
    Rule702_168dTurnPermanentAbilitySpecialAction(Condition),
    ...
    Rule702_168ePermanentsCostXAbilitiesSpecial(Condition),
    ...
    Rule702_168fFaceSpellsPermanentsCastCards,
    ...
    Rule702_170aPlotAbilityCardHandCost,
    ...
    Rule702_170fEffectAbilityCardZoneHand,
    ...
    Rule702_171aSaddleAbilityNTapNumber,
    ...
    Rule702_172aAbilitySpellsStackChooseModes,
    ...
    Rule702_172bCardsAbilityCostCastNot,

    // 702.173. Freerunning
    Rule702_173Freerunning,
    ...
    Rule702_173aFreerunningAbilityStackCostPay(Condition),
    ...
    Rule702_174aGiftAbilitiesCardStackBattlefield,
    ...
    Rule702_174bPermanentAbilityGiftEntersCost(Condition),
    ...
    Rule702_174mSpellsAbilityEffectGiftPromised(Condition),

    // 702.175. Offspring
    Rule702_175Offspring,
    ...
    Rule702_175aOffspringAbilitiesCostPayAdditional(Condition),
    ...
    Rule702_175bSpellMultipleInstancesBasedNot(Condition),

    // 702.176. Impending
    Rule702_176Impending,
    ...
    Rule702_176aImpendingAbilitiesSpellStackEffect(Condition),
    ...
    Rule702_177aExhaustAbilitySpecialCostEffect,
    ...
    Rule702_177bEffectActionAbilityTurnActivate(Condition),
    ...
    Rule702_178aMaxSpeedAbilitySpecialLong,
    ...
    Rule702_178bAbilityGrantedMaxSpeedZones(Condition),

    // 702.179. Start Your Engines!
    Rule702_179StartEngines,
    ...
    Rule702_179cPlayerSpeedIncreaseValue(Condition),
    ...
    Rule702_179fEffectsPlayersSpeedZeroPurpose(Condition),

    // 702.180. Harmonize
    Rule702_180Harmonize,
    ...
    Rule702_180aHarmonizeAbilitiesCardGraveyardSpell(Condition),
    ...
    Rule702_180bChooseCreatureTapSpellsCost,
    ...
    Rule702_181aMobilizeAbilityNCreatureAttacks(Condition),

    // 702.182. Job Select
    Rule702_182JobSelect,
    ...
    Rule702_182aJobSelectAbilityEquipmentEnters(Condition),
    ...
    Rule702_183aAbilitySpellsStackChooseAdditional,
    ...
    Rule702_184aStationAbilityTapUntappedCreature,
    ...
    Rule702_184bCardPrintedStationAbilityNonstandard,
    ...
    Rule702_184cStaticAbilitiesModifyCreaturesPermanent,
    ...
    Rule702_185aWarpAbilitiesCardStackCost(Condition),
    ...
    Rule702_185bEffectsWarpedCardsExileAbility,
    ...
    Rule702_185cEffectsSpellWarpedTurnCast,
    ...
    Rule702_188aWebSlingingAbilitySpellStack,

    // 702.189. Firebending
    Rule702_189Firebending,
    ...
    Rule702_189aFirebendingAbilityNCreatureAttacks(Condition),
    ...
    Rule702_189bAbilityTriggersPlayerFirebendsResolves(Condition),
    ...
    Rule702_190aSneakAbilitySpellStackCost,
    ...
    Rule702_190bPermanentSpellCostBattlefieldCreature,

    // 702.191. Increment
    Rule702_191Increment,
    ...
    Rule702_191aIncrementAbilityCastSpellPermanent(Condition),

    // 702.191b. If a creature has multiple instances of increment, each one triggers separately.
    Rule702_191bCreatureMultipleInstancesIncrementTriggers(Condition),
    ...
    Rule702_192aSpellAbilitiesTimeControlObject(Condition),
    ...
    Rule703_1TurnBasedActionsPhaseStack(Condition),
    ...
    Rule703_1aAbilitiesStepPhaseNotTurn,

    // 703.2. Turn-based actions are not controlled by any player.
    Rule703_2TurnBasedActionsNotControlled,
    ...
    Rule703_3StepPhaseTurnBasedAction(Condition),

    // 703.4. The turn-based actions are as follows:
    Rule703_4TurnBasedActions,
    ...
    Rule703_4aImmediatelyUntapStepPermanentsPhase(Condition),
    ...
    Rule703_4bImmediatelyPhasingActionCompletedStep(Condition),
    ...
    Rule703_4cImmediatelyGameStepActionPermanents(Condition),

    // 703.4d. Immediately after the draw step begins, the active player draws a card. See rule 504.1.
    Rule703_4dImmediatelyDrawStepActiveCard,
    ...
    Rule703_4eArchenemyGamePhaseCardScheme,
    ...
    Rule703_4fPhaseSagaAbilitiesSchemeAction,
    ...
    Rule703_4gImmediatelyActionPlacingAttractionsVisit(Condition),
    ...
    Rule703_4kCombatDamageStepApnapCreature,
    ...
    Rule703_4mImmediatelyCombatDamageAssignedStep,
    ...
    Rule703_4nImmediatelyCleanupStepHandCards(Condition),
    ...
    Rule704_1StateBasedActionsGameStack(Condition),
    ...
    Rule704_3StateBasedActionsAbilitiesStack(Condition),

    // 704.4. Unlike triggered abilities, state-based actions pay no attention to what happens during the resolution of a spell or ability.
    Rule704_4AbilitiesStateBasedActionsSpell,

    // 704.5. The state-based actions are as follows:
    Rule704_5StateBasedActions,

    // 704.5a. If a player has 0 or less life, that player loses the game.
    Rule704_5aPlayerZeroLifeLosesGame(Condition),
    ...
    Rule704_5bCardLibraryStateBasedActions(Condition),
    ...
    Rule704_5cPlayerPoisonCountersLosesGame(Condition),

    // 704.5d. If a token is in a zone other than the battlefield, it ceases to exist.
    Rule704_5dTokenZoneThanBattlefieldCeases(Condition),

    // 704.5e. If a copy of a spell is in a zone other than the stack, it ceases to exist. If a copy of a card is in any zone other than the stack or the battlefield, it ceases to exist.
    Rule704_5eSpellZoneStackCardBattlefield(Condition),

    // 704.5f. If a creature has toughness 0 or less, it’s put into its owner’s graveyard. Regeneration can’t replace this event.
    Rule704_5fCreatureToughnessZeroGraveyardCant(Condition),

    // 704.5g. If a creature has toughness greater than 0, it has damage marked on it, and the total damage marked on it is greater than or equal to its toughness, that creature has been dealt lethal damage and is destroyed. Regeneration can replace this event.
    Rule704_5gCreatureToughnessGreaterZeroDamage(Condition),

    // 704.5h. If a creature has toughness greater than 0, and it’s been dealt damage by a source with deathtouch since the last time state-based actions were checked, that creature is destroyed. Regeneration can replace this event.
    Rule704_5hCreatureZeroDamageStateBased(Condition),

    // 704.5i. If a planeswalker has loyalty 0, it’s put into its owner’s graveyard.
    Rule704_5iPlaneswalkerLoyaltyZeroOwnersGraveyard(Condition),

    // 704.5j. If two or more legendary permanents with the same name are controlled by the same player, that player chooses one of them, and the rest are put into their owners’ graveyards. This is called the “legend rule.”
    Rule704_5jLegendaryPermanentsNameControlledLegend(Condition),

    // 704.5k. If two or more permanents have the supertype world, all except the one that has had the world supertype for the shortest amount of time are put into their owners’ graveyards. In the event of a tie for the shortest amount of time, all are put into their owners’ graveyards. This is called the “world rule.”
    Rule704_5kPermanentsSupertypeWorldExceptShortest(Condition),

    // 704.5m. If an Aura is attached to an illegal object or player, or is not attached to an object or player, that Aura is put into its owner’s graveyard.
    Rule704_5mAuraAttachedObjectNotGraveyard(Condition),
    ...
    Rule704_5nEquipmentFortificationAttachedPermanentBattlefield(Condition),
    ...
    Rule704_5pBattleCreatureObjectBattlefieldPermanent(Condition),

    // 704.5q. If a permanent has both a +1/+1 counter and a -1/-1 counter on it, N +1/+1 and N -1/-1 counters are removed from it, where N is the smaller of the number of +1/+1 and -1/-1 counters on it.
    Rule704_5qPermanentCounterNRemovedSmaller(Condition),
    ...
    Rule704_5rPermanentAbilitySaysCantN(Condition),
    ...
    Rule704_5sSagaPermanentAbilitiesNotStack(Condition),
    ...
    Rule704_5tPlayersCardAbilityNotStack(Condition),
    ...
    Rule704_5uPermanentSpaceSculptorCreaturesBattlefield(Condition),
    ...
    Rule704_5vZeroAbilityNotStackGraveyard(Condition),
    ...
    Rule704_5wBattlePlayerCreaturesBasedGraveyard(Condition),
    ...
    Rule704_5xSiegesControllerDesignatedProtectorGraveyard(Condition),
    ...
    Rule704_5yPermanentThanRoleTimestampGraveyard(Condition),
    ...
    Rule704_6aHeadedGiantGameZeroVariant(Condition),
    ...
    Rule704_6bHeadedGiantGameTeamVariant(Condition),
    ...
    Rule704_6cCommanderGamePlayerCombatDamage,
    ...
    Rule704_6dCommanderGraveyardExileObjectZone(Condition),
    ...
    Rule704_6eArchenemySchemeCardZoneAbilities(Condition),
    ...
    Rule704_6fPlanechaseCardZoneAbilityNot(Condition),
    ...
    Rule704_7MultipleStateBasedActionsEffect(Condition),
    ...
    Rule704_8StateBasedActionPermanentBattlefield(Condition),
    ...
    Rule705_1CardsFlippingObjectHeadsTails(Condition),
    ...
    Rule705_2EffectsPlayerFlipHeadsTails(Condition),
    ...
    Rule705_3EffectStateCoinFlipResult(Condition),
    ...
    Rule706_1EffectPlayerRollDieSpecify,

    // 706.1a. Such an effect may refer to an “N-sided die,” “N-sided dice,” or one or more “dN,” where N is a positive integer. In those cases, the die must have N equally likely outcomes, numbered from 1 to N.
    Rule706_1aEffectNSidedDieDice,
    ...
    Rule706_1bPlayersAgreeAlternateMethodRolling,
    ...
    Rule706_2RollNumberIndicatedTopFace,
    ...
    Rule706_2aModifiersOptionalCostsActivateAbilities(Condition),
    ...
    Rule706_2bEffectsAttemptingModifyNaturalResult(Condition),

    // 706.3. Some abilities that instruct a player to roll one or more dice include a results table.
    Rule706_3AbilitiesPlayerRollDiceInclude,
    ...
    Rule706_3aEffectRangeN1N2N(Condition),
    ...
    Rule706_3bInstructionRollDiceBasedAbility,
    ...
    Rule706_3cEffectsResultsChartsIncludeRoll,
    ...
    Rule706_4AbilitiesPlayerRollDiceNot(Condition),
    ...
    Rule706_5CardAbilityEffectRolledDoubles(Condition),
    ...
    Rule706_6PlayerAbilitiesTriggerIgnoredEffects(Condition),
    ...
    Rule706_7PlanechaseGameRollingAbilityEffect(Condition),
    ...
    Rule706_8CardCentaurAttentionAbilityStore,
    ...
    Rule706_8aStoreResultPermanentStoredValue,
    ...
    Rule706_8bRerollStoredResultsPermanentRoll(Condition),
    ...
    Rule706_8cPermanentAbilityStoresResultsStored(Condition),
    ...
    Rule707_1TurnCopySpellPermanentCard,
    ...
    Rule707_2ObjectStackXCostCard(Condition),
    ...
    Rule707_2cStaticAbilityGeneratesContinuousEffect(Condition),
    ...
    Rule707_3CopysCopiableValuesCopiedModified,
    ...
    Rule707_4EffectsPermanentObjectBattlefieldAbilities,
    ...
    Rule707_5ObjectEntersBattlefieldCopyPermanent(Condition),
    ...
    Rule707_6CopyingPermanentObjectEntersBattlefield(Condition),
    ...
    Rule707_7LinkedAbilitiesObjectActionsCant(Condition),
    ...
    Rule707_8CopyingPermanentDoubleFacedCards(Condition),
    ...
    Rule707_8aEffectPermanentCardNotBattlefield(Condition),

    // 707.9. Copy effects may include modifications or exceptions to the copying process.
    Rule707_9CopyEffectsIncludeModificationsExceptions,
    ...
    Rule707_9aCopyEffectsCauseGainAbility,
    ...
    Rule707_9bCopyEffectsModifyCharacteristicCopying,
    ...
    Rule707_9cCopyEffectsSpecificallyStateNot(Condition),
    ...
    Rule707_9dEffectAbilityObjectNotState(Condition),
    ...
    Rule707_9eReplacementEffectsGenerateCopyInclude(Condition),
    ...
    Rule707_9fExceptionsCopyingProcessPermanentsEffect(Condition),
    ...
    Rule707_9gReplacementEffectsAbilitiesObjectTrigger(Condition),
    ...
    Rule707_10SpellAbilityStackCastX(Condition),
    ...
    Rule707_10aSpellZoneStackCardBattlefield(Condition),
    ...
    Rule707_10bAbilityObjectNotEffectsTurn(Condition),
    ...
    Rule707_10cEffectsSpellAbilityStateStack(Condition),
    ...
    Rule707_10dEffectsSpellAbilityObjectTarget(Condition),
    ...
    Rule707_10eEffectsSpellAbilityTargetObject(Condition),
    ...
    Rule707_10fEffectsCopyPermanentSpellResolves,
    ...
    Rule707_10gEffectPermanentSpellBattlefieldResolves(Condition),
    ...
    Rule707_11EffectPermanentNameTracksChanges(Condition),
    ...
    Rule707_12EffectCastObjectNotSpell,
    ...
    Rule707_13CardGarthEyePlayerObject,
    ...
    Rule707_14CardMagarStringsPlayerGraveyard,

    // 708. Face-Down Spells and Permanents

    // 708.1. Some cards allow spells and permanents to be face down.
    Rule708_1CardsAllowSpellsPermanentsFace,
    ...
    Rule708_2FaceSpellsPermanentsCharacteristicsAbility,
    ...
    Rule708_2aPermanentSpellAbilityObjectCreature(Condition),
    ...
    Rule708_2bPermanentCantSpellAbilityTurn(Condition),
    ...
    Rule708_3BattlefieldPermanentsAbilitiesTriggerEffect(Condition),
    ...
    Rule708_4CastStackEffectsSpellNot(Condition),
    ...
    Rule708_5SpellStackPermanentCantCards(Condition),
    ...
    Rule708_6SpellsPermanentsNotAbilityCast(Condition),
    ...
    Rule708_7AbilityPermanentTurnSpellsCant,
    ...
    Rule708_8PermanentEffectsAbilitiesBattlefieldTrigger,
    ...
    Rule708_9PermanentBattlefieldZoneSpellStack(Condition),
    ...
    Rule708_10FacePermanentCopyCopiableAbility(Condition),
    ...
    Rule708_11FacePermanentTurnedAbilityNot(Condition),
    ...
    Rule709_3bStackCharacteristicsHalfCastExist,
    ...
    Rule709_4aSplitCardEffectNotObject(Condition),
    ...
    Rule709_4dCharacteristicsFusedSplitSpellStack,
    ...
    Rule709_5CardsPermanentObjectAbilitiesBattlefield,
    ...
    Rule709_5aHalfSplitCardSharedType,
    ...
    Rule709_5bExistenceHalfObjectSpellStack(Condition),
    ...
    Rule709_5cLeftHalfUnlockedRightPermanent(Condition),
    ...
    Rule709_5dPermanentLeftHalfUnlockedBattlefield(Condition),
    ...
    Rule709_5ePermanentCostUnlockSpecialAction,
    ...
    Rule709_5fSpellsAbilitiesPlayerUnlockPermanent,
    ...
    Rule709_5gSpellsAbilitiesPlayerLockPermanent,
    ...
    Rule709_5hAbilitiesTriggerPlayerPermanentBattlefield(Condition),
    ...
    Rule709_5iAbilitiesTriggerFullyUnlocksPermanent(Condition),

    // 709.5j. Some cards refer to a “door” of a Room permanent. A door is a half of that permanent.
    Rule709_5jCardsDoorRoomPermanentHalf,
    ...
    Rule710_1FlipCardsFrameSingleText,
    ...
    Rule710_1aTopFlipCardAbilityPermanent(Condition),
    ...
    Rule710_1bBottomHalfCardPermanentBattlefield(Condition),
    ...
    Rule710_1cFlipCardsCostPermanentEffects(Condition),
    ...
    Rule710_2ZoneThanBattlefieldPermanentCard(Condition),
    ...
    Rule710_3EnsureClearTimesPermanentNot(Condition),
    ...
    Rule710_4FlippingPermanentWayProcessBattlefield(Condition),
    ...
    Rule710_5EffectPlayerChooseCardName(Condition),
    ...
    Rule711_2aLevelN1N2AbilitiesP(Condition),
    ...
    Rule711_2bLevelN3AbilitiesPLong,
    ...
    Rule711_3TextBoxStriationsAbilitiesCards,
    ...
    Rule711_4AbilityLevelerCardIsntPermanent(Condition),
    ...
    Rule711_5NumberLevelCountersLevelerCreature(Condition),
    ...
    Rule711_6ZoneThanBattlefieldLevelerCard,
    ...
    Rule711_7EnchantmentsClassAbilitiesNotCards,
    ...
    Rule712_1DoubleFacedCardNotTransforming,
    ...
    Rule712_2CardsAbilitiesTransformConvertTurn,
    ...
    Rule712_2aNonmodalDoubleFacedCardsBlock,
    ...
    Rule712_2bNonmodalDoubleFacedCardsBlock,
    ...
    Rule712_2cFrontFaceCardCreatureEffect,
    ...
    Rule712_3ModalCardsAbilityTransformConvert,
    ...
    Rule712_3aModalDoubleFacedCardsFront,
    ...
    Rule712_3bModalDoubleFacedCardsFace,
    ...
    Rule712_4aCardAbilityObjectBattlefieldPermanent,
    ...
    Rule712_4bPermanentBattlefieldEffectCardNot(Condition),
    ...
    Rule712_7PlayersEnsureCardsHiddenZones,
    ...
    Rule712_8FaceDoubleFacedCardIsnt,
    ...
    Rule712_8aDoubleCardZoneBattlefieldStack,

    // 712.8b. A meld card on the stack has only the characteristics of its front face.
    Rule712_8bMeldCardStackCharacteristicsFront,
    ...
    Rule712_8eNonmodalPermanentCostObjectZero(Condition),
    ...
    Rule712_8fModalSpellStackPermanentBattlefield,
    ...
    Rule712_8gCardsBattlefieldPermanentObjectZero(Condition),
    ...
    Rule712_9PermanentsCardsNotSpellAbility(Condition),
    ...
    Rule712_11aCardCastSpellTransformedConverted(Condition),
    ...
    Rule712_11bPlayerCastingCardSpellStack,
    ...
    Rule712_11cFaceStackEvaluatedCastConsidered(Condition),
    ...
    Rule712_11dAbilityCardsCastTransformedConverted(Condition),
    ...
    Rule712_12PlayerPlayingModalCardBattlefield,
    ...
    Rule712_13ResolvingSpellPermanentBattlefieldStack,
    ...
    Rule712_13aAbilitiesSpellStackBattlefieldCard(Condition),
    ...
    Rule712_14DoubleCardBattlefieldZoneStack,
    ...
    Rule712_14aSpellAbilityCardBattlefieldTransformed(Condition),
    ...
    Rule712_14bPlayerCardBattlefieldPermanentZone(Condition),
    ...
    Rule712_14cMeldCardMeldedBattlefieldPermanent(Condition),
    ...
    Rule712_15EffectCastCardFaceCreature(Condition),
    ...
    Rule712_15aFaceDoubleFacedPermanentCant(Condition),
    ...
    Rule712_16PermanentsCantSpellAbilityTurn(Condition),
    ...
    Rule712_17DoubleFacedCardHiddenSubstitute,
    ...
    Rule712_18DoubleFacedPermanentObjectEffects(Condition),
    ...
    Rule712_19EffectPlayerChooseCardNot(Condition),
    ...
    Rule712_20CardPermanentTransformsAbilityNot(Condition),
    ...
    Rule712_21MeldedPermanentBattlefieldCardsZone(Condition),
    ...
    Rule712_21aMeldedPermanentGraveyardLibraryCards(Condition),
    ...
    Rule712_21bPlayerExilesPermanentTimestampCards(Condition),
    ...
    Rule712_21cEffectObjectPermanentBattlefieldCards(Condition),
    ...
    Rule712_21dEffectsPermanentBattlefieldZoneCards(Condition),
    ...
    Rule712_21eEffectNeedsZonesPermanentCards(Condition),
    ...
    Rule713_1SubstituteCardGameSupplementDouble,
    ...
    Rule713_2SubstituteCardClearlyIndicateCost(Condition),
    ...
    Rule713_2aSubstituteCardsListNamesCosts,
    ...
    Rule713_2bSubstituteCardsListedStyleCore,
    ...
    Rule713_2cSubstituteCardsModalDoubleFaced,
    ...
    Rule713_5SubstituteCardFacePublicZone(Condition),
    ...
    Rule714_1SagaCardStriatedTextBox,
    ...
    Rule714_2aSymbolIncludesRomanNumeralRn,
    ...
    Rule714_2bRnEffectLoreCountersSaga(Condition),

    // 714.2c. “{rN1}, {rN2}—[Effect]” means the same as “{rN1}—[Effect]” and “{rN2}—[Effect].”
    Rule714_2cRn1Rn2Effect,
    ...
    Rule714_3aSagaAbilityEntersLoreCounter,
    ...
    Rule714_3bSagaAbilitiesEntersChooseNumber,
    ...
    Rule714_3cPhaseAbilitiesTurnBasedAction,
    ...
    Rule715_2TextAppearsObjectSpellCards,
    ...
    Rule715_3aCastingAdventurerCardAdventureCast(Condition),

    // 715.3b. While on the stack as an Adventure, the spell has only its alternative characteristics.
    Rule715_3bStackAdventureSpellAlternativeCharacteristics,
    ...
    Rule715_3cSpellNotCardEffectCast(Condition),
    ...
    Rule715_3dSpellCastGraveyardResolvesCard(Condition),
    ...
    Rule715_4ZoneExceptStackNotCard,
    ...
    Rule715_5EffectPlayerChooseCardName(Condition),
    ...
    Rule716_2aCostLevelNAbilitiesActivate(Condition),
    ...
    Rule716_2dEffectPermanentsLevelDoesntTreated(Condition),
    ...
    Rule716_3AbilityPrintedClassCardTrigger(Condition),
    ...
    Rule716_4CreatureCardsLevelerLevelAbilities,
    ...
    Rule718_1PrototypeCardsFrameAbilityCost,
    ...
    Rule718_3PlayerCastsCardSpellAbility,
    ...
    Rule718_3aCastingPrototypedSpellCostCast(Condition),
    ...
    Rule718_3bPrototypedSpellPermanentAlternativeCost(Condition),
    ...
    Rule718_3cSpellCostNotCardEffect(Condition),
    ...
    Rule718_3dPermanentSpellCostNotCard(Condition),
    ...
    Rule718_4ZoneStackBattlefieldNotCast(Condition),
    ...
    Rule718_5PrototypeCardsCostCastSpell,
    ...
    Rule723_1CardsAllowPlayerTurnEffect,
    ...
    Rule723_1aMultiplePlayerControllingEffectsAffect,
    ...
    Rule723_3ControlPlayerChangesObjectsTurn,
    ...
    Rule723_4ObjectGameVisibleCardsNot(Condition),
    ...
    Rule723_5ControllingPlayerChoicesSpellsAbilities,
    ...
    Rule723_5aControllerPlayerResourcesCardsCosts,
    ...
    Rule723_5bControllerPlayerCantChoicesDecisions(Condition),
    ...
    Rule723_6ControllerPlayerCantConcedeGame(Condition),
    ...
    Rule724_1CardsTurnEffectResolvingSpells(Condition),
    ...
    Rule724_1aTriggeredAbilitiesStackNotTrigger(Condition),
    ...
    Rule724_1dPhaseStepCombatCreaturesEffect(Condition),
    ...
    Rule724_1eTurnEndsStepAbilitiesTrigger(Condition),
    ...
    Rule724_1fAbilitiesNotStackCleanupStep(Condition),
    ...
    Rule724_2CardCombatPhaseEffectResolving(Condition),
    ...
    Rule724_2aTriggeredAbilitiesStackNotTrigger(Condition),
    ...
    Rule724_2dCurrentCombatPhaseCreaturesEffects,
    ...
    Rule724_2eCombatPhaseAbilitiesTriggerStep(Condition),
    ...
    Rule725_1MonarchDesignationPlayerGameEffect,
    ...
    Rule725_2AbilitiesMonarchStepCardCreature(Condition),
    ...
    Rule725_3PlayerMonarchTimeCurrentCeases(Condition),
    ...
    Rule725_4MonarchLeavesGameActiveTurn(Condition),
    ...
    Rule725_5ResultContinuousEffectAbilityBased(Condition),
    ...
    Rule726_1InitiativeDesignationPlayerGameEffect,
    ...
    Rule726_2InitiativeInherentTriggeredAbilities(Condition),
    ...
    Rule726_3PlayerInitiativeTimeCurrentlyCeases(Condition),
    ...
    Rule726_4PlayerInitiativeLeavesGameTurn(Condition),
    ...
    Rule726_5PlayerCurrentlyAbilityTriggerNot(Condition),
    ...
    Rule727_2CardsInvolvedGamePermanentsNot(Condition),
    ...
    Rule727_3CardsLibraryStateBasedActions(Condition),
    ...
    Rule727_4EffectResolvingStepSpellAbility(Condition),
    ...
    Rule727_5EffectsExemptCardsProcedureNot,
    ...
    Rule727_5aCommanderGameExemptedProcedureZone,
    ...
    Rule727_6SubgameRestartedMainGameEffects(Condition),
    ...
    Rule727_7MultiplayerGameLimitedRangeAbility(Condition),

    // 729. Subgames

    // 729.1. One card (Shahrazad) allows players to play a Magic subgame.
    Rule729_1CardShahrazadPlayersPlaySubgame,
    ...
    Rule729_1aSubgameGameEffectMainSpell(Condition),

    // 729.1b. No effects or definitions created in either the main game or the subgame have any meaning in the other, except as defined by the effect that created the subgame.
    Rule729_1bEffectsDefinitionsCreatedMainGame,
    ...
    Rule729_2GameZonesCardsLibraryStarting,
    ...
    Rule729_2aSubgameSupplementaryDecksCardsZone(Condition),
    ...
    Rule729_2bSubgameVanguardGameCardZone,
    ...
    Rule729_2cSubgameCommanderGameStartsZone(Condition),
    ...
    Rule729_3CardsStateBasedActionsStep(Condition),
    ...
    Rule729_4ObjectsMainGameCardsNot,
    ...
    Rule729_4aEffectsCardsAbilitiesTriggerZone(Condition),
    ...
    Rule729_4bPlayersMainGameCountersArent(Condition),
    ...
    Rule729_5CardsZoneLibraryExilePermanents(Condition),
    ...
    Rule729_5aEndSubgameCardNotZone(Condition),
    ...
    Rule729_5bEndSubgameVanguardCardZone(Condition),
    ...
    Rule729_5cEndSubgameCommanderGameZone(Condition),
    ...
    Rule730_2MergeObjectPermanentPlaceCard,
    ...
    Rule730_2aMergedPermanentCharacteristicsEffectTimestamp(Condition),
    ...
    Rule730_2bObjectMergesPermanentZoneBattlefield,
    ...
    Rule730_2cMergedPermanentObjectContinuousEffects,
    ...
    Rule730_2dMergedPermanentTokenResultingTopmost(Condition),
    ...
    Rule730_2eMergedPermanentFaceObjectEffects(Condition),
    ...
    Rule730_2fMergedPermanentTurnedFaceComponent(Condition),
    ...
    Rule730_2gPermanentCardCantTurnAbilities(Condition),
    ...
    Rule730_2hMergedPermanentFlipCardComponents(Condition),
    ...
    Rule730_3MergedPermanentLeavesBattlefieldZone(Condition),
    ...
    Rule730_3aMergedPermanentOwnersGraveyardLibrary(Condition),
    ...
    Rule730_3bPlayerExilesPermanentTimestampCards(Condition),
    ...
    Rule730_3cEffectObjectPermanentBattlefieldActions(Condition),
    ...
    Rule730_3dEffectsPermanentBattlefieldZoneObject(Condition),
    ...
    Rule730_3eEffectCardZonePermanentNot(Condition),
    ...
    Rule731_1DayNightDesignationsAbilitiesEffects,
    ...
    Rule731_1aPhrasesDayNightGameLosing,
    ...
    Rule731_2UntapStepGameChecksTurn(Condition),
    ...
    Rule731_2aDayPreviousTurnsCastSpells(Condition),
    ...
    Rule731_2bNightPreviousTurnsCastSpells(Condition),

    // 731.2c. If it’s neither day nor night, this check doesn’t happen and it remains neither.
    Rule731_2cDayNightCheckDoesntHappen(Condition),
    ...
    Rule732_1PlayingGamePlayersTypicallyAction(Condition),
    ...
    Rule732_1aShortcutsLargelyInformalLongPlayer,
    ...
    Rule732_1bOccasionallyGameStateActionsLoop,
    ...
    Rule732_1cTournamentsModifiedVersionGoverningPrecedence(Condition),

    // 732.2. Taking a shortcut follows the following procedure.
    Rule732_2ShortcutProcedure,
    ...
    Rule732_2aBasedStateCantActionsNot(Condition),
    ...
    Rule732_2bPlayerTurnOrderStartingSuggested(Condition),
    ...
    Rule732_5PlayerForcedPerformActionEnd(Condition),
    ...
    Rule732_6LoopEffectSaysBActions(Condition),
    ...
    Rule733_1ActionCantAbilitiesTriggerEffects(Condition),
    ...
    Rule733_2ReversingIllegalSpellsAbilitiesAction(Condition),
    ...
    Rule800_1MultiplayerGameThanPlayersAdditional,
    ...
    Rule800_2ConsistSeriesOptionsAddedMultiplayer,
    ...
    Rule800_4bObjectChangeBattlefieldStackZone(Condition),
    ...
    Rule800_4cEffectObjectNotStateBased(Condition),
    ...
    Rule800_4fObjectRequiresPlayerCostNot(Condition),
    ...
    Rule800_4gObjectRequiresPlayerLeftCost(Condition),
    ...
    Rule800_4hRequiresPlayerLeftGameTurn(Condition),
    ...
    Rule800_4iEffectRequiresPlayerCurrentActions(Condition),
    ...
    Rule800_4jTurnObjectStackResolvesPhase(Condition),

    // 800.4k. If a player who has left the game would begin a turn, that turn doesn’t begin.
    Rule800_4kPlayerLeftGameTurnDoesnt(Condition),
    ...
    Rule800_4mPlayerLeavesContinuousEffectsTurn(Condition),
    ...
    Rule800_4nPlayerLeavesAnteZoneNot(Condition),
    ...
    Rule800_4pPlanechaseGamePlayerDesignatedTurn(Condition),

    // 800.5. Unless a chosen variant or option prescribes otherwise, seating order is determined by any mutually agreeable method.
    Rule800_5ChosenVariantOptionPrescribesOtherwise(Condition),
    ...
    Rule800_6MultiplayerGameMulliganCardsLibrary,
    ...
    Rule800_7MultiplayerGameThanStepTurn,
    ...
    Rule801_1LimitedRangeInfluenceOptionApplied,
    ...
    Rule801_2PlayersSpellsAbilitiesEffectsDamage,
    ...
    Rule801_2dObjectPlayersRangeInfluenceControlled(Condition),
    ...
    Rule801_3CreaturesAttackOpponentsControllersCant(Condition),
    ...
    Rule801_4ObjectsPlayersCantSpellsAbilities,
    ...
    Rule801_5bPlayerAskedChooseOptionsNot(Condition),
    ...
    Rule801_7TriggeredAbilityDoesntTriggerEvent(Condition),
    ...
    Rule801_7aTriggerEventObjectStateAbility(Condition),
    ...
    Rule801_8CantObjectGraveyardStateBased(Condition),
    ...
    Rule801_9CantObjectPermanentBattlefieldState(Condition),
    ...
    Rule801_10SpellsAbilitiesCantAffectEffect,
    ...
    Rule801_11SpellAbilityRequiresGameControllers(Condition),
    ...
    Rule801_12WorldAppliesPermanentControllersRange(Condition),
    ...
    Rule801_13ReplacementPreventionEffectsWatchCant,
    ...
    Rule801_13aReplacementEffectSpellAbilityObject(Condition),
    ...
    Rule801_13bSpellAbilityEffectDamagePermanent(Condition),
    ...
    Rule801_14EffectPlayerWinsGameOpponents(Condition),
    ...
    Rule801_15EffectSpellAbilityGameDraw(Condition),
    ...
    Rule801_16GameSomehowLoopActionsObject(Condition),
    ...
    Rule801_17EffectsRestartGameExemptLimited,
    ...
    Rule801_18MultiplayerPlanechaseCardsAbilitiesEffects,
    ...
    Rule802_1MultiplayerGamesAllowAttackCombat(Condition),
    ...
    Rule802_2CombatPhaseStartsAttackingPlayer(Condition),
    ...
    Rule802_2aObjectEffectDefendingPlayerNot(Condition),
    ...
    Rule802_3AttackingCreatureAttackAttackersStep,
    ...
    Rule802_3aRestrictionsRequirementsDontBasedCreatures,

    // 802.3b. Creatures in a band can’t attack different players. See rule 702.22, “Banding.”
    Rule802_3bCreaturesBandCantAttackBanding,
    ...
    Rule802_4ThanPlayerAttackedApnapStep(Condition),
    ...
    Rule802_4aDefendingPlayerBlockCreaturesControl,
    ...
    Rule802_4bDefendingPlayersBlocksLegalCreatures(Condition),
    ...
    Rule802_5CombatDamageAssignedApnapStep,

    // 803. Attack Left and Attack Right Options

    // 803.1. Some multiplayer games use the optional attack left or attack right rules.
    Rule803_1MultiplayerGamesOptionalAttackLeft,
    ...
    Rule803_1aAttackLeftOptionPlayerCant(Condition),
    ...
    Rule803_1bAttackRightOptionPlayerCant(Condition),
    ...
    Rule805_1MultiplayerGamesTeamsSharedTurns(Condition),
    ...
    Rule805_2CantCreaturesAttackAbilitiesStack(Condition),
    ...
    Rule805_3MethodsTeamTurnWayStarting,
    ...
    Rule805_3aProcessTurnCardsLibraryHand(Condition),
    ...
    Rule805_5bActionsObjectStackResolvesPhase(Condition),
    ...
    Rule805_6ActivePlayerNonactiveOrderActions(Condition),
    ...
    Rule805_6aThanPlayerDrawCardsGame(Condition),
    ...
    Rule805_7MultipleTriggeredAbilitiesStackTurn(Condition),
    ...
    Rule805_8EffectPlayerTurnPhaseStep(Condition),
    ...
    Rule805_10aTeamsCreaturesAttackCombatPhase,
    ...
    Rule805_10bDeclareAttackersStepCreatureAttack,
    ...
    Rule805_10cObjectEffectAttackingPlayerNot(Condition),
    ...
    Rule805_10dDeclareBlockersStepCreaturesBlock,
    ...
    Rule805_10eObjectEffectDefendingPlayerNot(Condition),
    ...
    Rule806_2MultiplayerOptionsPlayFreeVariant,
    ...
    Rule806_2aLimitedRangeInfluenceOptionIsnt(Condition),
    ...
    Rule808_3MultiplayerOptionsPlayTeamVs,

    // 808.3a. The attack multiple players option is used (see rule 802).
    Rule808_3aAttackMultiplePlayersOption,
    ...
    Rule808_3bDeployCreaturesOptionsLimitedRange,
    ...
    Rule808_4PlayerRandomlyChooseTeamTurn(Condition),
    ...
    Rule810_5CardsHandNotCantPermanents(Condition),

    // 810.6. The team who plays first skips the draw step of its first turn.
    Rule810_6TeamPlaysSkipsStepTurn,
    ...
    Rule810_7HeadedGiantVariantCombatShared,
    ...
    Rule810_8HeadedGiantVariantNormalWinning,
    ...
    Rule810_9DamageLossLifeGainingHappen,
    ...
    Rule810_9aCostEffectNeedsValueIndividual(Condition),
    ...
    Rule810_9bCostEffectMembersNotZero(Condition),
    ...
    Rule810_9cEffectSetsSinglePlayersLife(Condition),
    ...
    Rule810_9dEffectSetLifeTotalPlayer(Condition),
    ...
    Rule810_9ePlayerCantExchangeLifeEffect(Condition),
    ...
    Rule810_9hEffectSaysPlayerCantZero(Condition),
    ...
    Rule810_10EffectsCausePlayersPoisonCounters,
    ...
    Rule810_10cEffectSaysPlayerCantPoison(Condition),
    ...
    Rule810_10dEffectNeedsKindsCountersPoisoned(Condition),
    ...
    Rule810_11HeadedGiantVariantPlayedEqually,
    ...
    Rule900_1AdditionalOptionalCasualGameVariants,
    ...
    Rule900_2CasualVariantsZonesCardsNot,
    ...
    Rule903_1CommanderVariantCreatedPopularizedCreature,
    ...
    Rule903_2CommanderGameFreeVariantAttack,
    ...
    Rule903_3CardCreatureNotObjectZones(Condition),
    ...
    Rule903_3aCardsAbilityCommanderModifiesDeck,
    ...
    Rule903_3bPlayersCommanderMeldCardPermanent(Condition),
    ...
    Rule903_3cPlayersCommanderComponentMergedPermanent(Condition),
    ...
    Rule903_3dEffectPermanentBattlefieldSpellZone(Condition),
    ...
    Rule903_3eEffectCommanderContinuousZonesLibrary(Condition),

    // 903.4. The Commander variant uses color identity to determine what cards can be in a deck with a certain commander. The color identity of a card is the color or colors of any mana symbols in that card’s mana cost or rules text, plus any colors defined by its characteristic-defining abilities (see rule 604.3) or color indicator (see rule 204).
    Rule903_4CommanderIdentityCardsCostAbilities,
    ...
    Rule903_4aColorIdentityEffectObjectCard(Condition),
    ...
    Rule903_4bCommanderStaticAbilityZonesIdentity(Condition),

    // 903.4c. Reminder text is ignored when determining a card’s color identity. See rule 207.2.
    Rule903_4cReminderTextIgnoredCardsIdentity(Condition),
    ...
    Rule903_4dFaceDoubleFacedCardIdentity(Condition),
    ...
    Rule903_4eCardAlternativeCharacteristicsAdventurerIdentity(Condition),
    ...
    Rule903_4fAbilityColorsNumberIdentityCosts(Condition),

    // 903.5. Each Commander deck is subject to the following deck construction rules.
    Rule903_5CommanderDeckConstructionRestrictions,
    ...
    Rule903_5aDeckContainExactlyCardsIncluding,
    ...
    Rule903_5bThanBasicLandsCardCommander,
    ...
    Rule903_5cCardIncludedCommanderDeckIdentity(Condition),

    // 903.5d. A card with a basic land type may be included in a Commander deck only if each color of mana it could produce is included in the commander’s color identity.
    Rule903_5dCardBasicLandTypeIdentity(Condition),

    // 903.5e. Commander games do not use sideboards.
    Rule903_5eCommanderGamesNotSideboards,
    ...
    Rule903_6StartGameZoneCardsLibrary(Condition),
    ...
    Rule903_7OnceStartingPlayerHandCards,
    ...
    Rule903_8CastCommanderZoneCostsTax,

    // 903.9. A commander may return to the command zone during a Commander game.
    Rule903_9CommanderReturnCommandZoneGame,

    // 903.9a. If a commander is in a graveyard or in exile and that object was put into that zone since the last time state-based actions were checked, its owner may put it into the command zone. This is a state-based action. See rule 704.
    Rule903_9aGraveyardExileObjectZoneState(Condition),

    // 903.9b. If a commander would be put into its owner’s hand or library from anywhere, its owner may put it into the command zone instead. This replacement effect may apply more than once to the same event. This is an exception to rule 614.5.
    Rule903_9bCommanderHandLibraryZoneEffect(Condition),
    ...
    Rule903_9cCommanderPermanentZoneEffectCard(Condition),
    ...
    Rule903_10CommanderVariantIncludesSpecificationWinning,
    ...
    Rule903_10aCombatDamageStateBasedAction,
    ...
    Rule903_11ExceptSpecialActionsEffectsCards,
    ...
    Rule903_11aPlayerAllowedCardCantIdentity(Condition),

    // 903.12. Brawl Option
    Rule903_12BrawlOption,
    ...
    Rule903_12aBrawlOptionStyleCommanderGame,

    // 903.12b. Brawl decks are usually constructed using cards from the Standard format.
    Rule903_12bBrawlDecksConstructedCardsStandard,
    ...
    Rule903_12cDeckLegendaryCardDesignatedCreature,
    ...
    Rule903_12dPlayersDeckContainExactlyCards,
    ...
    Rule903_12ePlayersCommanderColorsIdentityDeck(Condition),
    ...
    Rule903_12fPlayerBrawlGameStartingLife,
    ...
    Rule903_12gBrawlGameMulliganCardsLibrary,
    ...
    Rule903_12hNotStateBasedActionCombat(Condition),

    // 903.13. Commander Draft
    Rule903_13CommanderDraft,
    ...
    Rule903_13aCommanderDraftOptionStyleCards,
    ...
    Rule903_13bDraftTypicallyConsistsRoundsCards,
    ...
    Rule903_13cDraftRoundsBoosterPacksPassed,
    ...
    Rule903_13dDraftPlayerCardsNotAbility(Condition),
    ...
    Rule903_13eDraftCompleteCardsPlayerDrafted(Condition),
